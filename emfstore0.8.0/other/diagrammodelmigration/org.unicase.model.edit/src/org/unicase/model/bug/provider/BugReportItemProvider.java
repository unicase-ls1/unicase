...
public class BugReportItemProvider extends AnnotationItemProvider implements IEditingDomainItemProvider,
	...
	protected void addIncludingReleasesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_WorkItem_includingReleases_feature"),
	...
	protected void addResolutionTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_BugReport_resolutionType_feature"),
	...
	public Object getImage(Object object) {
		if (object instanceof BugReport) {
			...
			if (bugReport.getSeverity().equals(Severity.BLOCKER)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/Bug_blocker.png"));
			}
			if (bugReport.getSeverity().equals(Severity.TRIVIAL)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/Bug_trivial.png"));
			}
			if (bugReport.getSeverity().equals(Severity.MINOR)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/Bug_minor.png"));
			}
			if (bugReport.getSeverity().equals(Severity.MAJOR)) {
				return overlayImage(object, getResourceLocator().getImage("full/obj16/Bug_major.png"));
			}
		}
