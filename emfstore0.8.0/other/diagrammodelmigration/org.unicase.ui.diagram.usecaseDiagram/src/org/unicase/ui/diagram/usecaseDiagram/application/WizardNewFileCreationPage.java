...
public class WizardNewFileCreationPage extends WizardPage {
	...
	public void createControl(Composite parent) {
		...
		label
				.setText(org.unicase.ui.diagram.usecaseDiagram.part.Messages.WizardNewFileCreationPage_FileLabel);
		...
		button
				.setText(org.unicase.ui.diagram.usecaseDiagram.part.Messages.WizardNewFileCreationPage_BrowseButton);
	...
	protected boolean validatePage() {
		String fileName = fileNameEditor.getText().trim();
		if (fileName.length() == 0) {
			setErrorMessage(org.unicase.ui.diagram.usecaseDiagram.part.Messages.WizardNewFileCreationPage_EmptyFileNameError);
			return false;
		}
		if (!new Path("").isValidPath(fileName)) { //$NON-NLS-1$
			setErrorMessage(org.unicase.ui.diagram.usecaseDiagram.part.Messages.WizardNewFileCreationPage_InvalidFileNameError);
			return false;
		}
