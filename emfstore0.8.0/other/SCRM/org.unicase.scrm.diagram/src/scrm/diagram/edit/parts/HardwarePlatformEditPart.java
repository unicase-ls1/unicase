 ...
 * @generated
 */
public class HardwarePlatformEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwarePlatformEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwarePlatformEditPart.VISUAL_ID));
		}
		return parser;
	}
