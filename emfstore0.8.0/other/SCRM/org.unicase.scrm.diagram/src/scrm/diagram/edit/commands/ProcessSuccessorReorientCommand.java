 ...
 * @generated
 */
public class ProcessSuccessorReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ProcessSuccessorReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProcessSuccessor_4047(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistProcessSuccessor_4047(getOldSource(), getNewTarget());
	}
