...
public class MathematicalModelMathematicalExpressionEditPart extends
	 ...
	 * @generated
	 */
	public MathematicalModelMathematicalExpressionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelMathematicalExpressionEditPart.VISUAL_ID));
		}
		return parser;
	}
