...
/**
 * This is the item provider adapter for a {@link traceRecovery.Directory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DirectoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Directory_path_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Directory_path_feature", "_UI_Directory_type"),
				 TraceRecoveryPackage.Literals.DIRECTORY__PATH,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Directory.class)) {
			case TraceRecoveryPackage.DIRECTORY__PATH:
	...
	public ResourceLocator getResourceLocator() {
		return TraceRecoveryEditPlugin.INSTANCE;
	}
