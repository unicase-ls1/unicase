...
/**
 * This is the item provider adapter for a {@link traceRecovery.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceRecoveryPackage.Literals.LINK__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addStrengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_strength_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_strength_feature", "_UI_Link_type"),
				 TraceRecoveryPackage.Literals.LINK__STRENGTH,
				 true,
				 false,
				 false,
	...
	protected void addConfidencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_confidence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_confidence_feature", "_UI_Link_type"),
				 TraceRecoveryPackage.Literals.LINK__CONFIDENCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceRecoveryPackage.Literals.LINK__SOURCE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TraceRecoveryPackage.Literals.LINK__TARGET,
				 true,
				 false,
				 true,
				 null,
