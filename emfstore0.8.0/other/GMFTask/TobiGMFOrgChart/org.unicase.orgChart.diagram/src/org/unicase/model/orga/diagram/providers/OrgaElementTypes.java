...
public class OrgaElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType OrgDiagram_666 = getElementType("org.unicase.orgChart.diagram.OrgDiagram_666"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(OrgDiagram_666, OrgaPackage.eINSTANCE.getOrgDiagram());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(OrgDiagram_666);
