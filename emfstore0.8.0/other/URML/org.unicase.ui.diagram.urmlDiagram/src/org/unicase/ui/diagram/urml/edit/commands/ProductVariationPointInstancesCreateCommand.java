...
public class ProductVariationPointInstancesCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof VariationPointInstance) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getVariationPointInstances().add(getTarget());
		}
	 ...
	 * @generated
	 */
	protected VariationPointInstance getTarget() {
		return (VariationPointInstance) target;
	}
}
