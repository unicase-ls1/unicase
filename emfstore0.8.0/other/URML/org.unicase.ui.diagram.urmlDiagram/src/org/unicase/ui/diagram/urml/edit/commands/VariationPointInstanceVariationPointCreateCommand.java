...
public class VariationPointInstanceVariationPointCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof VariationPointInstance) {
			return false;
		}
		if (target != null && false == target instanceof VariationPoint) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setVariationPoint(getTarget());
		}
	 ...
	 * @generated
	 */
	protected VariationPointInstance getSource() {
		return (VariationPointInstance) source;
	}

	/**
	 * @generated
	 */
	protected VariationPoint getTarget() {
		return (VariationPoint) target;
	}
}
