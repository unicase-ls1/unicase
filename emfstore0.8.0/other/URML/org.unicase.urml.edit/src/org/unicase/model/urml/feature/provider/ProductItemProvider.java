...
/**
 * This is the item provider adapter for a {@link org.unicase.model.urml.feature.Product} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ProductItemProvider extends UrmlModelElementItemProvider implements IEditingDomainItemProvider,
	...
	protected void addFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Product_features_feature"), getString(
			"_UI_PropertyDescriptor_description", "_UI_Product_features_feature", "_UI_Product_type"),
			FeaturePackage.Literals.PRODUCT__FEATURES, true, false, true, null, null, null));
	}
