...
public class UseCaseStepsControlTest extends UITestSetup {
	...
	/**
	 * Modifying the fields in use-case step programatically and checking if it is reflected in UI.
	 */
	@Test
	...
	/**
	 * Modifying the attributes of system step and validating the changes propagated to UI.
	 */
	@Test
	...
	/**
	 * Modify the fields for a usecase step widget from UI and check if it is reflected in underlying ME.
	 */
	@SuppressWarnings("unchecked")
	@Test
