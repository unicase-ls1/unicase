...
public class AssessmentControlTest extends UITestSetup {
	...
	/**
	 * Create issue adds criteria,proposal and finally asses it...everything from UI along with validating the changes
	 * in the underlying ME.
	 */
	...
	/**
	 * Sets the assessment value programattically and see if the UI reflects it.
	 */
	@SuppressWarnings("unchecked")
	@Test
