...
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Book <em>Book</em>}'. <!-- begin-user-doc --> This
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Library <em>Library</em>}'. <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Writer <em>Writer</em>}'. <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
