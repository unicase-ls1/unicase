...
public class ImportXMIAction implements IActionDelegate {
	...
	private void runImport(Object firstElement) {
		if (firstElement instanceof IFile) {
			...
			final ProjectSpaceInternal projectSpace = dialog.getProjectSpace();
	...
	private void importFile(final ProjectSpaceInternal projectSpace, final URI fileURI, final Resource resource,
	 ...
	 */
	private void runImport(final ProjectSpaceInternal projectSpace, final org.eclipse.emf.common.util.URI uri,
