 ...
 * @generated
 */
public class ActivityPackageImpl extends EPackageImpl implements
		ActivityPackage {
	/**
	...
	public static ActivityPackage init() {
		if (isInited)
			return (ActivityPackage) EPackage.Registry.INSTANCE
		...
		ActivityPackageImpl theActivityPackage = (ActivityPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ActivityPackageImpl ? EPackage.Registry.INSTANCE
		...
		EPackage.Registry.INSTANCE.put(ActivityPackage.eNS_URI,
				theActivityPackage);
	...
	public EReference getActivityObject_IncomingTransitions() {
		return (EReference) activityObjectEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(activityObjectEClass,
				ACTIVITY_OBJECT__INCOMING_TRANSITIONS);
		createEReference(activityObjectEClass,
				ACTIVITY_OBJECT__OUTGOING_TRANSITIONS);
	...
	public void initializePackageContents() {
		...
		activityObjectEClass.getESuperTypes().add(
		...
		initEClass(activityObjectEClass, ActivityObject.class,
				"ActivityObject", IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActivityObject_IncomingTransitions(),
				this.getTransition(), this.getTransition_Target(),
				"incomingTransitions", null, 0, -1, ActivityObject.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getActivityObject_OutgoingTransitions(),
				this.getTransition(), this.getTransition_Source(),
				"outgoingTransitions", null, 0, -1, ActivityObject.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEReference(getTransition_Source(), this.getActivityObject(),
				this.getActivityObject_OutgoingTransitions(), "source", null,
				0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTransition_Target(), this.getActivityObject(),
				this.getActivityObject_IncomingTransitions(), "target", null,
				0, 1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(forkEClass, Fork.class, "Fork", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(branchEClass, Branch.class, "Branch", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(activityInitialEClass, ActivityInitial.class,
				"ActivityInitial", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(activityEndEClass, ActivityEnd.class, "ActivityEnd",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}
