...
public class UtilPackageImpl extends EPackageImpl implements UtilPackage {
	...
	public EReference getModelElementPath_Source() {
		return (EReference) modelElementPathEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void initializePackageContents() {
		...
		initEClass(modelElementPathEClass, ModelElementPath.class,
				"ModelElementPath", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getModelElementPath_Source(),
				theModelPackage_2.getModelElementId(), null, "source", null, 0,
				1, ModelElementPath.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModelElementPath_Target(),
				theModelPackage_2.getModelElementId(), null, "target", null, 0,
				1, ModelElementPath.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getModelElementPath_Path(),
				theModelPackage_2.getModelElementId(), null, "path", null, 0,
				-1, ModelElementPath.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
