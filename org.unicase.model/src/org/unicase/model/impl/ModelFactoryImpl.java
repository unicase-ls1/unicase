...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case ModelPackage.TEST_FOR_DIAGRAM: return createTestForDiagram();
			default:
	 ...
	 * @generated
	 */
	public TestForDiagram createTestForDiagram() {
		TestForDiagramImpl testForDiagram = new TestForDiagramImpl();
		return testForDiagram;
	}
