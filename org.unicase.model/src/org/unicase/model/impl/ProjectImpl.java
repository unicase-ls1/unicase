...
import org.unicase.model.util.ModelElementCache;
...
public class ProjectImpl extends EObjectImpl implements Project {
	...
	private ModelElementCache modelElementCache;
	private boolean cacheIsInitialized;
	...
	public <T extends ModelElement> EList<T> getAllModelElementsbyClass(EClass modelElementClass, EList<T> list,
		...
		if (subclasses) {
			for (ModelElement modelElement : getModelElementCache().getEntries()) {
	 ...
	 */
	private ModelElementCache getModelElementCache() {
	...
	private void initCacheAndNotifier() {
		if (!cacheIsInitialized) {
			...
			// init order of notifier and cache is crucial!
			new ProjectChangeNotifier(this);
			modelElementCache = new ModelElementCache(this);
		}
	}
	...
	public void handleEMFModelElementAdded(Project project, ModelElement modelElement) {
		if (this.modelElementCache.contains(modelElement.getModelElementId())) {
	...
	public boolean contains(ModelElementId modelElementId) {
		return this.getModelElementCache().contains(modelElementId);
	}
	...
	public ModelElement getModelElement(ModelElementId modelElementId) {
		return this.getModelElementCache().getModelElement(modelElementId);
	}
	...
	public boolean containsInstance(ModelElement modelElement) {
		...
		ModelElement element = this.getModelElementCache().getModelElement(modelElementId);
