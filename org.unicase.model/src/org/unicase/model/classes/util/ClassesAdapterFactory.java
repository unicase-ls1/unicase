...
public class ClassesAdapterFactory extends AdapterFactoryImpl {
	...
	protected ClassesSwitch<Adapter> modelSwitch = new ClassesSwitch<Adapter>() {
		...
		@Override
		public Adapter caseObject(org.unicase.model.classes.Object object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.classes.Object <em>Object</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
