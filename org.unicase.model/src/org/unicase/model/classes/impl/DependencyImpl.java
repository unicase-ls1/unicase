...
public class DependencyImpl extends ModelElementImpl implements Dependency {
		...
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.DEPENDENCY__SOURCE, oldSource,
							source));
			}
		}
		return source;
	...
	public NotificationChain basicSetSource(PackageElement newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassesPackage.DEPENDENCY__SOURCE,
					oldSource, newSource);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSource(PackageElement newSource) {
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this, ClassesPackage.PACKAGE_ELEMENT__OUTGOING_DEPENDENCIES,
						PackageElement.class, msgs);
			if (newSource != null)
				msgs = ((InternalEObject) newSource).eInverseAdd(this, ClassesPackage.PACKAGE_ELEMENT__OUTGOING_DEPENDENCIES,
						PackageElement.class, msgs);
			msgs = basicSetSource(newSource, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.DEPENDENCY__SOURCE, newSource, newSource));
	}
	...
	public PackageElement getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ClassesPackage.DEPENDENCY__TARGET, oldTarget,
							target));
			}
		}
		return target;
	...
	public NotificationChain basicSetTarget(PackageElement newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ClassesPackage.DEPENDENCY__TARGET,
					oldTarget, newTarget);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTarget(PackageElement newTarget) {
		if (newTarget != target) {
			NotificationChain msgs = null;
			if (target != null)
				msgs = ((InternalEObject) target).eInverseRemove(this, ClassesPackage.PACKAGE_ELEMENT__INCOMING_DEPENDENCIES,
						PackageElement.class, msgs);
			if (newTarget != null)
				msgs = ((InternalEObject) newTarget).eInverseAdd(this, ClassesPackage.PACKAGE_ELEMENT__INCOMING_DEPENDENCIES,
						PackageElement.class, msgs);
			msgs = basicSetTarget(newTarget, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ClassesPackage.DEPENDENCY__TARGET, newTarget, newTarget));
	}
