 ...
 *   <li>{@link org.unicase.model.classes.impl.ClassImpl#getBlob <em>Blob</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ClassImpl extends PackageElementImpl implements
	 ...
	 * @ordered
	 */
	protected static final Enumerator BLOB_EDEFAULT = null;
	/**
	 ...
	 * @ordered
	 */
	protected Enumerator blob = BLOB_EDEFAULT;
	...
	public void setInstantiationType(InstantiationType newInstantiationType) {
		...
		instantiationType = newInstantiationType == null ? INSTANTIATION_TYPE_EDEFAULT
				: newInstantiationType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassesPackage.CLASS__INSTANTIATION_TYPE,
	 ...
	 * @generated
	 */
	public void setBlob(Enumerator newBlob) {
		Enumerator oldBlob = blob;
		blob = newBlob;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ClassesPackage.CLASS__BLOB, oldBlob, blob));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case ClassesPackage.CLASS__BLOB:
			return BLOB_EDEFAULT == null ? blob != null : !BLOB_EDEFAULT
					.equals(blob);
		}
