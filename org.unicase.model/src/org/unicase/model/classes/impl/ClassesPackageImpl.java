...
public class ClassesPackageImpl extends EPackageImpl implements ClassesPackage {
	...
	public void initializePackageContents() {
		...
		objectEClass.getESuperTypes().add(theModelPackage.getModelElement());
		...
		initEReference(getClass_ParticipatedUseCases(), theRequirementPackage.getUseCase(), theRequirementPackage
			.getUseCase_ParticipatingClasses(), "participatedUseCases", null, 0, -1,
		...
		initEReference(getClass_Instances(), this.getObject(), this.getObject_Class(), "instances", null, 0, -1,
			org.unicase.model.classes.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getClass_Instances().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());

		initEClass(packageEClass, org.unicase.model.classes.Package.class, "Package", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPackage_ContainedPackageElements(), this.getPackageElement(), this
		...
		initEClass(objectEClass, org.unicase.model.classes.Object.class, "Object", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getObject_Class(), this.getClass_(), this.getClass_Instances(), "class", null, 0, 1,
			org.unicase.model.classes.Object.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getObject_Class().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
