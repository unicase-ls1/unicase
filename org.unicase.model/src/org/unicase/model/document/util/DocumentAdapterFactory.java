...
public class DocumentAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.document.LeafSection
	 * <em>Leaf Section</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.document.CompositeSection
	 * <em>Composite Section</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
