...
public class DocumentPackageImpl extends EPackageImpl implements DocumentPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getLeafSection_ModelElements(), theModelPackage.getModelElement(), theModelPackage
				.getModelElement_LeafSection(), "modelElements", null, 0, -1, LeafSection.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getCompositeSection_Subsections(), this.getSection(), this.getSection_Parent(), "subsections", null, 0,
				-1, CompositeSection.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
		...
		initEReference(getSection_Parent(), this.getCompositeSection(), this.getCompositeSection_Subsections(), "parent", null,
				0, 1, Section.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation(getLeafSection_ReferencedModelElements(), source, new String[] { "priority", "21.0", "position", "right" });
		addAnnotation(getCompositeSection_Subsections(), source, new String[] { "priority", "20.0", "position", "right" });
	}
