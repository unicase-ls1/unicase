...
public interface TaskPackage extends EPackage {
	...
	/**
	 * Returns the meta object for the reference list '{@link org.unicase.model.task.WorkItem#getIncludingReleases <em>Including Releases</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference WORK_ITEM__INCLUDING_RELEASES = eINSTANCE
				.getWorkItem_IncludingReleases();
		 ...
		 * @generated
		 */
		EReference MILESTONE__CONTAINED_MODEL_ELEMENTS = eINSTANCE
				.getMilestone_ContainedModelElements();
