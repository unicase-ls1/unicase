...
public interface TaskPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.unicase.model.task.WorkItem
	...
	/**
	 * The feature id for the '<em><b>Containing Workpackage</b></em>' container
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Associated Change Packages</b></em>'
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 ...
	 * {@link org.unicase.model.task.impl.ActionItemImpl <em>Action Item</em>}'
	...
	/**
	 * The meta object id for the '
	 * {@link org.unicase.model.task.impl.WorkPackageImpl <em>Work Package</em>}
	 * ' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The feature id for the '<em><b>Contained Work Items</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 ...
	 * {@link org.unicase.model.task.ActionItem#getAssignedTo
	...
	/**
	 * Returns the meta object for the reference list '
	 * {@link org.unicase.model.task.WorkItem#getAssociatedChangePackages
	 * <em>Associated Change Packages</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @return the meta object for the reference list '
	 *         <em>Associated Change Packages</em>'.
	...
	interface Literals {
		 ...
		 * {@link org.unicase.model.task.impl.ActionItemImpl
		 * <em>Action Item</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see org.unicase.model.task.impl.ActionItemImpl
		 * @see org.unicase.model.task.impl.TaskPackageImpl#getActionItem()
		...
		/**
		 * The meta object literal for the '<em><b>Due Date</b></em>' attribute
		...
		/**
		 * The meta object literal for the '<em><b>Done</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Estimate</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '
		 * {@link org.unicase.model.task.impl.WorkPackageImpl
		 * <em>Work Package</em>}' class. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see org.unicase.model.task.impl.WorkPackageImpl
		 * @see org.unicase.model.task.impl.TaskPackageImpl#getWorkPackage()
		...
		/**
		 * The meta object literal for the '<em><b>Contained Work Items</b></em>
		...
		/**
		 * The meta object literal for the '
		 * {@link org.unicase.model.task.WorkItem <em>Work Item</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.unicase.model.task.WorkItem
		 * @see org.unicase.model.task.impl.TaskPackageImpl#getWorkItem()
		...
		/**
		 * The meta object literal for the '
		 * <em><b>Containing Workpackage</b></em>' container reference feature.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '
		 * <em><b>Associated Change Packages</b></em>' reference list feature.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
