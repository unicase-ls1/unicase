...
public class WorkPackageImpl extends AnnotationImpl implements WorkPackage {
	...
	public WorkPackage getContainingWorkpackage() {
		if (eContainerFeatureID != TaskPackage.WORK_PACKAGE__CONTAINING_WORKPACKAGE) return null;
	...
	public NotificationChain basicSetContainingWorkpackage(WorkPackage newContainingWorkpackage, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newContainingWorkpackage, TaskPackage.WORK_PACKAGE__CONTAINING_WORKPACKAGE, msgs);
		return msgs;
	}
	...
	public void setContainingWorkpackage(WorkPackage newContainingWorkpackage) {
		if (newContainingWorkpackage != eInternalContainer() || (eContainerFeatureID != TaskPackage.WORK_PACKAGE__CONTAINING_WORKPACKAGE && newContainingWorkpackage != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, TaskPackage.WORK_PACKAGE__CONTAINING_WORKPACKAGE, newContainingWorkpackage, newContainingWorkpackage));
	}
	...
	public EList<ModelChangePackage> getAssociatedChangePackages() {
		if (associatedChangePackages == null) {
			associatedChangePackages = new EObjectResolvingEList<ModelChangePackage>(ModelChangePackage.class, this, TaskPackage.WORK_PACKAGE__ASSOCIATED_CHANGE_PACKAGES);
		}
	...
	public EList<WorkItem> getContainedWorkItems() {
		if (containedWorkItems == null) {
			containedWorkItems = new EObjectContainmentWithInverseEList<WorkItem>(WorkItem.class, this, TaskPackage.WORK_PACKAGE__CONTAINED_WORK_ITEMS, TaskPackage.WORK_ITEM__CONTAINING_WORKPACKAGE);
		}
