...
public class ActionItemImpl extends AnnotationImpl implements ActionItem {
	 ...
	 * 
	 * @param newChecked the new state <!-- end-user-doc -->
	 * @generated NOT
	 */
	...
	public User getReviewer() {
		if (reviewer != null && reviewer.eIsProxy()) {
			...
			if (reviewer != oldReviewer) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							TaskPackage.ACTION_ITEM__REVIEWER, oldReviewer,
							reviewer));
			}
		}
		return reviewer;
	...
	public NotificationChain basicSetReviewer(User newReviewer,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, TaskPackage.ACTION_ITEM__REVIEWER,
	...
	public void setReviewer(User newReviewer) {
		if (newReviewer != reviewer) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaskPackage.ACTION_ITEM__REVIEWER, newReviewer, newReviewer));
	}
	...
	public void setPriority(int newPriority) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaskPackage.ACTION_ITEM__PRIORITY, oldPriority, priority));
	}
	...
	public void setResolved(boolean newResolved) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaskPackage.ACTION_ITEM__RESOLVED, oldResolved, resolved));
	}
	...
	public EList<AbstractRelease> getIncludingReleases() {
		if (includingReleases == null) {
			includingReleases = new EObjectWithInverseResolvingEList.ManyInverse<AbstractRelease>(
					...
					TaskPackage.ACTION_ITEM__INCLUDING_RELEASES,
