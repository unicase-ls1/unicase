...
/**
 * Interface for MEState. An meestate element calculates the state for a
 * modelelement.
 * 
 * @author helming
 * 
...
public interface MEState {
	 ...
	 * @return <code>true</code> if the remove modelelement was in the reference
	 *         list of modified subelements.
	 */
