 ...
 * @generated
 */
public class StereotypeImpl extends UnicaseModelElementImpl implements
		Stereotype {
	/**
	...
	public void setRequired(boolean newRequired) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProfilePackage.STEREOTYPE__REQUIRED, oldRequired, required));
	}
	...
	public NotificationChain basicSetProfile(Profile newProfile,
		...
		msgs = eBasicSetContainer((InternalEObject) newProfile,
				ProfilePackage.STEREOTYPE__PROFILE, msgs);
		return msgs;
	}
		...
		if (newProfile != eInternalContainer()
			...
			if (newProfile != null)
				msgs = ((InternalEObject) newProfile).eInverseAdd(this,
						ProfilePackage.PROFILE__STEREOTYPES, Profile.class,
						msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					ProfilePackage.STEREOTYPE__PROFILE, newProfile, newProfile));
	}
	...
	public EList<StereotypeInstance> getStereotypeInstances() {
		if (stereotypeInstances == null) {
			stereotypeInstances = new EObjectWithInverseResolvingEList<StereotypeInstance>(
					StereotypeInstance.class, this,
					ProfilePackage.STEREOTYPE__STEREOTYPE_INSTANCES,
					ProfilePackage.STEREOTYPE_INSTANCE__STEREOTYPE);
		}
	...
	public EList<StereotypeAttribute> getStereotypeAttributes() {
		if (stereotypeAttributes == null) {
			stereotypeAttributes = new EObjectContainmentWithInverseEList.Resolving<StereotypeAttribute>(
					StereotypeAttribute.class, this,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case ProfilePackage.STEREOTYPE__STEREOTYPE_INSTANCES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getStereotypeInstances())
					.basicAdd(otherEnd, msgs);
		case ProfilePackage.STEREOTYPE__STEREOTYPE_ATTRIBUTES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getStereotypeAttributes())
					.basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case ProfilePackage.STEREOTYPE__STEREOTYPE_INSTANCES:
			return ((InternalEList<?>) getStereotypeInstances()).basicRemove(
					otherEnd, msgs);
		case ProfilePackage.STEREOTYPE__STEREOTYPE_ATTRIBUTES:
			return ((InternalEList<?>) getStereotypeAttributes()).basicRemove(
					otherEnd, msgs);
		}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(
		...
		case ProfilePackage.STEREOTYPE__PROFILE:
			return eInternalContainer().eInverseRemove(this,
					ProfilePackage.PROFILE__STEREOTYPES, Profile.class, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ProfilePackage.STEREOTYPE__STEREOTYPE_INSTANCES:
			...
			getStereotypeInstances().addAll(
					(Collection<? extends StereotypeInstance>) newValue);
			return;
		case ProfilePackage.STEREOTYPE__STEREOTYPE_ATTRIBUTES:
			getStereotypeAttributes().clear();
			getStereotypeAttributes().addAll(
					(Collection<? extends StereotypeAttribute>) newValue);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ProfilePackage.STEREOTYPE__STEREOTYPE_INSTANCES:
			return stereotypeInstances != null
					&& !stereotypeInstances.isEmpty();
		case ProfilePackage.STEREOTYPE__STEREOTYPE_ATTRIBUTES:
			return stereotypeAttributes != null
					&& !stereotypeAttributes.isEmpty();
		}
