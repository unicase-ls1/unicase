 ...
 * @generated
 */
public class FunctionalRequirementImpl extends UnicaseModelElementImpl
		implements FunctionalRequirement {
	...
	public void setCost(int newCost) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RequirementPackage.FUNCTIONAL_REQUIREMENT__COST, oldCost,
					cost));
	}
	...
	public void setDone(boolean newDone) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					RequirementPackage.FUNCTIONAL_REQUIREMENT__DONE, oldDone,
					done));
	}
