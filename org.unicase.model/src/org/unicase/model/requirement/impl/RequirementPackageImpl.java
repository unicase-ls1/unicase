...
public class RequirementPackageImpl extends EPackageImpl implements RequirementPackage {
	 ...
	 * @generated
	 */
	public EReference getNonFunctionalRequirement_ConstrainedScenarios() {
	 ...
	 * @generated
	 */
	public EReference getNonFunctionalRequirement_ConstrainedUseCases() {
	 ...
	 * @generated
	 */
	public EReference getNonFunctionalRequirement_ConstrainedFRs() {
	...
	public EReference getFunctionalRequirement_DetailedFeatures() {
		return (EReference) functionalRequirementEClass.getEStructuralFeatures().get(9);
	}
	 ...
	 * @generated
	 */
	public EReference getFunctionalRequirement_DetailedUseCases() {
	 ...
	 * @generated
	 */
	public EReference getUseCase_DetailingFunctionalRequirements() {
	 ...
	 * @generated
	 */
	public EReference getUseCase_ConstrainingNFRs() {
	 ...
	 * @generated
	 */
	public EReference getUseCase_ParticipatingClasses() {
	 ...
	 * @generated
	 */
	public EReference getUseCase_DescribedFeatures() {
	 ...
	 * @generated
	 */
	public EReference getFeature_DescribingUseCases() {
	 ...
	 * @generated
	 */
	public EReference getFeature_RefiningFeatures() {
	 ...
	 * @generated
	 */
	public EReference getFeature_DetailingRequirements() {
	...
	public void createPackageContents() {
		...
		createEReference(nonFunctionalRequirementEClass, NON_FUNCTIONAL_REQUIREMENT__CONSTRAINED_SCENARIOS);
		createEReference(nonFunctionalRequirementEClass, NON_FUNCTIONAL_REQUIREMENT__CONSTRAINED_USE_CASES);
		createEReference(nonFunctionalRequirementEClass, NON_FUNCTIONAL_REQUIREMENT__CONSTRAINED_FRS);
		...
		createEReference(functionalRequirementEClass, FUNCTIONAL_REQUIREMENT__DETAILED_USE_CASES);
		...
		createEReference(useCaseEClass, USE_CASE__DETAILING_FUNCTIONAL_REQUIREMENTS);
		createEReference(useCaseEClass, USE_CASE__CONSTRAINING_NF_RS);
		createEReference(useCaseEClass, USE_CASE__PARTICIPATING_CLASSES);
		createEReference(useCaseEClass, USE_CASE__INCLUDED_USE_CASES);
		createEReference(useCaseEClass, USE_CASE__EXTENDED_USE_CASES);
		createEReference(useCaseEClass, USE_CASE__DESCRIBED_FEATURES);
		...
		createEReference(featureEClass, FEATURE__DESCRIBING_USE_CASES);
		createEReference(featureEClass, FEATURE__REFINING_FEATURES);
		createEReference(featureEClass, FEATURE__DETAILING_REQUIREMENTS);
	}
	...
	public void initializePackageContents() {
		...
		featureEClass.getESuperTypes().add(theModelPackage.getModelElement());

		// Initialize classes and features; add operations and parameters
		initEClass(nonFunctionalRequirementEClass, NonFunctionalRequirement.class, "NonFunctionalRequirement",
			!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getNonFunctionalRequirement_ConstrainedScenarios(), this.getScenario(), this
			.getScenario_NonFunctionalRequirements(), "constrainedScenarios", null, 0, -1,
			NonFunctionalRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getNonFunctionalRequirement_ConstrainedScenarios().getEKeys().add(
			theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getNonFunctionalRequirement_ConstrainedUseCases(), this.getUseCase(), null,
			"constrainedUseCases", null, 0, -1, NonFunctionalRequirement.class, !IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getNonFunctionalRequirement_ConstrainedUseCases().getEKeys().add(
			theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getNonFunctionalRequirement_ConstrainedFRs(), this.getUseCase(), this
			.getUseCase_ConstrainingNFRs(), "constrainedFRs", null, 0, -1, NonFunctionalRequirement.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		getNonFunctionalRequirement_ConstrainedFRs().getEKeys()
		...
		getFunctionalRequirement_RefiningRequirements().getEKeys().add(
			theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getFunctionalRequirement_DetailedUseCases(), this.getUseCase(), this
			.getUseCase_DetailingFunctionalRequirements(), "detailedUseCases", null, 0, -1,
			FunctionalRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getFunctionalRequirement_DetailedUseCases().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		...
		initEAttribute(getFunctionalRequirement_Cost(), ecorePackage.getEInt(), "cost", null, 0, 1,
			FunctionalRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getFunctionalRequirement_DetailedFeatures(), this.getFeature(), this
			.getFeature_DetailingRequirements(), "detailedFeatures", null, 0, -1, FunctionalRequirement.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUseCase_DetailingFunctionalRequirements(), this.getFunctionalRequirement(), this
			.getFunctionalRequirement_DetailedUseCases(), "detailingFunctionalRequirements", null, 0, -1,
			UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUseCase_DetailingFunctionalRequirements().getEKeys()
			.add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getUseCase_ConstrainingNFRs(), this.getNonFunctionalRequirement(), this
			.getNonFunctionalRequirement_ConstrainedFRs(), "constrainingNFRs", null, 0, -1, UseCase.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		getUseCase_ConstrainingNFRs().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getUseCase_ParticipatingClasses(), theClassesPackage.getClass_(), theClassesPackage
			.getClass_ParticipatedUseCases(), "participatingClasses", null, 0, -1, UseCase.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
		getUseCase_ParticipatingClasses().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		...
		initEReference(getUseCase_DescribedFeatures(), this.getFeature(), this.getFeature_DescribingUseCases(),
			"describedFeatures", null, 0, -1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUseCase_DescribedFeatures().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		...
		initEReference(getScenario_NonFunctionalRequirements(), this.getNonFunctionalRequirement(), this
			.getNonFunctionalRequirement_ConstrainedScenarios(), "nonFunctionalRequirements", null, 0, -1,
		...
		initEReference(getFeature_DescribingUseCases(), this.getUseCase(), this.getUseCase_DescribedFeatures(),
			"describingUseCases", null, 0, -1, Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getFeature_DescribingUseCases().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getFeature_RefiningFeatures(), this.getFeature(), null, "refiningFeatures", null, 0, -1,
			Feature.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getFeature_RefiningFeatures().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getFeature_DetailingRequirements(), this.getFunctionalRequirement(), this
			.getFunctionalRequirement_DetailedFeatures(), "detailingRequirements", null, 0, -1, Feature.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		getFeature_DetailingRequirements().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation(getNonFunctionalRequirement_ConstrainedScenarios(), source, new String[] { "priority", "9.1",
			"position", "right" });
		addAnnotation(getNonFunctionalRequirement_ConstrainedUseCases(), source, new String[] { "priority", "9.2",
			"position", "right" });
		...
		addAnnotation(getFunctionalRequirement_RefiningRequirements(), source, new String[] { "priority", "12.0",
			"position", "right" });
		addAnnotation(getFunctionalRequirement_DetailedUseCases(), source, new String[] { "priority", "10.0",
			"position", "right" });
		...
		addAnnotation(getUseCase_DetailingFunctionalRequirements(), source, new String[] { "priority", "11.0",
			"position", "right" });
		addAnnotation(getUseCase_ConstrainingNFRs(), source, new String[] { "priority", "12.0", "position", "right" });
		addAnnotation(getUseCase_ParticipatingClasses(), source,
