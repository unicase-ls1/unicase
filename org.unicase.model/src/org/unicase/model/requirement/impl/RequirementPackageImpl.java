...
public class RequirementPackageImpl extends EPackageImpl implements RequirementPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getFunctionalRequirement_Cost(), theEcorePackage.getEInt(), "cost", null, 0, 1,
			FunctionalRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUseCase_IncludingUseCases(), this.getUseCase(), this.getUseCase_IncludedUseCases(),
			"includingUseCases", null, 0, -1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUseCase_IncludingUseCases().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		...
		initEReference(getUseCase_ExtendingUseCases(), this.getUseCase(), this.getUseCase_ExtendedUseCases(),
			"extendingUseCases", null, 0, -1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUseCase_ExtendingUseCases().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getUseCase_IncludedUseCases(), this.getUseCase(), this.getUseCase_IncludingUseCases(),
			"includedUseCases", null, 0, -1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getUseCase_IncludedUseCases().getEKeys().add(theModelPackage.getIdentifiableElement_Identifier());
		initEReference(getUseCase_ExtendedUseCases(), this.getUseCase(), this.getUseCase_ExtendingUseCases(),
			"extendedUseCases", null, 0, -1, UseCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation(getUseCase_NonFunctionalRequirements(), source, new String[] { "priority", "12.0", "position",
			"right" });
		addAnnotation(getUseCase_IncludingUseCases(), source, new String[] { "priority", "12.0", "position", "left" });
		addAnnotation(getUseCase_IdentifiedClasses(), source, new String[] { "priority", "13.0", "position", "right" });
		addAnnotation(getUseCase_ExtendingUseCases(), source, new String[] { "priority", "13.0", "position", "left" });
