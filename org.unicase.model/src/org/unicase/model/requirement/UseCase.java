 ...
 * org.unicase.model.requirement.UseCase#getFunctionalRequirements <em>Functional Requirements</em>}</li> <li>{@link
 * org.unicase.model.requirement.UseCase#getNonFunctionalRequirements <em>Non Functional Requirements</em>}</li>
 * <li>{@link org.unicase.model.requirement.UseCase#getIdentifiedClasses <em>Identified Classes</em>}</li> <li>{@link
 * org.unicase.model.requirement.UseCase#getIncludedUseCases <em>Included Use Cases</em>}</li> <li>{@link
 * org.unicase.model.requirement.UseCase#getExtendedUseCases <em>Extended Use Cases</em>}</li> </ul> </p>
