...
public class AttachmentFactoryImpl extends EFactoryImpl implements
	...
	public static AttachmentFactory init() {
		try {
			AttachmentFactory theAttachmentFactory = (AttachmentFactory) EPackage.Registry.INSTANCE
					.getEFactory(AttachmentPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public FileAttachmentType createFileAttachmentTypeFromString(
	 ...
	 * @generated
	 */
	public String convertFileAttachmentTypeToString(EDataType eDataType,
