...
public interface AttachmentPackage extends EPackage {
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute FILE_ATTACHMENT__FILE_NAME = eINSTANCE
				.getFileAttachment_FileName();
		 ...
		 * @generated
		 */
		EAttribute FILE_ATTACHMENT__FILE_HASH = eINSTANCE
				.getFileAttachment_FileHash();
		 ...
		 * @generated
		 */
		EAttribute FILE_ATTACHMENT__FILE_ID = eINSTANCE
				.getFileAttachment_FileID();
		 ...
		 * @generated
		 */
		EAttribute FILE_ATTACHMENT__FILE_SIZE = eINSTANCE
				.getFileAttachment_FileSize();
		 ...
		 * @generated
		 */
		EAttribute FILE_ATTACHMENT__FILE_TYPE = eINSTANCE
				.getFileAttachment_FileType();
