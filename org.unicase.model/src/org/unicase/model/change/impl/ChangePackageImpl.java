...
public class ChangePackageImpl extends EPackageImpl implements ChangePackage {
	...
	public static ChangePackage init() {
		...
		ChangePackageImpl theChangePackage = (ChangePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof ChangePackageImpl ? EPackage.Registry.INSTANCE
	...
	public void initializePackageContents() {
		...
		initEReference(getMergingIssue_BaseVersion(),
				theVersioningPackage.getPrimaryVersionSpec(), null,
				"baseVersion", null, 0, 1, MergingIssue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getMergingIssue_TargetVersion(),
				theVersioningPackage.getPrimaryVersionSpec(), null,
				"targetVersion", null, 0, 1, MergingIssue.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMergingProposal_PendingOperations(),
				theOperationsPackage.getAbstractOperation(), null,
				"pendingOperations", null, 0, -1, MergingProposal.class,
		...
		initEClass(mergingSolutionEClass, MergingSolution.class,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getMergingSolution_AppliedOperations(),
				theOperationsPackage.getAbstractOperation(), null,
				"appliedOperations", null, 0, -1, MergingSolution.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
	}
