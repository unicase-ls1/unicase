 ...
 * The following features are supported: <ul> <li>{@link org.unicase.model.rationale.Comment#getSender
 * <em>Sender</em>}</li> <li>{@link org.unicase.model.rationale.Comment#getRecipients <em>Recipients</em>}</li>
 * <li>{@link org.unicase.model.rationale.Comment#getCommentedElement <em>Commented Element</em>}</li> </ul> </p>
