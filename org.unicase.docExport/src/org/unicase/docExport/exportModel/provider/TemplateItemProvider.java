...
/**
 * This is the item provider adapter for a {@link org.unicase.docExport.exportModel.Template} object. <!--
...
public class TemplateItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Template_name_feature"), getString(
			"_UI_PropertyDescriptor_description", "_UI_Template_name_feature", "_UI_Template_type"),
			ExportModelPackage.Literals.TEMPLATE__NAME, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
			null, null));
	}

	/**
	 * This adds a property descriptor for the Default Template feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDefaultTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors
			.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
				getResourceLocator(), getString("_UI_Template_defaultTemplate_feature"), getString(
					"_UI_PropertyDescriptor_description", "_UI_Template_defaultTemplate_feature", "_UI_Template_type"),
				ExportModelPackage.Literals.TEMPLATE__DEFAULT_TEMPLATE, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Template_type") : getString("_UI_Template_type")
			+ " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			ExportModelPackage.Literals.TEMPLATE__MODEL_ELEMENT_RENDERER_MAPPING, RenderersFactory.eINSTANCE
				.createModelElementRendererMapping()));

		newChildDescriptors.add(createChildParameter(ExportModelPackage.Literals.TEMPLATE__LAYOUT_OPTIONS,
			OptionsFactory.eINSTANCE.createLayoutOptions()));

		newChildDescriptors.add(createChildParameter(ExportModelPackage.Literals.TEMPLATE__GLOBAL_RENDERER_OPTIONS,
