 ...
 * <ul>
 * <li>{@link org.unicase.docExport.exportModel.renderers.options.impl.DateAttributeOptionImpl#getGlobalOption <em>
 * Global Option</em>}</li>
...
public class DateAttributeOptionImpl extends AttributeOptionImpl implements DateAttributeOption {
			...
			if (globalOption != oldGlobalOption) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						OptionsPackage.DATE_ATTRIBUTE_OPTION__GLOBAL_OPTION, oldGlobalOption, globalOption));
			}
		}
		return globalOption;
	}
	...
	public void setGlobalOption(DateAttributeOption newGlobalOption) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.DATE_ATTRIBUTE_OPTION__GLOBAL_OPTION,
				oldGlobalOption, globalOption));
	}
