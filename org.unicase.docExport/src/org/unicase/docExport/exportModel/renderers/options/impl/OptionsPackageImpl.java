...
public class OptionsPackageImpl extends EPackageImpl implements OptionsPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getRendererOption_Name(), theEcorePackage.getEString(), "name", null, 0, 1,
			RendererOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);

		initEClass(attributeOptionEClass, AttributeOption.class, "AttributeOption", IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getAttributeOption_Hide(), theEcorePackage.getEBoolean(), "hide", "false", 0, 1,
			AttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeOption_OverwriteGlobalOption(), theEcorePackage.getEBoolean(),
			"overwriteGlobalOption", "false", 0, 1, AttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeOption_AttributeText(), theEcorePackage.getEString(), "attributeText", null, 0, 1,
			AttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getAttributeOption_OrderNumber(), theEcorePackage.getEInt(), "orderNumber", null, 0, 1,
			AttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSingleReferenceAttributeOption_GlobalOption(), this.getSingleReferenceAttributeOption(),
			null, "globalOption", null, 0, 1, SingleReferenceAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE,
		...
		initEReference(getMultiReferenceAttributeOption_GlobalOption(), this.getMultiReferenceAttributeOption(), null,
			"globalOption", null, 0, 1, MultiReferenceAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getStringAttributeOption_GlobalOption(), this.getStringAttributeOption(), null, "globalOption",
			null, 0, 1, StringAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getLayoutOptions_SectionTextOption(), this.getTextOption(), null, "sectionTextOption", null, 0,
			1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideAnnotations(), theEcorePackage.getEBoolean(), "hideAnnotations", null, 0,
			1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideAttachments(), theEcorePackage.getEBoolean(), "hideAttachments", null, 0,
			1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideIncomingDocumentReferences(), theEcorePackage.getEBoolean(),
			"hideIncomingDocumentReferences", null, 0, 1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE,
			IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideModelElementImages(), theEcorePackage.getEBoolean(),
			"hideModelElementImages", null, 0, 1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getLayoutOptions_ModelElementTextOption(), this.getTextOption(), null, "modelElementTextOption",
			...
			!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HeaderText(), theEcorePackage.getEString(), "headerText", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_FooterText(), theEcorePackage.getEString(), "footerText", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getLayoutOptions_SectionOption(), this.getSectionOption(), null, "sectionOption", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_SectionFontSizeDecreaseStep(), theEcorePackage.getEInt(),
		...
		initEAttribute(getLayoutOptions_ShowModelElementTypeInSectionTitle(), theEcorePackage.getEBoolean(),
		...
		initEAttribute(getLayoutOptions_AppendixStyle(), this.getAppendixStyle(), "appendixStyle", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_LogoImage(), theEcorePackage.getEString(), "logoImage", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getLayoutOptions_FooterTextOption(), this.getTextOption(), null, "footerTextOption", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_FooterShowDocumentTitle(), theEcorePackage.getEBoolean(),
		...
		initEAttribute(getLayoutOptions_HeaderStyle(), this.getHeaderStyle(), "headerStyle", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_LogoWidth(), theEcorePackage.getEInt(), "logoWidth", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_LogoHeight(), theEcorePackage.getEInt(), "logoHeight", null, 0, 1,
			LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_LogoOnCoverPage(), theEcorePackage.getEBoolean(), "logoOnCoverPage", null, 0,
			1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getLayoutOptions_TableOfContentsTextOption(), this.getTextOption(), null,
			...
			IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideTableOfContents(), theEcorePackage.getEBoolean(), "hideTableOfContents",
			null, 0, 1, LayoutOptions.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID,
			IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getLayoutOptions_HideHeaderAndFooterOnCoverPage(), theEcorePackage.getEBoolean(),
		...
		initEAttribute(getTextOption_FontFamily(), this.getFontFamily(), "fontFamily", "", 0, 1, TextOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTextOption_FontSize(), theEcorePackage.getEInt(), "fontSize", "12", 0, 1, TextOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTextOption_Bold(), theEcorePackage.getEBoolean(), "bold", null, 0, 1, TextOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTextOption_Underline(), theEcorePackage.getEBoolean(), "underline", null, 0, 1,
		...
		initEAttribute(getTextOption_TextAlign(), this.getTextAlign(), "textAlign", null, 0, 1, TextOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTextOption_Italics(), theEcorePackage.getEBoolean(), "italics", null, 0, 1, TextOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(referenceAttributeOptionEClass, ReferenceAttributeOption.class, "ReferenceAttributeOption",
			IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReferenceAttributeOption_Contained(), theEcorePackage.getEBoolean(), "contained", null, 0, 1,
		...
		initEAttribute(getUColor_Red(), theEcorePackage.getEInt(), "red", null, 0, 1, UColor.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUColor_Green(), theEcorePackage.getEInt(), "green", null, 0, 1, UColor.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getUColor_Blue(), theEcorePackage.getEInt(), "blue", null, 0, 1, UColor.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(boxModelOptionEClass, BoxModelOption.class, "BoxModelOption", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getBoxModelOption_Margin(), theEcorePackage.getEDouble(), "margin", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_MarginTop(), theEcorePackage.getEDouble(), "marginTop", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_MarginLeft(), theEcorePackage.getEDouble(), "marginLeft", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_MarginBottom(), theEcorePackage.getEDouble(), "marginBottom", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_MarginRight(), theEcorePackage.getEDouble(), "marginRight", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_Border(), theEcorePackage.getEDouble(), "border", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_BorderTop(), theEcorePackage.getEDouble(), "borderTop", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_BorderLeft(), theEcorePackage.getEDouble(), "borderLeft", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_BorderBottom(), theEcorePackage.getEDouble(), "borderBottom", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_BorderRight(), theEcorePackage.getEDouble(), "borderRight", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		...
		initEReference(getBoxModelOption_BorderColor(), this.getUColor(), null, "borderColor", null, 0, 1,
			...
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_Padding(), theEcorePackage.getEDouble(), "padding", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_PaddingTop(), theEcorePackage.getEDouble(), "paddingTop", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_PaddingLeft(), theEcorePackage.getEDouble(), "paddingLeft", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_PaddingBottom(), theEcorePackage.getEDouble(), "paddingBottom", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_PaddingRight(), theEcorePackage.getEDouble(), "paddingRight", "0", 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getBoxModelOption_BackgroundColor(), this.getUColor(), null, "backgroundColor", null, 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_KeepTogether(), theEcorePackage.getEBoolean(), "keepTogether", null, 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_KeepWithPrevious(), theEcorePackage.getEBoolean(), "keepWithPrevious", null,
			0, 1, BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_KeepWithNext(), theEcorePackage.getEBoolean(), "keepWithNext", null, 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_BreakBefore(), theEcorePackage.getEBoolean(), "breakBefore", null, 0, 1,
			BoxModelOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getBoxModelOption_Width(), theEcorePackage.getEInt(), "width", null, 0, 1, BoxModelOption.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getSectionOption_SectionNumberingStyle(), this.getSectionNumberingStyle(),
			...
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSectionOption_LeaveOutPreviousSectionNumbering(), theEcorePackage.getEBoolean(),
		...
		initEClass(booleanAttributeOptionEClass, BooleanAttributeOption.class, "BooleanAttributeOption", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getBooleanAttributeOption_GlobalOption(), this.getBooleanAttributeOption(), null,
			"globalOption", null, 0, 1, BooleanAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(dateAttributeOptionEClass, DateAttributeOption.class, "DateAttributeOption", !IS_ABSTRACT,
			!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDateAttributeOption_GlobalOption(), this.getDateAttributeOption(), null, "globalOption",
			null, 0, 1, DateAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
			IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
