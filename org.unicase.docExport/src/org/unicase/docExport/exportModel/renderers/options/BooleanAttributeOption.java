 ...
 * <ul>
 * <li>{@link org.unicase.docExport.exportModel.renderers.options.BooleanAttributeOption#getGlobalOption <em>Global
 * Option</em>}</li>
 * <li>{@link org.unicase.docExport.exportModel.renderers.options.BooleanAttributeOption#getBooleanStyle <em>Boolean
 * Style</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface BooleanAttributeOption extends AttributeOption {
	...
	/**
	 * Returns the value of the '<em><b>Boolean Style</b></em>' attribute. The literals are from the enumeration
	 * {@link org.unicase.docExport.exportModel.renderers.options.BooleanStyle}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <em>Boolean Style</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
