 ...
 * @generated
 */
public class VariationPointItemProvider extends AbstractFeatureItemProvider
	...
	protected void addOptionalSubFeaturesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getResourceLocator(),
				getString("_UI_VariationPoint_optionalSubFeatures_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VariationPoint_optionalSubFeatures_feature",
						"_UI_VariationPoint_type"),
				FeaturePackage.Literals.VARIATION_POINT__OPTIONAL_SUB_FEATURES,
	...
	protected void addMultiplicityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_VariationPoint_multiplicity_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VariationPoint_multiplicity_feature",
						"_UI_VariationPoint_type"),
				FeaturePackage.Literals.VARIATION_POINT__MULTIPLICITY, true,
	...
	protected void addInstancesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_VariationPoint_instances_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_VariationPoint_instances_feature",
						"_UI_VariationPoint_type"),
				FeaturePackage.Literals.VARIATION_POINT__INSTANCES, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(FeaturePackage.Literals.VARIATION_POINT__OPTIONAL_SUB_FEATURES);
		}
