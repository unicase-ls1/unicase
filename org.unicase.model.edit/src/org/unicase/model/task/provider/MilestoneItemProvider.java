 ...
 * @generated
 */
public class MilestoneItemProvider extends AnnotationItemProvider {
	/**
	...
	protected void addContainedModelElementsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Milestone_containedModelElements_feature",
						"_UI_Milestone_type"),
				TaskPackage.Literals.MILESTONE__CONTAINED_MODEL_ELEMENTS, true,
				false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(TaskPackage.Literals.MILESTONE__CONTAINED_MODEL_ELEMENTS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Milestone"));
	}
