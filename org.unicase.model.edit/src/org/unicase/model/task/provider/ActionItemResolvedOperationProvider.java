...
/**
 * Provider class for visualization of resolved/unresolved operations in the
 * commitDialog.
 * 
 * @author Michael Kagel
 */
public class ActionItemResolvedOperationProvider extends
		DefaultOperationLabelProvider {

	/**
	 * Checks if the attributeOperation is a resolved or unresolved operation,
	 * if this is true the method returns 1 otherwise 0. {@inheritDoc}
	 * 
	...
	public CanRender canRender(AbstractOperation operation) {
		...
		// if (attOp.getFeatureName().equals("resolved")
		// && attOp.getNewValue() != null
		// && attOp.getOldValue() != null
		...
		if ((Boolean) attOp.getNewValue()) {
			return "Resolved "
					+ AbstractOperationItemProvider
							.getModelElementClassAndName((attOp
									.getModelElementId()));
		} else {
			return "Unresolved "
					+ AbstractOperationItemProvider
