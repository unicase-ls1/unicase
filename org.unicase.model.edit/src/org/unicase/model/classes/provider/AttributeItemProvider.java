 ...
 * @generated
 */
public class AttributeItemProvider extends UnicaseModelElementItemProvider {
	/**
	...
	protected void addVisibilityPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Attribute_visibility_feature",
						"_UI_Attribute_type"),
				ClassesPackage.Literals.ATTRIBUTE__VISIBILITY, true, false,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				ClassesPackage.Literals.ATTRIBUTE__TYPE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Attribute_id_feature", "_UI_Attribute_type"),
				ClassesPackage.Literals.ATTRIBUTE__ID, true, false, false,
	...
	protected void addImplementationTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Attribute_implementationType_feature",
						"_UI_Attribute_type"),
				ClassesPackage.Literals.ATTRIBUTE__IMPLEMENTATION_TYPE, true,
	...
	protected void addImplementationEnumerationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Attribute_implementationEnumeration_feature",
						"_UI_Attribute_type"),
				ClassesPackage.Literals.ATTRIBUTE__IMPLEMENTATION_ENUMERATION,
	...
	protected void addTransientPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_Attribute_transient_feature",
								"_UI_Attribute_type"),
						ClassesPackage.Literals.ATTRIBUTE__TRANSIENT, true,
						false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
