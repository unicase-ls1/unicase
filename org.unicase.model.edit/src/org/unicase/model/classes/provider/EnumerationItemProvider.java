 ...
 * @generated
 */
public class EnumerationItemProvider extends PackageElementItemProvider {
	/**
	...
	protected void addAttributesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_Enumeration_attributes_feature",
						"_UI_Enumeration_type"),
				ClassesPackage.Literals.ENUMERATION__ATTRIBUTES, true, false,
				true, null, null, null));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ClassesPackage.Literals.ENUMERATION__LITERALS,
