...
public class MergingProposalItemProvider extends ProposalItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ChangePackage.Literals.MERGING_PROPOSAL__PENDING_OPERATIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/MergingProposal"));
	}
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				ChangePackage.Literals.MERGING_PROPOSAL__PENDING_OPERATIONS,
