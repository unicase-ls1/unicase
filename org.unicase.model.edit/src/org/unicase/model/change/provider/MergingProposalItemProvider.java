 ...
 * @generated
 */
public class MergingProposalItemProvider
	extends ProposalItemProvider
	implements
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_MergingProposal_conflictingProposals_feature", "_UI_MergingProposal_type"),
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_MergingProposal_pendingChanges_feature", "_UI_MergingProposal_type"),
				 ChangePackage.Literals.MERGING_PROPOSAL__PENDING_CHANGES,
				 true,
				 false,
				 true,
				 null,
