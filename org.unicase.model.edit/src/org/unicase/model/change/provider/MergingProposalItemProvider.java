...
public class MergingProposalItemProvider extends ProposalItemProvider implements IEditingDomainItemProvider,
	...
	/**
	 * This adds a property descriptor for the Conflicting Proposals feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	protected void addConflictingProposalsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			...
			getString("_UI_MergingProposal_conflictingProposals_feature"), getString(
				"_UI_PropertyDescriptor_description", "_UI_MergingProposal_conflictingProposals_feature",
				"_UI_MergingProposal_type"), ChangePackage.Literals.MERGING_PROPOSAL__CONFLICTING_PROPOSALS, true,
	...
	protected void addPendingChangesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			...
			getString("_UI_PropertyDescriptor_description", "_UI_MergingProposal_pendingChanges_feature",
				"_UI_MergingProposal_type"), ChangePackage.Literals.MERGING_PROPOSAL__PENDING_CHANGES, true, false,
			true, null, null, null));
	}
