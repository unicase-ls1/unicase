...
public class MergingIssueItemProvider extends IssueItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(ChangePackage.Literals.MERGING_ISSUE__BASE_VERSION);
			childrenFeatures
					.add(ChangePackage.Literals.MERGING_ISSUE__TARGET_VERSION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/MergingIssue"));
	}
