 ...
 * 
 * @author Hodaie
 *   This handlers handles annotateActionItem command.
 *   This command creates a new template action item, 
 *   attaches it to the selected model element, and opens it. 
 *   
 *
 */
...
public class AnnotateActionItemHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		//1. extract the model element, to which the action item will be attached
		//   see #getModelElement()
	...
	private ModelElement getModelElement(ExecutionEvent event) {
		...
		if (partId.equals(MEEDITOR_ID)){
			Object o = HandlerUtil.getVariable(event, MEEDITOR_EVALUATIONSERVICE_VARIABLE);
			me = (ModelElement) o;
