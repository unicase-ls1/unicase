 ...
 * @generated
 */
public class MeetingItemProvider extends UnicaseModelElementItemProvider {
	/**
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Meeting"));
	}
			...
			if (starttime != null) {
				return text
						...
						+ DateFormat.getDateTimeInstance(DateFormat.SHORT,
								DateFormat.SHORT, Locale.GERMANY).format(
								starttime.getTime()) + ")";
			}
		}
		return text;
