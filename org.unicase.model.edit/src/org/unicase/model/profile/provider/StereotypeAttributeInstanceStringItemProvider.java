 ...
 * @generated
 */
public class StereotypeAttributeInstanceStringItemProvider extends
		StereotypeAttributeInstanceItemProvider implements
	 ...
	 * @generated
	 */
	public StereotypeAttributeInstanceStringItemProvider(
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_StereotypeAttributeInstanceString_value_feature",
								"_UI_StereotypeAttributeInstanceString_type"),
						ProfilePackage.Literals.STEREOTYPE_ATTRIBUTE_INSTANCE_STRING__VALUE,
						true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/StereotypeAttributeInstanceString"));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_StereotypeAttributeInstanceString_type")
				: getString("_UI_StereotypeAttributeInstanceString_type") + " "
						+ label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification
				.getFeatureID(StereotypeAttributeInstanceString.class)) {
