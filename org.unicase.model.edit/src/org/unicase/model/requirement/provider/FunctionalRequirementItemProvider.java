 ...
 * @generated
 */
public class FunctionalRequirementItemProvider extends
	...
	protected void addCostPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_FunctionalRequirement_cost_feature",
						"_UI_FunctionalRequirement_type"),
				RequirementPackage.Literals.FUNCTIONAL_REQUIREMENT__COST, true,
	...
	protected void addDonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_FunctionalRequirement_done_feature",
						"_UI_FunctionalRequirement_type"),
				RequirementPackage.Literals.FUNCTIONAL_REQUIREMENT__DONE, true,
