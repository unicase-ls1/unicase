 ...
 * @generated
 */
public class UseCaseItemProvider extends UnicaseModelElementItemProvider {
	/**
	...
	protected void addSystemFunctionsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UseCase_systemFunctions_feature",
						"_UI_UseCase_type"),
				RequirementPackage.Literals.USE_CASE__SYSTEM_FUNCTIONS, true,
				false, true, null, null, null));
	}
	...
	protected void addDonePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description",
						"_UI_UseCase_done_feature", "_UI_UseCase_type"),
				RequirementPackage.Literals.USE_CASE__DONE, true, false, false,
	...
	protected void addUseCaseStepsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_UseCase_useCaseSteps_feature",
								"_UI_UseCase_type"),
