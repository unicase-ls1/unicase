 ...
 * @generated
 */
public class MitigationItemProvider extends ModelElementItemProvider implements IEditingDomainItemProvider,
	...
	/**
	 * This adds a property descriptor for the Technique feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addTechniquePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Mitigation_technique_feature"), getString(
			"_UI_PropertyDescriptor_description", "_UI_Mitigation_technique_feature", "_UI_Mitigation_type"),
			HazardPackage.Literals.MITIGATION__TECHNIQUE, true, false, false,
	...
	protected void addEvaluationStatusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Mitigation_evaluationStatus_feature"),
			getString("_UI_PropertyDescriptor_description", "_UI_Mitigation_evaluationStatus_feature",
				"_UI_Mitigation_type"), HazardPackage.Literals.MITIGATION__EVALUATION_STATUS, true, false, false,
			ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addCausesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			.getRootAdapterFactory(), getResourceLocator(), getString("_UI_Mitigation_causes_feature"), getString(
			"_UI_PropertyDescriptor_description", "_UI_Mitigation_causes_feature", "_UI_Mitigation_type"),
			HazardPackage.Literals.MITIGATION__CAUSES, true, false, true, null, null, null));
	}
	...
	/**
	 * This returns Mitigation.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
