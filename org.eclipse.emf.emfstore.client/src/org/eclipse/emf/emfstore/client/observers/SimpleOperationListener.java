...
public abstract class SimpleOperationListener implements OperationListener, CommitObserver {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.emfstore.client.observers.OperationListener#operationExecuted(org.eclipse.emf.emfstore.server.model.versioning.operations.AbstractOperation)
	 */
	 ...
	 * NULL!
	 * 
	 * @see org.eclipse.emf.emfstore.client.observers.CommitObserver#commitCompleted(org.eclipse.emf.emfstore.client.core.ProjectSpaceInternal,
	 *      org.eclipse.emf.emfstore.server.model.versioning.PrimaryVersionSpec)
	 */
	public void commitCompleted(ProjectSpaceInternal projectSpace, PrimaryVersionSpec newRevision) {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.emfstore.client.observers.CommitObserver#inspectChanges(org.eclipse.emf.emfstore.client.core.ProjectSpaceInternal,
	 *      org.eclipse.emf.emfstore.server.model.versioning.ChangePackage)
	 */
	public boolean inspectChanges(ProjectSpaceInternal projectSpace, ChangePackage changePackage) {
		return true;
	}
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.emfstore.client.observers.OperationListener#operationUnDone(org.eclipse.emf.emfstore.server.model.versioning.operations.AbstractOperation)
	 */
