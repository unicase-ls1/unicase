...
/**
 * An observer which waits for commit notifications and authorizes the commit
 * procedure.
 * 
 * @author shterev
 */
...
public interface CommitObserver {
	...
	/**
	 * Called before the commit proceeds. A callback method to initiate the
	 * commit dialog and allow the user to confirm the changes.
	 * 
	 * @param projectSpace
	 *            the project space the commit occurs on
	 * @param changePackage
	 *            the change package
	 * @return true if the changes have been confirmed, false - otherwise.
	 */
	boolean inspectChanges(ProjectSpaceData projectSpace,
	 ...
	 * 
	 * @param projectSpace
	 *            the {@link ProjectSpaceInternal}
	 * @param newRevision
	 *            the new revision that was created by the commit
	 */
	void commitCompleted(ProjectSpaceData projectSpace,
