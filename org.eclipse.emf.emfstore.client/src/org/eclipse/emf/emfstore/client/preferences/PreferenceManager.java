...
public final class PreferenceManager {
	 ...
	 */
	public OrgUnitProperty getProperty(ProjectSpaceInternal projectSpace, PropertyKey key) {
		try {
	 ...
	 */
	public void setProperty(ProjectSpaceInternal projectSpace, PropertyKey key, String value) {
	 ...
	 * @param value the value
	 */
	public void setProperty(ProjectSpaceInternal projectSpace, PropertyKey key, EObject[] value) {
		OrgUnitProperty property = createProperty(key, value);
		projectSpace.setProperty(property);
	}
	 ...
	 * @param value the value
	 */
	public void setProperty(ProjectSpaceInternal projectSpace, PropertyKey key, int value) {
		OrgUnitProperty property = createProperty(key, value);
		projectSpace.setProperty(property);
	}
	 ...
	 * @param value the value
	 */
	public void setProperty(ProjectSpaceInternal projectSpace, PropertyKey key, boolean value) {
		OrgUnitProperty property = createProperty(key, value);
		projectSpace.setProperty(property);
	}
