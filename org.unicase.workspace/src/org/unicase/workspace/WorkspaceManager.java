...
public final class WorkspaceManager {
	...
	private Workspace initWorkSpace() {
		...
		// internalDomain.getChangeRecorder().dispose();
		try {
			Field declaredField = TransactionalEditingDomainImpl.class.getDeclaredField("recorder");
			declaredField.setAccessible(true);
			try {
				TransactionChangeRecorder recorder = new TransactionChangeRecorder(internalDomain, resourceSet) {
				...
				TransactionChangeRecorder oldRecorder = (TransactionChangeRecorder) declaredField.get(domain);
				oldRecorder.dispose();
				declaredField.set(domain, recorder);
