...
public final class WorkspaceUtil {
	...
	public static String cleanFormatedText(String text) {
		...
		if (Configuration.getRTFStatus()) {
			// the text should be already clear of html formatting
			return text;
		}
		text = convertRTFtoPlain(text);
		return text;
	}

	/**
	 * Converts html formatted rich text to plain text.
	 * 
	 * @param text the html text
	 * @return plain text.
	 */
	public static String convertRTFtoPlain(String text) {
		if (text == null) {
			return "";
		}
	 ...
	 * @return a string only containing the plain text
	 */
	public static String cleanBeginnText(String text) {
		String ret = "";
