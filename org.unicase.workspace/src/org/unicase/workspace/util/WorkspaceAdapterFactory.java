...
public class WorkspaceAdapterFactory extends AdapterFactoryImpl {
	...
	protected WorkspaceSwitch<Adapter> modelSwitch =
		new WorkspaceSwitch<Adapter>() {
			...
			@Override
			public Adapter caseServerInfoAggregation(ServerInfoAggregation object) {
				return createServerInfoAggregationAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.workspace.ServerInfoAggregation <em>Server Info Aggregation</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
