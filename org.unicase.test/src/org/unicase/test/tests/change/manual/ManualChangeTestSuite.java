...
public class ManualChangeTestSuite extends ChangeTestSuite {
	...
	public void initTestCases() {
		// BidirectionalNonContainmentReference bidirectionalRefTest = new
		// BidirectionalNonContainmentReference(getTestProjectSpace(), "bidirectional ref", getTestProjectPrams());
