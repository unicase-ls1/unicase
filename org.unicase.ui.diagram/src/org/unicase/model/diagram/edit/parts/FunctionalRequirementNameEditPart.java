...
import org.unicase.model.diagram.providers.ModelParserProvider;

/**
 * @generated
 */
public class FunctionalRequirementNameEditPart extends LabelEditPart implements
	...
	static {
		registerSnapBackPosition(
				ModelVisualIDRegistry
						.getType(org.unicase.model.diagram.edit.parts.FunctionalRequirementNameEditPart.VISUAL_ID),
				new Point(0, 0));
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof ModelTextSelectionEditPolicy) {
			((ModelTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new ModelParserProvider.HintAdapter(
					ModelElementTypes.Class_1001, getParserElement(),
					parserHint);
