package org.unicase.model.diagram.sheet;
...
import org.unicase.model.diagram.navigator.ModelNavigatorGroup;
...
public class ModelSheetLabelProvider extends DecoratingLabelProvider {
	...
	public ModelSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(ModelDiagramEditorPlugin
	...
	public String getText(Object element) {
		...
		if (selected instanceof ModelNavigatorGroup) {
			return ((ModelNavigatorGroup) selected).getGroupName();
		}
