...
public interface LibraryPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link library.impl.LibraryBaseImpl <em>Base</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see library.impl.LibraryBaseImpl
	 * @see library.impl.LibraryPackageImpl#getLibraryBase()
	 * @generated
	 */
	int LIBRARY_BASE = 3;
	 ...
	 * @ordered
	 */
	int BOOK__IDENTIFIER = LIBRARY_BASE__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int BOOK__CREATOR = LIBRARY_BASE__CREATOR;
	 ...
	 * @ordered
	 */
	int BOOK__CREATION_DATE = LIBRARY_BASE__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int BOOK__TITLE = LIBRARY_BASE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int BOOK__PAGES = LIBRARY_BASE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int BOOK__AUTHOR = LIBRARY_BASE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int BOOK__PUBLICATION_YEAR = LIBRARY_BASE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int BOOK_FEATURE_COUNT = LIBRARY_BASE_FEATURE_COUNT + 4;
	 ...
	 * @ordered
	 */
	int LIBRARY__SECTIONS = LIBRARY_BASE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LIBRARY__AUTHORS = LIBRARY_BASE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LIBRARY_FEATURE_COUNT = LIBRARY_BASE_FEATURE_COUNT + 2;
	...
	/**
	 * The meta object id for the '{@link library.impl.SectionImpl <em>Section</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see library.impl.SectionImpl
	 * @see library.impl.LibraryPackageImpl#getSection()
	 * @generated
	 */
	int SECTION = 4;
	 ...
	 * @ordered
	 */
	int SECTION__IDENTIFIER = LIBRARY_BASE__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int SECTION__CREATOR = LIBRARY_BASE__CREATOR;
	 ...
	 * @ordered
	 */
	int SECTION__CREATION_DATE = LIBRARY_BASE__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int SECTION__BOOKS = LIBRARY_BASE_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int SECTION__CATEGORY = LIBRARY_BASE_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int SECTION__SECTION_NAME = LIBRARY_BASE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int SECTION_FEATURE_COUNT = LIBRARY_BASE_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the attribute '{@link library.Book#getPublicationYear <em>Publication Year</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Publication Year</em>'.
	 * @see library.Book#getPublicationYear()
	 * @see #getBook()
	 * @generated
	 */
	EAttribute getBook_PublicationYear();
	...
	/**
	 * Returns the meta object for the containment reference list '{@link library.Library#getSections <em>Sections</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Sections</em>'.
	 * @see library.Library#getSections()
	 * @see #getLibrary()
	 * @generated
	 */
	EReference getLibrary_Sections();
	...
	/**
	 * Returns the meta object for class '{@link library.LibraryBase <em>Base</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link library.Section <em>Section</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the containment reference list '{@link library.Section#getBooks <em>Books</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Books</em>'.
	 * @see library.Section#getBooks()
	 * @see #getSection()
	 * @generated
	 */
	EReference getSection_Books();

	/**
	 * Returns the meta object for the attribute '{@link library.Section#getCategory <em>Category</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Category</em>'.
	 * @see library.Section#getCategory()
	 * @see #getSection()
	 * @generated
	 */
	EAttribute getSection_Category();

	/**
	 * Returns the meta object for the attribute '{@link library.Section#getSectionName <em>Section Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Section Name</em>'.
	 * @see library.Section#getSectionName()
	 * @see #getSection()
	 * @generated
	 */
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute BOOK__PUBLICATION_YEAR = eINSTANCE.getBook_PublicationYear();
		 ...
		 * @generated
		 */
		EReference LIBRARY__SECTIONS = eINSTANCE.getLibrary_Sections();
		...
		/**
		 * The meta object literal for the '{@link library.impl.LibraryBaseImpl <em>Base</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see library.impl.LibraryBaseImpl
		 * @see library.impl.LibraryPackageImpl#getLibraryBase()
		...
		/**
		 * The meta object literal for the '{@link library.impl.SectionImpl <em>Section</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see library.impl.SectionImpl
		 * @see library.impl.LibraryPackageImpl#getSection()
		 ...
		 * @generated
		 */
		EReference SECTION__BOOKS = eINSTANCE.getSection_Books();
		 ...
		 * @generated
		 */
		EAttribute SECTION__CATEGORY = eINSTANCE.getSection_Category();
