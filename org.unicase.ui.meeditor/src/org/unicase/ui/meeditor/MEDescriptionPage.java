...
public class MEDescriptionPage extends FormPage {
	...
	private void createWidget() {
		...
		if (Configuration.getRTFStatus()) {
			textControl = new MERichTextControl(ModelPackage.eINSTANCE.getModelElement_Description(), domain,
				modelElement, toolkit);
			((MERichTextControl) textControl).setShowExpand(false);
		} else {
			textControl = new RTEditor(ModelPackage.eINSTANCE.getModelElement_Description(), domain, modelElement,
				toolkit);
		}
