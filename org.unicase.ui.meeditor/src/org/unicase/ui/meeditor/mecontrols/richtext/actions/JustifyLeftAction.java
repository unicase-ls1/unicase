...
public class JustifyLeftAction extends Action implements Listener{
    ...
    public JustifyLeftAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("org.unicase.ui.meeditor", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifyleft.gif"));
