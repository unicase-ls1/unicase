...
public class InsertRowBeforeAction extends Action implements Listener{
    ...
    public InsertRowBeforeAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("org.unicase.ui.meeditor", "tiny_mce/jscripts/tiny_mce/plugins/table/images/table_insert_row_before.gif"));
