...
public class InsertEditTableAction extends Action implements Listener {
	...
	public void run() {
		...
		if (dialog.open() == IDialogConstants.OK_ID) {
			this.composer.execute(JavaScriptCommands.INSERT_EDIT_TABLE(dialog
					.getCellpadding(), dialog.getCellspacing(), dialog
					.getAlign(), dialog.getClazz(), dialog.getStyle(), dialog
					.getId()));
