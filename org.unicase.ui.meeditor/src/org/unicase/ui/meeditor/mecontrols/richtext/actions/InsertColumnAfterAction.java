...
public class InsertColumnAfterAction extends Action implements Listener{
    ...
    public InsertColumnAfterAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("org.unicase.ui.meeditor", "tiny_mce/jscripts/tiny_mce/plugins/table/images/table_insert_col_after.gif"));
