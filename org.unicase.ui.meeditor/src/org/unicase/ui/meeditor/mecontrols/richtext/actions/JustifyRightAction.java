...
public class JustifyRightAction extends Action implements Listener{
    ...
    public JustifyRightAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("org.unicase.ui.meeditor", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/justifyright.gif"));
