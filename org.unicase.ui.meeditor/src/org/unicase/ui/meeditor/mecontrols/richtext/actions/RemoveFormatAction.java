...
public class RemoveFormatAction extends Action  {
    ...
    public RemoveFormatAction(HtmlComposer composer) {
        ...
        setImageDescriptor(AbstractUIPlugin.imageDescriptorFromPlugin("org.unicase.ui.meeditor", "tiny_mce/jscripts/tiny_mce/themes/advanced/images/removeformat.gif"));
