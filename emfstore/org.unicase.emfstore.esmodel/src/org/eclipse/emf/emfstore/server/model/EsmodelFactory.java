 ...
 * 
 * @see org.eclipse.emf.emfstore.server.model.EsmodelPackage
 * @generated
 */
public interface EsmodelFactory extends EFactory {
	 ...
	 * @generated
	 */
	EsmodelFactory eINSTANCE = org.eclipse.emf.emfstore.server.model.impl.EsmodelFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Project History</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Project Info</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Session Id</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Server Space</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Project Id</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Client Version Info</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
