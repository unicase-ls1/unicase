...
public class BowlingValidator extends EObjectValidator {
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Has Correct Street Number' of
	 * 'Player'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The {@link org.eclipse.emf.common.util.Diagnostic#getCode() code} for constraint 'Has Tounament Pro' of
	 * 'Tournament'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	public boolean validatePlayer(Player player, DiagnosticChain diagnostics, Map<Object, Object> context) {
		...
		if (result || diagnostics != null)
			result &= validatePlayer_hasName(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasStreet(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasDateOfBirth(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasCorrectStreetNumber(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasTelephon(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasHeight(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasIsAvailable(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasNotes(player, diagnostics, context);
		if (result || diagnostics != null)
			result &= validatePlayer_hasGame(player, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validatePlayer_hasCorrectStreetNumber(Player player, DiagnosticChain diagnostics,
	...
	public boolean validateTournament(Tournament tournament, DiagnosticChain diagnostics, Map<Object, Object> context) {
		if (!validate_NoCircularContainment(tournament, diagnostics, context))
			return false;
		boolean result = validate_EveryMultiplicityConforms(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryDataValueConforms(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryReferenceIsContained(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryBidirectionalReferenceIsPaired(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryProxyResolves(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_UniqueID(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryKeyUnique(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validate_EveryMapEntryUnique(tournament, diagnostics, context);
		if (result || diagnostics != null)
			result &= validateTournament_hasTounamentPro(tournament, diagnostics, context);
		return result;
	}
	 ...
	 * @generated
	 */
	public boolean validateTournament_hasTounamentPro(Tournament tournament, DiagnosticChain diagnostics,
		Map<Object, Object> context) {
