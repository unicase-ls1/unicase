...
public class PlayerImpl extends EObjectImpl implements Player {
	...
	public void setIsAvailable(boolean newIsAvailable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BowlingPackage.PLAYER__IS_AVAILABLE, oldIsAvailable,
				isAvailable));
	}
	...
	public boolean hasName(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (name == null || name == "") {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "name", BowlingValidator.PLAYER__HAS_NAME,
					"Name must filled out", new Object[] { this, BowlingPackage.eINSTANCE.getPlayer_Name() }));
			}
			return false;
		}
		return true;
	...
	public boolean hasStreet(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (street == null || street == "") {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "street",
					BowlingValidator.PLAYER__HAS_STREET, "Street must filled out", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_Street() }));
			}
			return false;
		}
		return true;
	...
	public boolean hasDateOfBirth(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (dateOfBirth == null || (dateOfBirth.after(rightNow.getTime()))) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "dateOfBirth",
					BowlingValidator.PLAYER__HAS_DATE_OF_BIRTH, "Date of Birth must be smaller than today's date",
	...
	public boolean hasCorrectStreetNumber(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (streetNumber <= 0) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "streetNumber",
					BowlingValidator.PLAYER__HAS_CORRECT_STREET_NUMBER, "Invalid Street Number", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_StreetNumber() }));
			}
			return false;
		}
	...
	public boolean hasTelephon(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (telephon == null) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "telephon",
					BowlingValidator.PLAYER__HAS_TELEPHON, "Telephon number must filled out", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_Telephon() }));
			}
			return false;
		}
		return true;
	...
	public boolean hasHeight(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (height <= 0.0) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "height",
					BowlingValidator.PLAYER__HAS_HEIGHT, "Height must filled out", new Object[] { this,
	...
	public boolean hasIsAvailable(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (isAvailable == false) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "isAvailable",
					BowlingValidator.PLAYER__HAS_IS_AVAILABLE, "Must be set", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_IsAvailable() }));
			}
			return false;
		}
		return true;
	...
	public boolean hasNotes(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (notes == null || notes == "") {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "notes",
					BowlingValidator.PLAYER__HAS_NOTES, "Notes must filled out", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_Notes() }));
			}
			return false;
		}
		return true;
	...
	public boolean hasGame(DiagnosticChain diagnosticianChain, Map<?, ?> context) {
		...
		if (games.isEmpty()) {
			if (diagnosticianChain != null) {
				diagnosticianChain.add(new BasicDiagnostic(Diagnostic.ERROR, "games",
					BowlingValidator.PLAYER__HAS_GAME, "Games must referenced", new Object[] { this,
						BowlingPackage.eINSTANCE.getPlayer_Games() }));
			}
			return false;
		}
		return true;
