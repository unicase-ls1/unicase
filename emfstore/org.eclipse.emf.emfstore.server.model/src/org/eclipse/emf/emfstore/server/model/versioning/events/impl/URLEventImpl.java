 ...
 * <ul>
 *   <li>{@link org.eclipse.emf.emfstore.server.model.versioning.events.impl.URLEventImpl#getSourceModelElement <em>Source Model Element</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.server.model.versioning.events.impl.URLEventImpl#getSourceView <em>Source View</em>}</li>
 *   <li>{@link org.eclipse.emf.emfstore.server.model.versioning.events.impl.URLEventImpl#getSourceURL <em>Source URL</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class URLEventImpl extends EventImpl implements URLEvent {
	...
	public ModelElementId getSourceModelElement() {
		if (sourceModelElement != null && sourceModelElement.eIsProxy()) {
			...
			if (sourceModelElement != oldSourceModelElement) {
				...
				NotificationChain msgs = oldSourceModelElement.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, null, null);
				if (newSourceModelElement.eInternalContainer() == null) {
					msgs = newSourceModelElement.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, oldSourceModelElement, sourceModelElement));
			}
		}
	...
	public NotificationChain basicSetSourceModelElement(ModelElementId newSourceModelElement, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, oldSourceModelElement, newSourceModelElement);
	...
	public void setSourceModelElement(ModelElementId newSourceModelElement) {
		if (newSourceModelElement != sourceModelElement) {
			...
			if (sourceModelElement != null)
				msgs = ((InternalEObject)sourceModelElement).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, null, msgs);
			if (newSourceModelElement != null)
				msgs = ((InternalEObject)newSourceModelElement).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, null, msgs);
			msgs = basicSetSourceModelElement(newSourceModelElement, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.URL_EVENT__SOURCE_MODEL_ELEMENT, newSourceModelElement, newSourceModelElement));
	}
	...
	public void setSourceView(String newSourceView) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.URL_EVENT__SOURCE_VIEW, oldSourceView, sourceView));
	}
	...
	public ModelElementId getSourceURL() {
		if (sourceURL != null && sourceURL.eIsProxy()) {
			...
			if (sourceURL != oldSourceURL) {
				...
				NotificationChain msgs = oldSourceURL.eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_URL, null, null);
				if (newSourceURL.eInternalContainer() == null) {
					msgs = newSourceURL.eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_URL, null, msgs);
				}
				if (msgs != null) msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EventsPackage.URL_EVENT__SOURCE_URL, oldSourceURL, sourceURL));
			}
		}
		return sourceURL;
	}
	...
	public NotificationChain basicSetSourceURL(ModelElementId newSourceURL, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, EventsPackage.URL_EVENT__SOURCE_URL, oldSourceURL, newSourceURL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSourceURL(ModelElementId newSourceURL) {
		if (newSourceURL != sourceURL) {
			NotificationChain msgs = null;
			if (sourceURL != null)
				msgs = ((InternalEObject)sourceURL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_URL, null, msgs);
			if (newSourceURL != null)
				msgs = ((InternalEObject)newSourceURL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EventsPackage.URL_EVENT__SOURCE_URL, null, msgs);
			msgs = basicSetSourceURL(newSourceURL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventsPackage.URL_EVENT__SOURCE_URL, newSourceURL, newSourceURL));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case EventsPackage.URL_EVENT__SOURCE_URL:
				if (resolve) return getSourceURL();
