...
/**
 * This is the item provider adapter for a {@link org.eclipse.emf.emfstore.server.model.notification.ESNotification}
 * object. <!--
...
public class ESNotificationItemProvider extends IdentifiableElementItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ESNotification_details_feature", "_UI_ESNotification_type"),
				 NotificationPackage.Literals.ES_NOTIFICATION__DETAILS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_ESNotification_provider_feature", "_UI_ESNotification_type"),
				 NotificationPackage.Literals.ES_NOTIFICATION__PROVIDER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(NotificationPackage.Literals.ES_NOTIFICATION__RELATED_OPERATIONS,
