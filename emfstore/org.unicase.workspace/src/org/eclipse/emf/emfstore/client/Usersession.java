 ...
 * <ul>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getUsername <em>Username</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getPassword <em>Password</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getSessionId <em>Session Id</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getPersistentPassword <em>Persistent Password</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getServerInfo <em>Server Info</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#isSavePassword <em>Save Password</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getACUser <em>AC User</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.Usersession#getChangedProperties <em>Changed Properties</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession()
 * @model
 * @generated
 */
public interface Usersession extends EObject {
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_Username()
	 * @model
	 * @generated
	 */
	String getUsername();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getUsername <em>Username</em>}' attribute. <!--
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_Password()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getPassword <em>Password</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_SessionId()
	 * @model transient="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getSessionId <em>Session Id</em>}' reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_PersistentPassword()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getPersistentPassword
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_ServerInfo()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getServerInfo <em>Server Info</em>}' reference.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_SavePassword()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#isSavePassword <em>Save Password</em>}'
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_ACUser()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.Usersession#getACUser <em>AC User</em>}' containment
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getUsersession_ChangedProperties()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
