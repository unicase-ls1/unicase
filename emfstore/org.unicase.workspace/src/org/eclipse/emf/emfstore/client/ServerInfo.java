 ...
 * <ul>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getUrl <em>Url</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getPort <em>Port</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getProjectInfos <em>Project Infos</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getLastUsersession <em>Last Usersession</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.ServerInfo#getCertificateAlias <em>Certificate Alias</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo()
 * @model
 * @generated
 */
public interface ServerInfo extends EObject {
	 ...
	 * @see #setName(String)
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_Name()
	 * @model required="true"
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.ServerInfo#getName <em>Name</em>}' attribute. <!--
	 ...
	 * @see #setUrl(String)
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_Url()
	 * @model required="true"
	 * @generated
	 */
	String getUrl();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.ServerInfo#getUrl <em>Url</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see #setPort(int)
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_Port()
	 * @model required="true"
	 * @generated
	 */
	int getPort();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.ServerInfo#getPort <em>Port</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_ProjectInfos()
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_LastUsersession()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.ServerInfo#getLastUsersession <em>Last Usersession</em>}'
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getServerInfo_CertificateAlias()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.ServerInfo#getCertificateAlias <em>Certificate Alias</em>}'
