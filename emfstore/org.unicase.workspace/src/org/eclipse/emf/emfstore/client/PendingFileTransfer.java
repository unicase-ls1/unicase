 ...
 * <ul>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getAttachmentId <em>Attachment Id</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getFileVersion <em>File Version</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getChunkNumber <em>Chunk Number</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#isUpload <em>Upload</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getFileName <em>File Name</em>}</li>
 * <li>{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getPreliminaryFileName <em>Preliminary File Name</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer()
 * @model
 * @generated
 */
public interface PendingFileTransfer extends EObject {
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_AttachmentId()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getAttachmentId <em>Attachment Id</em>}'
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_FileVersion()
	 * @model
	 * @generated
	 */
	int getFileVersion();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getFileVersion <em>File Version</em>}'
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_ChunkNumber()
	 * @model
	 * @generated
	 */
	int getChunkNumber();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getChunkNumber <em>Chunk Number</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_Upload()
	 * @model
	 * @generated
	 */
	boolean isUpload();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#isUpload <em>Upload</em>}' attribute.
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_FileName()
	 * @model
	 * @generated
	 */
	String getFileName();
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getFileName <em>File Name</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @see org.eclipse.emf.emfstore.client.WorkspacePackage#getPendingFileTransfer_PreliminaryFileName()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link org.eclipse.emf.emfstore.client.PendingFileTransfer#getPreliminaryFileName
