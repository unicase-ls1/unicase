 ...
 * 
 * @see org.eclipse.emf.emfstore.client.model.WorkspacePackage
 * @generated
 */
public interface WorkspaceFactory extends EFactory {
	 ...
	 * @generated
	 */
	WorkspaceFactory eINSTANCE = org.eclipse.emf.emfstore.client.model.impl.WorkspaceFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Server Info</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Usersession</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Project Space</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Operation Composite</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Event Composite</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
