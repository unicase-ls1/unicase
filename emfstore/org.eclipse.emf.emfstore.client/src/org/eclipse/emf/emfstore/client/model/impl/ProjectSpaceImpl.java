...
public class ProjectSpaceImpl extends IdentifiableElementImpl implements ProjectSpace, LoginObserver {
	 ...
	 * <em>Changed Shared Properties</em>}' containment reference list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 * 
	 *            public EMap<String, EMFStoreProperty> getProperties() { if
	 *            (properties == null) { properties = new EcoreEMap<String,
	 *            EMFStoreProperty>( ModelPackage.Literals.PROPERTY_MAP_ENTRY,
	 *            PropertyMapEntryImpl.class, this,
	 *            ModelPackage.PROJECT_SPACE__PROPERTIES); } return properties;
	 *            }
	 */
	 ...
	 * @generated
	 * 
	 *            public EMap<String, EMFStoreProperty>
	 *            getChangedSharedProperties() { if (changedSharedProperties ==
	 *            null) { changedSharedProperties = new EcoreEMap<String,
	 *            EMFStoreProperty>( ModelPackage.Literals.PROPERTY_MAP_ENTRY,
	 *            PropertyMapEntryImpl.class, this,
	...
	public PrimaryVersionSpec finalizeCommit(ChangePackage changePackage, LogMessage logMessage,
		...
		try {
			getPropertyManager().transmit();
		} catch (EmfStoreException e) {
			WorkspaceUtil.logException("EMFStoreProperties transmit failed.", e);
		}
	...
	public PrimaryVersionSpec update(final VersionSpec version, final UpdateObserver observer) throws EmfStoreException {
		...
		try {
			...
			WorkspaceUtil.handleException("EMFStoreProperties transmit failed.", e);
		}
	...
	public void shareProject(Usersession usersession) throws EmfStoreException {
		...
		WorkspaceManager.getObserverBus().notify(ShareObserver.class).beforeShare(this);
