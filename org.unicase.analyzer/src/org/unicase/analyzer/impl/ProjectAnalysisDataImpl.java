...
public class ProjectAnalysisDataImpl extends EObjectImpl implements ProjectAnalysisData {
	...
	/**
	 * The cached value of the '{@link #getProjectId() <em>Project Id</em>}' reference. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getProjectId()
	 * @generated
	...
	public NotificationChain basicSetProjectState(Project newProjectState, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				AnalyzerPackage.PROJECT_ANALYSIS_DATA__PROJECT_STATE, oldProjectState, newProjectState);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProjectState != projectState) {
			...
			if (projectState != null)
				msgs = ((InternalEObject) projectState).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- AnalyzerPackage.PROJECT_ANALYSIS_DATA__PROJECT_STATE, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyzerPackage.PROJECT_ANALYSIS_DATA__PROJECT_STATE,
	...
	public EList<ChangePackage> getChangePackages() {
		if (changePackages == null) {
			changePackages = new EObjectContainmentEList<ChangePackage>(ChangePackage.class, this,
				AnalyzerPackage.PROJECT_ANALYSIS_DATA__CHANGE_PACKAGES);
		}
	...
	public NotificationChain basicSetPrimaryVersionSpec(PrimaryVersionSpec newPrimaryVersionSpec, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				AnalyzerPackage.PROJECT_ANALYSIS_DATA__PRIMARY_VERSION_SPEC, oldPrimaryVersionSpec,
				newPrimaryVersionSpec);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPrimaryVersionSpec(PrimaryVersionSpec newPrimaryVersionSpec) {
		if (newPrimaryVersionSpec != primaryVersionSpec) {
			...
			if (primaryVersionSpec != null)
				msgs = ((InternalEObject) primaryVersionSpec).eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- AnalyzerPackage.PROJECT_ANALYSIS_DATA__PRIMARY_VERSION_SPEC, null, msgs);
			if (newPrimaryVersionSpec != null)
				msgs = ((InternalEObject) newPrimaryVersionSpec).eInverseAdd(this, EOPPOSITE_FEATURE_BASE
					- AnalyzerPackage.PROJECT_ANALYSIS_DATA__PRIMARY_VERSION_SPEC, null, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				AnalyzerPackage.PROJECT_ANALYSIS_DATA__PRIMARY_VERSION_SPEC, newPrimaryVersionSpec,
				newPrimaryVersionSpec));
	}
			...
			if (projectId != oldProjectId) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						AnalyzerPackage.PROJECT_ANALYSIS_DATA__PROJECT_ID, oldProjectId, projectId));
			}
		}
		return projectId;
	}
	...
	public void setProjectId(ProjectId newProjectId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AnalyzerPackage.PROJECT_ANALYSIS_DATA__PROJECT_ID,
