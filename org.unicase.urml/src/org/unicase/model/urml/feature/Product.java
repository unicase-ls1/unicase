...
public interface Product extends UrmlModelElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.urml.feature.VariationPointInstance#getProducts <em>Products</em>}'.
	 * <!-- begin-user-doc
	 * -->
	 * <p>
	 ...
	 * The list contents are of type {@link org.unicase.model.urml.feature.Feature}.
	 * It is bidirectional and its opposite is '{@link org.unicase.model.urml.feature.Feature#getProducts <em>Products</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
