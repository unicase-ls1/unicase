...
public class UsecasePackageImpl extends EPackageImpl implements UsecasePackage {
	...
	public static UsecasePackage init() {
		...
		UsecasePackageImpl theUsecasePackage = (UsecasePackageImpl) (EPackage.Registry.INSTANCE
				...
				.get(eNS_URI) : new UsecasePackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getUseCase_Actors(), this.getActor(),
				this.getActor_UseCases(), "actors", null, 0, -1, UseCase.class,
		...
		initEReference(getApplicationDomainUseCase_DetailedGoal(),
				theGoalPackage.getGoal(),
				theGoalPackage.getGoal_DetailingUseCases(), "detailedGoal",
				null, 0, -1, ApplicationDomainUseCase.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getSolutionDomainUseCase_DetailedFeature(),
				...
				theFeaturePackage.getAbstractFeature_DetailingUseCases(),
				"detailedFeature", null, 0, 1, SolutionDomainUseCase.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(actorEClass, Actor.class, "Actor", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getActor_UseCases(), this.getUseCase(),
				this.getUseCase_Actors(), "useCases", null, 0, -1, Actor.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
	}
