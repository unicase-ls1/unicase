 ...
 *   <li>{@link org.unicase.emfstore.jdt.configuration.impl.EntryImpl#getProjectRelativeLocation <em>Project Relative Location</em>}</li>
...
public class EntryImpl extends EObjectImpl implements Entry {
	...
	public void setConfiguration(EMFStoreJDTConfiguration newConfiguration) {
		if (newConfiguration != eInternalContainer() || (eContainerFeatureID() != ConfigurationPackage.ENTRY__CONFIGURATION && newConfiguration != null)) {
			...
			if (newConfiguration != null)
				msgs = ((InternalEObject)newConfiguration).eInverseAdd(this, ConfigurationPackage.EMF_STORE_JDT_CONFIGURATION__ENTRY, EMFStoreJDTConfiguration.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case ConfigurationPackage.ENTRY__CONFIGURATION:
				return eInternalContainer().eInverseRemove(this, ConfigurationPackage.EMF_STORE_JDT_CONFIGURATION__ENTRY, EMFStoreJDTConfiguration.class, msgs);
		}
