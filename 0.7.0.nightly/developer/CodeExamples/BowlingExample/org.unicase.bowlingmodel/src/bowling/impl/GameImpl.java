...
public class GameImpl extends EObjectImpl implements Game {
	...
	public void setPlayer(Player newPlayer) {
		if (newPlayer != player) {
			...
			if (player != null)
				msgs = ((InternalEObject)player).eInverseRemove(this, BowlingPackage.PLAYER__GAME, Player.class, msgs);
			if (newPlayer != null)
				msgs = ((InternalEObject)newPlayer).eInverseAdd(this, BowlingPackage.PLAYER__GAME, Player.class, msgs);
