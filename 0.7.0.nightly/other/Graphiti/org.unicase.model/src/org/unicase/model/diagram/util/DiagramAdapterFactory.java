...
public class DiagramAdapterFactory extends AdapterFactoryImpl {
	...
	protected DiagramSwitch<Adapter> modelSwitch = new DiagramSwitch<Adapter>() {
		...
		@Override
		public Adapter caseGDiagram(GDiagram object) {
			return createGDiagramAdapter();
		}

		@Override
		public Adapter caseOrgChartDiagram(OrgChartDiagram object) {
			return createOrgChartDiagramAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.diagram.GDiagram <em>GDiagram</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGDiagramAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.diagram.OrgChartDiagram <em>Org Chart Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOrgChartDiagramAdapter() {
		return null;
	}
