 ...
 *   <li>{@link org.unicase.model.testspec.impl.TestStepImpl#getTestCase <em>Test Case</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TestStepImpl extends UnicaseModelElementImpl implements TestStep {
	...
	public TestCase getTestCase() {
		if (eContainerFeatureID() != TestspecPackage.TEST_STEP__TEST_CASE) return null;
	...
	public NotificationChain basicSetTestCase(TestCase newTestCase, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newTestCase, TestspecPackage.TEST_STEP__TEST_CASE, msgs);
		return msgs;
	}
	...
	public void setTestCase(TestCase newTestCase) {
		if (newTestCase != eInternalContainer() || (eContainerFeatureID() != TestspecPackage.TEST_STEP__TEST_CASE && newTestCase != null)) {
			...
			if (newTestCase != null)
				msgs = ((InternalEObject)newTestCase).eInverseAdd(this, TestspecPackage.TEST_CASE__STEP, TestCase.class, msgs);
			msgs = basicSetTestCase(newTestCase, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.TEST_STEP__TEST_CASE, newTestCase, newTestCase));
	}
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
			...
			case TestspecPackage.TEST_STEP__TEST_CASE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TestspecPackage.TEST_STEP__TEST_CASE:
				return eInternalContainer().eInverseRemove(this, TestspecPackage.TEST_CASE__STEP, TestCase.class, msgs);
		}
