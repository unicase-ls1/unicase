...
public class TestspecPackageImpl extends EPackageImpl implements TestspecPackage {
	...
	public EReference getTestProtocol_TestCase() {
		return (EReference)testProtocolEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getTestCase_TestProtocol() {
	 ...
	 * @generated
	 */
	public EAttribute getTestStepInput_Value() {
		return (EAttribute)testStepInputEClass.getEStructuralFeatures().get(4);
	}
	 ...
	 * @generated
	 */
	public EAttribute getTestStepOutput_Value() {
		return (EAttribute)testStepOutputEClass.getEStructuralFeatures().get(4);
	}
	...
	public void createPackageContents() {
		...
		createEReference(testCaseEClass, TEST_CASE__TEST_PROTOCOL);
		...
		createEAttribute(testStepInputEClass, TEST_STEP_INPUT__VALUE);
		...
		createEAttribute(testStepOutputEClass, TEST_STEP_OUTPUT__VALUE);
	...
	public void initializePackageContents() {
		...
		testStepEClass.getESuperTypes().add(theMetamodelPackage.getNonDomainElement());
		...
		initEReference(getTestProtocol_TestCase(), this.getTestCase(), this.getTestCase_TestProtocol(), "testCase", null, 0, 1, TestProtocol.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTestCase_Step(), this.getTestStep(), this.getTestStep_TestCase(), "step", null, 0, -1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		getTestCase_Step().getEKeys().add(theMetamodelPackage.getIdentifiableElement_Identifier());
		initEReference(getTestCase_TestProtocol(), this.getTestProtocol(), this.getTestProtocol_TestCase(), "testProtocol", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getTestStep_TestCase(), this.getTestCase(), this.getTestCase_Step(), "testCase", null, 0, 1, TestStep.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTestStepInput_Value(), theEcorePackage.getEString(), "value", "", 0, 1, TestStepInput.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTestStepOutput_Value(), theEcorePackage.getEString(), "value", null, 0, 1, TestStepOutput.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	/**
	 * Initializes the annotations for <b>org.unicase.meeditor</b>.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void createOrg_1Annotations() {
		String source = "org.unicase.meeditor";													
		addAnnotation
		  (getTestCase_TestProtocol(), 
		   source, 
		   new String[] {
			 "priority", "5",
			 "position", "bottom"
