...
public class SearchresultWidget extends Composite implements MouseListener {
	...
	private void init() {
		...
		compositeTitle.setLayoutData(new GridData(SWT.FILL, SWT.NONE, false, false, 3, 1));
		...
		lblImage.setLayoutData(new GridData(SWT.NONE, SWT.CENTER, false, false, 1, 2));
//		lblImage.setLayoutData(new GridData(SWT.NONE, SWT.NONE, false, false));
		...
		lblPath = new Label(compositeTitle, SWT.LEFT);
		String path = buildPath(result);
		if (path == null) {
			path = "not available";
		}
		lblPath.setText("Path: " + path);
		lblPath.setLayoutData(new GridData(SWT.NONE, SWT.NONE, false, false));
	...
	public void mouseDoubleClick(MouseEvent e) {
		ActionHelper.openModelElement((ModelElement)result, this.getClass().getName());
	}
