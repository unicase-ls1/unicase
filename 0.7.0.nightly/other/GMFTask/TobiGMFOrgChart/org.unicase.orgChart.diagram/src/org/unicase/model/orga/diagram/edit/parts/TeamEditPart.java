...
import org.unicase.model.orga.diagram.edit.policies.TeamItemSemanticEditPolicy;
...
public class TeamEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new TeamItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		TeamFigure figure = new TeamFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TeamNameEditPart) {
			((TeamNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureTeamNameFigure());
			return true;
		}
		return false;
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/types = new ArrayList/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/();
		if (targetEditPart instanceof org.unicase.model.orga.diagram.edit.parts.TeamEditPart) {
			types.add(OrgaElementTypes.TeamHasOrgUnit_4001);
		}
