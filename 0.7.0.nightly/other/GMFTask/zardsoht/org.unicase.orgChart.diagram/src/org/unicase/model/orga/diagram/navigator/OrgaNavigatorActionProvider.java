...
import org.unicase.model.orga.diagram.part.OrgaDiagramEditor;
 ...
 * @generated
 */
public class OrgaNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof OrgaNavigatorItem) {
					selectedElement = ((OrgaNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, OrgaDiagramEditor.ID);
