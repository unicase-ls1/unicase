...
public class DocumentTemplatePackageImpl extends EPackageImpl implements DocumentTemplatePackage {
	 ...
	 * @see org.unicase.documentexport.documentTemplate.DocumentTemplatePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DocumentTemplatePackage init() {
		if (isInited) return (DocumentTemplatePackage)EPackage.Registry.INSTANCE.getEPackage(DocumentTemplatePackage.eNS_URI);

		// Obtain or create and register package
		DocumentTemplatePackageImpl theDocumentTemplatePackage = (DocumentTemplatePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof DocumentTemplatePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new DocumentTemplatePackageImpl());
