...
import org.unicase.documentexport.builders.DefaultModelElementRendererBuilder;
...
import org.unicase.documentexport.documentTemplate.renderers.impl.DocumentRendererImpl;
...
import org.unicase.documentexport.renderers.elements.URootCompositeSection;
...
public class DefaultDocumentRendererImpl extends DocumentRendererImpl implements DefaultDocumentRenderer {
	...
	private void renderDocLeafSection(LeafSectionImpl modelElement, LayoutOptions layoutOptions) {
		...
		section.add(new UParagraph(modelElement.getDescriptionPlainText(), layoutOptions.getDefaultTextOption()));
