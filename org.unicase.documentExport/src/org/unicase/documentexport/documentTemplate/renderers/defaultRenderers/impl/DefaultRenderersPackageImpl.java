...
import org.unicase.documentexport.documentTemplate.impl.DocumentTemplatePackageImpl;
...
import org.unicase.documentexport.documentTemplate.renderers.defaultRenderers.DefaultDocumentRenderer;
...
import org.unicase.documentexport.documentTemplate.renderers.impl.RenderersPackageImpl;

import org.unicase.documentexport.documentTemplate.renderers.options.OptionsPackage;

import org.unicase.documentexport.documentTemplate.renderers.options.impl.OptionsPackageImpl;

import org.unicase.documentexport.documentTemplate.renderers.specialRenderers.SpecialRenderersPackage;

import org.unicase.documentexport.documentTemplate.renderers.specialRenderers.impl.SpecialRenderersPackageImpl;
...
public class DefaultRenderersPackageImpl extends EPackageImpl implements DefaultRenderersPackage {
	 ...
	 * @see org.unicase.documentexport.documentTemplate.renderers.defaultRenderers.DefaultRenderersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DefaultRenderersPackage init() {
		if (isInited) return (DefaultRenderersPackage)EPackage.Registry.INSTANCE.getEPackage(DefaultRenderersPackage.eNS_URI);

		// Obtain or create and register package
		DefaultRenderersPackageImpl theDefaultRenderersPackage = (DefaultRenderersPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof DefaultRenderersPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new DefaultRenderersPackageImpl());
		...
		DocumentTemplatePackageImpl theDocumentTemplatePackage = (DocumentTemplatePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(DocumentTemplatePackage.eNS_URI) instanceof DocumentTemplatePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(DocumentTemplatePackage.eNS_URI) : DocumentTemplatePackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EReference getDefaultModelElementRenderer_AttributeRendererMapping() {
		return (EReference)defaultModelElementRendererEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(defaultModelElementRendererEClass, DEFAULT_MODEL_ELEMENT_RENDERER__ATTRIBUTE_RENDERER_MAPPING);
	...
	public void initializePackageContents() {
		...
		initEClass(defaultModelElementRendererEClass, DefaultModelElementRenderer.class, "DefaultModelElementRenderer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getDefaultModelElementRenderer_AttributeRendererMapping(), theRenderersPackage.getAttributeRendererMapping(), null, "attributeRendererMapping", null, 0, -1, DefaultModelElementRenderer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(defaultAttributeRendererEClass, DefaultAttributeRenderer.class, "DefaultAttributeRenderer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(defaultDocumentRendererEClass, DefaultDocumentRenderer.class, "DefaultDocumentRenderer", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
	}
