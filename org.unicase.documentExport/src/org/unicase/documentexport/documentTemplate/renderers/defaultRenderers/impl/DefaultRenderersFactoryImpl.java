...
public class DefaultRenderersFactoryImpl extends EFactoryImpl implements DefaultRenderersFactory {
	...
	public static DefaultRenderersFactory init() {
		try {
			DefaultRenderersFactory theDefaultRenderersFactory = (DefaultRenderersFactory)EPackage.Registry.INSTANCE.getEFactory("http://unicase.org/documentExport/documentTemplate/renderers/defaultRenderers"); 
