...
public class RenderersFactoryImpl extends EFactoryImpl implements RenderersFactory {
	...
	public static RenderersFactory init() {
		try {
			RenderersFactory theRenderersFactory = (RenderersFactory)EPackage.Registry.INSTANCE.getEFactory("http://unicase.org/documentExport/documentTemplate/renderers"); 
