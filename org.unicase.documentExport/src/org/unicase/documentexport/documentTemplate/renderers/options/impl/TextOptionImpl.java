 ...
 * <ul>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.TextOptionImpl#getFontFamily <em>Font Family</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.TextOptionImpl#getFontSize <em>Font Size</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.TextOptionImpl#isBold <em>Bold</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.TextOptionImpl#isUnderline <em>Underline</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.TextOptionImpl#getFontColor <em>Font Color</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TextOptionImpl extends RendererOptionImpl implements TextOption {
	...
	public void setFontFamily(FontFamily newFontFamily) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.TEXT_OPTION__FONT_FAMILY, oldFontFamily, fontFamily));
	}
	...
	public void setFontSize(int newFontSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.TEXT_OPTION__FONT_SIZE, oldFontSize, fontSize));
	}
	...
	public NotificationChain basicSetFontColor(UColor newFontColor, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, OptionsPackage.TEXT_OPTION__FONT_COLOR, oldFontColor, newFontColor);
	...
	public void setFontColor(UColor newFontColor) {
		if (newFontColor != fontColor) {
			...
			if (fontColor != null)
				msgs = ((InternalEObject)fontColor).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - OptionsPackage.TEXT_OPTION__FONT_COLOR, null, msgs);
			if (newFontColor != null)
				msgs = ((InternalEObject)newFontColor).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - OptionsPackage.TEXT_OPTION__FONT_COLOR, null, msgs);
			msgs = basicSetFontColor(newFontColor, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.TEXT_OPTION__FONT_COLOR, newFontColor, newFontColor));
	}
	...
	public void setUnderline(boolean newUnderline) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, OptionsPackage.TEXT_OPTION__UNDERLINE, oldUnderline, underline));
	}
