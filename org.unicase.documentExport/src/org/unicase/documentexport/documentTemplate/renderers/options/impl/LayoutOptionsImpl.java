 ...
 * <ul>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#getCoverText <em>Cover Text</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#getCoverTextTextOption <em>Cover Text Text Option</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#getDefaultTextOption <em>Default Text Option</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#getSectionTextOption <em>Section Text Option</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#isHideAnnotations <em>Hide Annotations</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#isHideAttachments <em>Hide Attachments</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#isHideIncomingDocumentReferences <em>Hide Incoming Document References</em>}</li>
 *   <li>{@link org.unicase.documentexport.documentTemplate.renderers.options.impl.LayoutOptionsImpl#getPageNumberingStyle <em>Page Numbering Style</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
