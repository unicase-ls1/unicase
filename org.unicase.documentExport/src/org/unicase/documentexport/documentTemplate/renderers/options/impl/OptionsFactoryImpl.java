...
public class OptionsFactoryImpl extends EFactoryImpl implements OptionsFactory {
	...
	public static OptionsFactory init() {
		try {
			OptionsFactory theOptionsFactory = (OptionsFactory)EPackage.Registry.INSTANCE.getEFactory("http://unicase.org/documentExport/documentTemplate/renderers/options"); 
