...
import org.unicase.documentexport.documentTemplate.renderers.defaultRenderers.impl.DefaultRenderersPackageImpl;
...
import org.unicase.documentexport.documentTemplate.renderers.options.PageNumberingStyle;
...
import org.unicase.documentexport.documentTemplate.renderers.options.UColor;
...
public class OptionsPackageImpl extends EPackageImpl implements OptionsPackage {
	 ...
	 * @see org.unicase.documentexport.documentTemplate.renderers.options.OptionsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public EReference getSingleReferenceAttributeOption_ReferenceOption() {
		return (EReference)singleReferenceAttributeOptionEClass.getEStructuralFeatures().get(1);
	}
	 ...
	 * @generated
	 */
	public EReference getMultiReferenceAttributeOption_ReferenceOption() {
	...
	public EReference getMultiReferenceAttributeOption_ListOption() {
		return (EReference)multiReferenceAttributeOptionEClass.getEStructuralFeatures().get(2);
	}
	...
	public void createPackageContents() {
		...
		createEReference(singleReferenceAttributeOptionEClass, SINGLE_REFERENCE_ATTRIBUTE_OPTION__REFERENCE_OPTION);
		...
		createEReference(multiReferenceAttributeOptionEClass, MULTI_REFERENCE_ATTRIBUTE_OPTION__REFERENCE_OPTION);
	...
	public void initializePackageContents() {
		...
		initEReference(getSingleReferenceAttributeOption_ReferenceOption(), this.getReferenceOption(), null, "referenceOption", null, 0, 1, SingleReferenceAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getMultiReferenceAttributeOption_ReferenceOption(), this.getReferenceOption(), null, "referenceOption", null, 0, 1, MultiReferenceAttributeOption.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
