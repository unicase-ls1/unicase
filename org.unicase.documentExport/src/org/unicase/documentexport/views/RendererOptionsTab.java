...
import org.unicase.documentexport.ModelElementRendererRegistry;
		...
		list.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent event) {
				...
				createRendererOptionsSelector(
						mapping.getRenderer(), 
						mapping.getEClassName()
				);
			}
		});
	}
	
	private void createRendererOptionsSelector(
		...
		final ArrayList<ModelElementRenderer> renderers = ModelElementRendererRegistry.getSupportedModelElementRenderers(eClassName, template);
