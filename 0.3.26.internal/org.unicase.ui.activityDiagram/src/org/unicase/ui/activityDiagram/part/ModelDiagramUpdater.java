...
public class ModelDiagramUpdater {
	...
	public static List getSemanticChildren(View view) {
		...
		case org.unicase.ui.activityDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID:
			return getMEDiagram_22SemanticChildren(view);
		}
	 ...
	 * @generated
	 */
	public static List getMEDiagram_22SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			if (visualID == org.unicase.ui.activityDiagram.edit.parts.ActivityEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.activityDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.activityDiagram.edit.parts.ForkEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.activityDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.activityDiagram.edit.parts.ActivityInitialEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.activityDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.activityDiagram.edit.parts.ActivityEndEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.activityDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.activityDiagram.edit.parts.BranchEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.activityDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
	...
	public static List getContainedLinks(View view) {
		switch (org.unicase.ui.activityDiagram.part.ModelVisualIDRegistry
				.getVisualID(view)) {
		case org.unicase.ui.activityDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID:
			return getMEDiagram_22ContainedLinks(view);
	 ...
	 * @generated
	 */
	public static List getMEDiagram_22ContainedLinks(View view) {
		MEDiagram modelElement = (MEDiagram) view.getElement();
		List result = new LinkedList();
		result
	...
	private static Collection getContainedTypeModelFacetLinks_Transition_4001(
		...
		for (Iterator links = container.getNewElements().iterator(); links
			...
			result
					.add(new org.unicase.ui.activityDiagram.part.ModelLinkDescriptor(
							src,
							dst,
							link,
