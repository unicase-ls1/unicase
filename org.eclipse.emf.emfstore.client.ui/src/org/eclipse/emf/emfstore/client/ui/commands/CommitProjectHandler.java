...
public class CommitProjectHandler extends ServerRequestCommandHandler implements
	...
	private ChangePackage handleBaseVersionException(
			...
			throws CommitCanceledException, EmfStoreException {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.eclipse.emf.emfstore.client.observers.CommitObserver#inspectChanges(org.eclipse.emf.emfstore.client.core.ProjectSpace,
