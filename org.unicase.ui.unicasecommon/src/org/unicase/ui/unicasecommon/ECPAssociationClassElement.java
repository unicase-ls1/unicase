...
public class ECPAssociationClassElement {
	...
	public ECPAssociationClassElement(EReference sourceFeature,
	...
	/**
	 * Return the features which constitute the features of this link that
	 * contain information about the link, other than source and target. The
	 * list should be ordered by priority of the ferature, important features
	 * first.
	 * 
