...
public interface ECPMetaModelElementContext {
	...
	/**
	 * Retrieve all EClasses from the {@link EcorePackage} registry that are
	 * subclasses of the given {@link EClass}. Does not include abstract classes
	 * or interfaces. Could exclude {@link AssociationClassElement}s.
	 * 
	 * @param eClass
	...
	/**
	 * Whether a {@link EClass} is a domain element. Non Domain Elements are not
	 * root nodes of the model and do not exist on their own. They have the
	 * following characteristic behavior: they don't appear in the openME
	 * dialog, they are deleted if the last link to them is deleted, and they
	 * are not shown in the new element wizard and the METyselection dialog
	 * (Table View).
	 * 
	 * @param eObject
	 *            the {@link EObject}
	...
	/**
	 * Whether a {@link EObject} is a association class. Association classes are
	...
	/**
	 * Returns an {@link ECPAssociationClassElement} wrapper for a
	 * {@link EObject}.
	 * 
	 * @param eObject
	 *            the {@link EObject}
	 ...
	 */
	EReference getPossibleContainingReference(final EObject newMEInstance,
			EObject parent);
