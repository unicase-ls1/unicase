...
public final class UnicaseActionHelper {
	...
	public static void openMEDiagram(MEDiagram diagram, boolean withMEEditor) {
		 ...
		 * (diagram.getType().equals(DiagramType.USECASE_DIAGRAM)) { id =
		 * "org.unicase.ui.diagram.usecaseDiagram.part.ModelDiagramEditorID"; } else if
		 * (diagram.getType().equals(DiagramType.COMPONENT_DIAGRAM)) { id =
		 * "org.unicase.ui.diagram.componentDiagram.part.ModelDiagramEditorID"; } else if
		 * (diagram.getType().equals(DiagramType.STATE_DIAGRAM)) { id =
		 * "org.unicase.ui.diagram.stateDiagram.part.ModelDiagramEditorID"; } else if
		 * (diagram.getType().equals(DiagramType.ACTIVITY_DIAGRAM)) { id =
		 * "org.unicase.ui.diagram.activityDiagram.part.ModelDiagramEditorID"; } else if
		 * (diagram.getType().equals(DiagramType.WORKITEM_DIAGRAM)) { id =
		 * "org.unicase.ui.diagram.workItemDiagram.part.ModelDiagramEditorID"; }
		 */
