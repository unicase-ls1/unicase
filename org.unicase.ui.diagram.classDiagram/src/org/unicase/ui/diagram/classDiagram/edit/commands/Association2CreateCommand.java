...
public class Association2CreateCommand extends CreateElementCommand {
	 ...
	 * @generated NOT
	 */
	public Association2CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
		super(request);
	...
	public boolean canExecute() {
		...
		return org.unicase.ui.diagram.classDiagram.edit.policies.ModelBaseItemSemanticEditPolicy.LinkConstraints
			.canCreateAssociation_4002(getContainer(), getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		org.unicase.ui.diagram.classDiagram.providers.ModelElementTypes.init_Association_4002(newElement);
		return newElement;
	}
