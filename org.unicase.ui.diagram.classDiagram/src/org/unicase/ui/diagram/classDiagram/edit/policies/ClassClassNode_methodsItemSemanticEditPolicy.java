...
public class ClassClassNode_methodsItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.unicase.ui.diagram.classDiagram.providers.ModelElementTypes.Method_3002 == req.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ClassesPackage.eINSTANCE.getClass_Methods());
			}
			return getGEFWrapper(new org.unicase.ui.diagram.classDiagram.edit.commands.MethodCreateCommand(req));
		}
