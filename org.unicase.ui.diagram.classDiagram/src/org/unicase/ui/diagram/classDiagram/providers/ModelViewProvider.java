...
public class ModelViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				if (!org.unicase.ui.diagram.classDiagram.providers.ModelElementTypes
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram
				.setType(org.unicase.ui.diagram.classDiagram.edit.parts.MEDiagramEditPart.MODEL_ID);
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		case org.unicase.ui.diagram.classDiagram.edit.parts.ClassSuperClassesEditPart.VISUAL_ID:
			return createClassSuperClasses_4007(containerView, index,
					persisted, preferencesHint);
		case org.unicase.ui.diagram.classDiagram.edit.parts.DependencyEditPart.VISUAL_ID:
			return createDependency_4006(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		}
	...
	public Node createClass_2001(EObject domainElement, View containerView,
		...
		node
				.setType(org.unicase.ui.diagram.classDiagram.part.ModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createClassSuperClasses_4007(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createDependency_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
