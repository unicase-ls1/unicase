...
public class LibrarySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LibraryPackage.BOOK: {
			...
			if (result == null)
				result = caseLibraryBase(book);
			if (result == null)
				result = caseModelElement(book);
			if (result == null)
				result = caseIdentifiableElement(book);
			if (result == null)
		...
		case LibraryPackage.LIBRARY: {
			...
			if (result == null)
				result = caseLibraryBase(library);
			if (result == null)
				result = caseModelElement(library);
			if (result == null)
				result = caseIdentifiableElement(library);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LibraryPackage.WRITER: {
			...
			if (result == null)
				result = caseLibraryBase(writer);
			if (result == null)
				result = caseModelElement(writer);
			if (result == null)
				result = caseIdentifiableElement(writer);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LibraryPackage.LIBRARY_BASE: {
			...
			if (result == null)
				result = caseModelElement(libraryBase);
			if (result == null)
				result = caseIdentifiableElement(libraryBase);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '
	 * <em>Writer</em>'. <!-- begin-user-doc --> This implementation returns
	 * null; returning a non-null result will terminate the switch. <!--
	 * end-user-doc -->
	 * 
	 * @param object
