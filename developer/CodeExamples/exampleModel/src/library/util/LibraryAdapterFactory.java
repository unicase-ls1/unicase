...
public class LibraryAdapterFactory extends AdapterFactoryImpl {
	...
	protected LibrarySwitch<Adapter> modelSwitch = new LibrarySwitch<Adapter>() {
		...
		@Override
		public Adapter caseLibraryBase(LibraryBase object) {
			return createLibraryBaseAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Book
	 * <em>Book</em>}'. <!-- begin-user-doc --> This default implementation
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Library
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.Writer
	 * <em>Writer</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link library.LibraryBase
	 * <em>Base</em>}'. <!-- begin-user-doc --> This default implementation
	 * returns null so that we can easily ignore cases; it's useful to ignore a
	 * case when inheritance will catch all the cases anyway. <!-- end-user-doc
	 * -->
	 * 
	 ...
	 * {@link org.unicase.metamodel.IdentifiableElement
	...
	/**
	 * Creates a new adapter for an object of class '
	 * {@link org.unicase.metamodel.ModelElement <em>Model Element</em>}'. <!--
