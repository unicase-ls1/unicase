 ...
 * <li>{@link library.impl.LibraryImpl#getIncludedLibraries <em>Included
 * Libraries</em>}</li>
 * </ul>
 * </p>
 * 
...
public class LibraryImpl extends LibraryBaseImpl implements Library {
	...
	/**
	 * The cached value of the '{@link #getIncludedLibraries()
	 * <em>Included Libraries</em>}' containment reference list. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	protected EList<Library> includedLibraries;
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					LibraryPackage.LIBRARY__NAME, oldName, name));
	}
	...
	public EList<Writer> getWriters() {
		if (writers == null) {
			writers = new EObjectContainmentEList.Resolving<Writer>(
					Writer.class, this, LibraryPackage.LIBRARY__WRITERS);
		}
		return writers;
	}
	...
	public EList<Book> getBooks() {
		if (books == null) {
			books = new EObjectContainmentEList.Resolving<Book>(Book.class,
					this, LibraryPackage.LIBRARY__BOOKS);
		}
		return books;
	}
	 ...
	 * @generated
	 */
	public EList<Library> getIncludedLibraries() {
		if (includedLibraries == null) {
			includedLibraries = new EObjectContainmentEList.Resolving<Library>(
					Library.class, this,
					LibraryPackage.LIBRARY__INCLUDED_LIBRARIES);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case LibraryPackage.LIBRARY__INCLUDED_LIBRARIES:
			...
			getIncludedLibraries().addAll(
					(Collection<? extends Library>) newValue);
			return;
		}
