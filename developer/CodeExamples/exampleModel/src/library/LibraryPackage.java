...
public interface LibraryPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link library.impl.LibraryBaseImpl
	 ...
	 * @ordered
	 */
	int BOOK__CATEGORY = LIBRARY_BASE_FEATURE_COUNT + 2;
	 ...
	 * @ordered
	 */
	int BOOK__AUTHOR = LIBRARY_BASE_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link library.impl.LibraryImpl
	...
	/**
	 * The feature id for the '<em><b>Included Libraries</b></em>' containment
	 * reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int LIBRARY__INCLUDED_LIBRARIES = LIBRARY_BASE_FEATURE_COUNT + 3;
	 ...
	 * @ordered
	 */
	int LIBRARY_FEATURE_COUNT = LIBRARY_BASE_FEATURE_COUNT + 4;

	/**
	 * The meta object id for the '{@link library.impl.WriterImpl
	...
	/**
	 * The meta object id for the '{@link library.BookCategory
	...
	/**
	 * Returns the meta object for the attribute '{@link library.Book#getTitle
	...
	/**
	 * Returns the meta object for the attribute '{@link library.Book#getPages
	 ...
	 * {@link library.Book#getCategory <em>Category</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference '{@link library.Book#getAuthor
	...
	/**
	 * Returns the meta object for class '{@link library.Library
	...
	/**
	 * Returns the meta object for the attribute '
	 * {@link library.Library#getName <em>Name</em>}'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * {@link library.Library#getWriters <em>Writers</em>}'. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link library.Library#getBooks <em>Books</em>}'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list '
	 *         <em>Books</em>'.
	...
	/**
	 * Returns the meta object for the containment reference list '
	 * {@link library.Library#getIncludedLibraries <em>Included Libraries</em>}
	 * '. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list '
	 *         <em>Included Libraries</em>'.
	 * @see library.Library#getIncludedLibraries()
	 * @see #getLibrary()
	 * @generated
	 */
	EReference getLibrary_IncludedLibraries();
	...
	/**
	 * Returns the meta object for the attribute '{@link library.Writer#getName
	...
	/**
	 * Returns the meta object for class '{@link library.LibraryBase
	...
	/**
	 * Returns the meta object for enum '{@link library.BookCategory
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link library.impl.BookImpl
		...
		/**
		 * The meta object literal for the '<em><b>Pages</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link library.impl.LibraryImpl
		 * <em>Library</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 * 
		 * @see library.impl.LibraryImpl
		...
		/**
		 * The meta object literal for the '<em><b>Writers</b></em>' containment
		...
		/**
		 * The meta object literal for the '<em><b>Included Libraries</b></em>'
		 * containment reference list feature. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @generated
		 */
		EReference LIBRARY__INCLUDED_LIBRARIES = eINSTANCE
				.getLibrary_IncludedLibraries();

		/**
		 * The meta object literal for the '{@link library.impl.WriterImpl
		 * <em>Writer</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc
		 * -->
		 * 
		 * @see library.impl.WriterImpl
		...
		/**
		 * The meta object literal for the '{@link library.impl.LibraryBaseImpl
		 * <em>Base</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see library.impl.LibraryBaseImpl
		 * @see library.impl.LibraryPackageImpl#getLibraryBase()
		...
		/**
		 * The meta object literal for the '{@link library.BookCategory
		 * <em>Book Category</em>}' enum. <!-- begin-user-doc --> <!--
		 * end-user-doc -->
		 * 
		 * @see library.BookCategory
		 * @see library.impl.LibraryPackageImpl#getBookCategory()
