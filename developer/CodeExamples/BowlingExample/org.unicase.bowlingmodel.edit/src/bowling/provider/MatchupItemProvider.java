...
public class MatchupItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Matchup_game_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Matchup_game_feature", "_UI_Matchup_type"),
	...
	public String getText(Object object) {
		String label = "";
		List<Game> games = ((Matchup)object).getGame();
