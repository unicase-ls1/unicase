...
public class ModelCreationWizardPage extends WizardNewFileCreationPage {
	...
	public void createControl(Composite parent) {
		...
		setFileName(org.unicase.ui.diagram.stateDiagram.part.ModelDiagramEditorUtil.getUniqueFileName(
	...
	protected boolean validatePage() {
		...
		if (extension != null && !getFilePath().toString().endsWith("." + extension)) {
			setErrorMessage(NLS.bind(
				org.unicase.ui.diagram.stateDiagram.part.Messages.ModelCreationWizardPageExtensionError, extension));
			return false;
		}
		return true;
	}
