 ...
 */
package org.unicase.emfstore.esmodel.accesscontrol.provider;
...
public class OrgUnitPropertiesItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OrgUnitProperties_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitProperties_name_feature", "_UI_OrgUnitProperties_type"),
				 AccesscontrolPackage.Literals.ORG_UNIT_PROPERTIES__NAME,
				 true,
				 false,
				 false,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OrgUnitProperties_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OrgUnitProperties_value_feature", "_UI_OrgUnitProperties_type"),
				 AccesscontrolPackage.Literals.ORG_UNIT_PROPERTIES__VALUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns OrgUnitProperties.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_OrgUnitProperties_type") :
