 ...
 * {@link org.unicase.emfstore.esmodel.ProjectHistory} object. <!--
...
public class ProjectHistoryItemProvider extends ItemProviderAdapter implements
	...
	protected void addProjectNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ProjectHistory_projectName_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ProjectHistory_projectName_feature",
						"_UI_ProjectHistory_type"),
				EsmodelPackage.Literals.PROJECT_HISTORY__PROJECT_NAME, true,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(EsmodelPackage.Literals.PROJECT_HISTORY__PROJECT_ID);
			childrenFeatures
					.add(EsmodelPackage.Literals.PROJECT_HISTORY__VERSIONS);
		}
