 ...
 * {@link org.unicase.emfstore.esmodel.ProjectInfo} object. <!-- begin-user-doc
 * --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ProjectInfoItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_ProjectInfo_name_feature"), getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ProjectInfo_name_feature",
								"_UI_ProjectInfo_type"),
						EsmodelPackage.Literals.PROJECT_INFO__NAME, true,
						false, false,
	...
	protected void addDescriptionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ProjectInfo_description_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ProjectInfo_description_feature",
						"_UI_ProjectInfo_type"),
				EsmodelPackage.Literals.PROJECT_INFO__DESCRIPTION, true, false,
	...
	protected void addProjectIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ProjectInfo_projectId_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ProjectInfo_projectId_feature",
						"_UI_ProjectInfo_type"),
				EsmodelPackage.Literals.PROJECT_INFO__PROJECT_ID, true, false,
				true, null, null, null));
	}
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ProjectInfo_version_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ProjectInfo_version_feature",
						"_UI_ProjectInfo_type"),
				EsmodelPackage.Literals.PROJECT_INFO__VERSION, true, false,
				true, null, null, null));
	}
