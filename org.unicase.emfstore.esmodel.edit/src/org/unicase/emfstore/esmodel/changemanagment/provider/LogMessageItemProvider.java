 ...
 * {@link org.unicase.emfstore.esmodel.changemanagment.LogMessage} object. <!--
...
public class LogMessageItemProvider extends ItemProviderAdapter implements
	...
	protected void addMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_LogMessage_message_feature"), getString(
	...
	protected void addAuthorPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_LogMessage_author_feature"), getString(
								"_UI_PropertyDescriptor_description",
	...
	protected void addDatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_LogMessage_date_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_LogMessage_date_feature", "_UI_LogMessage_type"),
				ChangemanagmentPackage.Literals.LOG_MESSAGE__DATE, true, false,
