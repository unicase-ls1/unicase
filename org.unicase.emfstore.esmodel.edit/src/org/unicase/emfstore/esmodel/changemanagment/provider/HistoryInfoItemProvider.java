 ...
 * {@link org.unicase.emfstore.esmodel.changemanagment.HistoryInfo} object. <!--
...
public class HistoryInfoItemProvider extends ItemProviderAdapter implements
	...
	protected void addPrimerySpecPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_HistoryInfo_primerySpec_feature"), getString(
	...
	protected void addLogMessagePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_HistoryInfo_logMessage_feature"), getString(
						"_UI_PropertyDescriptor_description",
