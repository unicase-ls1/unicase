...
/**
 * This is the action bar contributor for the Change model editor. <!--
 * begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class ChangeActionBarContributor extends
	 ...
	 * @generated
	 */
	public ChangeActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("change-settings"));
		toolBarManager.add(new Separator("change-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(ModelEditorPlugin.INSTANCE.getString("_UI_ChangeEditor_menu"), "org.unicase.model.changeMenuID");
