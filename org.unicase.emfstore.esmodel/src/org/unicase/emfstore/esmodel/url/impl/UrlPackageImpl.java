...
public class UrlPackageImpl extends EPackageImpl implements UrlPackage {
	...
	public static UrlPackage init() {
		...
		UrlPackageImpl theUrlPackage = (UrlPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof UrlPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new UrlPackageImpl());
