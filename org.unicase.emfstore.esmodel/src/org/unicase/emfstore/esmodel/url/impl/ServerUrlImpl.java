...
/*
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Server Url</b></em>'. <!-- end-user-doc --> <p>
 * The following features are implemented: <ul> <li>{@link
 * org.unicase.emfstore.esmodel.url.impl.ServerUrlImpl#getHostName <em>Host Name</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.url.impl.ServerUrlImpl#getPort <em>Port</em>}</li> </ul> </p>
 * @generated
 */
