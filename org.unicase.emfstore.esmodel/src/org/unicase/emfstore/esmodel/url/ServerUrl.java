...
/*
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Server Url</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link org.unicase.emfstore.esmodel.url.ServerUrl#getHostName <em>Host
 * Name</em>}</li> <li>{@link org.unicase.emfstore.esmodel.url.ServerUrl#getPort <em>Port</em>}</li> </ul> </p>
 * @see org.unicase.emfstore.esmodel.url.UrlPackage#getServerUrl()
 * @model
 * @generated
 */
public interface ServerUrl extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.url.ServerUrl#getPort <em>Port</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
