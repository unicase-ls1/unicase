 ...
 * org.unicase.emfstore.esmodel.url.ModelElementUrl#getServerUrl <em>Server Url</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.url.ModelElementUrl#getProjectUrlFragment <em>Project Url Fragment</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.url.ModelElementUrl#getModelElementUrlFragment <em>Model Element Url Fragment</em>}</li>
 * </ul> </p>
