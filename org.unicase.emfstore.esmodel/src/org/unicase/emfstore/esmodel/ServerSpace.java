 ...
 * <p> The following features are supported: <ul> <li>{@link org.unicase.emfstore.esmodel.ServerSpace#getGroups
 * <em>Groups</em>}</li> <li>{@link org.unicase.emfstore.esmodel.ServerSpace#getProjects <em>Projects</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.ServerSpace#getOpenSessions <em>Open Sessions</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.ServerSpace#getUsers <em>Users</em>}</li> </ul> </p>
