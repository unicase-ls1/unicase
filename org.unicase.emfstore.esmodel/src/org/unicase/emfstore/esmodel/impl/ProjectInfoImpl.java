 ...
 * <p> The following features are implemented: <ul> <li>{@link org.unicase.emfstore.esmodel.impl.ProjectInfoImpl#getName
 * <em>Name</em>}</li> <li>{@link org.unicase.emfstore.esmodel.impl.ProjectInfoImpl#getDescription
 * <em>Description</em>}</li> <li>{@link org.unicase.emfstore.esmodel.impl.ProjectInfoImpl#getProjectId <em>Project
 * Id</em>}</li> <li>{@link org.unicase.emfstore.esmodel.impl.ProjectInfoImpl#getVersion <em>Version</em>}</li> </ul>
 * </p>
 * @generated
 */
	...
	public void setProjectIdGen(ProjectId newProjectId) {
		if (newProjectId != projectId)
		{
			...
			if (newProjectId != null)
				msgs = ((InternalEObject)newProjectId).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - EsmodelPackage.PROJECT_INFO__PROJECT_ID, null, msgs);
			msgs = basicSetProjectId(newProjectId, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EsmodelPackage.PROJECT_INFO__PROJECT_ID, newProjectId, newProjectId));
	}
