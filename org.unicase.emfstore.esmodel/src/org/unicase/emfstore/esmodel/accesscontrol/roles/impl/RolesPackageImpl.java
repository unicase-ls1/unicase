...
public class RolesPackageImpl extends EPackageImpl implements RolesPackage {
	...
	public static RolesPackage init() {
		...
		RolesPackageImpl theRolesPackage = (RolesPackageImpl) (EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI) instanceof RolesPackageImpl ? EPackage.Registry.INSTANCE
				.getEPackage(eNS_URI)
	...
	public void initializePackageContents() {
		...
		initEReference(getRole_Projects(), theEsmodelPackage.getProjectInfo(),
		...
		addEParameter(op, theEsmodelPackage.getProjectId(), "projectId", 0, 1,
		...
		addEParameter(op, theEsmodelPackage.getProjectId(), "projectId", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, theModelPackage.getModelElement(), "modelElement", 0,
