...
public interface RolesFactory extends EFactory {
	 ...
	 * @generated
	 */
	RolesFactory eINSTANCE = org.unicase.emfstore.esmodel.accesscontrol.roles.impl.RolesFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Reader Role</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Writer Role</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Project Admin Role</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Server Admin</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
