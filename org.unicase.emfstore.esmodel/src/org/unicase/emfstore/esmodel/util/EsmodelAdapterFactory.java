...
public class EsmodelAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.emfstore.esmodel.ProjectInfo <em>Project Info</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.emfstore.esmodel.ServerSpace <em>Server Space</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that
	 * we can easily ignore cases; it's useful to ignore a case when inheritance
	 * will catch all the cases anyway. <!-- end-user-doc -->
	 * @return the new adapter.
