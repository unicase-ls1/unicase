...
public interface VersioningFactory extends EFactory {
	 ...
	 * @generated
	 */
	VersioningFactory eINSTANCE = org.unicase.emfstore.esmodel.versioning.impl.VersioningFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Tag Version Spec</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Date Version Spec</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Primary Version Spec</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Log Message</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Change Package</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>History Info</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>History Query</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Head Version Spec</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
