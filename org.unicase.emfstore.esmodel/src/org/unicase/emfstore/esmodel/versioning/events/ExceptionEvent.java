 ...
 * <li>{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionStackTrace <em>Exception Stack
 * Trace</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionCauseTitle <em>Exception Cause
 * Title</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionCauseStackTrace <em>Exception
 * Cause Stack Trace</em>}</li>
 * </ul>
 * </p>
 * 
...
public interface ExceptionEvent extends Event {
	/**
	 * Returns the value of the '<em><b>Exception Title</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionTitle
	 * <em>Exception Title</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Exception Stack Trace</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <em>Exception Stack Trace</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Exception Cause Title</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <em>Exception Cause Title</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Exception Cause Stack Trace</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * <em>Exception Cause Stack Trace</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
