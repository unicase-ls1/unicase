 ...
 * org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionTitle <em>Exception Title</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionStackTrace <em>Exception Stack
 * Trace</em>}</li> <li>{@link org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionCauseTitle
 * <em>Exception Cause Title</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.ExceptionEvent#getExceptionCauseStackTrace <em>Exception Cause Stack
 * Trace</em>}</li> </ul> </p>
