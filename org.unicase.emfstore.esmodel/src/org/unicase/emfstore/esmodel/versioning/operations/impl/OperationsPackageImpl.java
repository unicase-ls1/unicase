...
public class OperationsPackageImpl extends EPackageImpl implements
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractOperation_Accepted(), ecorePackage
				.getEBoolean(), "accepted", null, 0, 1,
				AbstractOperation.class, IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		addEOperation(abstractOperationEClass, ecorePackage.getEBoolean(),
				"isChange", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEClass(referenceOperationEClass, ReferenceOperation.class,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getReferenceOperation_Bidirectional(), ecorePackage
				.getEBoolean(), "bidirectional", null, 0, 1,
		...
		initEClass(multiAttributeMoveOperationEClass,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getMultiAttributeMoveOperation_OldIndex(), ecorePackage
				.getEInt(), "oldIndex", null, 0, 1,
				MultiAttributeMoveOperation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getMultiAttributeMoveOperation_NewIndex(), ecorePackage
				.getEInt(), "newIndex", null, 0, 1,
				MultiAttributeMoveOperation.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
