 ...
 * org.unicase.emfstore.esmodel.notification.Notification#getSender <em>Sender</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.notification.Notification#getRecipient <em>Recipient</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.notification.Notification#getProject <em>Project</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.notification.Notification#getRelatedModelElements <em>Related Model Elements</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.notification.Notification#getMessage <em>Message</em>}</li> </ul> </p>
 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification()
 * @model
 * @generated
 */
public interface Notification extends IdentifiableElement {
	 ...
	 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification_Sender()
	 * @model
	 * @generated
	 */
	String getSender();
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.notification.Notification#getSender <em>Sender</em>}'
	 ...
	 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification_Recipient()
	 * @model
	 * @generated
	 */
	String getRecipient();
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.notification.Notification#getRecipient
	 ...
	 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification_Project()
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.notification.Notification#getProject <em>Project</em>}
	 ...
	 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification_RelatedModelElements()
	 * @model containment="true" resolveProxies="true"
	 * @generated
	 */
	 ...
	 * @see org.unicase.emfstore.esmodel.notification.NotificationPackage#getNotification_Message()
	 * @model
	 * @generated
	 */
	String getMessage();
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.notification.Notification#getMessage <em>Message</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
