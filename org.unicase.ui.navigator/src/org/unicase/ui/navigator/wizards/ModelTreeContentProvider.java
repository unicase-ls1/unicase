 ...
 * 
 * @author Hodaie
 * ContentProvider for TreeViewer which is shown on ModelTreePage
 *
 */
public class ModelTreeContentProvider extends AdapterFactoryContentProvider {
	...
	/**.
	 * ({@inheritDoc})
	 * Return an array of sub-packages of Model package
	 */
	@Override
	...
	/**.
	 * ({@inheritDoc})
	 * Shows the children only when argument is an EPackage.
	...
	/**.
	 * ({@inheritDoc})
	 * If argument is an EClass return false.
	 * This is to prevent showing of the plus sign beside an EClass in TreeViewer
	 */
	@Override
