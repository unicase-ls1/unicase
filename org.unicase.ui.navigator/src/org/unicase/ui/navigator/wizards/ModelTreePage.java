 ...
 * 
 * @author Hodaie
 * This is the first page of NewModelElementWizard. 
 * On this page the model packages and their class (only those who inherit ModelElement and
 * are not abstract) are shown in a TreeViewer.
 * If user selects a class in this tree, the wizard can finish.  
 *
 */
public class ModelTreePage extends WizardPage implements Listener{
	...
	public void createControl(Composite parent) {
		...
		//TODO: treeViewer must be initialized with a SWT Tree to prevent multi selection.
		...
		treeViewer.setInput(WorkspaceManager
	...
	/**
	 * Check if tree selection is a ME and wizard can complete. 
	 * This Method sets the newMEType and treeCompleted fields in NewModelElementWizard
	 * @return 
	 */
    ...
    /**.
     * ({@inheritDoc}
     * On selection change in TreeViewer updates wizard buttons accordingly
     */
