...
public class ConfigurableRectangleFigure extends Shape {
	...
	*/
	 ...
	 * The input string is parsed for occurences of the letters 'N','S','E' and 'W', which denote the four orientations. 
	 *  
	 * @param borders
	 * The input string. 
	 * 
	...
	/**
	 * @return
	 * Returns a string denoting the border orientations which are drawn
	 */
