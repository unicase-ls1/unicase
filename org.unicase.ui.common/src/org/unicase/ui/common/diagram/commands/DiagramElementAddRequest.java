...
public class DiagramElementAddRequest extends CreateElementRequest {
	 ...
	 * 
	 * @param container
	 * The container which should contain the new elements
	 * @param elementType
	 * The element types which should be added
	 */
	...
	/**
	 * @param addReferences
	 * Flag indicating if connecting references between nodes should also be added 
	 */
