...
public class DiagramEditorContextMenuProvider extends DiagramContextMenuProvider {
	 ...
	 * @generated
	 */
	private org.unicase.ui.usecaseDiagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part, EditPartViewer viewer) {
		super(part, viewer);
		this.part = part;
		deleteAction = new org.unicase.ui.usecaseDiagram.part.DeleteElementAction(part);
		deleteAction.init();
	}
