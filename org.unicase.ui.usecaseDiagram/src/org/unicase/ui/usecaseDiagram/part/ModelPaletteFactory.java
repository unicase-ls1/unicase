...
public class ModelPaletteFactory {
	...
	private ToolEntry createUseCase1CreationTool() {
		...
		entry
				.setSmallIcon(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes
						.getImageDescriptor(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCase_2002));
	...
	private ToolEntry createActor2CreationTool() {
		...
		entry
				.setSmallIcon(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes
						.getImageDescriptor(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.Actor_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
