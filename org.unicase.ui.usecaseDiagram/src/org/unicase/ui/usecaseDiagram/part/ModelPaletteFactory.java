...
public class ModelPaletteFactory {
	...
	private PaletteContainer createDefault1Group() {
		...
		paletteContainer.setDescription(org.unicase.ui.usecaseDiagram.part.Messages.Default1Group_desc);
	...
	private ToolEntry createUseCase1CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(org.unicase.ui.usecaseDiagram.part.Messages.UseCase1CreationTool_title,
			null, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes
	...
	private ToolEntry createActor2CreationTool() {
		...
		NodeToolEntry entry = new NodeToolEntry(org.unicase.ui.usecaseDiagram.part.Messages.Actor2CreationTool_title,
			null, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.providers.ModelElementTypes
	...
	private ToolEntry createInitiate3CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(
			...
			org.unicase.ui.usecaseDiagram.part.Messages.Initiate3CreationTool_desc, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.part.ModelDiagramEditorPlugin
	...
	private ToolEntry createParticipate4CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(
			org.unicase.ui.usecaseDiagram.part.Messages.Participate4CreationTool_title, null, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.part.ModelDiagramEditorPlugin
	...
	private ToolEntry createInclude5CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(org.unicase.ui.usecaseDiagram.part.Messages.Include5CreationTool_title,
			null, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.part.ModelDiagramEditorPlugin
	...
	private ToolEntry createExtend6CreationTool() {
		...
		LinkToolEntry entry = new LinkToolEntry(org.unicase.ui.usecaseDiagram.part.Messages.Extend6CreationTool_title,
			null, types);
		entry.setSmallIcon(org.unicase.ui.usecaseDiagram.part.ModelDiagramEditorPlugin
