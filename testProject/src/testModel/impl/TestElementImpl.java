 ...
 * <ul>
 * <li>{@link testModel.impl.TestElementImpl#getValues <em>Values</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class TestElementImpl extends ModelElementImpl implements TestElement {
	...
	public EList<String> getValues() {
		if (values == null) {
			values = new EDataTypeEList<String>(String.class, this,
					TestModelPackage.TEST_ELEMENT__VALUES);
		}
		return values;
	}
