...
public class GlobalAttributeTypeOptions {
	...
	public GlobalAttributeTypeOptions(Composite parent, DocumentTemplate template) {
		...
		createAttributeTypes(template.globalRendererOptions);
	...
	private void createAttributeTypeOptions(int index) {
		...
		factory.buildOptionsFormular(attributeTypeOptions, template.globalRendererOptions.get(index));
