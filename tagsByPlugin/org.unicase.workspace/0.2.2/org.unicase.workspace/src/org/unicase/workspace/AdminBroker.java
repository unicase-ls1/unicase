 ...
 * delegates the method calls to the server (
 * {@link org.unicase.emfstore.AdminEmfStore}) via
 * {@link org.unicase.emfstore.AdminConnectionManager}.
 * 
 * @author Hodaie
 * @author Wesendonk
 */
public interface AdminBroker {
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#createGroup(org.unicase.emfstore.esmodel.SessionId,
	 *      String)
	 * 
	 * @param name
	 *            new name
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#deleteGroup(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId)
	 * 
	 * @param group
	 *            orgUnit id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#removeGroup(org.unicase.emfstore.esmodel.SessionId,
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#createUser(org.unicase.emfstore.esmodel.SessionId,
	 *      String)
	 * 
	 * @param name
	 *            user's name
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#deleteUser(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId)
	 * 
	 * @param user
	 *            user id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#getMembers(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId)
	 * 
	 * @param groupId
	 *            group id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#getOrgUnit(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId)
	 * 
	 * @param orgUnitId
	 *            orgUnit id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#addMember(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId, ACOrgUnitId)
	 * 
	 * @param group
	 *            group id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#removeMember(org.unicase.emfstore.esmodel.SessionId,
	 *      ACOrgUnitId, ACOrgUnitId)
	 * 
	 * @param group
	 *            group id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#changeOrgUnit(org.unicase.emfstore.esmodel.SessionId,
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#getParticipants(org.unicase.emfstore.esmodel.SessionId,
	 *      ProjectId)
	 * 
	 * @param projectId
	 *            project id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#addParticipant(org.unicase.emfstore.esmodel.SessionId,
	 ...
	 *             if an exceptions occurs on the server or on transport
	 */
	void addParticipant(ProjectId projectId, ACOrgUnitId participant)
			throws EmfStoreException;

	/**
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#removeParticipant(org.unicase.emfstore.esmodel.SessionId,
	 *      ProjectId, ACOrgUnitId)
	 * 
	 * @param projectId
	 *            project id
	 ...
	 *Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#getRole(org.unicase.emfstore.esmodel.SessionId,
	 *      ProjectId, ACOrgUnitId)
	 * 
	 * @param projectId
	 *            project id
	 ...
	 * Delegates call to method in {@link org.unicase.emfstore.AdminEmfStore}.
	 * 
	 * @see org.unicase.emfstore.AdminEmfStore#changeRole(org.unicase.emfstore.esmodel.SessionId,
	 ...
	 *             if an exceptions occurs on the server or on transport
	 */
	void changeRole(ProjectId projectId, ACOrgUnitId orgUnit, EClass role)
			throws EmfStoreException;
