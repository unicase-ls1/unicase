...
/**
 * 
 * @author denglerm This is the converter for DiagramType parameter passed to createME
...
public class DiagramTypeConverter extends AbstractParameterValueConverter {
	...
	/**
	 * . {@inheritDoc} This creates the DiagramType object back from its string
	 * representation.
	 * 
	 */
	@Override
	...
	/**
	 * . ({@inheritDoc}) This creates a string representation of DiagramType object
