...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.ui.componentDiagram.part.ModelDiagramUpdater
				.getMEDiagram_99SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result
					.add(((org.unicase.ui.componentDiagram.part.ModelNodeDescriptor) it
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.componentDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.componentDiagram.part.ModelDiagramUpdater
