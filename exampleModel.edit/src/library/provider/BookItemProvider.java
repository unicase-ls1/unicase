	...
	protected void addPublicationYearPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Book_publicationYear_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Book_publicationYear_feature", "_UI_Book_type"),
				 LibraryPackage.Literals.BOOK__PUBLICATION_YEAR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
