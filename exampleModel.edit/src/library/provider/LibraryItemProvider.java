...
public class LibraryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LibraryPackage.Literals.LIBRARY__SECTIONS);
	...
	public String getText(Object object) {
		String label = ((Library)object).getIdentifier();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Library.class)) {
			case LibraryPackage.LIBRARY__SECTIONS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(LibraryPackage.Literals.LIBRARY__SECTIONS,
				 LibraryFactory.eINSTANCE.createSection()));
