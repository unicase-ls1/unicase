 ...
 * @author pfeifferc
 */
public class AssignWorkItemToUserRefactoringDialog extends AbstractElementListSelectionRefactoringDialog {

	/**
	 * @param parent the
	 * @param abstractRefactoringStrategy the
	 */
	public AssignWorkItemToUserRefactoringDialog(Shell parent,
