...
package org.unicase.ui.refactoring.templates.util;
...
public class RefactoringDialogHelper {
	...
	private static AdapterFactoryItemDelegator adapterFactoryItemDelegator = new AdapterFactoryItemDelegator(
	 ...
	 * @return the control
	 */
	public Control createMEControl(AbstractMEControl control, Composite parent, UnicaseModelElement modelElement,
			String feature) {
	...
	/**
	 * @param eObject the
	 * @param invalidStructuralFeature the
	 * @return the control
	 */
	public static AbstractMEControl getMEControl(EObject eObject, EStructuralFeature invalidStructuralFeature) {
		...
		for(IItemPropertyDescriptor itemPropertyDescriptor : propertyDescriptors) {
			EStructuralFeature structuralFeature = (EStructuralFeature) itemPropertyDescriptor.getFeature(eObject);
			if(structuralFeature.getName().equals(invalidStructuralFeature.getName())) {
				return controlFactory.createControl(itemPropertyDescriptor, eObject);
			}
		}
		return null;
	}
