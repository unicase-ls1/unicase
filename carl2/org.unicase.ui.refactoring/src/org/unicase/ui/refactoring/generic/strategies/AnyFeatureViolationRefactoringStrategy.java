...
/**
 * An {@link AbstractRefactoringStrategy} for arbitrary features.
 * 
 * @author pfeifferc
 */
public class AnyFeatureViolationRefactoringStrategy extends AbstractRefactoringStrategy {
	...
	private void openDialog(EStructuralFeature structuralFeature) {
		ModelElement modelElement = (ModelElement) getInvalidEObject();
		EReference eReference = (EReference) structuralFeature;
		EClass clazz = eReference.getEReferenceType();
		Collection<EObject> allElements = new EMFStoreModelelementContext(modelElement).getAllModelElementsbyClass(clazz, new BasicEList<EObject>());
