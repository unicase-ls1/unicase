...
public class ClientVersionInfoItemProvider extends ItemProviderAdapter
	...
	protected void addVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ClientVersionInfo_version_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ClientVersionInfo_version_feature",
						"_UI_ClientVersionInfo_type"),
				EsmodelPackage.Literals.CLIENT_VERSION_INFO__VERSION, true,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ClientVersionInfo_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ClientVersionInfo_name_feature",
						"_UI_ClientVersionInfo_type"),
				EsmodelPackage.Literals.CLIENT_VERSION_INFO__NAME, true, false,
