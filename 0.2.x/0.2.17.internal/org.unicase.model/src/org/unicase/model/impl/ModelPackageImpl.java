...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation(getModelElement_Description(), source, new String[] {
				"priority", "1.0", "position", "left" });
		addAnnotation(getModelElement_Annotations(), source, new String[] {
				"priority", "100.0", "position", "right" });
		addAnnotation(getModelElement_Attachments(), source, new String[] {
				"priority", "101.0", "position", "right" });
		addAnnotation(getModelElement_IncomingDocumentReferences(), source,
