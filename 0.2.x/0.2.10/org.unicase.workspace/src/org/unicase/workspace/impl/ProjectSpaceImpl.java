 ...
 *             <em>Operations</em>}</li>
 *             <li>{@link org.unicase.workspace.impl.ProjectSpaceImpl#getEvents
 *             <em>Events</em>}</li>
 *             <li>
			...
			if (true) {
				try {
					...
					if (cause != null && cause instanceof DanglingHREFException) {
						...
						if (foundProblems) {
							WorkspaceUtil.logException("An error in the data was detected during save! Self-healing fixed the problem.", e);
						}
					}
				...
				if (notification instanceof NotificationImpl) {
					...
					// operations being created.
						...
						WorkspaceUtil.logException(
								"Access to next field of notification failed.",
								e);
					} catch (NoSuchFieldException e) {
						WorkspaceUtil.logException(
								"Access to next field of notification failed.",
