 ...
 * @generated
 */
public class LinkEventItemProvider extends EventItemProvider implements
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCreatedNewPropertyDescriptor(object);
		}
	...
	protected void addSourceViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_LinkEvent_sourceView_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_LinkEvent_sourceView_feature",
						"_UI_LinkEvent_type"),
				EventsPackage.Literals.LINK_EVENT__SOURCE_VIEW, true, false,
	...
	protected void addSourceElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_LinkEvent_sourceElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_LinkEvent_sourceElement_feature",
						"_UI_LinkEvent_type"),
				EventsPackage.Literals.LINK_EVENT__SOURCE_ELEMENT, true, false,
				true, null, null, null));
	}
	...
	protected void addTargetElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_LinkEvent_targetElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_LinkEvent_targetElement_feature",
						"_UI_LinkEvent_type"),
				EventsPackage.Literals.LINK_EVENT__TARGET_ELEMENT, true, false,
				true, null, null, null));
	}
	...
	protected void addCreatedNewPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_LinkEvent_createdNew_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_LinkEvent_createdNew_feature",
						"_UI_LinkEvent_type"),
				EventsPackage.Literals.LINK_EVENT__CREATED_NEW, true, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_LinkEvent_type")
