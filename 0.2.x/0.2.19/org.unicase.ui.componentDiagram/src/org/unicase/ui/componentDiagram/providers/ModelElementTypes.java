...
public class ModelElementTypes extends ElementInitializers {
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ComponentService_1001, ComponentPackage.eINSTANCE
					.getComponentService());

			elements.put(Component_1002, ComponentPackage.eINSTANCE
					.getComponent());

			elements.put(ComponentOfferedServices_3001,
					ComponentPackage.eINSTANCE.getComponent_OfferedServices());

			elements.put(ComponentConsumedServices_3002,
