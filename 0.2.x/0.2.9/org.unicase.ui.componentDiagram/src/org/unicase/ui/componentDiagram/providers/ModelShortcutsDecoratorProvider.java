 ...
 * @generated
 */
public class ModelShortcutsDecoratorProvider extends AbstractProvider implements
		IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		public void refresh() {
			...
			EditPart editPart = (EditPart) getDecoratorTarget().getAdapter(
					EditPart.class);
			Image image = org.unicase.ui.componentDiagram.part.ModelDiagramEditorPlugin
