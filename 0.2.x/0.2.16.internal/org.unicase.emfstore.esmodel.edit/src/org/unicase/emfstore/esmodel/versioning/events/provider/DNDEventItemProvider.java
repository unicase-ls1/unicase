 ...
 * @generated
 */
public class DNDEventItemProvider extends EventItemProvider implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_DNDEvent_sourceView_feature",
								"_UI_DNDEvent_type"),
						EventsPackage.Literals.DND_EVENT__SOURCE_VIEW, true,
						false, false,
	...
	protected void addTargetViewPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_PropertyDescriptor_description",
								"_UI_DNDEvent_targetView_feature",
								"_UI_DNDEvent_type"),
						EventsPackage.Literals.DND_EVENT__TARGET_VIEW, true,
						false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Drag Source Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDragSourceElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DNDEvent_dragSourceElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DNDEvent_dragSourceElement_feature",
						"_UI_DNDEvent_type"),
				EventsPackage.Literals.DND_EVENT__DRAG_SOURCE_ELEMENT, true,
				false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Drop Target Element feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addDropTargetElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_DNDEvent_dropTargetElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_DNDEvent_dropTargetElement_feature",
						"_UI_DNDEvent_type"),
				EventsPackage.Literals.DND_EVENT__DROP_TARGET_ELEMENT, true,
				false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_DNDEvent_type")
