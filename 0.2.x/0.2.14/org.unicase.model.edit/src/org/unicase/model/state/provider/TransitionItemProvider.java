 ...
 * @generated
 */
public class TransitionItemProvider extends ModelElementItemProvider implements
	...
	protected void addConditionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_Transition_condition_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_Transition_condition_feature",
						"_UI_Transition_type"),
				StatePackage.Literals.TRANSITION__CONDITION, true, false,
	...
	protected void addSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_Transition_source_feature"), getString(
								"_UI_PropertyDescriptor_description",
								"_UI_Transition_source_feature",
								"_UI_Transition_type"),
						StatePackage.Literals.TRANSITION__SOURCE, true, false,
						true, null, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString("_UI_Transition_target_feature"), getString(
								...
								"_UI_Transition_type"),
						StatePackage.Literals.TRANSITION__TARGET, true, false,
						true, null, null, null));
	}
