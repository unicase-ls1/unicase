	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							org.unicase.ui.diagram.usecaseDiagram.part.Messages.InitDiagramFile_ResourceErrorDialogTitle,
							org.unicase.ui.diagram.usecaseDiagram.part.Messages.InitDiagramFile_ResourceErrorDialogMessage);
			return;
		}
