...
public class ModelDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		String initialPath = PreferenceHelper.getPreference(OPEN_MODEL_PATH,
		...
		if (fileDialog.getFilterPath() != null) {
			...
			PreferenceHelper.setPreference(OPEN_MODEL_PATH,
	...
	private static UseCaseDiagram createInitialModel() {
		return DiagramFactory.eINSTANCE.createUseCaseDiagram();
	}
