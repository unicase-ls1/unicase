 ...
 * 
 * @see org.unicase.model.urml.danger.DangerPackage
 * @generated
 */
public class DangerAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected DangerSwitch<Adapter> modelSwitch = new DangerSwitch<Adapter>() {
		@Override
		...
		@Override
		public Adapter caseProceduralMitigation(ProceduralMitigation object) {
			return createProceduralMitigationAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.urml.danger.Danger <em>Danger</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.urml.danger.Mitigation
	 * <em>Mitigation</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.urml.danger.ProceduralMitigation
	 * <em>Procedural Mitigation</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
