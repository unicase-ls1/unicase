...
public interface UsecaseFactory extends EFactory {
	 ...
	 * @generated
	 */
	UsecaseFactory eINSTANCE = org.unicase.model.urml.usecase.impl.UsecaseFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Solution Domain Use Case</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
