...
public class ModelFactoryImpl extends EFactoryImpl implements ModelFactory {
	...
	public EObject create(EClass eClass) {
		...
		case ModelPackage.WORKSPACE_DATA_INTERNAL:
			return createWorkspaceDataInternal();
		case ModelPackage.SERVER_INFO:
			return createServerInfo();
		case ModelPackage.USERSESSION:
			return createUsersession();
		case ModelPackage.PROJECT_SPACE_DATA_INTERNAL:
			return createProjectSpaceDataInternal();
		...
		case ModelPackage.PROJECT_DATA:
	 ...
	 * @generated
	 */
	public WorkspaceDataInternal createWorkspaceDataInternal() {
		WorkspaceDataInternalImpl workspaceDataInternal = new WorkspaceDataInternalImpl();
		return workspaceDataInternal;
	}
	 ...
	 * @generated
	 */
	public ProjectSpaceDataInternal createProjectSpaceDataInternal() {
		ProjectSpaceDataInternalImpl projectSpaceDataInternal = new ProjectSpaceDataInternalImpl();
		return projectSpaceDataInternal;
	}
