...
public class BowlingItemProviderAdapterFactory extends BowlingAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link bowling.Playerlist} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PlayerlistItemProvider playerlistItemProvider;

	/**
	 * This creates an adapter for a {@link bowling.Playerlist}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createPlayerlistAdapter() {
		if (playerlistItemProvider == null) {
			playerlistItemProvider = new PlayerlistItemProvider(this);
		}

		return playerlistItemProvider;
	}
