...
public class OrgaDiagramUpdater {
	...
	public static List getSemanticChildren(View view) {
		...
		case OrgDiagramEditPart.VISUAL_ID:
			return getOrgDiagram_666SemanticChildren(view);
		}
	 ...
	 * @generated
	 */
	public static List getOrgDiagram_666SemanticChildren(View view) {
	...
	public static List getContainedLinks(View view) {
		switch (OrgaVisualIDRegistry.getVisualID(view)) {
		case OrgDiagramEditPart.VISUAL_ID:
			return getOrgDiagram_666ContainedLinks(view);
	 ...
	 * @generated
	 */
	public static List getOrgDiagram_666ContainedLinks(View view) {
		return Collections.EMPTY_LIST;
	}
