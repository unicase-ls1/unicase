...
public interface Gesture extends GestureNotifier {
	...
	/**
	 * Indicates the gesture's ability to execute. It is up to the gesture interpreter to decide whether this gesture
	 * should be executed
	 * 
	...
	/**
	 * @param canExecute Indicates the gesture's ability to execute. It is up to the gesture interpreter to decide
	...
	/**
	 * Indicates if a gesture accepts the current constellation of touches. Acceptance means it may be able to interpret
	 * the touches and may become executable in the future.
	 * 
	...
	/**
	 * Resets the gesture. Sets volatile fields to null, sets touch acceptance state to true, sets execution state to
	 * false
	 */
	void reset();
	...
	/**
	 * @return The gestures which can not be executed concurrently with this gesture and therefore precede this gesture
	 */
