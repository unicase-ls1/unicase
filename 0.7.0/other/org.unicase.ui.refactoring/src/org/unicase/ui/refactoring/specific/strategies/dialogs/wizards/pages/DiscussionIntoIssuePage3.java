...
package org.unicase.ui.refactoring.specific.strategies.dialogs.wizards.pages;
...
public class DiscussionIntoIssuePage3 extends AbstractRefactoringWizardPage implements ModelElementChangeListener {
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.unicase.ui.refactoring.templates.dialogs.wizards.pages.refactoringstrategies.dialogs.wizards.pages.AbstractRefactoringWizardPage#createControl(org.eclipse.swt.widgets.Composite)
	 */
	@Override
	...
	public void onChange(Notification notification) {
		...
		setPageComplete(issue.getLeafSection() != null || issue.getContainingWorkpackage() != null || WorkspaceManager.getProjectSpace(issue) != null);
	}
	...
	public boolean performFinish() {
		...
		new UnicaseCommand() {
			...
			protected void doRun() {
				...
				for(EObject modelElement: getRefactoringWizard().getChildModelElements()) {
