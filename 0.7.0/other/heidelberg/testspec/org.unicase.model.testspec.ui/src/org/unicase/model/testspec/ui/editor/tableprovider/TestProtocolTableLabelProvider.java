...
/**
 * Label provider of the dynamic table holding the test step parameters in the TestProtocol.
 * 
 ...
 * 
 */
public class TestProtocolTableLabelProvider extends LabelProvider
    ...
    public String getColumnText(Object element, int columnIndex) {
        if (element != null && element instanceof TestStepInput) {
            ...
            case COLUMN_VALUE:
            	return testStepOutput.getValue();
            case COLUMN_ID:
