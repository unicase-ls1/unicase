 ...
 * 
 */
public class TestStepParameterControl extends AbstractMEControl {
	   /**
     * Priority of control.
     * 
     * Indicates with which priority this control will be used.
     */
     ...
     * 
     */
    public TestStepParameterControl() {
        super();
    }
    ...
    public Control createControl(final Composite parent, final int style) {
        ...
        createEditor();
        /* Table composite will be shown in the scrollable composite */
        scrolledComposite.setContent(tableComposite);
        /*
         * Table composite will fill the whole vertical space of the scrollable
         * composite
         */
        scrolledComposite.setExpandVertical(true);
        /*
         * Table composite will fill the whole horizontal space of the
     ...
     * 
     * @param toolbar
     *            - toolbar where the buttons will be displayed
     */
    ...
    private void createTable(Composite tableComposite) {
        ...
        /* Table header and lines will be visible */
    ...
    private void createEditor() {
        ...
        /* Editor will be "activated" when the user double-clicks on a cell */
    ...
    /**
     * Specifies that the dynamic table will be shown for input and output
     * parameters.
     * 
