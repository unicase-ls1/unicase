...
import org.unicase.model.usecase.*;
...
public class UsecaseSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case UsecasePackage.USE_CASE: {
				...
				if (result == null) result = caseRequirement_UseCase(useCase);
				if (result == null) result = caseUnicaseModelElement(useCase);
				if (result == null) result = caseModelElement(useCase);
				if (result == null) result = caseIdentifiableElement(useCase);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsecasePackage.OPTION: {
				Option option = (Option)theEObject;
				T result = caseOption(option);
				if (result == null) result = caseUnicaseModelElement(option);
				if (result == null) result = caseNonDomainElement(option);
				if (result == null) result = caseModelElement(option);
				if (result == null) result = caseIdentifiableElement(option);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsecasePackage.ACTOR_STEP: {
				ActorStep actorStep = (ActorStep)theEObject;
				T result = caseActorStep(actorStep);
				if (result == null) result = caseUnicaseModelElement(actorStep);
				if (result == null) result = caseNonDomainElement(actorStep);
				if (result == null) result = caseModelElement(actorStep);
				if (result == null) result = caseIdentifiableElement(actorStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case UsecasePackage.SYSTEM_STEP: {
				SystemStep systemStep = (SystemStep)theEObject;
				T result = caseSystemStep(systemStep);
				if (result == null) result = caseUnicaseModelElement(systemStep);
				if (result == null) result = caseNonDomainElement(systemStep);
				if (result == null) result = caseModelElement(systemStep);
				if (result == null) result = caseIdentifiableElement(systemStep);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseRequirement_UseCase(org.unicase.model.requirement.UseCase object) {
		return null;
	}
