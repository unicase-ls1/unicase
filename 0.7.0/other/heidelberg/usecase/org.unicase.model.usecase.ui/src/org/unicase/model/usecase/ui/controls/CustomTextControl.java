 ...
 * 
 * @author helming
 * @brief Modification of original file in meeditor: No toolbar above text field
 */
public class CustomTextControl extends AbstractMEControl {
	...
	protected Control createControl(Composite parent, int style, Composite c, TextViewer t) {
		...
		eAdapter = new AdapterImpl() {
			...
			public void notifyChanged(Notification msg) {
				if (msg.getFeature() != null && msg.getFeature().equals(CustomTextControl.this.attribute)) {
					load();
				}
	...
	public int canRender(IItemPropertyDescriptor itemPropertyDescriptor, ModelElement modelElement) {
		...
		if ((modelElement instanceof UseCase || modelElement instanceof Option || modelElement instanceof SystemStep)
			&& feature instanceof EAttribute
			&& ((EAttribute) feature).getEType().getInstanceClass().equals(String.class)) {
