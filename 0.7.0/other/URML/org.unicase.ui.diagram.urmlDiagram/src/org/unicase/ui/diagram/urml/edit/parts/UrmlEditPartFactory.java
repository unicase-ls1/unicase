	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case AbstractFeatureRequiredFeaturesEditPart.VISUAL_ID:
				return new AbstractFeatureRequiredFeaturesEditPart(view);

			case RequiresLabelEditPart.VISUAL_ID:
				return new RequiresLabelEditPart(view);
			...
			case VariationPointOptionalSubFeaturesEditPart.VISUAL_ID:
				return new VariationPointOptionalSubFeaturesEditPart(view);

			case SuggestsLabelEditPart.VISUAL_ID:
				return new SuggestsLabelEditPart(view);
			...
			case ProductFeaturesEditPart.VISUAL_ID:
				return new ProductFeaturesEditPart(view);
