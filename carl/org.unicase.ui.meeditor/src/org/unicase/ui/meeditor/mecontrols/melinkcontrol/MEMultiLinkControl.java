...
public class MEMultiLinkControl extends AbstractMEControl {
	...
	private Color defaultColor = new Color(Display.getCurrent(), 25, 76, 127);
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.unicase.ui.meeditor.mecontrols.AbstractMEControl#validate(org.eclipse.emf.validation.model.IConstraintStatus)
	 */
	@Override
	public void validate(boolean isInvalid) {
		if (!isInvalid) {
			section.setTitleBarForeground(defaultColor);
		} else {
			section.setTitleBarForeground(MEEditorPage.VIOLATION_RED);
		}
	}
}