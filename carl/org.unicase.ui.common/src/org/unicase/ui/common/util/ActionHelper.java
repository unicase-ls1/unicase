...
public final class ActionHelper {
	 ...
	 * 
	 * @param me ModelElement to open
	 * @param problemFeatures the feature to be marked as having a problem
	 * @param sourceView the view that requested the open model element
	 * @param context the context of the model element
	 */
	public static void openModelElement(final ModelElement me, List<EStructuralFeature> problemFeatures,
		...
		openAndMarkMEWithMEEditor(me, problemFeatures, context);
	}

	private static void openAndMarkMEWithMEEditor(ModelElement me, List<EStructuralFeature> problemFeatures,
		...
		context.addVariable(FEATURE_TO_MARK_EVALUATIONCONTEXT_VARIABLE, problemFeatures);
