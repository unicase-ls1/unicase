 ...
 * @generated
 */
public class HazardCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public HazardCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		Hazard newElement = HazardFactory.eINSTANCE.createHazard();
