 ...
 * @generated
 */
public class HazardCauseCreateCommand extends CreateElementCommand {

	/**
	 * @generated
	 */
	public HazardCauseCreateCommand(CreateElementRequest req) {
		super(req);
	}
	...
	protected EObject doDefaultElementCreation() {
		HazardCause newElement = HazardFactory.eINSTANCE.createHazardCause();
