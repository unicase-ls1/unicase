...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
				.getMEDiagram_66SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result
					.add(((org.unicase.ui.urmlDiagram.part.ModelNodeDescriptor) it
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = org.unicase.ui.urmlDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				org.unicase.ui.urmlDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.urmlDiagram.part.ModelLinkDescriptor) LinkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.urmlDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
								.getMEDiagram_66ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
		...
		case org.unicase.ui.urmlDiagram.edit.parts.HazardCauseEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
								.getHazardCause_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case org.unicase.ui.urmlDiagram.edit.parts.MitigationEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
								.getMitigation_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case org.unicase.ui.urmlDiagram.edit.parts.HazardEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
								.getHazard_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
		...
		case org.unicase.ui.urmlDiagram.edit.parts.ActorEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.urmlDiagram.part.ModelDiagramUpdater
								.getActor_2004ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement())
					|| view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final org.unicase.ui.urmlDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.urmlDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
					.next();
