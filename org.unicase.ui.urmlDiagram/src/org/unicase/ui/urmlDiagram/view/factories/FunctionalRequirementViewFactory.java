 ...
 * @generated
 */
public class FunctionalRequirementViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = org.unicase.ui.urmlDiagram.part.ModelVisualIDRegistry
					.getType(org.unicase.ui.urmlDiagram.edit.parts.FunctionalRequirementEditPart.VISUAL_ID);
		...
		if (!org.unicase.ui.urmlDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", org.unicase.ui.urmlDiagram.edit.parts.MEDiagramEditPart.MODEL_ID); //$NON-NLS-1$
