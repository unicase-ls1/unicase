...
public class PropertiesForm extends Form {
	...
	/**
	 * 
	 * This will be called from a tabContents to handle following situation. If form
	 * input is a project, and from users of groups tab one of participants of
	 * this project is deleted, then the table viewer on project properties must
	 * be updated. Accordingly, if a group is open and one of its users is
	 ...
	 * If current input is the same as deleted OrgUnit, the input will be set to null.
	 * 
