...
public class ModelVisualIDRegistry {
	 ...
	 * @generated
	 */
	private static final String DEBUG_KEY = "org.unicase.ui.stateDiagram/debug/visualID"; //$NON-NLS-1$
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		case org.unicase.ui.stateDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID:
			...
			if (StatePackage.eINSTANCE.getStateInitial().isSuperTypeOf(
					domainElement.eClass())) {
				return org.unicase.ui.stateDiagram.edit.parts.StateInitialEditPart.VISUAL_ID;
			}
			if (StatePackage.eINSTANCE.getStateEnd().isSuperTypeOf(
					domainElement.eClass())) {
				return org.unicase.ui.stateDiagram.edit.parts.StateEndEditPart.VISUAL_ID;
			}
			break;
		}
		return -1;
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case org.unicase.ui.stateDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID:
			...
			if (org.unicase.ui.stateDiagram.edit.parts.StateInitialEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			if (org.unicase.ui.stateDiagram.edit.parts.StateEndEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case org.unicase.ui.stateDiagram.edit.parts.TransitionEditPart.VISUAL_ID:
			if (org.unicase.ui.stateDiagram.edit.parts.TransitionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		}
