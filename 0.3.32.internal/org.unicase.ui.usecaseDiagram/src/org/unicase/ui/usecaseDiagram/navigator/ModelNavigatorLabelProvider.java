...
public class ModelNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case org.unicase.ui.usecaseDiagram.edit.parts.ActorEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://unicase.org/model/requirement?Actor", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.Actor_2001); //$NON-NLS-1$
		case org.unicase.ui.usecaseDiagram.edit.parts.UseCaseEditPart.VISUAL_ID:
			return getImage(
					"Navigator?TopLevelNode?http://unicase.org/model/requirement?UseCase", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCase_2002); //$NON-NLS-1$
		case org.unicase.ui.usecaseDiagram.edit.parts.ActorParticipatedUseCasesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/requirement?Actor?participatedUseCases", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.ActorParticipatedUseCases_4001); //$NON-NLS-1$
		case org.unicase.ui.usecaseDiagram.edit.parts.ActorInitiatedUseCasesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/requirement?Actor?initiatedUseCases", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.ActorInitiatedUseCases_4002); //$NON-NLS-1$
		case org.unicase.ui.usecaseDiagram.edit.parts.UseCaseIncludedUseCasesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/requirement?UseCase?includedUseCases", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCaseIncludedUseCases_4003); //$NON-NLS-1$
		case org.unicase.ui.usecaseDiagram.edit.parts.UseCaseExtendedUseCasesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/requirement?UseCase?extendedUseCases", org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCaseExtendedUseCases_4004); //$NON-NLS-1$
		}
	...
	private String getActor_2001Text(View view) {
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.Actor_2001,
	...
	private String getUseCase_2002Text(View view) {
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCase_2002,
				(view.getElement() != null ? view.getElement() : view),
				org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry
	...
	private String getActorParticipatedUseCases_4001Text(View view) {
		...
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.ActorParticipatedUseCases_4001,
				(view.getElement() != null ? view.getElement() : view),
				org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry
						.getType(org.unicase.ui.usecaseDiagram.edit.parts.ParticipateLabelEditPart.VISUAL_ID));
		IParser parser = ParserService.getInstance().getParser(hintAdapter);
		if (parser != null) {
			return parser.getPrintString(hintAdapter, ParserOptions.NONE
					.intValue());
	...
	private String getActorInitiatedUseCases_4002Text(View view) {
		...
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.ActorInitiatedUseCases_4002,
				(view.getElement() != null ? view.getElement() : view),
				org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry
						.getType(org.unicase.ui.usecaseDiagram.edit.parts.InitiateLabelEditPart.VISUAL_ID));
		IParser parser = ParserService.getInstance().getParser(hintAdapter);
		if (parser != null) {
			return parser.getPrintString(hintAdapter, ParserOptions.NONE
					.intValue());
	...
	private String getUseCaseIncludedUseCases_4003Text(View view) {
		...
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCaseIncludedUseCases_4003,
				(view.getElement() != null ? view.getElement() : view),
				org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry
	...
	private String getUseCaseExtendedUseCases_4004Text(View view) {
		...
		IAdaptable hintAdapter = new org.unicase.ui.usecaseDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.UseCaseExtendedUseCases_4004,
				(view.getElement() != null ? view.getElement() : view),
				org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry
