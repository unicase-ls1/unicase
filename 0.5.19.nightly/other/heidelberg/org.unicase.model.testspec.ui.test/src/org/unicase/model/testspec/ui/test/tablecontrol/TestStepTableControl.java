 ...
 * 
 */
public class TestStepTableControl extends StubAbstractMEControl {
    /**
     * Priority of control.
     * 
     ...
     * 
     */
    public TestStepTableControl(String featureName) {
        super(featureName);
    }
    ...
    private void createTableTree(Composite treeComposite) {
        ...
        testStepsTree.setLinesVisible(false);
        /* Create columns */
        createColumns();
    ...
    public ModelElementChangeListener getChangeListener() {
        return this.modelElementChangeListener;
    }
