...
/**
 * Change input or output parameter of a given test step.
 * 
 * @author Sharon Friedrich
 * 
 */
public class ChangeTestStepParameterCommand extends StubUnicaseCommand {
	/**
	 ...
	 */
	public ChangeTestStepParameterCommand(final ModelElement modelElement,
