	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = org.unicase.ui.diagram.workItemDiagram.part.ModelVisualIDRegistry
					.getType(org.unicase.ui.diagram.workItemDiagram.edit.parts.ActionItemEditPart.VISUAL_ID);
		...
		if (!org.unicase.ui.diagram.workItemDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put(
							"modelID", org.unicase.ui.diagram.workItemDiagram.edit.parts.MEDiagramEditPart.MODEL_ID); //$NON-NLS-1$
