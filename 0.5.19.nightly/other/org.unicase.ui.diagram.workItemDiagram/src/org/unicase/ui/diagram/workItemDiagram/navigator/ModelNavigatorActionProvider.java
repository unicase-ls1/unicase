...
public class ModelNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(
					org.unicase.ui.diagram.workItemDiagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof org.unicase.ui.diagram.workItemDiagram.navigator.ModelNavigatorItem) {
					selectedElement = ((org.unicase.ui.diagram.workItemDiagram.navigator.ModelNavigatorItem) selectedElement)
							.getView();
