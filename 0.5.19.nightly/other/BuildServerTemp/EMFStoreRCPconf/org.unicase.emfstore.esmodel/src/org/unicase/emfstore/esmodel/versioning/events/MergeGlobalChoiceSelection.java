 ...
 * 
 * @see org.unicase.emfstore.esmodel.versioning.events.EventsPackage#getMergeGlobalChoiceSelection()
 * @model
 * @generated
 */
public enum MergeGlobalChoiceSelection implements Enumerator {
	...
	/**
	 * An array of all the '<em><b>Merge Global Choice Selection</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * Returns the '<em><b>Merge Global Choice Selection</b></em>' literal with the specified name. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
