...
public class ExportersSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ExportersPackage.CSV_EXPORTER: {
			...
			if (result == null)
				result = caseExporter(csvExporter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Exporter</em>'. <!-- begin-user-doc --> This
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>CSV Exporter</em>'. <!-- begin-user-doc -->
