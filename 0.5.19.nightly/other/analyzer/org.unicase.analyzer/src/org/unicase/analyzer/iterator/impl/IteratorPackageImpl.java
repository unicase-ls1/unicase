...
public class IteratorPackageImpl extends EPackageImpl implements IteratorPackage {
	 ...
	 * 
	 * <p>This method is used to initialize {@link IteratorPackage#eINSTANCE} when that field is accessed.
	...
	public void initializePackageContents() {
		...
		initEAttribute(getVersionIterator_StepLength(), ecorePackage.getEInt(), "stepLength", "1", 0, 1, VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getVersionIterator_Forward(), ecorePackage.getEBoolean(), "forward", "true", 0, 1, VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersionIterator_ReturnProjectDataCopy(), theEcorePackage.getEBoolean(), "returnProjectDataCopy", "", 0, 1, VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getTimeIterator_StepLengthUnit(), theEcorePackage.getEInt(), "stepLengthUnit", "1", 0, 1, TimeIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
