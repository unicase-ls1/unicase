...
/**
	 */
public class DiscussionIntoIssueDialog extends AbstractRefactoringDialog {

	/**
	 * @param parentShell the
	 * @param wizard the
	 */
	public DiscussionIntoIssueDialog(Shell parentShell, AbstractRefactoringWizard wizard) {
