 ...
 * @author pfeifferc
 */
public class DiscussionIntoIssuePage4 extends AbstractRefactoringWizardPage {
	 ...
	 * @param wizard the
	 */
	public DiscussionIntoIssuePage4(String pageName, AbstractRefactoringWizard wizard) {
	...
	public void createControl(Composite parent) {
		...
		createExplanatoryTextComposite(body, TextSnippets.DISCUSSIONINTOISSUE4INFORMATION, "information.png");
		// create instruction text composite
		createExplanatoryTextComposite(body, TextSnippets.DISCUSSIONINTOISSUE4INSTRUCTION, "exclamation.png");
	...
	public IWizardPage getNextPage() {
		if (button.getSelection()) {
			return getRefactoringWizard().getPage("page1");
		} else {
