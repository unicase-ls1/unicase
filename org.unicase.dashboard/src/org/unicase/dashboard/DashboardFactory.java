...
public interface DashboardFactory extends EFactory {
	 ...
	 * @generated
	 */
	DashboardFactory eINSTANCE = org.unicase.dashboard.impl.DashboardFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Notification</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Subscription Composite</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Notification Operation</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
