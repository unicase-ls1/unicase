package org.unicase.model.classDiagram.parsers;
...
public abstract class AbstractParser implements IParser {
	...
	protected IParserEditStatus validateNewValues(Object[] values) {
		...
		for (int i = 0; i < values.length; i++) {
			...
			if (value instanceof InvalidValue) {
				return new ParserEditStatus(org.unicase.model.classDiagram.part.ModelDiagramEditorPlugin.ID,
			...
			if (Boolean.TYPE.equals(iClass)) {
				if (value instanceof Boolean) {
					...
					value = new InvalidValue(NLS.bind(
						org.unicase.model.classDiagram.part.Messages.AbstractParser_UnexpectedValueTypeMessage, iClass
							.getName()));
				}
					...
					if (s.length() == 0) {
						...
						try {
							...
							value = new InvalidValue(
								NLS
									.bind(
										org.unicase.model.classDiagram.part.Messages.AbstractParser_WrongStringConversionMessage,
										iClass.getName()));
						}
					}
				} else {
				...
				if (value instanceof String) {
					...
					if (literal == null) {
						value = new InvalidValue(NLS.bind(
							org.unicase.model.classDiagram.part.Messages.AbstractParser_UnknownLiteralMessage, value));
					} else {
						value = literal.getInstance();
					}
				} else {
					value = new InvalidValue(NLS.bind(
						org.unicase.model.classDiagram.part.Messages.AbstractParser_UnexpectedValueTypeMessage,
