 ...
 * @generated
 */
public class MessageFormatParser extends org.unicase.model.classDiagram.parsers.AbstractParser {
		...
		if (values == null) {
			return new ParserEditStatus(org.unicase.model.classDiagram.part.ModelDiagramEditorPlugin.ID,
				IParserEditStatus.UNEDITABLE, NLS.bind(
					org.unicase.model.classDiagram.part.Messages.MessageFormatParser_InvalidInputError, new Integer(pos
						.getErrorIndex())));
		}
