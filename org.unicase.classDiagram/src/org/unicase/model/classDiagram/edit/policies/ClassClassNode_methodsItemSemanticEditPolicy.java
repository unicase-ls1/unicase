...
public class ClassClassNode_methodsItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.unicase.model.classDiagram.providers.ModelElementTypes.Method_3002 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ClassesPackage.eINSTANCE
						.getClass_Methods());
			}
			return getGEFWrapper(new org.unicase.model.classDiagram.edit.commands.MethodCreateCommand(
					req));
		}
