...
public class AttributeEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.model.classDiagram.edit.policies.AttributeItemSemanticEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new org.unicase.model.classDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.model.classDiagram.providers.ModelElementTypes.Attribute_3001, getParserElement(),
				parserHint);
