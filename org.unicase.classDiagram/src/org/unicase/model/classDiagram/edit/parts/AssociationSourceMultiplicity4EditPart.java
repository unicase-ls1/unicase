...
public class AssociationSourceMultiplicity4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(org.unicase.model.classDiagram.part.ModelVisualIDRegistry
			.getType(org.unicase.model.classDiagram.edit.parts.AssociationSourceMultiplicity4EditPart.VISUAL_ID),
			new Point(0, 0));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new org.unicase.model.classDiagram.providers.ModelParserProvider.HintAdapter(
				org.unicase.model.classDiagram.providers.ModelElementTypes.Association_4004, getParserElement(),
				parserHint);
