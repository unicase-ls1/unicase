...
public class DependencyEditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.model.classDiagram.edit.policies.DependencyItemSemanticEditPolicy());
	}
	...
	public class DependencyFigure extends PolylineConnectionEx {
		...
		private RotatableDecoration createTargetDecoration() {
			org.unicase.model.classDiagram.unicase.DependencyDecoration df = new org.unicase.model.classDiagram.unicase.DependencyDecoration();
