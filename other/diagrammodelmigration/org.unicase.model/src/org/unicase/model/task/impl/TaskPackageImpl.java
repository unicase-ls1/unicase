...
public class TaskPackageImpl extends EPackageImpl implements TaskPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getWorkItem_Resolved(), ecorePackage.getEBoolean(), "resolved", null, 0, 1, WorkItem.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getWorkItem_IncludingReleases(), theReleasePackage.getRelease(), theReleasePackage
			.getRelease_IncludedWorkItems(), "includingReleases", null, 0, -1, WorkItem.class, !IS_TRANSIENT,
			!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
			IS_ORDERED);
