...
public class AttachmentPackageImpl extends EPackageImpl implements AttachmentPackage {
	...
	public void initializePackageContents() {
		...
		initEClass(patchAttachmentEClass, PatchAttachment.class, "PatchAttachment", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPatchAttachment_AppliedTo(), theReleasePackage.getRelease(), theReleasePackage
			.getRelease_AppliedPatches(), "appliedTo", null, 0, -1, PatchAttachment.class, !IS_TRANSIENT, !IS_VOLATILE,
