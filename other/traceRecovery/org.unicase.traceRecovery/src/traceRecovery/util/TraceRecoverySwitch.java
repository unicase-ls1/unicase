 ...
 * @generated
 */
public class TraceRecoverySwitch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TraceRecoveryPackage.LINK: {
				Link link = (Link)theEObject;
				T result = caseLink(link);
				if (result == null) result = caseUnicaseModelElement(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceRecoveryPackage.QUERY: {
				Query query = (Query)theEObject;
				T result = caseQuery(query);
				if (result == null) result = caseUnicaseModelElement(query);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case TraceRecoveryPackage.DIRECTORY: {
