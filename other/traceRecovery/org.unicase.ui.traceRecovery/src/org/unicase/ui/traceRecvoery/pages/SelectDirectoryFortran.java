 ...
 *
 */
public class SelectDirectoryFortran extends WizardPage implements Listener {
	Text indexDir;
	Button selectDir;
	Project project;
	...
	public SelectDirectoryFortran(){
		super("SelectDirectoryFortran");
	...
	public IWizardPage getNextPage(){
		if(super.getNextPage()  instanceof RunRecovery){
			...
			recovery.setCodeLanguage("fortran");
			recovery.treeSetUp();
		}
