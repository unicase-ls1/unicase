...
/**
 * This is the item provider adapter for a {@link traceRecovery.Query} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Query_modelElement_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Query_modelElement_feature", "_UI_Query_type"),
				 TraceRecoveryPackage.Literals.QUERY__MODEL_ELEMENT,
				 true,
				 false,
				 true,
				 null,
