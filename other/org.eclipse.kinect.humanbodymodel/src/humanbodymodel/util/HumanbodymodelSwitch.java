 ...
 * @generated
 */
public class HumanbodymodelSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case HumanbodymodelPackage.HUMAN: {
				Human human = (Human)theEObject;
				T result = caseHuman(human);
				if (result == null) result = casePositionedElement(human);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HumanbodymodelPackage.POSITIONED_ELEMENT: {
				PositionedElement positionedElement = (PositionedElement)theEObject;
				T result = casePositionedElement(positionedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HumanbodymodelPackage.HUMAN_CONTAINER: {
				HumanContainer humanContainer = (HumanContainer)theEObject;
				T result = caseHumanContainer(humanContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HumanbodymodelPackage.HUMAN_LINK: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Human Container</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Human Container</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseHumanContainer(HumanContainer object) {
		return null;
	}
