...
import org.unicase.wireframe.diagram.providers.ElementInitializers;
import org.unicase.wireframe.provider.WireframeItemProviderAdapterFactory;

/**
 * @generated
 */
public class WireframeDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.unicase.wireframe.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static WireframeDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private WireframeDocumentProvider documentProvider;
	 ...
	 * @generated
	 */
	public WireframeDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static WireframeDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public WireframeDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new WireframeDocumentProvider();
		}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, WireframeDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, WireframeDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
