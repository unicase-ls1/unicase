	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider
				.getParser(WireframeElementTypes.Label_2004, getParserElement(), WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.LabelTextEditPart.VISUAL_ID));
		}
		return parser;
	}
