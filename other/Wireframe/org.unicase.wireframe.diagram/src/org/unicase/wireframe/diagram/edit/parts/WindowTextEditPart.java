 ...
 * @generated
 */
public class WindowTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public WindowTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.Window_2003, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.WindowTextEditPart.VISUAL_ID));
		}
		return parser;
	}
