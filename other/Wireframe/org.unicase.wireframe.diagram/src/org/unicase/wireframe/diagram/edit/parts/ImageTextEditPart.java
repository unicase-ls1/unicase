 ...
 * @generated
 */
public class ImageTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ImageTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider
				.getParser(WireframeElementTypes.Image_2008, getParserElement(), WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.ImageTextEditPart.VISUAL_ID));
		}
		return parser;
	}
