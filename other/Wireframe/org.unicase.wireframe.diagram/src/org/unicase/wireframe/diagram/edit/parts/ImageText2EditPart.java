 ...
 * @generated
 */
public class ImageText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ImageText2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.Image_3002, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.ImageText2EditPart.VISUAL_ID));
		}
		return parser;
	}
