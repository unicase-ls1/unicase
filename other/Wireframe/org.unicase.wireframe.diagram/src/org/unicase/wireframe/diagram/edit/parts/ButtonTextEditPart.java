...
public class ButtonTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.Button_2006, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.ButtonTextEditPart.VISUAL_ID));
		}
		return parser;
	}
