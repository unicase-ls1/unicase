...
import org.unicase.wireframe.diagram.edit.policies.WireframeTextSelectionEditPolicy;
 ...
 * @generated
 */
public class TextFieldText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TextFieldText2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new WireframeTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.TextField_3005, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.TextFieldText2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, WireframeEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
