...
import org.unicase.wireframe.diagram.edit.parts.WireframeEditPartFactory;
import org.unicase.wireframe.diagram.part.WireframeVisualIDRegistry;

/**
 * @generated
 */
public class WireframeEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public WireframeEditPartProvider() {
		setFactory(new WireframeEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!PanelEditPart.MODEL_ID.equals(WireframeVisualIDRegistry.getModelID(view))) {
				return false;
			}
