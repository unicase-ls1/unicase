...
public class LabelText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.Label_3003, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.LabelText2EditPart.VISUAL_ID));
		}
		return parser;
	}
