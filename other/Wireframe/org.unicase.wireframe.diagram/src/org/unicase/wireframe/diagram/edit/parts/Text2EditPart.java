...
import org.unicase.wireframe.diagram.edit.policies.Text2ItemSemanticEditPolicy;
...
public class Text2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextText2EditPart) {
			((TextText2EditPart) childEditPart).setLabel(getPrimaryShape().getText_text());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WireframeVisualIDRegistry.getType(TextText2EditPart.VISUAL_ID));
	}
