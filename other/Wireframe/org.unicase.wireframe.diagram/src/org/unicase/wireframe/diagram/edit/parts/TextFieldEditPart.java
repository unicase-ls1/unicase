...
public class TextFieldEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextFieldTextEditPart) {
			((TextFieldTextEditPart) childEditPart).setLabel(getPrimaryShape().getTextField_text());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WireframeVisualIDRegistry.getType(TextFieldTextEditPart.VISUAL_ID));
	}
