...
public class LabelEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelTextEditPart) {
			((LabelTextEditPart) childEditPart).setLabel(getPrimaryShape().getLabel_text());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WireframeVisualIDRegistry.getType(LabelTextEditPart.VISUAL_ID));
	}
