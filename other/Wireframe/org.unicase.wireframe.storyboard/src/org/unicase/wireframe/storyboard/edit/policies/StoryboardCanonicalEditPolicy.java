...
import org.unicase.wireframe.storyboard.part.StoryboardDiagramUpdater;
import org.unicase.wireframe.storyboard.part.StoryboardNodeDescriptor;
import org.unicase.wireframe.storyboard.part.StoryboardVisualIDRegistry;

/**
 * @generated
 */
public class StoryboardCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<StoryboardNodeDescriptor> childDescriptors = StoryboardDiagramUpdater
			.getStoryboard_44SemanticChildren(viewObject);
		for (StoryboardNodeDescriptor d : childDescriptors) {
	...
	private boolean isMyDiagramElement(View view) {
		return PanelEditPart.VISUAL_ID == StoryboardVisualIDRegistry.getVisualID(view);
	}
	...
	protected void refreshSemantic() {
		...
		List<StoryboardNodeDescriptor> childDescriptors = StoryboardDiagramUpdater
			.getStoryboard_44SemanticChildren((View) getHost().getModel());
		...
		for (Iterator<StoryboardNodeDescriptor> descriptorsIterator = childDescriptors.iterator(); descriptorsIterator
			.hasNext();) {
			StoryboardNodeDescriptor next = descriptorsIterator.next();
			String hint = StoryboardVisualIDRegistry.getType(next.getVisualID());
		...
		for (StoryboardNodeDescriptor next : childDescriptors) {
			String hint = StoryboardVisualIDRegistry.getType(next.getVisualID());
