 ...
 * @author staudta
 */
public class NotifierProxyClientConfigSectionInfo {
	 ...
	 * @throws NotificationProxyClientException will be thrown on misconfigured ini section
	 */
	public NotifierProxyClientConfigSectionInfo(String sectionName, ServerInfo serverInfo, String username, String password, int backchannelPort, MailerInfo mailerInfo) throws NotificationProxyClientException {
