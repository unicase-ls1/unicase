 ...
 * <!-- end-user-doc -->
 * @see org.unicase.model.emailbundle.EmailbundlePackage#getAggregatedSettings()
 * @model
 * @generated
 */
public enum AggregatedSettings implements Enumerator {
	 ...
	 * @generated
	 */
	private static final AggregatedSettings[] VALUES_ARRAY =
		new AggregatedSettings[] {
			NONE,
			DAYS,
			WEEKDAY,
		};
	...
	public static AggregatedSettings get(int value) {
		switch (value) {
			...
			case WEEKDAY_VALUE: return WEEKDAY;
		}
		return null;
	}
