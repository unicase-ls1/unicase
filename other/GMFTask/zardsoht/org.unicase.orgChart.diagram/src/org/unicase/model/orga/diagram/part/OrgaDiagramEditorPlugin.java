...
import org.unicase.model.orga.provider.OrgaItemProviderAdapterFactory;
 ...
 * @generated
 */
public class OrgaDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.unicase.orgChart.diagram"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static OrgaDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private OrgaDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	public OrgaDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static OrgaDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	protected void fillItemProviderFactories(List factories) {
		factories.add(new OrgaItemProviderAdapterFactory());
		factories
				.add(new org.unicase.model.diagram.provider.DiagramItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public OrgaDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new OrgaDocumentProvider();
		}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.ERROR, OrgaDiagramEditorPlugin.ID,
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(
				new Status(IStatus.INFO, OrgaDiagramEditorPlugin.ID,
