 ...
 * $Id$
 */
package org.unicase.model.orga.util;
...
public class OrgaAdapterFactory extends AdapterFactoryImpl {
	...
	protected OrgaSwitch<Adapter> modelSwitch =
		new OrgaSwitch<Adapter>() {
			@Override
			public Adapter caseOrgaUnit(OrgaUnit object) {
				return createOrgaUnitAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseOrgDiagram(OrgDiagram object) {
				return createOrgDiagramAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.orga.OrgaUnit <em>Unit</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOrgaUnitAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.orga.Team <em>Team</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.orga.Employee <em>Employee</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.orga.OrgDiagram <em>Org Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createOrgDiagramAdapter() {
		return null;
	}
