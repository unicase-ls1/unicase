...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>EMF Store Team Provider Configuration</b></em>
 * '. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link org.eclipse.emf.emfstore.teamprovider.configuration.impl.EMFStoreTeamProviderConfigurationImpl#getEntry
 * <em>Entry</em>}</li>
 * <li>
 * {@link org.eclipse.emf.emfstore.teamprovider.configuration.impl.EMFStoreTeamProviderConfigurationImpl#getAnywayCommit
 * <em>Anyway Commit</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
 */
public class EMFStoreTeamProviderConfigurationImpl extends EObjectImpl implements EMFStoreTeamProviderConfiguration {
	/**
	 ...
	 * @generated
	 */
	protected EMFStoreTeamProviderConfigurationImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ConfigurationPackage.Literals.EMF_STORE_TEAM_PROVIDER_CONFIGURATION;
	}
	...
	public EList<Entry> getEntry() {
		if (entry == null) {
			entry = new EObjectContainmentWithInverseEList<Entry>(Entry.class, this,
				ConfigurationPackage.EMF_STORE_TEAM_PROVIDER_CONFIGURATION__ENTRY,
				ConfigurationPackage.ENTRY__CONFIGURATION);
		}
		return entry;
	}
	...
	public EList<EMFStoreLocation> getAnywayCommit() {
		if (anywayCommit == null) {
			anywayCommit = new EObjectContainmentEList<EMFStoreLocation>(EMFStoreLocation.class, this,
				ConfigurationPackage.EMF_STORE_TEAM_PROVIDER_CONFIGURATION__ANYWAY_COMMIT);
		}
		return anywayCommit;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case ConfigurationPackage.EMF_STORE_TEAM_PROVIDER_CONFIGURATION__ENTRY:
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case ConfigurationPackage.EMF_STORE_TEAM_PROVIDER_CONFIGURATION__ANYWAY_COMMIT:
...
} // EMFStoreTeamProviderConfigurationImpl
