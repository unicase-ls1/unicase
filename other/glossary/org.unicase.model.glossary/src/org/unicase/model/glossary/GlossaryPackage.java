...
public interface GlossaryPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__IDENTIFIER = ModelPackage.MODEL_ELEMENT__IDENTIFIER;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__NAME = ModelPackage.MODEL_ELEMENT__NAME;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__DESCRIPTION = ModelPackage.MODEL_ELEMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__CREATOR = ModelPackage.MODEL_ELEMENT__CREATOR;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__CREATION_DATE = ModelPackage.MODEL_ELEMENT__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__ANNOTATIONS = ModelPackage.MODEL_ELEMENT__ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__ATTACHMENTS = ModelPackage.MODEL_ELEMENT__ATTACHMENTS;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__INCOMING_DOCUMENT_REFERENCES = ModelPackage.MODEL_ELEMENT__INCOMING_DOCUMENT_REFERENCES;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__LEAF_SECTION = ModelPackage.MODEL_ELEMENT__LEAF_SECTION;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__STATE = ModelPackage.MODEL_ELEMENT__STATE;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__APPLIED_STEREOTYPE_INSTANCES = ModelPackage.MODEL_ELEMENT__APPLIED_STEREOTYPE_INSTANCES;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY__COMMENTS = ModelPackage.MODEL_ELEMENT__COMMENTS;
	 ...
	 * @ordered
	 */
	int GLOSSARY_ENTRY_FEATURE_COUNT = ModelPackage.MODEL_ELEMENT_FEATURE_COUNT + 0;
