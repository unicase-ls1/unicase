...
/**
 * A decision provider provides methods to decide certain decisions
 * which occur during the changetracking workflow.
 * An implementation usually asks the user for the decision.
 * This class decouples the UI from the logic code, since the business logic only
 * uses this interface. The UI plug-in
...
public interface IDecisionProvider {
	 ...
	 * 
	 * This decision occurs when a new model element is to be
	 * inserted in a unicase project. Its place in the project and
	 * the disred name have to be chosen.
	 * 
	 * @author gex
	 *
	 */
	public class PlacementAndNameDecision{
		 ...
		 * @param placeInto target model element into which to put the new model element.
		 */
		 ...
		 * This means that the model element is put into the project
		 * at the desired location and its name is set.
		 * 
		 * Since this method alters the project model, it must be executed
		 * in a unicase command.
		 */
		...
		/**
		 * Retrieves the target object in which the new model element is to be put.
	 ...
	 * @exception CancelledByUserException if the user decided to cancel the process.
	 */
