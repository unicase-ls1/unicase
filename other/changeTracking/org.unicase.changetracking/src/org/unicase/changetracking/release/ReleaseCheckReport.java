 ...
 * 
 * It features: - the list of problems found - the states of the change packages
 * (i.e. merged, unmerged or erroneous) - a statistics about how many work items
 * of the release are already resolved. - a repository location where the
 * release is located.
 * 
 * @author jfinis
 * 
...
public class ReleaseCheckReport {
	...
	/**
	 * Returns the list of problems. The returned list is unmodifiable.
	 * 
	...
	/**
	 * Returns the change package results as a map from change package to its
	 * result. The returned map is unmodifiable.
	 * 
	 ...
	 * of the change packages. Therefore, all change packages are flagged with
	 * the ERROR status.
	 * 
	 ...
	 */
	public ReleaseCheckReport(RepositoryLocation repoLoc, WorkItemStatistics workItemStats, Set<ChangePackage> set, List<Problem> errorMessages, boolean checkedOut) {
