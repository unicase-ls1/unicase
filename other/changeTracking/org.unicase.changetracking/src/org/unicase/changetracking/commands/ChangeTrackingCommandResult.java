...
/**
 * The result of a change tracking command.
 * Stores the result type and additional information like a message
 * or an exception which caused an erroneous result.
 * @author gex
 *
 */
public class ChangeTrackingCommandResult {
	...
	public static enum ResultType{
		/**
		 * The command was executed successfully without any
		 * warnings.
		 */
		SUCCESS, 
		...
		/**
		 * The command could not be conducted because of an exception.
		 * The getException method will yield the exception which
		 * caused the problem.
		 */
		ERROR,
		...
		/**
		 * The command was aborted because the user used the tool wrongly.
		 * For example, he might have provided invalid input.
		 */
		MISUSE
	}
	...
	/**
	 * Message (either success, misuse, or warning message, depending on the result type).
	 */
	...
	/**
	 * Returns the default caption, which a message box
	 * displaying the result should have. This caption
	...
	/**
	 * Returns the exception causing an ERROR
	 * result. If this is no ERROR result,
	 ...
	 * This is either the success, warning,
	 * or misuse message, depending on the
	 * result type.
	 * @return message
	 */
	...
	/**
	 * Returns the caption which should be
	 * used for message boxes displaying
	 * the result.
	 * @return caption.
	 */
