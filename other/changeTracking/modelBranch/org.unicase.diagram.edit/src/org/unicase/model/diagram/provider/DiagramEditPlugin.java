...
public final class DiagramEditPlugin extends EMFPlugin {
	...
	public DiagramEditPlugin() {
		super(new ResourceLocator[] { EcoreEditPlugin.INSTANCE, EsmodelEditPlugin.INSTANCE, MetamodelEditPlugin.INSTANCE, ModelEditPlugin.INSTANCE, NotationEditPlugin.INSTANCE, });
	}
