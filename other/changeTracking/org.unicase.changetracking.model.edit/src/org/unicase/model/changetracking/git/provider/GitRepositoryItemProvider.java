 ...
 * @generated
 */
public class GitRepositoryItemProvider
	extends RepositoryLocationItemProvider
	implements
		...
		IItemPropertySource
{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GitRepository_url_feature", "_UI_GitRepository_type"),
				 GitPackage.Literals.GIT_REPOSITORY__URL,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_GitRepository_identifyingCommitHash_feature", "_UI_GitRepository_type"),
	...
	public String getText(Object object)
	{
		...
		return label == null || label.length() == 0 ?
			getString("_UI_GitRepository_type") :
