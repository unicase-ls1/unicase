 ...
 * <ul>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getPrecondition <em>Precondition</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getPostcondition <em>Postcondition</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getInfrastructure <em>Infrastructure</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getNonFunctionalRequirement <em>Non Functional Requirement</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getFunctionalRequirement <em>Functional Requirement</em>}</li>
 *   <li>{@link org.unicase.model.testspec.impl.LogicalTestCaseImpl#getStep <em>Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class LogicalTestCaseImpl extends ModelElementImpl implements LogicalTestCase {
	...
	protected EClass eStaticClass() {
		return TestspecPackage.Literals.LOGICAL_TEST_CASE;
	}
	...
	public void setType(EnumType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__TYPE, oldType, type));
	}
	...
	public void setPrecondition(String newPrecondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__PRECONDITION, oldPrecondition, precondition));
	}
	...
	public void setPostcondition(String newPostcondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__POSTCONDITION, oldPostcondition, postcondition));
	}
	...
	public void setInfrastructure(String newInfrastructure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__INFRASTRUCTURE, oldInfrastructure, infrastructure));
	}
	...
	public NonFunctionalRequirement getNonFunctionalRequirement() {
		if (nonFunctionalRequirement != null && nonFunctionalRequirement.eIsProxy()) {
			...
			if (nonFunctionalRequirement != oldNonFunctionalRequirement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestspecPackage.LOGICAL_TEST_CASE__NON_FUNCTIONAL_REQUIREMENT, oldNonFunctionalRequirement, nonFunctionalRequirement));
			}
		}
	...
	public void setNonFunctionalRequirement(NonFunctionalRequirement newNonFunctionalRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__NON_FUNCTIONAL_REQUIREMENT, oldNonFunctionalRequirement, nonFunctionalRequirement));
	}
	...
	public FunctionalRequirement getFunctionalRequirement() {
		if (functionalRequirement != null && functionalRequirement.eIsProxy()) {
			...
			if (functionalRequirement != oldFunctionalRequirement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TestspecPackage.LOGICAL_TEST_CASE__FUNCTIONAL_REQUIREMENT, oldFunctionalRequirement, functionalRequirement));
			}
		}
	...
	public void setFunctionalRequirement(FunctionalRequirement newFunctionalRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.LOGICAL_TEST_CASE__FUNCTIONAL_REQUIREMENT, oldFunctionalRequirement, functionalRequirement));
	}
	...
	public EList<TestStep> getStep() {
		if (step == null) {
			step = new EObjectResolvingEList<TestStep>(TestStep.class, this, TestspecPackage.LOGICAL_TEST_CASE__STEP);
		}
		return step;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TestspecPackage.LOGICAL_TEST_CASE__NON_FUNCTIONAL_REQUIREMENT:
				if (resolve) return getNonFunctionalRequirement();
				return basicGetNonFunctionalRequirement();
			case TestspecPackage.LOGICAL_TEST_CASE__FUNCTIONAL_REQUIREMENT:
				if (resolve) return getFunctionalRequirement();
				return basicGetFunctionalRequirement();
			case TestspecPackage.LOGICAL_TEST_CASE__STEP:
				return getStep();
		}
