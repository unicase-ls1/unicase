...
public class TestspecPackageImpl extends EPackageImpl implements TestspecPackage {
	...
	public static TestspecPackage init() {
		...
		TestspecPackageImpl theTestspecPackage = (TestspecPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof TestspecPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI) : new TestspecPackageImpl());
	 ...
	 * @generated
	 */
	public EAttribute getTestCase_Endcriteria() {
	...
	public void createPackageContents() {
		...
		createEAttribute(testCaseEClass, TEST_CASE__ENDCRITERIA);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTestCase_Endcriteria(), theEcorePackage.getEString(), "endcriteria", null, 0, 1, TestCase.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
