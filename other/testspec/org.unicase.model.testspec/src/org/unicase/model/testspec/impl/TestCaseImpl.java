 ...
 *   <li>{@link org.unicase.model.testspec.impl.TestCaseImpl#getEndcriteria <em>Endcriteria</em>}</li>
...
public class TestCaseImpl extends ModelElementImpl implements TestCase {
	...
	/**
	 * The default value of the '{@link #getEndcriteria() <em>Endcriteria</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getEndcriteria()
	 * @generated
	 * @ordered
	 */
	protected static final String ENDCRITERIA_EDEFAULT = null;

	/**
	 * The cached value of the '{@link #getEndcriteria() <em>Endcriteria</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getEndcriteria()
	 * @generated
	 * @ordered
	 */
	protected String endcriteria = ENDCRITERIA_EDEFAULT;
	...
	public EList<TestStep> getStep() {
		if (step == null) {
			step = new EObjectResolvingEList<TestStep>(TestStep.class, this, TestspecPackage.TEST_CASE__STEP);
		}
		return step;
	}
	 ...
	 * @generated
	 */
	public void setEndcriteria(String newEndcriteria) {
		String oldEndcriteria = endcriteria;
		endcriteria = newEndcriteria;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TestspecPackage.TEST_CASE__ENDCRITERIA, oldEndcriteria, endcriteria));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case TestspecPackage.TEST_CASE__ENDCRITERIA:
				return getEndcriteria();
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case TestspecPackage.TEST_CASE__INFRASTRUCTURE:
				...
				return;
			case TestspecPackage.TEST_CASE__ENDCRITERIA:
				setEndcriteria((String)newValue);
				return;
			case TestspecPackage.TEST_CASE__NON_FUNCTIONAL_REQUIREMENT:
	...
	public void eUnset(int featureID) {
		switch (featureID) {
			...
			case TestspecPackage.TEST_CASE__INFRASTRUCTURE:
				...
				return;
			case TestspecPackage.TEST_CASE__ENDCRITERIA:
				setEndcriteria(ENDCRITERIA_EDEFAULT);
				return;
			case TestspecPackage.TEST_CASE__NON_FUNCTIONAL_REQUIREMENT:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case TestspecPackage.TEST_CASE__ENDCRITERIA:
				return ENDCRITERIA_EDEFAULT == null ? endcriteria != null : !ENDCRITERIA_EDEFAULT.equals(endcriteria);
			case TestspecPackage.TEST_CASE__NON_FUNCTIONAL_REQUIREMENT:
