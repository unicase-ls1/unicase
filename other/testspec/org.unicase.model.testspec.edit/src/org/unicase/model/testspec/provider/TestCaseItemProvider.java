...
public class TestCaseItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addEndcriteriaPropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Endcriteria feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	protected void addEndcriteriaPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_TestCase_endcriteria_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_TestCase_endcriteria_feature", "_UI_TestCase_type"),
				 TestspecPackage.Literals.TEST_CASE__ENDCRITERIA,
				 true,
				 true,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
