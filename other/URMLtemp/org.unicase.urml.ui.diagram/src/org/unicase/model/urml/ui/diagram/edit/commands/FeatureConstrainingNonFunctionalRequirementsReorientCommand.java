 ...
 * @generated
 */
public class FeatureConstrainingNonFunctionalRequirementsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureConstrainingNonFunctionalRequirementsReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof NonFunctionalRequirement && newEnd instanceof Feature)) {
			return false;
		}
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints
			.canExistFeatureConstrainingNonFunctionalRequirements_4010(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints
			.canExistFeatureConstrainingNonFunctionalRequirements_4010(getOldSource(), getNewTarget());
	}
