...
public class IsRefinedLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsRefinedLabel2EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public IsRefinedLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.FeatureSubFeatures_4015, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsRefinedLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
