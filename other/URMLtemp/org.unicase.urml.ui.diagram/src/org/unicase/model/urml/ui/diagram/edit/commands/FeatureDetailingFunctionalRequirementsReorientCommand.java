 ...
 * @generated
 */
public class FeatureDetailingFunctionalRequirementsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureDetailingFunctionalRequirementsReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof FunctionalRequirement && newEnd instanceof Feature)) {
			return false;
		}
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canExistFeatureDetailingFunctionalRequirements_4006(
