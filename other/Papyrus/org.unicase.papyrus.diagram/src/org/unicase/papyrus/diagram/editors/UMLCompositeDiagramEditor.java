...
public class UMLCompositeDiagramEditor extends UMLDiagramEditor {
	 ...
	 * @generated
	 */
	public static final String ID = "org.unicase.papyrus.diagram.composite.UMLDiagramEditorID"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final String CONTEXT_ID = "org.unicase.papyrus.diagram.composite.diagramContext"; //$NON-NLS-1$
