...
/**
 * Editor for Papyrus use case diagrams.
 * 
 * @author mharut
 */
public class UMLUseCaseDiagramEditor extends UMLDiagramEditor {
	 ...
	 * @generated
	 */
	public static final String ID = "org.unicase.papyrus.uml.diagram.usecase.UMLDiagramEditorID"; //$NON-NLS-1$

	/**
	 * @generated
	 */
	public static final String CONTEXT_ID = "org.unicase.papyrus.uml.diagram.usecase.diagramContext"; //$NON-NLS-1$
