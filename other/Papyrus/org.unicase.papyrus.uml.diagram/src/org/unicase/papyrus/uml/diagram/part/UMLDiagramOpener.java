	...
	private Map<UMLDiagramType, String> getDiagramTypeToEditorID() {
		if (diagramTypeToEditorID == null) {
			...
			diagramTypeToEditorID.put(UMLDiagramType.ACTIVITY,
				"org.unicase.papyrus.uml.diagram.activity.UMLDiagramEditorID");
			diagramTypeToEditorID.put(UMLDiagramType.CLASS, "org.unicase.papyrus.uml.diagram.clazz.UMLDiagramEditorID");
			diagramTypeToEditorID.put(UMLDiagramType.COMMUNICATION,
				"org.unicase.papyrus.uml.diagram.communication.UMLDiagramEditorID");
			diagramTypeToEditorID.put(UMLDiagramType.COMPOSITE,
				"org.unicase.papyrus.uml.diagram.composite.UMLDiagramEditorID");
