 ...
 */
public class ExportBBCodeDialo extends TitleAreaDialog {
	 ...
	 */
	public ExportBBCodeDialo(Shell parentShell,UnicaseModelElement modelElement) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		Text t = new Text (container3, SWT.H_SCROLL | SWT.V_SCROLL | SWT.BORDER);
	...
	private boolean checkFileName(String fileUrl) {
		...
		if (f.exists()) {
			...
			try {
				...
				MessageBox messageBox = new MessageBox(ExportBBCodeDialo.platformShell, SWT.YES | SWT.NO | SWT.ICON_WARNING
					| SWT.CENTER);
				...
				MessageBox messageBox = new MessageBox(ExportBBCodeDialo.platformShell, SWT.OK | SWT.ICON_ERROR | SWT.CENTER);
