...
/**
 * This is the item provider adapter for a {@link org.unicase.model.usecase.Option} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_targetStep_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_targetStep_feature", "_UI_Option_type"),
				 UsecasePackage.Literals.OPTION__TARGET_STEP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addSourceStepPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_sourceStep_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_sourceStep_feature", "_UI_Option_type"),
				 UsecasePackage.Literals.OPTION__SOURCE_STEP,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addIncludedUseCasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Option_includedUseCase_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Option_includedUseCase_feature", "_UI_Option_type"),
				 UsecasePackage.Literals.OPTION__INCLUDED_USE_CASE,
				 true,
				 false,
				 true,
				 null,
