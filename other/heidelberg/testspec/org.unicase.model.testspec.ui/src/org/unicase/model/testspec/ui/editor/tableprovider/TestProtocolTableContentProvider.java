...
/**
 * Content provider of the dynamic table holding the test step parameters in the TestProtocol. The
 * class reads the data model and returns the data as an array.
 * 
 * @author chen
 * 
 */
public class TestProtocolTableContentProvider implements
        IStructuredContentProvider {
    /**
     * Method that is called if table needs to be filled with new objects.
     * 
