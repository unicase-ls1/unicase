 ...
 *   <li>{@link org.unicase.model.testspec.TestCase#getTestProtocol <em>Test Protocol</em>}</li>
 * </ul>
 * </p>
 *
...
public interface TestCase extends UnicaseModelElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.testspec.TestStep#getTestCase <em>Test Case</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @model opposite="testCase" containment="true" resolveProxies="true" keys="identifier"
	...
	/**
	 * Returns the value of the '<em><b>Test Protocol</b></em>' reference.
	 * It is bidirectional and its opposite is '{@link org.unicase.model.testspec.TestProtocol#getTestCase <em>Test Case</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Test Protocol</em>' reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Test Protocol</em>' reference.
	 * @see #setTestProtocol(TestProtocol)
	 * @see org.unicase.model.testspec.TestspecPackage#getTestCase_TestProtocol()
	 * @see org.unicase.model.testspec.TestProtocol#getTestCase
	 * @model opposite="testCase"
	 *        annotation="org.unicase.meeditor priority='5' position='bottom'"
	 * @generated
	 */
	TestProtocol getTestProtocol();

	/**
	 * Sets the value of the '{@link org.unicase.model.testspec.TestCase#getTestProtocol <em>Test Protocol</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param value the new value of the '<em>Test Protocol</em>' reference.
	 * @see #getTestProtocol()
	 * @generated
	 */
	void setTestProtocol(TestProtocol value);
