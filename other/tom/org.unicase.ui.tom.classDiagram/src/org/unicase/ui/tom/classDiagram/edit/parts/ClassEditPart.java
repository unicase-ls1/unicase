...
public class ClassEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
					...
					public Command getCommand(Request request) {
						if (understandsRequest(request)) {
							if (request instanceof CreateViewAndElementRequest) {
								...
								if (type == org.unicase.ui.tom.classDiagram.providers.ModelElementTypes.Attribute_3001) {
									EditPart compartmentEditPart = getChildBySemanticHint(org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
											.getType(org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
								if (type == org.unicase.ui.tom.classDiagram.providers.ModelElementTypes.Method_3002) {
									EditPart compartmentEditPart = getChildBySemanticHint(org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
											.getType(org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart.VISUAL_ID));
									return compartmentEditPart == null ? null
											: compartmentEditPart
													.getCommand(request);
								}
		...
		installEditPolicy(
				...
				new org.unicase.ui.tom.classDiagram.edit.policies.ClassItemSemanticEditPolicy());
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new org.unicase.ui.tom.classDiagram.edit.policies.ModelTextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassNameEditPart) {
			((org.unicase.ui.tom.classDiagram.edit.parts.ClassNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureClassFigure_name());
			return true;
		}
		if (childEditPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_attributes();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart) {
			IFigure pane = getPrimaryShape().getFigureClassFigure_methods();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.add(((org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart) childEditPart)
							.getFigure());
			return true;
		}
		if (childEditPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart) {
			...
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane
					.remove(((org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_attributesEditPart) {
			return getPrimaryShape().getFigureClassFigure_attributes();
		}
		if (editPart instanceof org.unicase.ui.tom.classDiagram.edit.parts.ClassClassNode_methodsEditPart) {
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
