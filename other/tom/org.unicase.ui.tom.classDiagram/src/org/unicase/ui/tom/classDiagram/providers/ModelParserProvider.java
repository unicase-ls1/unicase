...
public class ModelParserProvider extends AbstractProvider implements
	...
	protected IParser createClassName_5001Parser() {
		...
		org.unicase.ui.tom.classDiagram.parsers.MessageFormatParser parser = new org.unicase.ui.tom.classDiagram.parsers.MessageFormatParser(
				features);
		return parser;
	}
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
					.getVisualID(vid));
		}
