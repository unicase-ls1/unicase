...
public class ClassClassNode_attributesItemSemanticEditPolicy
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		if (org.unicase.ui.tom.classDiagram.providers.ModelElementTypes.Attribute_3001 == req
				.getElementType()) {
			if (req.getContainmentFeature() == null) {
				req.setContainmentFeature(ClassesPackage.eINSTANCE
						.getClass_Attributes());
			}
			return getGEFWrapper(new org.unicase.ui.tom.classDiagram.edit.commands.AttributeCreateCommand(
					req));
		}
