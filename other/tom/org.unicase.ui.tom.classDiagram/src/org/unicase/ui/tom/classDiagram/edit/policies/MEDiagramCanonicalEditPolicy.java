...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor) LinkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.tom.classDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.tom.classDiagram.part.ModelDiagramUpdater
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
					.next();
