...
import org.unicase.ui.refactoring.ui.dialogs.AbstractRefactoringInputDialog;
			...
			new UnicaseCommand() {
				...
				protected void doRun() {
					...
					if(button.getSelection()) {
						boolean delete = true;
						if(!invalidModelElement.getAllContainedModelElements().isEmpty()) {
