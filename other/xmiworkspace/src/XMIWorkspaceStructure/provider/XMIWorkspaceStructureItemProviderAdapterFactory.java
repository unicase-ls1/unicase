 ...
 * @generated
 */
public class XMIWorkspaceStructureItemProviderAdapterFactory extends XMIWorkspaceStructureAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	/**
	 ...
	 * @generated
	 */
	public XMIWorkspaceStructureItemProviderAdapterFactory() {
	...
	public Adapter createXMIECPVirtualContainerAdapter() {
		if (xmiecpVirtualContainerItemProvider == null) {
			xmiecpVirtualContainerItemProvider = new XMIECPVirtualContainerItemProvider(this);
		}

		return xmiecpVirtualContainerItemProvider;
	}
	...
	public Adapter createXMIECPFolderAdapter() {
		if (xmiecpFolderItemProvider == null) {
			xmiecpFolderItemProvider = new XMIECPFolderItemProvider(this);
		}

		return xmiecpFolderItemProvider;
	}
	...
	public void dispose() {
		...
		if (xmiecpVirtualContainerItemProvider != null) xmiecpVirtualContainerItemProvider.dispose();
