 ...
 * @generated
 */
public class Association4CreateCommand extends CreateElementCommand {
	 ...
	 * @generated NOT
	 */
	public Association4CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
		super(request);
	...
	public boolean canExecute() {
		...
		return org.unicase.ui.diagram.classDiagram.edit.policies.ModelBaseItemSemanticEditPolicy.LinkConstraints
			.canCreateAssociation_4004(getContainer(), getSource(), getTarget());
	}
	...
	protected EObject doDefaultElementCreation() {
		...
		org.unicase.ui.diagram.classDiagram.providers.ModelElementTypes.init_Association_4004(newElement);
		return newElement;
	}
