...
public interface Transition extends UnicaseModelElement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.activity.ActivityObject#getOutgoingTransitions <em>Outgoing Transitions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.activity.ActivityObject#getIncomingTransitions <em>Incoming Transitions</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
