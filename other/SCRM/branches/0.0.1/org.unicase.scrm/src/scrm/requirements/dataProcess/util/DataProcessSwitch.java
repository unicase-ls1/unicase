...
public class DataProcessSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DataProcessPackage.DATA_HANDLING: {
			DataHandling dataHandling = (DataHandling) theEObject;
			T result = caseDataHandling(dataHandling);
			if (result == null)
				result = caseProcess(dataHandling);
			if (result == null)
				result = caseRequirement(dataHandling);
			if (result == null)
				result = caseIRequirement(dataHandling);
			if (result == null)
				result = caseSCRMModelElement(dataHandling);
			if (result == null)
				result = caseUnicaseModelElement(dataHandling);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
