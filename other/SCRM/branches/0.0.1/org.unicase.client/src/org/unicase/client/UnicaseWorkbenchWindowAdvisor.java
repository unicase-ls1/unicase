...
public class UnicaseWorkbenchWindowAdvisor extends WorkbenchWindowAdvisor {
	...
	public void postWindowOpen() {
		try {
			final MetadataRepositoryElement unicaseRepository = new MetadataRepositoryElement(null, new URI("http://unicase.googlecode.com/svn/updatesite/release/0.0.1"), true);
...
//			ElementUtils.updateRepositoryUsingElements(new MetadataRepositoryElement[] {unicaseRepository, papyrusRepository}, null);
