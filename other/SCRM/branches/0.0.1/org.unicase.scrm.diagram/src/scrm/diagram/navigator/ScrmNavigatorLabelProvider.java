...
public class ScrmNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case PerformanceDescribedMethodEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/scrm/requirements?Performance?describedMethod", ScrmElementTypes.PerformanceDescribedMethod_4059); //$NON-NLS-1$
		...
		case RequirementDefiningDataEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/scrm/requirements?Requirement?definingData", ScrmElementTypes.RequirementDefiningData_4060); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		case PerformanceDescribedMethodEditPart.VISUAL_ID:
			return getPerformanceDescribedMethod_4059Text(view);
		case MathematicalModelNumericalMethodsEditPart.VISUAL_ID:
		...
		case RequirementDefiningDataEditPart.VISUAL_ID:
			return getRequirementDefiningData_4060Text(view);
		case RequirementRealizedMethodEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getRequirementDefiningData_4060Text(View view) {
		IParser parser = ScrmParserProvider
				.getParser(ScrmElementTypes.RequirementDefiningData_4060, view
						.getElement() != null ? view.getElement() : view,
						ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 6058); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	 ...
	 * @generated
	 */
	private String getPerformanceDescribedMethod_4059Text(View view) {
		IParser parser = ScrmParserProvider.getParser(
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError(
					"Parser was not found for label " + 6057); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
