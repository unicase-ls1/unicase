 ...
 * @generated
 */
public class KnowledgeSpaceKnowledgeSpaceCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getKnowledgeSpaceKnowledgeSpaceCompartment_7001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getKnowledgeSpaceKnowledgeSpaceCompartment_7001SemanticChildren((View) getHost()
						.getModel());
