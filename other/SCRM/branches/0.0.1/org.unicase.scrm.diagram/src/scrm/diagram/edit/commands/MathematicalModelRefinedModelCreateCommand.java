 ...
 * @generated
 */
public class MathematicalModelRefinedModelCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public MathematicalModelRefinedModelCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMathematicalModelRefinedModel_4058(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRefinedModel(getTarget());
		}
