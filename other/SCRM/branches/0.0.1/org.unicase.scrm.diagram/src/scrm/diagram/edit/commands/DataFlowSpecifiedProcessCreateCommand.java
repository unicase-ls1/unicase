 ...
 * @generated
 */
public class DataFlowSpecifiedProcessCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public DataFlowSpecifiedProcessCreateCommand(
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof DataFlow) {
			return false;
		}
		if (target != null
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateDataFlowSpecifiedProcess_4056(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSpecifiedProcess(getTarget());
		}
