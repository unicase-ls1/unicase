...
import scrm.diagram.edit.policies.DataHandling2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class DataHandling2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DataHandling2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new DataHandling2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataHandlingName2EditPart) {
			((DataHandlingName2EditPart) childEditPart)
	...
	/**
	 * @generated NOT: changed size
	 */
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(130, 20);
		return result;
	}
