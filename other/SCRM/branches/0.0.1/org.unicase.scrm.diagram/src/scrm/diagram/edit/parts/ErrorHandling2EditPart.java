...
import scrm.diagram.edit.policies.ErrorHandling2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ErrorHandling2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ErrorHandling2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ErrorHandling2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ErrorHandlingName2EditPart) {
			((ErrorHandlingName2EditPart) childEditPart)
