 ...
 * @generated
 */
public class DataHandlingName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataHandlingName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataHandlingName2EditPart.VISUAL_ID));
		}
		return parser;
	}
