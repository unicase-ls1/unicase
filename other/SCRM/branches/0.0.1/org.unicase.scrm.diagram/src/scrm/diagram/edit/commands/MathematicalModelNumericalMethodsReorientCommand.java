...
public class MathematicalModelNumericalMethodsReorientCommand extends
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getNumericalMethods().remove(getOldTarget());
		getNewSource().getNumericalMethods().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getNumericalMethods().remove(getOldTarget());
		getOldSource().getNumericalMethods().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
