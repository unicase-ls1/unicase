...
public class FeatureImpl extends SCRMModelElementImpl implements Feature {
	...
	public RequirementSpace getContainingRequirementSpace() {
		if (eContainerFeatureID() != RequirementsPackage.FEATURE__CONTAINING_REQUIREMENT_SPACE)
			return null;
	...
	public NotificationChain basicSetContainingRequirementSpace(
		...
		msgs = eBasicSetContainer(
				...
				RequirementsPackage.FEATURE__CONTAINING_REQUIREMENT_SPACE, msgs);
		return msgs;
	}
	...
	public void setContainingRequirementSpace(
		...
		if (newContainingRequirementSpace != eInternalContainer()
				|| (eContainerFeatureID() != RequirementsPackage.FEATURE__CONTAINING_REQUIREMENT_SPACE && newContainingRequirementSpace != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RequirementsPackage.FEATURE__CONTAINING_REQUIREMENT_SPACE,
	...
	public EList<Hardware> getDependencies() {
		if (dependencies == null) {
			dependencies = new EObjectWithInverseResolvingEList<Hardware>(
					Hardware.class, this,
					RequirementsPackage.FEATURE__DEPENDENCIES,
