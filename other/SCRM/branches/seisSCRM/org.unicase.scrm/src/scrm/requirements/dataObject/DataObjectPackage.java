...
public interface DataObjectPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int DATA_DEFINITION__CONTAINING_REQUIREMENT_SPACE = RequirementsPackage.IREQUIREMENT__CONTAINING_REQUIREMENT_SPACE;
	 ...
	 * @ordered
	 */
	int SEISMIC_SOURCE__CONTAINING_REQUIREMENT_SPACE = DATA_DEFINITION__CONTAINING_REQUIREMENT_SPACE;
	 ...
	 * @ordered
	 */
	int COMPUTATIONAL_MESH__CONTAINING_REQUIREMENT_SPACE = DATA_DEFINITION__CONTAINING_REQUIREMENT_SPACE;
	 ...
	 * @ordered
	 */
	int SYNTHETIC_SEISMOGRAM__CONTAINING_REQUIREMENT_SPACE = DATA_DEFINITION__CONTAINING_REQUIREMENT_SPACE;
