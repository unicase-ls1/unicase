...
/**
 * This is the item provider adapter for a {@link scrm.requirements.dataObject.ControlParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ControlParameterItemProvider extends SCRMModelElementItemProvider
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_ControlParameter_controlledProcess_feature"),
						getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ControlParameter_controlledProcess_feature",
								"_UI_ControlParameter_type"),
						DataObjectPackage.Literals.CONTROL_PARAMETER__CONTROLLED_PROCESS,
	...
	protected void addFormatPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_ControlParameter_format_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_ControlParameter_format_feature",
						"_UI_ControlParameter_type"),
				DataObjectPackage.Literals.CONTROL_PARAMETER__FORMAT, true,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/ControlParameter"));
	}
