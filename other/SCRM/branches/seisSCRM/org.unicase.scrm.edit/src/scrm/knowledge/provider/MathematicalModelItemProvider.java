		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getString(
								...
								"_UI_MathematicalModel_type"),
						KnowledgePackage.Literals.MATHEMATICAL_MODEL__USED_IN_NUMERICAL_METHODS,
						true, false, true, null, null, null));
	}
	...
	protected void addInvolvedDataPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_MathematicalModel_involvedData_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_MathematicalModel_involvedData_feature",
						"_UI_MathematicalModel_type"),
				KnowledgePackage.Literals.MATHEMATICAL_MODEL__INVOLVED_DATA,
				true, false, true, null, null, null));
	}
