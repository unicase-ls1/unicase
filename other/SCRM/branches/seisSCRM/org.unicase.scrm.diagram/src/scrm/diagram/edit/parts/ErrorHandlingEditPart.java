...
public class ErrorHandlingEditPart extends ShapeNodeEditPart {
	...
	public class ErrorHandlingFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			GridData constraintFFigureErrorHandling_name = new GridData();
			constraintFFigureErrorHandling_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigureErrorHandling_name.horizontalAlignment = GridData.CENTER;
			constraintFFigureErrorHandling_name.horizontalIndent = 0;
			constraintFFigureErrorHandling_name.horizontalSpan = 1;
			constraintFFigureErrorHandling_name.verticalSpan = 1;
			constraintFFigureErrorHandling_name.grabExcessHorizontalSpace = false;
			constraintFFigureErrorHandling_name.grabExcessVerticalSpace = false;
			this.add(fFigureErrorHandling_name,
					constraintFFigureErrorHandling_name);
			...
			GridData constraintFFigureErrorHandling_description = new GridData();
			constraintFFigureErrorHandling_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigureErrorHandling_description.horizontalAlignment = GridData.FILL;
			constraintFFigureErrorHandling_description.horizontalIndent = 0;
			constraintFFigureErrorHandling_description.horizontalSpan = 1;
			constraintFFigureErrorHandling_description.verticalSpan = 1;
			constraintFFigureErrorHandling_description.grabExcessHorizontalSpace = true;
			constraintFFigureErrorHandling_description.grabExcessVerticalSpace = false;
			this.add(fFigureErrorHandling_description,
					constraintFFigureErrorHandling_description);
