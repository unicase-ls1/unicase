 ...
 * @generated
 */
public class PostProcessingNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PostProcessingNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PostProcessingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
