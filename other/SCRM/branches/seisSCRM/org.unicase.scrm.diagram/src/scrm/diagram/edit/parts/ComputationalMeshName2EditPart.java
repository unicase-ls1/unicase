 ...
 * @generated
 */
public class ComputationalMeshName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshName2EditPart.VISUAL_ID));
		}
		return parser;
	}
