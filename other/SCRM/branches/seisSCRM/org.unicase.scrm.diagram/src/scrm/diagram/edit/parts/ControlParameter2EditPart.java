...
import scrm.diagram.edit.policies.ControlParameter2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ControlParameter2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ControlParameter2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ControlParameter2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ControlParameterName2EditPart) {
			((ControlParameterName2EditPart) childEditPart)
