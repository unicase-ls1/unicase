 ...
 * @generated
 */
public class ControlParameterNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ControlParameterNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ControlParameterNameEditPart.VISUAL_ID));
		}
		return parser;
	}
