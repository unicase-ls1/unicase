 ...
 * @generated
 */
public class InputDataReadingName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public InputDataReadingName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.InputDataReadingName2EditPart.VISUAL_ID));
		}
		return parser;
	}
