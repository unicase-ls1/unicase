 ...
 * @generated
 */
public class SeismicSourceAccuracyEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SeismicSourceAccuracyEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SeismicSourceAccuracyEditPart.VISUAL_ID));
		}
		return parser;
	}
