...
import scrm.diagram.edit.policies.Performance2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Performance2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Performance2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Performance2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PerformanceName2EditPart) {
			((PerformanceName2EditPart) childEditPart)
