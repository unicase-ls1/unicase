 ...
 * @generated
 */
public class RequirementRequiredInterfaceCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementRequiredInterfaceCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRequirementRequiredInterface_4073(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRequiredInterface(getTarget());
		}
