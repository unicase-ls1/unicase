...
import scrm.diagram.edit.policies.Process2ItemSemanticEditPolicy;
...
public class Process2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ProcessName2EditPart) {
			((ProcessName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry
				.getType(ProcessName2EditPart.VISUAL_ID));
	}
