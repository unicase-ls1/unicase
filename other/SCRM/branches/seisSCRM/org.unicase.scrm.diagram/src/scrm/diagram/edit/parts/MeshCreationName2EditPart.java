 ...
 * @generated
 */
public class MeshCreationName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MeshCreationName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MeshCreationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
