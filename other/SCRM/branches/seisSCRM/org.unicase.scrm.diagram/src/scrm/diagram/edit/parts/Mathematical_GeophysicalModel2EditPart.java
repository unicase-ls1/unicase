...
import scrm.diagram.edit.policies.Mathematical_GeophysicalModel2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Mathematical_GeophysicalModel2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Mathematical_GeophysicalModel2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Mathematical_GeophysicalModel2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof Mathematical_GeophysicalModelName2EditPart) {
			((Mathematical_GeophysicalModelName2EditPart) childEditPart)
