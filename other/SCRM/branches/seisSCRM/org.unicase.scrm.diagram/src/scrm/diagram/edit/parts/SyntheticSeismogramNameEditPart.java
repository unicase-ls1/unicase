 ...
 * @generated
 */
public class SyntheticSeismogramNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SyntheticSeismogramNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SyntheticSeismogramNameEditPart.VISUAL_ID));
		}
		return parser;
	}
