...
import scrm.diagram.edit.policies.PreProcessingItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PreProcessingEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PreProcessingEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PreProcessingItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PreProcessingFigure();
	}

	/**
	 * @generated
	 */
	public PreProcessingFigure getPrimaryShape() {
		return (PreProcessingFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PreProcessingNameEditPart) {
			((PreProcessingNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePreProcessing_name());
			return true;
		}
		if (childEditPart instanceof PreProcessingDescriptionEditPart) {
			((PreProcessingDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePreProcessing_description());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class PreProcessingFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePreProcessing_name;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePreProcessing_description;

		/**
		 * @generated
		 */
		public PreProcessingFigure() {
		...
		private void createContents() {
			...
			fFigurePreProcessing_name = new WrappingLabel();
			fFigurePreProcessing_name.setText("");

			fFigurePreProcessing_name.setFont(FFIGUREPREPROCESSING_NAME_FONT);

			GridData constraintFFigurePreProcessing_name = new GridData();
			constraintFFigurePreProcessing_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigurePreProcessing_name.horizontalAlignment = GridData.CENTER;
			constraintFFigurePreProcessing_name.horizontalIndent = 0;
			constraintFFigurePreProcessing_name.horizontalSpan = 1;
			constraintFFigurePreProcessing_name.verticalSpan = 1;
			constraintFFigurePreProcessing_name.grabExcessHorizontalSpace = false;
			constraintFFigurePreProcessing_name.grabExcessVerticalSpace = false;
			this.add(fFigurePreProcessing_name,
					constraintFFigurePreProcessing_name);

			fFigurePreProcessing_description = new WrappingLabel();
			fFigurePreProcessing_description.setText("");
			fFigurePreProcessing_description.setTextWrap(true);

			GridData constraintFFigurePreProcessing_description = new GridData();
			constraintFFigurePreProcessing_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigurePreProcessing_description.horizontalAlignment = GridData.FILL;
			constraintFFigurePreProcessing_description.horizontalIndent = 0;
			constraintFFigurePreProcessing_description.horizontalSpan = 1;
			constraintFFigurePreProcessing_description.verticalSpan = 1;
			constraintFFigurePreProcessing_description.grabExcessHorizontalSpace = true;
			constraintFFigurePreProcessing_description.grabExcessVerticalSpace = false;
			this.add(fFigurePreProcessing_description,
					constraintFFigurePreProcessing_description);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePreProcessing_name() {
			return fFigurePreProcessing_name;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePreProcessing_description() {
			return fFigurePreProcessing_description;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREPREPROCESSING_NAME_FONT = new Font(
