...
import scrm.diagram.edit.policies.Solver2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Solver2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Solver2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Solver2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SolverName2EditPart) {
			((SolverName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry
				.getType(SolverName2EditPart.VISUAL_ID));
	}
