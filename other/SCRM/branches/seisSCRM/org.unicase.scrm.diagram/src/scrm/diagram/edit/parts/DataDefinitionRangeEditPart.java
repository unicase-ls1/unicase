 ...
 * @generated
 */
public class DataDefinitionRangeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataDefinitionRangeEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionRangeEditPart.VISUAL_ID));
		}
		return parser;
	}
