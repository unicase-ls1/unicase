...
import scrm.diagram.edit.policies.PostProcessing2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PostProcessing2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PostProcessing2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PostProcessing2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PostProcessingName2EditPart) {
			((PostProcessingName2EditPart) childEditPart)
