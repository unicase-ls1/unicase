 ...
 * @generated
 */
public class PostProcessingDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PostProcessingDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PostProcessingDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
