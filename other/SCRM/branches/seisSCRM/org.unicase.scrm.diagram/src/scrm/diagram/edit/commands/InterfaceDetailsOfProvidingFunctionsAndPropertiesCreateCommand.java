 ...
 * @generated
 */
public class InterfaceDetailsOfProvidingFunctionsAndPropertiesCreateCommand
	 ...
	 * @generated
	 */
	public InterfaceDetailsOfProvidingFunctionsAndPropertiesCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateInterfaceDetailsOfProvidingFunctionsAndProperties_4070(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDetailsOfProvidingFunctionsAndProperties().add(
					getTarget());
		}
