 ...
 * @generated
 */
public class ControlParameterFormatEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ControlParameterFormatEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ControlParameterFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
