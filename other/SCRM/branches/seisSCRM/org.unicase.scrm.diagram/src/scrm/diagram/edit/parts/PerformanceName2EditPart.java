 ...
 * @generated
 */
public class PerformanceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PerformanceName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PerformanceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
