 ...
 * @generated
 */
public class ControlParameterDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ControlParameterDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ControlParameterDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
