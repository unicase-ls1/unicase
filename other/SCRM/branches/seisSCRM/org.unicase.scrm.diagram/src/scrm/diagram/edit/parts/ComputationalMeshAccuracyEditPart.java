 ...
 * @generated
 */
public class ComputationalMeshAccuracyEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshAccuracyEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshAccuracyEditPart.VISUAL_ID));
		}
		return parser;
	}
