 ...
 * @generated
 */
public class SeismicSourceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SeismicSourceName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SeismicSourceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
