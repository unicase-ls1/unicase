 ...
 * @generated
 */
public class PostProcessingName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PostProcessingName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PostProcessingName2EditPart.VISUAL_ID));
		}
		return parser;
	}
