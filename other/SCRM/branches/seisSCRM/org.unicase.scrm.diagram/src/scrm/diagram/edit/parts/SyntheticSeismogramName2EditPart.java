 ...
 * @generated
 */
public class SyntheticSeismogramName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SyntheticSeismogramName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SyntheticSeismogramName2EditPart.VISUAL_ID));
		}
		return parser;
	}
