 ...
 * @generated
 */
public class ComputationalMeshFormatEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshFormatEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
