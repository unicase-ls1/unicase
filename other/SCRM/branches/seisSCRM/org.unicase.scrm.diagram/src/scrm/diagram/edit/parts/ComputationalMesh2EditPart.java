...
import scrm.diagram.edit.policies.ComputationalMesh2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class ComputationalMesh2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public ComputationalMesh2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ComputationalMesh2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ComputationalMeshName2EditPart) {
			((ComputationalMeshName2EditPart) childEditPart)
