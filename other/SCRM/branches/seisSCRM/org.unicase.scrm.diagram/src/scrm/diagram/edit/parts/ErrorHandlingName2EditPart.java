 ...
 * @generated
 */
public class ErrorHandlingName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ErrorHandlingName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ErrorHandlingName2EditPart.VISUAL_ID));
		}
		return parser;
	}
