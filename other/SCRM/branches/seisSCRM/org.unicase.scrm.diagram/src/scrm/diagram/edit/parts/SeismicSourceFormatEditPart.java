 ...
 * @generated
 */
public class SeismicSourceFormatEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SeismicSourceFormatEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SeismicSourceFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
