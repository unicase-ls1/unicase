 ...
 * @generated
 */
public class KnowledgeSpaceName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public KnowledgeSpaceName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.KnowledgeSpaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
