 ...
 * @generated
 */
public class SyntheticSeismogramDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SyntheticSeismogramDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SyntheticSeismogramDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
