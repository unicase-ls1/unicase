 ...
 * @generated
 */
public class KnowledgeSpaceKnowledgeSpaceCompartment2CanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getKnowledgeSpaceKnowledgeSpaceCompartment_7002SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getKnowledgeSpaceKnowledgeSpaceCompartment_7002SemanticChildren((View) getHost()
						.getModel());
