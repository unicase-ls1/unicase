 ...
 * @generated
 */
public class FeatureSuperFeatureCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureSuperFeatureCreateCommand(CreateRelationshipRequest request,
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateFeatureSuperFeature_4053(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getSuperFeature().add(getTarget());
		}
