...
import scrm.diagram.edit.policies.MeshCreationItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MeshCreationEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MeshCreationEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MeshCreationItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new MeshCreationFigure();
	}

	/**
	 * @generated
	 */
	public MeshCreationFigure getPrimaryShape() {
		return (MeshCreationFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MeshCreationNameEditPart) {
			((MeshCreationNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureMeshCreation_name());
			return true;
		}
		if (childEditPart instanceof MeshCreationDescriptionEditPart) {
			((MeshCreationDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureMeshCreation_description());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class MeshCreationFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureMeshCreation_name;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureMeshCreation_description;

		/**
		 * @generated
		 */
		public MeshCreationFigure() {
		...
		private void createContents() {
			...
			fFigureMeshCreation_name = new WrappingLabel();
			fFigureMeshCreation_name.setText("");

			fFigureMeshCreation_name.setFont(FFIGUREMESHCREATION_NAME_FONT);

			GridData constraintFFigureMeshCreation_name = new GridData();
			constraintFFigureMeshCreation_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigureMeshCreation_name.horizontalAlignment = GridData.CENTER;
			constraintFFigureMeshCreation_name.horizontalIndent = 0;
			constraintFFigureMeshCreation_name.horizontalSpan = 1;
			constraintFFigureMeshCreation_name.verticalSpan = 1;
			constraintFFigureMeshCreation_name.grabExcessHorizontalSpace = false;
			constraintFFigureMeshCreation_name.grabExcessVerticalSpace = false;
			this.add(fFigureMeshCreation_name,
					constraintFFigureMeshCreation_name);

			fFigureMeshCreation_description = new WrappingLabel();
			fFigureMeshCreation_description.setText("");
			fFigureMeshCreation_description.setTextWrap(true);

			GridData constraintFFigureMeshCreation_description = new GridData();
			constraintFFigureMeshCreation_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigureMeshCreation_description.horizontalAlignment = GridData.FILL;
			constraintFFigureMeshCreation_description.horizontalIndent = 0;
			constraintFFigureMeshCreation_description.horizontalSpan = 1;
			constraintFFigureMeshCreation_description.verticalSpan = 1;
			constraintFFigureMeshCreation_description.grabExcessHorizontalSpace = true;
			constraintFFigureMeshCreation_description.grabExcessVerticalSpace = false;
			this.add(fFigureMeshCreation_description,
					constraintFFigureMeshCreation_description);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureMeshCreation_name() {
			return fFigureMeshCreation_name;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureMeshCreation_description() {
			return fFigureMeshCreation_description;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREMESHCREATION_NAME_FONT = new Font(
