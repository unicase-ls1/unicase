 ...
 * @generated
 */
public class PreProcessingDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PreProcessingDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PreProcessingDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
