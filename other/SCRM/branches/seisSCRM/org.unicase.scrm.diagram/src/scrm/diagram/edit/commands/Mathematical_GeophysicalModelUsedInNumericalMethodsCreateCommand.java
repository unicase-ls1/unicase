 ...
 * @generated
 */
public class Mathematical_GeophysicalModelUsedInNumericalMethodsCreateCommand
	 ...
	 * @generated
	 */
	public Mathematical_GeophysicalModelUsedInNumericalMethodsCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateMathematical_GeophysicalModelUsedInNumericalMethods_4065(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getUsedInNumericalMethods().add(getTarget());
		}
