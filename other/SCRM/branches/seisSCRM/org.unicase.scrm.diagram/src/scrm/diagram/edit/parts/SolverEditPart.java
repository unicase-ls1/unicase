...
import scrm.diagram.edit.policies.SolverItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SolverEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SolverEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SolverItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new SolverFigure();
	}

	/**
	 * @generated
	 */
	public SolverFigure getPrimaryShape() {
		return (SolverFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SolverNameEditPart) {
			((SolverNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureSolver_name());
			return true;
		}
		if (childEditPart instanceof SolverDescriptionEditPart) {
			((SolverDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureSolver_description());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry
				.getType(SolverNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class SolverFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureSolver_name;
		/**
		 * @generated
		 */
		private WrappingLabel fFigureSolver_description;
		...
		private void createContents() {
			...
			fFigureSolver_name = new WrappingLabel();
			fFigureSolver_name.setText("");

			fFigureSolver_name.setFont(FFIGURESOLVER_NAME_FONT);

			GridData constraintFFigureSolver_name = new GridData();
			constraintFFigureSolver_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigureSolver_name.horizontalAlignment = GridData.CENTER;
			constraintFFigureSolver_name.horizontalIndent = 0;
			constraintFFigureSolver_name.horizontalSpan = 1;
			constraintFFigureSolver_name.verticalSpan = 1;
			constraintFFigureSolver_name.grabExcessHorizontalSpace = false;
			constraintFFigureSolver_name.grabExcessVerticalSpace = false;
			this.add(fFigureSolver_name, constraintFFigureSolver_name);

			fFigureSolver_description = new WrappingLabel();
			fFigureSolver_description.setText("");
			fFigureSolver_description.setTextWrap(true);

			GridData constraintFFigureSolver_description = new GridData();
			constraintFFigureSolver_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigureSolver_description.horizontalAlignment = GridData.FILL;
			constraintFFigureSolver_description.horizontalIndent = 0;
			constraintFFigureSolver_description.horizontalSpan = 1;
			constraintFFigureSolver_description.verticalSpan = 1;
			constraintFFigureSolver_description.grabExcessHorizontalSpace = true;
			constraintFFigureSolver_description.grabExcessVerticalSpace = false;
			this.add(fFigureSolver_description,
					constraintFFigureSolver_description);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureSolver_name() {
			return fFigureSolver_name;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigureSolver_description() {
			return fFigureSolver_description;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGURESOLVER_NAME_FONT = new Font(Display.getCurrent(),
			"Arial", 9, SWT.BOLD);
