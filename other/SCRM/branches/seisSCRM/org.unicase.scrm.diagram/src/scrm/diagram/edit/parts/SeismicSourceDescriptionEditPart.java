 ...
 * @generated
 */
public class SeismicSourceDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SeismicSourceDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SeismicSourceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
