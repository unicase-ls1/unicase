 ...
 * @generated
 */
public class Mathematical_GeophysicalModelNameEditPart extends
	 ...
	 * @generated
	 */
	public Mathematical_GeophysicalModelNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.Mathematical_GeophysicalModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
