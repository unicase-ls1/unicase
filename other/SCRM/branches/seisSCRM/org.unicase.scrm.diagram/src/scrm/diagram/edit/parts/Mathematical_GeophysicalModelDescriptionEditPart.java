 ...
 * @generated
 */
public class Mathematical_GeophysicalModelDescriptionEditPart extends
	 ...
	 * @generated
	 */
	public Mathematical_GeophysicalModelDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.Mathematical_GeophysicalModelDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
