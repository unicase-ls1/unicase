...
import scrm.diagram.edit.policies.SyntheticSeismogram2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SyntheticSeismogram2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public SyntheticSeismogram2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SyntheticSeismogram2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SyntheticSeismogramName2EditPart) {
			((SyntheticSeismogramName2EditPart) childEditPart)
