...
import scrm.diagram.edit.commands.PerformanceHardwareCreateCommand;
import scrm.diagram.edit.commands.PerformanceHardwareReorientCommand;
 ...
 * @generated
 */
public class Performance2ItemSemanticEditPolicy extends
		ScrmBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public Performance2ItemSemanticEditPolicy() {
		super(ScrmElementTypes.Performance_3011);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ScrmVisualIDRegistry.getVisualID(outgoingLink) == PerformanceHardwareEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
						outgoingLink.getSource().getElement(), null,
						outgoingLink.getTarget().getElement(), false);
				cmd.add(new DestroyReferenceCommand(r));
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (ScrmElementTypes.PerformanceHardware_4074 == req.getElementType()) {
			return getGEFWrapper(new PerformanceHardwareCreateCommand(req,
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case PerformanceHardwareEditPart.VISUAL_ID:
			return getGEFWrapper(new PerformanceHardwareReorientCommand(req));
