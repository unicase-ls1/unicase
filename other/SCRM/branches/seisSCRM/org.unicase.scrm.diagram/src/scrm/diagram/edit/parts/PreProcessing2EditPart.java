...
import scrm.diagram.edit.policies.PreProcessing2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PreProcessing2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PreProcessing2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PreProcessing2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PreProcessingName2EditPart) {
			((PreProcessingName2EditPart) childEditPart)
