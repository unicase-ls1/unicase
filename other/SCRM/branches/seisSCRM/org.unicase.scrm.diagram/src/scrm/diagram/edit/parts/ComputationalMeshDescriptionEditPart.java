 ...
 * @generated
 */
public class ComputationalMeshDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
