 ...
 * @generated
 */
public class ComputationalMeshNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshNameEditPart.VISUAL_ID));
		}
		return parser;
	}
