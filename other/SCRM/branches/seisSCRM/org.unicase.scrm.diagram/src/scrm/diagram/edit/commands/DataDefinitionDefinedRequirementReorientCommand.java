...
public class DataDefinitionDefinedRequirementReorientCommand extends
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Requirement && newEnd instanceof scrm.requirements.dataObject.DataDefinition)) {
			return false;
		}
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDataDefinitionDefinedRequirement_4075(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistDataDefinitionDefinedRequirement_4075(getOldSource(),
						getNewTarget());
	}
