 ...
 * @generated
 */
public class SyntheticSeismogramRangeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SyntheticSeismogramRangeEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SyntheticSeismogramRangeEditPart.VISUAL_ID));
		}
		return parser;
	}
