 ...
 * @generated
 */
public class MeshCreationDescriptionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MeshCreationDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MeshCreationDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
