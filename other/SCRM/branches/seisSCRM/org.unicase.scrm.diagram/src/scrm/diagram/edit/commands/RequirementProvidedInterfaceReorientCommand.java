 ...
 * @generated
 */
public class RequirementProvidedInterfaceReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementProvidedInterfaceReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementProvidedInterface_4072(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementProvidedInterface_4072(getOldSource(),
						getNewTarget());
	}
