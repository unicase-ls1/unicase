...
import scrm.diagram.edit.policies.Station2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Station2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public Station2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new Station2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StationName2EditPart) {
			((StationName2EditPart) childEditPart).setLabel(getPrimaryShape()
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry
				.getType(StationName2EditPart.VISUAL_ID));
	}
