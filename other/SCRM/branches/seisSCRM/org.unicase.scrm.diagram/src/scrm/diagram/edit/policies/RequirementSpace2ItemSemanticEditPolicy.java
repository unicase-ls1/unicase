 ...
 * @generated
 */
public class RequirementSpace2ItemSemanticEditPolicy extends
		ScrmBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public RequirementSpace2ItemSemanticEditPolicy() {
				...
				for (Iterator<?> cit = node.getChildren().iterator(); cit
					...
					case StatusMonitoring2EditPart.VISUAL_ID:
						...
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
							...
							if (ScrmVisualIDRegistry.getVisualID(outgoingLink) == StatusMonitoringMonitoredProcessEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(),
										null, outgoingLink.getTarget()
												.getElement(), false);
					...
					case ControlParameter2EditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it
								.hasNext();) {
							Edge outgoingLink = (Edge) it.next();
							if (ScrmVisualIDRegistry.getVisualID(outgoingLink) == ControlParameterControlledProcessEditPart.VISUAL_ID) {
								DestroyReferenceRequest r = new DestroyReferenceRequest(
										outgoingLink.getSource().getElement(),
										null, outgoingLink.getTarget()
												.getElement(), false);
