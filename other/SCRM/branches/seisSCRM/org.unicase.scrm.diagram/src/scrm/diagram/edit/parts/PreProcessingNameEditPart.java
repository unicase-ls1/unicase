 ...
 * @generated
 */
public class PreProcessingNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PreProcessingNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PreProcessingNameEditPart.VISUAL_ID));
		}
		return parser;
	}
