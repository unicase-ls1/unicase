 ...
 * @generated
 */
public class SyntheticSeismogramAccuracyEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SyntheticSeismogramAccuracyEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SyntheticSeismogramAccuracyEditPart.VISUAL_ID));
		}
		return parser;
	}
