...
import scrm.diagram.edit.policies.MeshCreation2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class MeshCreation2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public MeshCreation2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new MeshCreation2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof MeshCreationName2EditPart) {
			((MeshCreationName2EditPart) childEditPart)
