...
import scrm.diagram.edit.policies.PostProcessingItemSemanticEditPolicy;
 ...
 * @generated
 */
public class PostProcessingEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public PostProcessingEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new PostProcessingItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new PostProcessingFigure();
	}

	/**
	 * @generated
	 */
	public PostProcessingFigure getPrimaryShape() {
		return (PostProcessingFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof PostProcessingNameEditPart) {
			((PostProcessingNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigurePostProcessing_name());
			return true;
		}
		if (childEditPart instanceof PostProcessingDescriptionEditPart) {
			((PostProcessingDescriptionEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePostProcessing_description());
			return true;
		}
		return false;
	}
	 ...
	 * @generated
	 */
	public class PostProcessingFigure extends RoundedRectangle {

		/**
		 * @generated
		 */
		private WrappingLabel fFigurePostProcessing_name;
		/**
		 * @generated
		 */
		private WrappingLabel fFigurePostProcessing_description;

		/**
		 * @generated
		 */
		public PostProcessingFigure() {
		...
		private void createContents() {
			...
			fFigurePostProcessing_name = new WrappingLabel();
			fFigurePostProcessing_name.setText("");

			fFigurePostProcessing_name.setFont(FFIGUREPOSTPROCESSING_NAME_FONT);

			GridData constraintFFigurePostProcessing_name = new GridData();
			constraintFFigurePostProcessing_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigurePostProcessing_name.horizontalAlignment = GridData.CENTER;
			constraintFFigurePostProcessing_name.horizontalIndent = 0;
			constraintFFigurePostProcessing_name.horizontalSpan = 1;
			constraintFFigurePostProcessing_name.verticalSpan = 1;
			constraintFFigurePostProcessing_name.grabExcessHorizontalSpace = false;
			constraintFFigurePostProcessing_name.grabExcessVerticalSpace = false;
			this.add(fFigurePostProcessing_name,
					constraintFFigurePostProcessing_name);

			fFigurePostProcessing_description = new WrappingLabel();
			fFigurePostProcessing_description.setText("");
			fFigurePostProcessing_description.setTextWrap(true);

			GridData constraintFFigurePostProcessing_description = new GridData();
			constraintFFigurePostProcessing_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigurePostProcessing_description.horizontalAlignment = GridData.FILL;
			constraintFFigurePostProcessing_description.horizontalIndent = 0;
			constraintFFigurePostProcessing_description.horizontalSpan = 1;
			constraintFFigurePostProcessing_description.verticalSpan = 1;
			constraintFFigurePostProcessing_description.grabExcessHorizontalSpace = true;
			constraintFFigurePostProcessing_description.grabExcessVerticalSpace = false;
			this.add(fFigurePostProcessing_description,
					constraintFFigurePostProcessing_description);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigurePostProcessing_name() {
			return fFigurePostProcessing_name;
		}

		/**
		 * @generated
		 */
		public WrappingLabel getFigurePostProcessing_description() {
			return fFigurePostProcessing_description;
		}
	 ...
	 * @generated
	 */
	static final Font FFIGUREPOSTPROCESSING_NAME_FONT = new Font(
