 ...
 * @generated
 */
public class MeshCreationNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public MeshCreationNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MeshCreationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
