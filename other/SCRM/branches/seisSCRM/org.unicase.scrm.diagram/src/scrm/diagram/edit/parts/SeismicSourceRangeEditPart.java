 ...
 * @generated
 */
public class SeismicSourceRangeEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SeismicSourceRangeEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SeismicSourceRangeEditPart.VISUAL_ID));
		}
		return parser;
	}
