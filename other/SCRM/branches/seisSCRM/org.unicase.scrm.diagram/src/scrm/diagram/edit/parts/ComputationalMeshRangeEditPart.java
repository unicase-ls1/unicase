 ...
 * @generated
 */
public class ComputationalMeshRangeEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ComputationalMeshRangeEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ComputationalMeshRangeEditPart.VISUAL_ID));
		}
		return parser;
	}
