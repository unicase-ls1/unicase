 ...
 * @generated
 */
public class InterfaceDetailsOfRequiringFunctionsAndPropertiesCreateCommand
	 ...
	 * @generated
	 */
	public InterfaceDetailsOfRequiringFunctionsAndPropertiesCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy
				.getLinkConstraints()
				.canCreateInterfaceDetailsOfRequiringFunctionsAndProperties_4071(
						getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDetailsOfRequiringFunctionsAndProperties().add(
					getTarget());
		}
