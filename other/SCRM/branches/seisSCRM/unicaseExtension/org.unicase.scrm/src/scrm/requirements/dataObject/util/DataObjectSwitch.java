...
import scrm.requirements.dataObject.*;
...
public class DataObjectSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DataObjectPackage.SEISMIC_SOURCE: {
			...
			if (result == null)
				result = caseUnicaseModelElement(seismicSource);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataObjectPackage.COMPUTATIONAL_MESH: {
			...
			if (result == null)
				result = caseUnicaseModelElement(computationalMesh);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataObjectPackage.SYNTHETIC_SEISMOGRAM: {
			...
			if (result == null)
				result = caseUnicaseModelElement(syntheticSeismogram);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataObjectPackage.STATION: {
			...
			if (result == null)
				result = caseUnicaseModelElement(station);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataObjectPackage.CONTROL_PARAMETER: {
			...
			if (result == null)
				result = caseUnicaseModelElement(controlParameter);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
