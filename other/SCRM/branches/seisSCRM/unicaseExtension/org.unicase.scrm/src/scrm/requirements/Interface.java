...
public interface Interface extends IRequirement {
	 ...
	 * It is bidirectional and its opposite is '{@link scrm.requirements.dataObject.DataDefinition#getProvidedInterface <em>Provided Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * The list contents are of type {@link scrm.requirements.dataObject.DataDefinition}.
	 * It is bidirectional and its opposite is '{@link scrm.requirements.dataObject.DataDefinition#getRequiredInterface <em>Required Interface</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
