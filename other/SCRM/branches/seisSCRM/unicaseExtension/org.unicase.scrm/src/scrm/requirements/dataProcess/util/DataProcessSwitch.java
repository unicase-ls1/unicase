...
public class DataProcessSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case DataProcessPackage.SOLVER: {
			...
			if (result == null)
				result = caseUnicaseModelElement(solver);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataProcessPackage.MESH_CREATION: {
			...
			if (result == null)
				result = caseUnicaseModelElement(meshCreation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataProcessPackage.PRE_PROCESSING: {
			...
			if (result == null)
				result = caseUnicaseModelElement(preProcessing);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case DataProcessPackage.POST_PROCESSING: {
			...
			if (result == null)
				result = caseUnicaseModelElement(postProcessing);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
