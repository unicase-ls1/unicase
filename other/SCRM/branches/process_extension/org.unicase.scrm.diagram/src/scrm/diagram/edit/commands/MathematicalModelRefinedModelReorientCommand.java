 ...
 * @generated
 */
public class MathematicalModelRefinedModelReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public MathematicalModelRefinedModelReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMathematicalModelRefinedModel_4058(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistMathematicalModelRefinedModel_4058(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setRefinedModel(null);
		getNewSource().setRefinedModel(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setRefinedModel(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
