 ...
 * @generated
 */
public class RequirementRefinedRequirementReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementRefinedRequirementReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementRefinedRequirement_4054(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementRefinedRequirement_4054(getOldSource(),
						getNewTarget());
	}
