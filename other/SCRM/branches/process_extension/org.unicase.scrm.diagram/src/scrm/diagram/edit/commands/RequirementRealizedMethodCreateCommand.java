 ...
 * @generated
 */
public class RequirementRealizedMethodCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementRealizedMethodCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRequirementRealizedMethod_4050(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRealizedMethod(getTarget());
		}
