 ...
 * @generated
 */
public class RequirementSpaceRequirementSpaceCompartment2CanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getRequirementSpaceRequirementSpaceCompartment_7004SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getRequirementSpaceRequirementSpaceCompartment_7004SemanticChildren((View) getHost()
						.getModel());
