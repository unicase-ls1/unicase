 ...
 * @generated
 */
public class RequirementSpecifiedFeatureCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementSpecifiedFeatureCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateRequirementSpecifiedFeature_4052(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setSpecifiedFeature(getTarget());
		}
