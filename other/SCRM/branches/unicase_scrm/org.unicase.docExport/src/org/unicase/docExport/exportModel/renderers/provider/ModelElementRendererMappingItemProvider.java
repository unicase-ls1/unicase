...
/**
 * This is the item provider adapter for a {@link org.unicase.docExport.exportModel.renderers.ModelElementRendererMapping} object.
 * <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * @generated
 */
public class ModelElementRendererMappingItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ModelElementRendererMapping_eClassName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ModelElementRendererMapping_eClassName_feature", "_UI_ModelElementRendererMapping_type"),
				 RenderersPackage.Literals.MODEL_ELEMENT_RENDERER_MAPPING__ECLASS_NAME,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns ModelElementRendererMapping.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ModelElementRendererMapping_type") :
		...
		newChildDescriptors.add
			(createChildParameter
				(RenderersPackage.Literals.MODEL_ELEMENT_RENDERER_MAPPING__RENDERER,
				 DefaultRenderersFactory.eINSTANCE.createDefaultModelElementRenderer()));

		newChildDescriptors.add
			(createChildParameter
				(RenderersPackage.Literals.MODEL_ELEMENT_RENDERER_MAPPING__RENDERER,
				 SpecialRenderersFactory.eINSTANCE.createMeetingRenderer()));

		newChildDescriptors.add
			(createChildParameter
				(RenderersPackage.Literals.MODEL_ELEMENT_RENDERER_MAPPING__RENDERER,
				 SpecialRenderersFactory.eINSTANCE.createMilestoneRenderer()));

		newChildDescriptors.add
			(createChildParameter
				(RenderersPackage.Literals.MODEL_ELEMENT_RENDERER_MAPPING__RENDERER,
				 SpecialRenderersFactory.eINSTANCE.createPackageFlatRenderer()));
