...
public class UColorItemProvider extends RendererOptionItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UColor_red_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UColor_red_feature", "_UI_UColor_type"),
				 OptionsPackage.Literals.UCOLOR__RED,
				 true,
				 false,
				 false,
	...
	protected void addGreenPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UColor_green_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UColor_green_feature", "_UI_UColor_type"),
				 OptionsPackage.Literals.UCOLOR__GREEN,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addBluePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UColor_blue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UColor_blue_feature", "_UI_UColor_type"),
				 OptionsPackage.Literals.UCOLOR__BLUE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_UColor_type") :
			getString("_UI_UColor_type") + " " + label;
	}
