 ...
 * @generated
 */
public class RequirementSpaceRequirementSpaceCompartmentCanonicalEditPolicy
	...
	protected List getSemanticChildrenList() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getRequirementSpaceRequirementSpaceCompartment_7003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getRequirementSpaceRequirementSpaceCompartment_7003SemanticChildren((View) getHost()
						.getModel());
