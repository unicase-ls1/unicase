 ...
 * @generated
 */
public class NumericalMethodSolvedProblemReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public NumericalMethodSolvedProblemReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof ScientificProblem && newEnd instanceof NumericalMethod)) {
			return false;
		}
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNumericalMethodSolvedProblem_4057(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistNumericalMethodSolvedProblem_4057(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setSolvedProblem(null);
		getNewSource().setSolvedProblem(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setSolvedProblem(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
