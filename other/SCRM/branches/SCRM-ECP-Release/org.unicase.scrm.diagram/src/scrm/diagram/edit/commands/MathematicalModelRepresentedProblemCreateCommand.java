 ...
 * @generated
 */
public class MathematicalModelRepresentedProblemCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public MathematicalModelRepresentedProblemCreateCommand(
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof ScientificProblem) {
			return false;
		}
		if (getSource() == null) {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateMathematicalModelRepresentedProblem_4048(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRepresentedProblem(getTarget());
		}
	 ...
	 * @generated
	 */
	protected ScientificProblem getTarget() {
		return (ScientificProblem) target;
	}
}
