 ...
 * @generated
 */
public class NumericalMethodName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NumericalMethodName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.NumericalMethodName2EditPart.VISUAL_ID));
		}
		return parser;
	}
