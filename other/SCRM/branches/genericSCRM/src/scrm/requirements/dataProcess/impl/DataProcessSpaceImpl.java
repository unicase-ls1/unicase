...
public class DataProcessSpaceImpl extends SCRMModelElementImpl implements
			...
			if (providedInterface != oldProvidedInterface) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(
							this,
							Notification.RESOLVE,
							DataProcessPackage.DATA_PROCESS_SPACE__PROVIDED_INTERFACE,
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Requirement.class) {
			...
			case DataProcessPackage.DATA_PROCESS_SPACE__PROVIDED_INTERFACE:
				return RequirementsPackage.REQUIREMENT__PROVIDED_INTERFACE;
			case DataProcessPackage.DATA_PROCESS_SPACE__REQUIRED_INTERFACE:
				return RequirementsPackage.REQUIREMENT__REQUIRED_INTERFACE;
			default:
				return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == Requirement.class) {
			...
			case RequirementsPackage.REQUIREMENT__PROVIDED_INTERFACE:
				return DataProcessPackage.DATA_PROCESS_SPACE__PROVIDED_INTERFACE;
			case RequirementsPackage.REQUIREMENT__REQUIRED_INTERFACE:
				return DataProcessPackage.DATA_PROCESS_SPACE__REQUIRED_INTERFACE;
			default:
				return -1;
			}
		}
