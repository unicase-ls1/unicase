...
public class FeatureItemProvider extends SCRMModelElementItemProvider implements
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addComputationalHardwarePropertyDescriptor(object);
	...
	/**
	 * This adds a property descriptor for the Computational Hardware feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addComputationalHardwarePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(),
				getResourceLocator(),
				getString("_UI_Feature_computationalHardware_feature"),
				getString("_UI_PropertyDescriptor_description",
						"_UI_Feature_computationalHardware_feature",
						"_UI_Feature_type"),
				RequirementsPackage.Literals.FEATURE__COMPUTATIONAL_HARDWARE,
	...
	protected void collectNewChildDescriptors(
		...
		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
				DataProcessFactory.eINSTANCE.createDataVisualizationProcess()));

		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
				DataProcessFactory.eINSTANCE.createReportGenerationProcess()));
		...
		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
				DataProcessFactory.eINSTANCE
						.createBuildingModelConstructionProcess()));

		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
				DataProcessFactory.eINSTANCE
						.createCostMinimizationCalculationProcess()));

		newChildDescriptors
				.add(createChildParameter(
						RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
						DataProcessFactory.eINSTANCE
								.createControlSystemDesignProcess()));

		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__DETAILED_REQUIREMENTS,
				DataProcessFactory.eINSTANCE
						.createEnergyUsageCalculationProcess()));
		...
		newChildDescriptors.add(createChildParameter(
				RequirementsPackage.Literals.FEATURE__PROVIDED_INTERFACES,
				RequirementsFactory.eINSTANCE.createHardwareInterface()));
	}
