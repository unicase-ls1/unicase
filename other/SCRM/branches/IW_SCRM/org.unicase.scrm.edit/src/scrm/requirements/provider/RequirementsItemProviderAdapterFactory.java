...
public class RequirementsItemProviderAdapterFactory extends
	...
	/**
	 * This keeps track of the one adapter used for all {@link scrm.requirements.ComputionalHardware} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected ComputionalHardwareItemProvider computionalHardwareItemProvider;

	/**
	 * This creates an adapter for a {@link scrm.requirements.ComputionalHardware}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createComputionalHardwareAdapter() {
		if (computionalHardwareItemProvider == null) {
			computionalHardwareItemProvider = new ComputionalHardwareItemProvider(
					this);
		}

		return computionalHardwareItemProvider;
	}
	...
	/**
	 * This keeps track of the one adapter used for all {@link scrm.requirements.HardwareInterface} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link scrm.requirements.HardwareInterface}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createHardwareInterfaceAdapter() {
		if (hardwareInterfaceItemProvider == null) {
			hardwareInterfaceItemProvider = new HardwareInterfaceItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all {@link scrm.requirements.RegulatoryPolicy} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected RegulatoryPolicyItemProvider regulatoryPolicyItemProvider;

	/**
	 * This creates an adapter for a {@link scrm.requirements.RegulatoryPolicy}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createRegulatoryPolicyAdapter() {
		if (regulatoryPolicyItemProvider == null) {
			regulatoryPolicyItemProvider = new RegulatoryPolicyItemProvider(
					this);
		}

		return regulatoryPolicyItemProvider;
	}
	...
	public void dispose() {
		...
		if (computionalHardwareItemProvider != null)
			computionalHardwareItemProvider.dispose();
		if (constraintItemProvider != null)
		...
		if (hardwareInterfaceItemProvider != null)
			hardwareInterfaceItemProvider.dispose();
		if (regulatoryPolicyItemProvider != null)
			regulatoryPolicyItemProvider.dispose();
	}
