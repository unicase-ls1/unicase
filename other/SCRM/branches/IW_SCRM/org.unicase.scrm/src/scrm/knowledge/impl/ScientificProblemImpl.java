...
public class ScientificProblemImpl extends SCRMModelElementImpl implements
	 ...
	 * @ordered
	 */
	protected EList<Model> representingModel;
	 ...
	 * @ordered
	 */
	protected EList<Method> solvingMethods;
	 ...
	 * @generated
	 */
	public EList<Model> getRepresentingModel() {
		if (representingModel == null) {
			representingModel = new EObjectWithInverseResolvingEList<Model>(
					Model.class, this,
	 ...
	 * @generated
	 */
	public EList<Method> getSolvingMethods() {
		if (solvingMethods == null) {
			solvingMethods = new EObjectWithInverseResolvingEList<Method>(
					Method.class, this,
	...
	public void eSet(int featureID, Object newValue) {
		...
		case KnowledgePackage.SCIENTIFIC_PROBLEM__REPRESENTING_MODEL:
			...
			getRepresentingModel().addAll(
					(Collection<? extends Model>) newValue);
			return;
		case KnowledgePackage.SCIENTIFIC_PROBLEM__SOLVING_METHODS:
			getSolvingMethods().clear();
			getSolvingMethods().addAll((Collection<? extends Method>) newValue);
			return;
		case KnowledgePackage.SCIENTIFIC_PROBLEM__INFLUENCED_FEATURE:
