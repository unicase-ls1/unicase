 ...
 *   <li>{@link scrm.requirements.impl.FeatureImpl#getComputationalHardware <em>Computational Hardware</em>}</li>
...
public class FeatureImpl extends SCRMModelElementImpl implements Feature {
	...
	/**
	 * The cached value of the '{@link #getSubFeatures() <em>Sub Features</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSubFeatures()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getSuperFeature() <em>Super Feature</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getSuperFeature()
	 * @generated
	 * @ordered
	 */
	protected EList<Feature> superFeature;
	...
	/**
	 * The cached value of the '{@link #getComputationalHardware() <em>Computational Hardware</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getComputationalHardware()
	 * @generated
	 * @ordered
	 */
	protected EList<ComputionalHardware> computationalHardware;
	...
	protected FeatureImpl() {
		super();
		description = "Shortly describe the desired feature here (e.g. Heat Balance Simulation, Automatically Scheduling and etc.).";
	}
	...
	public EList<Constraint> getConstraints() {
		if (constraints == null) {
			constraints = new EObjectWithInverseResolvingEList<Constraint>(
					Constraint.class, this,
					RequirementsPackage.FEATURE__CONSTRAINTS,
	 ...
	 * @generated
	 */
	public EList<ComputionalHardware> getComputationalHardware() {
		if (computationalHardware == null) {
			computationalHardware = new EObjectWithInverseResolvingEList<ComputionalHardware>(
					ComputionalHardware.class, this,
					RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE,
					RequirementsPackage.COMPUTIONAL_HARDWARE__DEPENDING_FEATURE);
		}
		return computationalHardware;
	}
	...
	public EList<Interface> getRequiredInterfaces() {
		if (requiredInterfaces == null) {
			requiredInterfaces = new EObjectWithInverseResolvingEList.ManyInverse<Interface>(
					Interface.class, this,
					RequirementsPackage.FEATURE__REQUIRED_INTERFACES,
					RequirementsPackage.INTERFACE__REQUIRING_FEATURES);
		}
	...
	public EList<Interface> getProvidedInterfaces() {
		if (providedInterfaces == null) {
			providedInterfaces = new EObjectWithInverseResolvingEList.ManyInverse<Interface>(
					Interface.class, this,
					RequirementsPackage.FEATURE__PROVIDED_INTERFACES,
					RequirementsPackage.INTERFACE__PROVIDING_FEATURES);
		}
	...
	public EList<Requirement> getDetailedRequirements() {
		if (detailedRequirements == null) {
			detailedRequirements = new EObjectContainmentWithInverseEList.Resolving<Requirement>(
			...
			if (influencingProblem != oldInfluencingProblem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							RequirementsPackage.FEATURE__INFLUENCING_PROBLEM,
							oldInfluencingProblem, influencingProblem));
			}
		}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetInfluencingProblem(
			ScientificProblem newInfluencingProblem, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					RequirementsPackage.FEATURE__INFLUENCING_PROBLEM,
					oldInfluencingProblem, newInfluencingProblem);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setInfluencingProblem(ScientificProblem newInfluencingProblem) {
		if (newInfluencingProblem != influencingProblem) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					RequirementsPackage.FEATURE__INFLUENCING_PROBLEM,
					newInfluencingProblem, newInfluencingProblem));
	}
	...
	public EList<Feature> getSubFeatures() {
		if (subFeatures == null) {
			subFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
	 ...
	 * @generated
	 */
	public EList<Feature> getSuperFeature() {
		if (superFeature == null) {
			superFeature = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.FEATURE__SUPER_FEATURE,
					RequirementsPackage.FEATURE__SUB_FEATURES);
		}
	...
	public EList<Feature> getRequiredFeatures() {
		if (requiredFeatures == null) {
			requiredFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.FEATURE__REQUIRED_FEATURES,
					RequirementsPackage.FEATURE__REQUIRING_FEATURES);
		}
	...
	public EList<Feature> getExcludedFeatures() {
		if (excludedFeatures == null) {
			excludedFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.FEATURE__EXCLUDED_FEATURES,
					RequirementsPackage.FEATURE__EXCLUDING_FEATURES);
		}
	...
	public EList<Feature> getExcludingFeatures() {
		if (excludingFeatures == null) {
			excludingFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.FEATURE__EXCLUDING_FEATURES,
					RequirementsPackage.FEATURE__EXCLUDED_FEATURES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		case RequirementsPackage.FEATURE__DETAILED_REQUIREMENTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDetailedRequirements())
		...
		case RequirementsPackage.FEATURE__SUPER_FEATURE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getSuperFeature())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.FEATURE__CONSTRAINTS:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getConstraints())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getComputationalHardware())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.FEATURE__REQUIRED_INTERFACES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getRequiredInterfaces())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.FEATURE__PROVIDED_INTERFACES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getProvidedInterfaces())
					.basicAdd(otherEnd, msgs);
			...
			if (influencingProblem != null)
				msgs = ((InternalEObject) influencingProblem)
						.eInverseRemove(
								...
								KnowledgePackage.SCIENTIFIC_PROBLEM__INFLUENCED_FEATURE,
								ScientificProblem.class, msgs);
			return basicSetInfluencingProblem((ScientificProblem) otherEnd,
					msgs);
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case RequirementsPackage.FEATURE__DETAILED_REQUIREMENTS:
			return ((InternalEList<?>) getDetailedRequirements()).basicRemove(
					otherEnd, msgs);
		case RequirementsPackage.FEATURE__SUB_FEATURES:
			return ((InternalEList<?>) getSubFeatures()).basicRemove(otherEnd,
					msgs);
		case RequirementsPackage.FEATURE__SUPER_FEATURE:
			return ((InternalEList<?>) getSuperFeature()).basicRemove(otherEnd,
					msgs);
		case RequirementsPackage.FEATURE__CONSTRAINTS:
			return ((InternalEList<?>) getConstraints()).basicRemove(otherEnd,
					msgs);
		case RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE:
			return ((InternalEList<?>) getComputationalHardware()).basicRemove(
					otherEnd, msgs);
		case RequirementsPackage.FEATURE__REQUIRED_INTERFACES:
			return ((InternalEList<?>) getRequiredInterfaces()).basicRemove(
					otherEnd, msgs);
		case RequirementsPackage.FEATURE__PROVIDED_INTERFACES:
			return ((InternalEList<?>) getProvidedInterfaces()).basicRemove(
					otherEnd, msgs);
		case RequirementsPackage.FEATURE__INFLUENCING_PROBLEM:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE:
			return getComputationalHardware();
		case RequirementsPackage.FEATURE__REQUIRED_INTERFACES:
	...
	public void eSet(int featureID, Object newValue) {
		...
		case RequirementsPackage.FEATURE__DETAILED_REQUIREMENTS:
			...
			getDetailedRequirements().addAll(
		...
		case RequirementsPackage.FEATURE__SUB_FEATURES:
			...
			return;
		case RequirementsPackage.FEATURE__SUPER_FEATURE:
			getSuperFeature().clear();
			getSuperFeature().addAll((Collection<? extends Feature>) newValue);
			return;
		case RequirementsPackage.FEATURE__CONSTRAINTS:
			...
			return;
		case RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE:
			getComputationalHardware().clear();
			getComputationalHardware().addAll(
					(Collection<? extends ComputionalHardware>) newValue);
			return;
		case RequirementsPackage.FEATURE__REQUIRED_INTERFACES:
			getRequiredInterfaces().clear();
			getRequiredInterfaces().addAll(
					(Collection<? extends Interface>) newValue);
			return;
		case RequirementsPackage.FEATURE__PROVIDED_INTERFACES:
			getProvidedInterfaces().clear();
			getProvidedInterfaces().addAll(
					(Collection<? extends Interface>) newValue);
			return;
		case RequirementsPackage.FEATURE__INFLUENCING_PROBLEM:
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
		case RequirementsPackage.FEATURE__DETAILED_REQUIREMENTS:
			return detailedRequirements != null
					&& !detailedRequirements.isEmpty();
		case RequirementsPackage.FEATURE__SUB_FEATURES:
			return subFeatures != null && !subFeatures.isEmpty();
		case RequirementsPackage.FEATURE__SUPER_FEATURE:
			return superFeature != null && !superFeature.isEmpty();
		case RequirementsPackage.FEATURE__CONSTRAINTS:
			return constraints != null && !constraints.isEmpty();
		case RequirementsPackage.FEATURE__COMPUTATIONAL_HARDWARE:
			return computationalHardware != null
					&& !computationalHardware.isEmpty();
		case RequirementsPackage.FEATURE__REQUIRED_INTERFACES:
