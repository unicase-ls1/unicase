 ...
 * <ul>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getProvidingFeatures <em>Providing Features</em>}</li>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getRequiringFeatures <em>Requiring Features</em>}</li>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getProvidingData <em>Providing Data</em>}</li>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getRequiringData <em>Requiring Data</em>}</li>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getDetailsOfProvidingFunctionsAndProperties <em>Details Of Providing Functions And Properties</em>}</li>
 *   <li>{@link scrm.requirements.impl.HardwareInterfaceImpl#getDetailsOfRequiringFunctionsAndProperties <em>Details Of Requiring Functions And Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class HardwareInterfaceImpl extends SCRMModelElementImpl implements
		HardwareInterface {
	/**
	...
	protected HardwareInterfaceImpl() {
		super();
		description = "Specify what devices (e.g. sensors) are supported and how, for example, based on what protocols";
	}
	...
	protected EClass eStaticClass() {
		return RequirementsPackage.Literals.HARDWARE_INTERFACE;
	}
	...
	public EList<Feature> getProvidingFeatures() {
		if (providingFeatures == null) {
			providingFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.HARDWARE_INTERFACE__PROVIDING_FEATURES,
	...
	public EList<Feature> getRequiringFeatures() {
		if (requiringFeatures == null) {
			requiringFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(
					Feature.class, this,
					RequirementsPackage.HARDWARE_INTERFACE__REQUIRING_FEATURES,
	...
	public EList<Data> getProvidingData() {
		if (providingData == null) {
			providingData = new EObjectWithInverseResolvingEList<Data>(
					Data.class, this,
					RequirementsPackage.HARDWARE_INTERFACE__PROVIDING_DATA,
	...
	public EList<Data> getRequiringData() {
		if (requiringData == null) {
			requiringData = new EObjectWithInverseResolvingEList<Data>(
					Data.class, this,
					RequirementsPackage.HARDWARE_INTERFACE__REQUIRING_DATA,
	...
	public EList<Requirement> getDetailsOfProvidingFunctionsAndProperties() {
		if (detailsOfProvidingFunctionsAndProperties == null) {
			detailsOfProvidingFunctionsAndProperties = new EObjectWithInverseResolvingEList<Requirement>(
					Requirement.class,
					this,
					RequirementsPackage.HARDWARE_INTERFACE__DETAILS_OF_PROVIDING_FUNCTIONS_AND_PROPERTIES,
	...
	public EList<Requirement> getDetailsOfRequiringFunctionsAndProperties() {
		if (detailsOfRequiringFunctionsAndProperties == null) {
			detailsOfRequiringFunctionsAndProperties = new EObjectWithInverseResolvingEList<Requirement>(
					Requirement.class,
					this,
					RequirementsPackage.HARDWARE_INTERFACE__DETAILS_OF_REQUIRING_FUNCTIONS_AND_PROPERTIES,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd,
		...
		switch (featureID) {
		case RequirementsPackage.HARDWARE_INTERFACE__PROVIDING_FEATURES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getProvidingFeatures())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.HARDWARE_INTERFACE__REQUIRING_FEATURES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getRequiringFeatures())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.HARDWARE_INTERFACE__PROVIDING_DATA:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getProvidingData())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.HARDWARE_INTERFACE__REQUIRING_DATA:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getRequiringData())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.HARDWARE_INTERFACE__DETAILS_OF_PROVIDING_FUNCTIONS_AND_PROPERTIES:
			return ((InternalEList<InternalEObject>) (InternalEList<?>) getDetailsOfProvidingFunctionsAndProperties())
					.basicAdd(otherEnd, msgs);
		case RequirementsPackage.HARDWARE_INTERFACE__DETAILS_OF_REQUIRING_FUNCTIONS_AND_PROPERTIES:
