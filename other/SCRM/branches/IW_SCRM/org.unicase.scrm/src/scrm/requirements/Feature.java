 ...
 *   <li>{@link scrm.requirements.Feature#getComputationalHardware <em>Computational Hardware</em>}</li>
...
public interface Feature extends IRequirement {
	...
	/**
	 * Returns the value of the '<em><b>Computational Hardware</b></em>' reference list.
	 * The list contents are of type {@link scrm.requirements.ComputionalHardware}.
	 * It is bidirectional and its opposite is '{@link scrm.requirements.ComputionalHardware#getDependingFeature <em>Depending Feature</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Computational Hardware</em>' reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Computational Hardware</em>' reference list.
	 * @see scrm.requirements.RequirementsPackage#getFeature_ComputationalHardware()
	 * @see scrm.requirements.ComputionalHardware#getDependingFeature
	 * @model opposite="dependingFeature"
	 *        annotation="org.unicase.ui.meeditor position='left' priority='26'"
	 * @generated
	 */
	EList<ComputionalHardware> getComputationalHardware();
