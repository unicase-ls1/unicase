...
public class RequirementsSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RequirementsPackage.COMPUTIONAL_HARDWARE: {
			ComputionalHardware computionalHardware = (ComputionalHardware) theEObject;
			T result = caseComputionalHardware(computionalHardware);
			if (result == null)
				result = caseIRequirement(computionalHardware);
			if (result == null)
				result = caseSCRMModelElement(computionalHardware);
			if (result == null)
				result = caseUnicaseModelElement(computionalHardware);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case RequirementsPackage.HARDWARE_INTERFACE: {
			...
			if (result == null)
				result = caseInterface(hardwareInterface);
			if (result == null)
				result = caseIRequirement(hardwareInterface);
			if (result == null)
				result = caseSCRMModelElement(hardwareInterface);
			if (result == null)
				result = caseUnicaseModelElement(hardwareInterface);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case RequirementsPackage.REGULATORY_POLICY: {
			RegulatoryPolicy regulatoryPolicy = (RegulatoryPolicy) theEObject;
			T result = caseRegulatoryPolicy(regulatoryPolicy);
			if (result == null)
				result = caseConstraint(regulatoryPolicy);
			if (result == null)
				result = caseIRequirement(regulatoryPolicy);
			if (result == null)
				result = caseSCRMModelElement(regulatoryPolicy);
			if (result == null)
				result = caseUnicaseModelElement(regulatoryPolicy);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Computional Hardware</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Computional Hardware</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseComputionalHardware(ComputionalHardware object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Regulatory Policy</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Regulatory Policy</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRegulatoryPolicy(RegulatoryPolicy object) {
		return null;
	}
