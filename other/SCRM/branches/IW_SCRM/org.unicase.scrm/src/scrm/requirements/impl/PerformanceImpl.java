...
public class PerformanceImpl extends RequirementImpl implements Performance {
	 ...
	 * @ordered
	 */
	protected ComputionalHardware hardware;
	 ...
	 * @generated
	 */
	public ComputionalHardware getHardware() {
		if (hardware != null && hardware.eIsProxy()) {
			InternalEObject oldHardware = (InternalEObject) hardware;
			hardware = (ComputionalHardware) eResolveProxy(oldHardware);
	 ...
	 * @generated
	 */
	public ComputionalHardware basicGetHardware() {
		return hardware;
	}
	 ...
	 * @generated
	 */
	public void setHardware(ComputionalHardware newHardware) {
		ComputionalHardware oldHardware = hardware;
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case RequirementsPackage.PERFORMANCE__HARDWARE:
			setHardware((ComputionalHardware) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case RequirementsPackage.PERFORMANCE__HARDWARE:
			setHardware((ComputionalHardware) null);
			return;
		}
