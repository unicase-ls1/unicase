...
public class RequirementsPackageImpl extends EPackageImpl implements
	 ...
	 * @generated
	 */
	private EClass computionalHardwareEClass = null;
	 ...
	 * @generated
	 */
	private EClass regulatoryPolicyEClass = null;
	 ...
	 * @generated
	 */
	public EReference getFeature_ComputationalHardware() {
	 ...
	 * @generated
	 */
	public EClass getComputionalHardware() {
		return computionalHardwareEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getComputionalHardware_DependingFeature() {
		return (EReference) computionalHardwareEClass.getEStructuralFeatures()
				.get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComputionalHardware_Processor() {
		return (EAttribute) computionalHardwareEClass.getEStructuralFeatures()
				.get(1);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComputionalHardware_Platform() {
		return (EAttribute) computionalHardwareEClass.getEStructuralFeatures()
				.get(2);
	}
	 ...
	 * @generated
	 */
	public EAttribute getComputionalHardware_Memory() {
		return (EAttribute) computionalHardwareEClass.getEStructuralFeatures()
				.get(3);
	}
	 ...
	 * @generated
	 */
	public EAttribute getSoftwareInterface_Version() {
	 ...
	 * @generated
	 */
	public EClass getRegulatoryPolicy() {
		return regulatoryPolicyEClass;
	}
	...
	public void createPackageContents() {
		...
		createEReference(featureEClass, FEATURE__COMPUTATIONAL_HARDWARE);
		...
		computionalHardwareEClass = createEClass(COMPUTIONAL_HARDWARE);
		createEReference(computionalHardwareEClass,
				COMPUTIONAL_HARDWARE__DEPENDING_FEATURE);
		createEAttribute(computionalHardwareEClass,
				COMPUTIONAL_HARDWARE__PROCESSOR);
		createEAttribute(computionalHardwareEClass,
				COMPUTIONAL_HARDWARE__PLATFORM);
		createEAttribute(computionalHardwareEClass,
				COMPUTIONAL_HARDWARE__MEMORY);
		...
		createEAttribute(softwareInterfaceEClass, SOFTWARE_INTERFACE__VERSION);
		...
		regulatoryPolicyEClass = createEClass(REGULATORY_POLICY);
	}
	...
	public void initializePackageContents() {
		...
		computionalHardwareEClass.getESuperTypes().add(this.getIRequirement());
		...
		hardwareInterfaceEClass.getESuperTypes().add(this.getInterface());
		regulatoryPolicyEClass.getESuperTypes().add(this.getConstraint());
		...
		initEReference(getInterface_ProvidingData(),
				theDataObjectPackage.getData(),
				theDataObjectPackage.getData_ProvidedInterface(),
				"providingData", null, 0, -1, Interface.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getInterface_RequiringData(),
				theDataObjectPackage.getData(),
				theDataObjectPackage.getData_RequiredInterface(),
		...
		initEReference(getRequirement_HandlingData(),
				theDataObjectPackage.getData(),
				theDataObjectPackage.getData_DefinedRequirement(),
				"handlingData", null, 0, -1, Requirement.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRequirement_RealizedMethod(),
				theKnowledgePackage.getMethod(),
				theKnowledgePackage.getMethod_RealizingRequirement(),
		...
		initEReference(getRequirement_RequiredInterface(), this.getInterface(),
				...
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getRequirement_Mandatory(),
				theEcorePackage.getEBoolean(), "mandatory", "true", 0, 1,
		...
		initEReference(getFeature_Constraints(), this.getConstraint(),
				...
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getFeature_ComputationalHardware(),
				this.getComputionalHardware(),
				this.getComputionalHardware_DependingFeature(),
				"computationalHardware", null, 0, -1, Feature.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(computionalHardwareEClass, ComputionalHardware.class,
				"ComputionalHardware", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getComputionalHardware_DependingFeature(),
				this.getFeature(), this.getFeature_ComputationalHardware(),
				"dependingFeature", null, 0, 1, ComputionalHardware.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getComputionalHardware_Processor(),
				ecorePackage.getEString(), "processor", null, 0, 1,
				ComputionalHardware.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getComputionalHardware_Platform(),
				ecorePackage.getEString(), "platform", null, 0, 1,
				ComputionalHardware.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getComputionalHardware_Memory(),
				theEcorePackage.getEString(), "memory", null, 0, 1,
				ComputionalHardware.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEClass(softwareInterfaceEClass, SoftwareInterface.class,
				...
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSoftwareInterface_Version(),
				theEcorePackage.getEString(), "version", "1.0.x", 0, 1,
		...
		initEClass(performanceEClass, Performance.class, "Performance",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPerformance_Hardware(),
				this.getComputionalHardware(), null, "hardware", null, 0, 1,
				Performance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(hardwareInterfaceEClass, HardwareInterface.class,
				"HardwareInterface", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(regulatoryPolicyEClass, RegulatoryPolicy.class,
				"RegulatoryPolicy", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
	...
	protected void createOrgAnnotations() {
		...
		addAnnotation(getRequirement_RequiredInterface(), source, new String[] {
				"position", "left", "priority", "20" });
		addAnnotation(getRequirement_Mandatory(), source, new String[] {
				"position", "left", "priority", "4" });
		...
		addAnnotation(getFeature_ComputationalHardware(), source, new String[] {
				"position", "left", "priority", "26" });
		...
		addAnnotation(getComputionalHardware_DependingFeature(), source,
				new String[] { "position", "left", "priority", "15" });
		addAnnotation(getComputionalHardware_Processor(), source, new String[] {
				"position", "left", "priority", "5" });
		addAnnotation(getComputionalHardware_Platform(), source, new String[] {
				"position", "left", "priority", "6" });
		addAnnotation(getComputionalHardware_Memory(), source, new String[] {
