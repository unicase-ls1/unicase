...
public class ScrmViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		return MathematicalModelEditPart.VISUAL_ID == visualID || NumericalMethodEditPart.VISUAL_ID == visualID;
	}
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		switch (visualID) {
		case MathematicalModelEditPart.VISUAL_ID:
			return createMathematicalModel_2001(domainElement, containerView, index, persisted, preferencesHint);
		case NumericalMethodEditPart.VISUAL_ID:
			return createNumericalMethod_2002(domainElement, containerView, index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		case NumericalMethodMathematicalModelEditPart.VISUAL_ID:
			return createNumericalMethodMathematicalModel_4003(containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createMathematicalModel_2001(EObject domainElement, View containerView, int index, boolean persisted,
	 ...
	 * @generated
	 */
	public Node createNumericalMethod_2002(EObject domainElement, View containerView, int index, boolean persisted,
		PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles().add(NotationFactory.eINSTANCE.createDescriptionStyle());
		node.getStyles().add(NotationFactory.eINSTANCE.createLineStyle());
	 ...
	 * @generated
	 */
	public Edge createNumericalMethodMathematicalModel_4003(View containerView, int index, boolean persisted,
		PreferencesHint preferencesHint) {
		...
		edge.setType(ScrmVisualIDRegistry.getType(NumericalMethodMathematicalModelEditPart.VISUAL_ID));
