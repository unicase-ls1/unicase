 ...
 * @generated
 */
public class ScrmParserProvider extends AbstractProvider implements IParserProvider {
	...
	private IParser getScientificProblemName_5003Parser() {
		if (scientificProblemName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { ScrmPackage.eINSTANCE.getSCRMModelElement_Name() };
	...
	private IParser getScientificProblemDescription_5019Parser() {
		if (scientificProblemDescription_5019Parser == null) {
			EAttribute[] features = new EAttribute[] { ScrmPackage.eINSTANCE.getSCRMModelElement_Description() };
			MessageFormatParser parser = new MessageFormatParser(features);
