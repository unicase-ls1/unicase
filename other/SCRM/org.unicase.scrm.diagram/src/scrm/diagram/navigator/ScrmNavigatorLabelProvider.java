...
public class ScrmNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	private String getScientificProblem_2007Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificProblem_2007,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
				.getType(ScientificProblemNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getMathematicalModel_2005Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModel_2005,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5001); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getNumericalMethod_2006Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.NumericalMethod_2006,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getAssumption_2008Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Assumption_2008,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeature_2009Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Feature_2009, view.getElement() != null ? view
			.getElement() : view, ScrmVisualIDRegistry.getType(FeatureDescriptionNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getHardware_2010Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Hardware_2010, view.getElement() != null ? view
			.getElement() : view, ScrmVisualIDRegistry.getType(HardwareDescriptionNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5006); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getConstraint_2011Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Constraint_2011,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5007); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getUserInterface_2012Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.UserInterface_2012,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5008); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getSoftwareInterface_2013Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.SoftwareInterface_2013,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5009); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getProcess_2014Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Process_2014, view.getElement() != null ? view
			.getElement() : view, ScrmVisualIDRegistry.getType(ProcessDescriptionNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getPerformance_2015Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Performance_2015,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5011); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDataFlow_2016Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.DataFlow_2016, view.getElement() != null ? view
			.getElement() : view, ScrmVisualIDRegistry.getType(DataFlowDescriptionNameEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5012); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDataDefinition_2017Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.DataDefinition_2017,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5013); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getInputDataReading_2018Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.InputDataReading_2018,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5014); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getDataHandling_2019Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.DataHandling_2019,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5015); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getResultsOutput_2020Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ResultsOutput_2020,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5016); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getErrorHandling_2021Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ErrorHandling_2021,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5017); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getStatusMonitoring_2022Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.StatusMonitoring_2022,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5018); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getScientificKnowledgeRequirements_4005Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificKnowledgeRequirements_4005, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
			.getType(WrappingLabelEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6003); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getScientificProblemRepresentingModel_4006Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificProblemRepresentingModel_4006, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6004); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getScientificProblemSolvingMethod_4007Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificProblemSolvingMethod_4007, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6005); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getScientificProblemInfluencedFeature_4008Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificProblemInfluencedFeature_4008, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6006); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getMathematicalModel_4004Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModel_4004,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getMathematicalModel_4010Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModel_4010,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6008); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getMathematicalModelNumericalMethods_4011Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModelNumericalMethods_4011, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6009); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getMathematicalModelDependencies_4012Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModelDependencies_4012, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6010); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getNumericalMethodDependencies_4015Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.NumericalMethodDependencies_4015, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6013); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getNumericalMethodRealizingRequirement_4016Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.NumericalMethodRealizingRequirement_4016, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6014); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getNumericalMethodPerformance_4017Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.NumericalMethodPerformance_4017, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6015); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureRequiredInterfaces_4023Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureRequiredInterfaces_4023, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6021); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureProvidedInterfaces_4024Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureProvidedInterfaces_4024, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6022); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureConstraints_4025Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureConstraints_4025,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6023); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureDependencies_4026Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureDependencies_4026,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6024); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureDetailedRequirements_4027Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureDetailedRequirements_4027, view
			.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6025); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeature_4029Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Feature_4029, view.getElement() != null ? view
			.getElement() : view, ScrmVisualIDRegistry.getType(WrappingLabel17EditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view),
				ParserOptions.NONE.intValue());
		} else {
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6027); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureRequiredFeatures_4030Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureRequiredFeatures_4030,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6028); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getFeatureExcludedFeatures_4032Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureExcludedFeatures_4032,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6030); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getRequirement_4036Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.Requirement_4036,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6034); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getRequirementDefiningData_4038Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.RequirementDefiningData_4038,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6036); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
	...
	private String getProcessDataFlow_4040Text(View view) {
		IParser parser = ScrmParserProvider.getParser(ScrmElementTypes.ProcessDataFlow_4040,
			view.getElement() != null ? view.getElement() : view, ScrmVisualIDRegistry
		...
		if (parser != null) {
			...
			ScrmDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 6038); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
