 ...
 * @generated
 */
public class ScientificProblemSolvingMethodReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ScientificProblemSolvingMethodReorientCommand(
	...
	protected boolean canReorientSource() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints
				.canExistScientificProblemSolvingMethod_4007(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints
				.canExistScientificProblemSolvingMethod_4007(getOldSource(),
						getNewTarget());
	}
