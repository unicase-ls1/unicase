...
public class Feature2CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	private final Feature container;

	/**
	 * @generated
	 */
	public Feature2CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints.canCreateFeature_4029(getContainer(), getSource(),
			getTarget());
	}
	 ...
	 * @generated
	 */
	private static Feature deduceContainer(EObject source, EObject target) {
