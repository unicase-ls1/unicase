 ...
 * @generated
 */
public class RequirementSpecifiedFeatureReorientCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public RequirementSpecifiedFeatureReorientCommand(
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Feature && newEnd instanceof Requirement)) {
			return false;
		}
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementSpecifiedFeature_4052(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistRequirementSpecifiedFeature_4052(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setSpecifiedFeature(null);
		getNewSource().setSpecifiedFeature(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setSpecifiedFeature(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
