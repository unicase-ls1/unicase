 ...
 * @generated
 */
public class NumericalMethodMathematicalModelCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NumericalMethodMathematicalModelCreateCommand(CreateRelationshipRequest request, EObject source,
		EObject target) {
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints.canCreateNumericalMethodMathematicalModel_4003(
			getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setMathematicalModel(getTarget());
		}
