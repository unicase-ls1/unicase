 ...
 * @generated
 */
public class FeatureConstraintsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureConstraintsCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints
			.canCreateFeatureConstraints_4025(getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getConstraints().add(getTarget());
		}
