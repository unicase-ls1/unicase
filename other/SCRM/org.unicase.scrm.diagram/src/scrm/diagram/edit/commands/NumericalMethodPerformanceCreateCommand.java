...
public class NumericalMethodPerformanceCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public NumericalMethodPerformanceCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints.canCreateNumericalMethodPerformance_4017(getSource(),
			getTarget());
	}
