 ...
 * @generated
 */
public class MathematicalModel3CreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public MathematicalModel3CreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.LinkConstraints.canCreateMathematicalModel_4010(getContainer(),
			getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		getContainer().getSubMathematicalModels().add(newElement);
		newElement.setSuperMathematicalModel(getSource());
		newElement.getSubMathematicalModels().add(getTarget());
