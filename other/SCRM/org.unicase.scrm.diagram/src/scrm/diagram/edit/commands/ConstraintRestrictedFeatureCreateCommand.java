 ...
 * @generated
 */
public class ConstraintRestrictedFeatureCreateCommand extends
		EditElementCommand {
	 ...
	 * @generated
	 */
	public ConstraintRestrictedFeatureCreateCommand(
	...
	public boolean canExecute() {
		...
		return ScrmBaseItemSemanticEditPolicy.getLinkConstraints()
				.canCreateConstraintRestrictedFeature_4051(getSource(),
						getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		if (getSource() != null && getTarget() != null) {
			getSource().setRestrictedFeature(getTarget());
		}
