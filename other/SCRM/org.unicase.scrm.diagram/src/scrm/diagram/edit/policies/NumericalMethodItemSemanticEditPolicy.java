 ...
 * @generated
 */
public class NumericalMethodItemSemanticEditPolicy extends ScrmBaseItemSemanticEditPolicy {
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ScrmElementTypes.ScientificProblemSolvingMethod_4007 == req.getElementType()) {
			return null;
		}
		if (ScrmElementTypes.MathematicalModelNumericalMethods_4011 == req.getElementType()) {
			return null;
		}
		if (ScrmElementTypes.NumericalMethodDependencies_4015 == req.getElementType()) {
			return getGEFWrapper(new NumericalMethodDependenciesCreateCommand(req, req.getSource(), req.getTarget()));
		}
		...
		if (ScrmElementTypes.NumericalMethodPerformance_4017 == req.getElementType()) {
			return getGEFWrapper(new NumericalMethodPerformanceCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getCompleteCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ScrmElementTypes.ScientificProblemSolvingMethod_4007 == req.getElementType()) {
			return getGEFWrapper(new ScientificProblemSolvingMethodCreateCommand(req, req.getSource(), req.getTarget()));
		}
		if (ScrmElementTypes.MathematicalModelNumericalMethods_4011 == req.getElementType()) {
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case ScientificProblemSolvingMethodEditPart.VISUAL_ID:
			return getGEFWrapper(new ScientificProblemSolvingMethodReorientCommand(req));
		...
		case NumericalMethodDependenciesEditPart.VISUAL_ID:
			return getGEFWrapper(new NumericalMethodDependenciesReorientCommand(req));
		...
		case NumericalMethodPerformanceEditPart.VISUAL_ID:
			return getGEFWrapper(new NumericalMethodPerformanceReorientCommand(req));
		}
