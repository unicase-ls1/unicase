 ...
 * @generated
 */
public class DataProcessSpaceDataProcessSpaceCompartment2CanonicalEditPolicy
	...
	protected EStructuralFeature getFeatureToSynchronize() {
		return scrm.requirements.dataProcess.DataProcessPackage.eINSTANCE
	...
	protected List getSemanticChildrenList() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getDataProcessSpaceDataProcessSpaceCompartment_7006SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<ScrmNodeDescriptor> childDescriptors = ScrmDiagramUpdater
				.getDataProcessSpaceDataProcessSpaceCompartment_7006SemanticChildren((View) getHost()
						.getModel());
