 ...
 * @generated
 */
public class ProcessItemSemanticEditPolicy extends ScrmBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ProcessItemSemanticEditPolicy() {
		super(ScrmElementTypes.Process_2014);
	}
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		...
		if (ScrmElementTypes.ProcessDataFlow_4040 == req.getElementType()) {
			return getGEFWrapper(new ProcessDataFlowCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
