 ...
 * @generated NOT
 */
public class MathematicalModelDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public MathematicalModelDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
