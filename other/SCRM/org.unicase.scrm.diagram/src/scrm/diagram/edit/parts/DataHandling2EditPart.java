...
public class DataHandling2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof DataHandlingDescription2EditPart) {
			((DataHandlingDescription2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof scrm.diagram.edit.parts.DataHandling2EditPart) {
			types.add(ScrmElementTypes.RequirementRefinedRequirement_4054);
		}
