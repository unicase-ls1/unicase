 ...
 * @generated
 */
public class UserInterfaceDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public UserInterfaceDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.UserInterfaceDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
