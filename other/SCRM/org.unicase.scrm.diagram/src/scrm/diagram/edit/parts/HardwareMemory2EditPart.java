 ...
 * @generated
 */
public class HardwareMemory2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareMemory2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareMemory2EditPart.VISUAL_ID));
		}
		return parser;
	}
