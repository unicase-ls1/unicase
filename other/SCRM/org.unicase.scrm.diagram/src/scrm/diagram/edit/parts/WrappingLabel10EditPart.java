...
public class WrappingLabel10EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(ScrmVisualIDRegistry
			.getType(scrm.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.NumericalMethodRealizingRequirement_4016,
				getParserElement(), ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.WrappingLabel10EditPart.VISUAL_ID));
		}
		return parser;
	}
