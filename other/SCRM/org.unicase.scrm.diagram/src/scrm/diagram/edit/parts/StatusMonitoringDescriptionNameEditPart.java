 ...
 * @generated
 */
public class StatusMonitoringDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public StatusMonitoringDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider
				.getParser(ScrmElementTypes.StatusMonitoring_2022, getParserElement(), ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.StatusMonitoringDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
