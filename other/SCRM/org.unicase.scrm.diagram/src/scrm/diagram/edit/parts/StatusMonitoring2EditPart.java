...
import scrm.diagram.edit.policies.StatusMonitoring2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class StatusMonitoring2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public StatusMonitoring2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new StatusMonitoring2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StatusMonitoringName2EditPart) {
			((StatusMonitoringName2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureStatusMonitoring_name());
			return true;
		}
		if (childEditPart instanceof StatusMonitoringDescription2EditPart) {
			((StatusMonitoringDescription2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof scrm.diagram.edit.parts.StatusMonitoring2EditPart) {
			types.add(ScrmElementTypes.RequirementRefinedRequirement_4054);
		}
