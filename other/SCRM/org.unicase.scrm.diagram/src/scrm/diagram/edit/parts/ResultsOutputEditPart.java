...
public class ResultsOutputEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ResultsOutputItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		ResultsOutputFigure figure = new ResultsOutputFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ResultsOutputDescriptionNameEditPart) {
			((ResultsOutputDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape()
				.getFigureResultsOutputLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(ResultsOutputDescriptionNameEditPart.VISUAL_ID));
	}
	...
	public List/*<org.eclipse.gmf.runtime.emf.type.core.IElementType>*/getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof scrm.diagram.edit.parts.ResultsOutputEditPart) {
			types.add(ScrmElementTypes.Requirement_4036);
		}
	 ...
	 * @generated
	 */
	public class ResultsOutputFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureResultsOutputLabel;
		...
		private void createContents() {
			...
			fFigureResultsOutputLabel = new WrappingLabel();
			fFigureResultsOutputLabel.setText("ResultsOutput");

			this.add(fFigureResultsOutputLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureResultsOutputLabel() {
			return fFigureResultsOutputLabel;
		}
