 ...
 * @generated
 */
public class ProcessDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProcessDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.Process_2014, getParserElement(),
				ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.ProcessDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
