 ...
 * @generated NOT
 */
public class DataFlowDescriptionEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataFlowDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataFlowDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
