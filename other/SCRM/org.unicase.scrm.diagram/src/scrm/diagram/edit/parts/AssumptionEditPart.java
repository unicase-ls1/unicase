...
public class AssumptionEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		AssumptionFigure figure = new AssumptionFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AssumptionDescriptionNameEditPart) {
			((AssumptionDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssumptionLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(AssumptionDescriptionNameEditPart.VISUAL_ID));
	}
	...
	public class AssumptionFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureAssumptionLabel;
		...
		private void createContents() {
			...
			fFigureAssumptionLabel = new WrappingLabel();
			fFigureAssumptionLabel.setText("");

			this.add(fFigureAssumptionLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureAssumptionLabel() {
			return fFigureAssumptionLabel;
		}
