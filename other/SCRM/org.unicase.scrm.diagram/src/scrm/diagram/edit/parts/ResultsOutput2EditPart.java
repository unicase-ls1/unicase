...
public class ResultsOutput2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ResultsOutputDescription2EditPart) {
			((ResultsOutputDescription2EditPart) childEditPart)
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof scrm.diagram.edit.parts.ResultsOutput2EditPart) {
			types.add(ScrmElementTypes.RequirementRefinedRequirement_4054);
		}
	...
	public class ResultsOutputFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			fFigureResultsOutput_name.setTextWrap(true);
			...
			fFigureResultsOutput_description.setTextWrap(true);
