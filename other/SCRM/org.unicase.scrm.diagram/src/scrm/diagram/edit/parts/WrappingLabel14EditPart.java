...
public class WrappingLabel14EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(ScrmVisualIDRegistry
			.getType(scrm.diagram.edit.parts.WrappingLabel14EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.FeatureConstraints_4025, getParserElement(),
				ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.WrappingLabel14EditPart.VISUAL_ID));
		}
		return parser;
	}
