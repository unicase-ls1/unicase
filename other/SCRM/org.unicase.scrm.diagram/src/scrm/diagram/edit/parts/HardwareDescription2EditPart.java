 ...
 * @generated
 */
public class HardwareDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
