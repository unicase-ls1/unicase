 ...
 * @generated
 */
public class DataDefinitionDescriptionNameEditPart extends CompartmentEditPart
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
