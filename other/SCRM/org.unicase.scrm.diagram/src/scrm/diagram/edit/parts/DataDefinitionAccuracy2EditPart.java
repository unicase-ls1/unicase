 ...
 * @generated
 */
public class DataDefinitionAccuracy2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DataDefinitionAccuracy2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionAccuracy2EditPart.VISUAL_ID));
		}
		return parser;
	}
