 ...
 * @generated NOT
 */
public class HardwareMemoryEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareMemoryEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareMemoryEditPart.VISUAL_ID));
		}
		return parser;
	}
