 ...
 * @generated NOT
 */
public class MathematicalModelTheoryEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public MathematicalModelTheoryEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelTheoryEditPart.VISUAL_ID));
		}
		return parser;
	}
