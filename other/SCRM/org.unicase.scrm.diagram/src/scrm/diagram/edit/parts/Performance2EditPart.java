...
public class Performance2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof PerformanceDescription2EditPart) {
			((PerformanceDescription2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigurePerformance_description());
			return true;
		}
		if (childEditPart instanceof PerformanceProblemSize2EditPart) {
			((PerformanceProblemSize2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
