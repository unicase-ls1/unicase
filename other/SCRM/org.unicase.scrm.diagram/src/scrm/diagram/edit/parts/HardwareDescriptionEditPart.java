 ...
 * @generated NOT
 */
public class HardwareDescriptionEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
