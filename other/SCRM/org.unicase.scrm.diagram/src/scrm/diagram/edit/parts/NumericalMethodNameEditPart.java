 ...
 * @generated NOT
 */
public class NumericalMethodNameEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NumericalMethodNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.NumericalMethodNameEditPart.VISUAL_ID));
		}
		return parser;
	}
