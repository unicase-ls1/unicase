 ...
 * @generated
 */
public class PerformanceDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PerformanceDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PerformanceDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
