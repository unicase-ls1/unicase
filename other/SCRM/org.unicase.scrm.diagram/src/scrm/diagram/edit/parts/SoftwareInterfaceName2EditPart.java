 ...
 * @generated
 */
public class SoftwareInterfaceName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SoftwareInterfaceName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SoftwareInterfaceName2EditPart.VISUAL_ID));
		}
		return parser;
	}
