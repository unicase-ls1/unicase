 ...
 * @generated
 */
public class KnowledgeSpace2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public KnowledgeSpace2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new KnowledgeSpace2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof KnowledgeSpaceName2EditPart) {
			((KnowledgeSpaceName2EditPart) childEditPart)
