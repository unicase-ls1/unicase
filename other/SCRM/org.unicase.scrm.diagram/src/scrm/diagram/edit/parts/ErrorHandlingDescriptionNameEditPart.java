 ...
 * @generated
 */
public class ErrorHandlingDescriptionNameEditPart extends CompartmentEditPart
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ErrorHandlingDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
