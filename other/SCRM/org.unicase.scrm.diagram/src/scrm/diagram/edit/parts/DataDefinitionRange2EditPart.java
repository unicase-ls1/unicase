 ...
 * @generated
 */
public class DataDefinitionRange2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataDefinitionRange2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionRange2EditPart.VISUAL_ID));
		}
		return parser;
	}
