 ...
 * @generated NOT
 */
public class HardwareProcessorEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareProcessorEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareProcessorEditPart.VISUAL_ID));
		}
		return parser;
	}
