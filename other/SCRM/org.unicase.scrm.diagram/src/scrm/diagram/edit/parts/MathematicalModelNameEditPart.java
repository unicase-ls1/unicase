 ...
 * @generated
 */
public class MathematicalModelNameEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MathematicalModelNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
