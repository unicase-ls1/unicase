 ...
 * @generated
 */
public class SoftwareInterfaceDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SoftwareInterfaceDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.SoftwareInterface_2013, getParserElement(),
				ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.SoftwareInterfaceDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
