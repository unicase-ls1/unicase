 ...
 * @generated
 */
public class MathematicalModelDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MathematicalModelDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
