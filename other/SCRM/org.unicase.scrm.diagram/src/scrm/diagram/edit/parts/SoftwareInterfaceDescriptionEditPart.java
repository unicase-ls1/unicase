 ...
 * @generated NOT
 */
public class SoftwareInterfaceDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public SoftwareInterfaceDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SoftwareInterfaceDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
