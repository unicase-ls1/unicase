 ...
 * @generated
 */
public class DataHandlingDescriptionNameEditPart extends CompartmentEditPart
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataHandlingDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
