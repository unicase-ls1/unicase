 ...
 * @generated
 */
public class HardwareProcessor2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public HardwareProcessor2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.HardwareProcessor2EditPart.VISUAL_ID));
		}
		return parser;
	}
