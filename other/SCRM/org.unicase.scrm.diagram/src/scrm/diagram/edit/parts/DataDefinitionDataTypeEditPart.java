 ...
 * @generated NOT
 */
public class DataDefinitionDataTypeEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public DataDefinitionDataTypeEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionDataTypeEditPart.VISUAL_ID));
		}
		return parser;
	}
