 ...
 * @generated
 */
public class SoftwareInterfaceDataTypes2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public SoftwareInterfaceDataTypes2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.SoftwareInterfaceDataTypes2EditPart.VISUAL_ID));
		}
		return parser;
	}
