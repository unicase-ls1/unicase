...
public class WrappingLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID),
			new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificKnowledgeRequirements_4005,
				getParserElement(), ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.WrappingLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
