 ...
 * @generated
 */
public class PerformanceDescriptionNameEditPart extends CompartmentEditPart
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PerformanceDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
