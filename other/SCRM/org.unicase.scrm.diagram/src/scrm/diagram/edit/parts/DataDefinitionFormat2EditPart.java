 ...
 * @generated
 */
public class DataDefinitionFormat2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DataDefinitionFormat2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionFormat2EditPart.VISUAL_ID));
		}
		return parser;
	}
