 ...
 * @generated NOT
 */
public class DataDefinitionFormatEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataDefinitionFormatEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionFormatEditPart.VISUAL_ID));
		}
		return parser;
	}
