 ...
 * @generated
 */
public class MathematicalModelName2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public MathematicalModelName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.MathematicalModelName2EditPart.VISUAL_ID));
		}
		return parser;
	}
