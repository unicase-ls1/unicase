 ...
 * @generated
 */
public class FeatureDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FeatureDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.FeatureDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
