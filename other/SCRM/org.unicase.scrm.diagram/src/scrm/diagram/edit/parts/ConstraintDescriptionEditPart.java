 ...
 * @generated NOT
 */
public class ConstraintDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public ConstraintDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ConstraintDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
