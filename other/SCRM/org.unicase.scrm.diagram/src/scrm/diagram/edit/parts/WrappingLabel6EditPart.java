...
public class WrappingLabel6EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
			ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.MathematicalModel_4010, getParserElement(),
				ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID));
		}
		return parser;
	}
