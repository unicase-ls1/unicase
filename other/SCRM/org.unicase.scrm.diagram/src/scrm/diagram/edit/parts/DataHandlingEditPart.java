...
public class DataHandlingEditPart extends ShapeNodeEditPart {
	...
	public class DataHandlingFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			GridData constraintFFigureDataHandling_name = new GridData();
			constraintFFigureDataHandling_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigureDataHandling_name.horizontalAlignment = GridData.CENTER;
			constraintFFigureDataHandling_name.horizontalIndent = 0;
			constraintFFigureDataHandling_name.horizontalSpan = 1;
			constraintFFigureDataHandling_name.verticalSpan = 1;
			constraintFFigureDataHandling_name.grabExcessHorizontalSpace = false;
			constraintFFigureDataHandling_name.grabExcessVerticalSpace = false;
			this.add(fFigureDataHandling_name,
					constraintFFigureDataHandling_name);
			...
			GridData constraintFFigureDataHandling_description = new GridData();
			constraintFFigureDataHandling_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigureDataHandling_description.horizontalAlignment = GridData.FILL;
			constraintFFigureDataHandling_description.horizontalIndent = 0;
			constraintFFigureDataHandling_description.horizontalSpan = 1;
			constraintFFigureDataHandling_description.verticalSpan = 1;
			constraintFFigureDataHandling_description.grabExcessHorizontalSpace = true;
			constraintFFigureDataHandling_description.grabExcessVerticalSpace = false;
			this.add(fFigureDataHandling_description,
					constraintFFigureDataHandling_description);
