...
public class DataHandlingEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new DataHandlingItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof DataHandlingDescriptionNameEditPart) {
			((DataHandlingDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape()
				.getFigureDataHandlingLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(DataHandlingDescriptionNameEditPart.VISUAL_ID));
	}
