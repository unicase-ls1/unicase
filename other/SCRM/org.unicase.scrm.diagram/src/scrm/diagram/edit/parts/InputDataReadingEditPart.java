...
public class InputDataReadingEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public class InputDataReadingFigure extends RoundedRectangle {
		...
		private void createContents() {
			...
			GridData constraintFFigureInputDataReading_name = new GridData();
			constraintFFigureInputDataReading_name.verticalAlignment = GridData.BEGINNING;
			constraintFFigureInputDataReading_name.horizontalAlignment = GridData.CENTER;
			constraintFFigureInputDataReading_name.horizontalIndent = 0;
			constraintFFigureInputDataReading_name.horizontalSpan = 1;
			constraintFFigureInputDataReading_name.verticalSpan = 1;
			constraintFFigureInputDataReading_name.grabExcessHorizontalSpace = false;
			constraintFFigureInputDataReading_name.grabExcessVerticalSpace = false;
			this.add(fFigureInputDataReading_name,
					constraintFFigureInputDataReading_name);

			fFigureInputDataReading_description = new WrappingLabel();
			fFigureInputDataReading_description.setText("");

			GridData constraintFFigureInputDataReading_description = new GridData();
			constraintFFigureInputDataReading_description.verticalAlignment = GridData.BEGINNING;
			constraintFFigureInputDataReading_description.horizontalAlignment = GridData.FILL;
			constraintFFigureInputDataReading_description.horizontalIndent = 0;
			constraintFFigureInputDataReading_description.horizontalSpan = 1;
			constraintFFigureInputDataReading_description.verticalSpan = 1;
			constraintFFigureInputDataReading_description.grabExcessHorizontalSpace = true;
			constraintFFigureInputDataReading_description.grabExcessVerticalSpace = false;
			this.add(fFigureInputDataReading_description,
					constraintFFigureInputDataReading_description);
