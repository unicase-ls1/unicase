...
public class InputDataReadingEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InputDataReadingItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		InputDataReadingFigure figure = new InputDataReadingFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputDataReadingDescriptionNameEditPart) {
			((InputDataReadingDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape()
				.getFigureInputDataReadingLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(InputDataReadingDescriptionNameEditPart.VISUAL_ID));
	}
	...
	public class InputDataReadingFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureInputDataReadingLabel;
		...
		private void createContents() {
			...
			fFigureInputDataReadingLabel = new WrappingLabel();
			fFigureInputDataReadingLabel.setText("InputDataReading");

			this.add(fFigureInputDataReadingLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureInputDataReadingLabel() {
			return fFigureInputDataReadingLabel;
		}
