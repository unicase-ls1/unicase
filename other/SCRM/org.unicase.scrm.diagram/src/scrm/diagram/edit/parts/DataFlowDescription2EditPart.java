 ...
 * @generated
 */
public class DataFlowDescription2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataFlowDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataFlowDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
