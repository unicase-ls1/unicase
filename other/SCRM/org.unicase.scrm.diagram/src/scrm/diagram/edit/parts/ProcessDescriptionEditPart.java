 ...
 * @generated NOT
 */
public class ProcessDescriptionEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ProcessDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ProcessDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
