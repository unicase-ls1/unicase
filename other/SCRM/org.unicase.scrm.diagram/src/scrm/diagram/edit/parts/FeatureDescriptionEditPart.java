 ...
 * @generated NOT
 */
public class FeatureDescriptionEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FeatureDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.FeatureDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
