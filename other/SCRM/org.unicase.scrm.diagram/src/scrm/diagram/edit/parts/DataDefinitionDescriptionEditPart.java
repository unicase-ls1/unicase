 ...
 * @generated NOT
 */
public class DataDefinitionDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public DataDefinitionDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
