 ...
 * @generated NOT
 */
public class StatusMonitoringDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public StatusMonitoringDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.StatusMonitoringDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
