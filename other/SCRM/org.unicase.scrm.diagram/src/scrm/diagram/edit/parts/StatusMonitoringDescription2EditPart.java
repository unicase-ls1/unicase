 ...
 * @generated
 */
public class StatusMonitoringDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public StatusMonitoringDescription2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.StatusMonitoringDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
