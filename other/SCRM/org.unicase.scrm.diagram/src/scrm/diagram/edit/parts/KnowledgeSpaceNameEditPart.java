 ...
 * @generated
 */
public class KnowledgeSpaceNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public KnowledgeSpaceNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.KnowledgeSpaceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
