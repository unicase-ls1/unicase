...
import scrm.diagram.edit.policies.InputDataReading2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class InputDataReading2EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public InputDataReading2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new InputDataReading2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof InputDataReadingName2EditPart) {
			((InputDataReadingName2EditPart) childEditPart)
