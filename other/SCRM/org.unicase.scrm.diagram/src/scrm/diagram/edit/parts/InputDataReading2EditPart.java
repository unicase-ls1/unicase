...
public class InputDataReading2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof InputDataReadingDescription2EditPart) {
			((InputDataReadingDescription2EditPart) childEditPart)
					.setLabel(getPrimaryShape()
	...
	public List<IElementType> getMARelTypesOnSourceAndTarget(
		...
		if (targetEditPart instanceof scrm.diagram.edit.parts.InputDataReading2EditPart) {
			types.add(ScrmElementTypes.RequirementRefinedRequirement_4054);
		}
