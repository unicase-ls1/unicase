 ...
 * @generated
 */
public class AssumptionName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public AssumptionName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.AssumptionName2EditPart.VISUAL_ID));
		}
		return parser;
	}
