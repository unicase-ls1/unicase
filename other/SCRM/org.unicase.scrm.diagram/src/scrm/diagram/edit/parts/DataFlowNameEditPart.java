 ...
 * @generated NOT
 */
public class DataFlowNameEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataFlowNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataFlowNameEditPart.VISUAL_ID));
		}
		return parser;
	}
