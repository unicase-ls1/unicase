 ...
 * @generated
 */
public class DataFlowDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataFlowDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.DataFlow_2016, getParserElement(),
				ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.DataFlowDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
