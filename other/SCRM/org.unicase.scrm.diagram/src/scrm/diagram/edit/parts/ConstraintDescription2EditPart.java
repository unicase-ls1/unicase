 ...
 * @generated
 */
public class ConstraintDescription2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ConstraintDescription2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider
					.getParser(
							ScrmElementTypes.Constraint_3006,
							getParserElement(),
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ConstraintDescription2EditPart.VISUAL_ID));
		}
		return parser;
	}
