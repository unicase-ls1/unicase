 ...
 * @generated NOT
 */
public class PerformanceNameEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PerformanceNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PerformanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
