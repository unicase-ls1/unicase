...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
			ScrmVisualIDRegistry.getType(scrm.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider.getParser(ScrmElementTypes.ScientificProblemSolvingMethod_4007,
				getParserElement(), ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID));
		}
		return parser;
	}
