...
public class NumericalMethodEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		NumMethodDescriptor figure = new NumMethodDescriptor();
	 ...
	 * @generated
	 */
	public NumMethodDescriptor getPrimaryShape() {
		return (NumMethodDescriptor) primaryShape;
	}
	 ...
	 * @generated
	 */
	public class NumMethodDescriptor extends Ellipse {

		/**
		 * @generated
		 */
		public NumMethodDescriptor() {
			this.setLineWidth(1);
	 ...
	 * @generated
	 */
	static final Font THIS_FONT = new Font(Display.getCurrent(), "Arial", 9, SWT.NORMAL);
