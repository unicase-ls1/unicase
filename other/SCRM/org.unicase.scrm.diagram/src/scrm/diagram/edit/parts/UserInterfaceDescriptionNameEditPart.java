 ...
 * @generated
 */
public class UserInterfaceDescriptionNameEditPart extends CompartmentEditPart
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.UserInterfaceDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
