 ...
 * @generated
 */
public class InputDataReadingDescriptionNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public InputDataReadingDescriptionNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScrmParserProvider
				.getParser(ScrmElementTypes.InputDataReading_2018, getParserElement(), ScrmVisualIDRegistry
					.getType(scrm.diagram.edit.parts.InputDataReadingDescriptionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
