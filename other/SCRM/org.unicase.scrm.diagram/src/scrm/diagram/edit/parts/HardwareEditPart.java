...
public class HardwareEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new HardwareItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		HardwareFigure figure = new HardwareFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof HardwareDescriptionNameEditPart) {
			((HardwareDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureHardwareLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(HardwareDescriptionNameEditPart.VISUAL_ID));
	}
	...
	public class HardwareFigure extends Ellipse {
		 ...
		 * @generated
		 */
		private WrappingLabel fFigureHardwareLabel;
		...
		private void createContents() {
			...
			fFigureHardwareLabel = new WrappingLabel();
			fFigureHardwareLabel.setText("Hardware");

			this.add(fFigureHardwareLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureHardwareLabel() {
			return fFigureHardwareLabel;
		}
