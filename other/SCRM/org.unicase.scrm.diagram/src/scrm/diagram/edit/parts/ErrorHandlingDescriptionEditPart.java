 ...
 * @generated NOT
 */
public class ErrorHandlingDescriptionEditPart extends SCRMModelElementLabelEditPart
	 ...
	 * @generated
	 */
	public ErrorHandlingDescriptionEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ErrorHandlingDescriptionEditPart.VISUAL_ID));
		}
		return parser;
	}
