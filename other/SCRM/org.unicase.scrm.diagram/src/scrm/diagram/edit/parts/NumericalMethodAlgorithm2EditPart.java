 ...
 * @generated
 */
public class NumericalMethodAlgorithm2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public NumericalMethodAlgorithm2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.NumericalMethodAlgorithm2EditPart.VISUAL_ID));
		}
		return parser;
	}
