 ...
 * @generated
 */
public class ResultsOutputName2EditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ResultsOutputName2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.ResultsOutputName2EditPart.VISUAL_ID));
		}
		return parser;
	}
