 ...
 * @generated NOT
 */
public class DataDefinitionNameEditPart extends SCRMModelElementLabelEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DataDefinitionNameEditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.DataDefinitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
