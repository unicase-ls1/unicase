 ...
 * @generated
 */
public class PerformanceProblemSize2EditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public PerformanceProblemSize2EditPart(View view) {
		super(view);
	}
			...
			parser = ScrmParserProvider
					.getParser(
							...
							ScrmVisualIDRegistry
									.getType(scrm.diagram.edit.parts.PerformanceProblemSize2EditPart.VISUAL_ID));
		}
		return parser;
	}
