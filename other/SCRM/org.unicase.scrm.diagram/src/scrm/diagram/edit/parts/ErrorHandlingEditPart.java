...
public class ErrorHandlingEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ErrorHandlingItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		ErrorHandlingFigure figure = new ErrorHandlingFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ErrorHandlingDescriptionNameEditPart) {
			((ErrorHandlingDescriptionNameEditPart) childEditPart).setLabel(getPrimaryShape()
				.getFigureErrorHandlingLabel());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScrmVisualIDRegistry.getType(ErrorHandlingDescriptionNameEditPart.VISUAL_ID));
	}
	 ...
	 * @generated
	 */
	public class ErrorHandlingFigure extends Ellipse {

		/**
		 * @generated
		 */
		private WrappingLabel fFigureErrorHandlingLabel;
		...
		private void createContents() {
			...
			fFigureErrorHandlingLabel = new WrappingLabel();
			fFigureErrorHandlingLabel.setText("ErrorHandling");

			this.add(fFigureErrorHandlingLabel);
		 ...
		 * @generated
		 */
		public WrappingLabel getFigureErrorHandlingLabel() {
			return fFigureErrorHandlingLabel;
		}
