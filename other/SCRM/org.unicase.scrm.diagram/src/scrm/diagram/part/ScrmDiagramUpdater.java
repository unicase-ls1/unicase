...
public class ScrmDiagramUpdater {
	...
	public static List getScientificProblem_2007ContainedLinks(View view) {
		...
		result.addAll(getOutgoingFeatureModelFacetLinks_ScientificProblem_SolvingMethod_4007(modelElement));
	...
	public static List getMathematicalModel_2005IncomingLinks(View view) {
		...
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificProblem_RepresentingModel_4006(modelElement,
			crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_MathematicalModel_4004(modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_MathematicalModel_4010(modelElement, crossReferences));
		return result;
	}
	...
	public static List getNumericalMethod_2006IncomingLinks(View view) {
		...
		Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificProblem_SolvingMethod_4007(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_MathematicalModel_NumericalMethods_4011(modelElement,
			crossReferences));
		return result;
	}
	...
	public static List getAssumption_2008IncomingLinks(View view) {
		...
		Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_MathematicalModel_Dependencies_4012(modelElement,
			crossReferences));
		result
			.addAll(getIncomingFeatureModelFacetLinks_NumericalMethod_Dependencies_4015(modelElement, crossReferences));
		return result;
	}
	...
	public static List getFeature_2009IncomingLinks(View view) {
		...
		Map crossReferences = EcoreUtil.CrossReferencer.find(view.eResource().getResourceSet().getResources());
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificProblem_InfluencedFeature_4008(modelElement,
			crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Feature_4029(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_RequiredFeatures_4030(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_ExcludedFeatures_4032(modelElement, crossReferences));
		return result;
	}
	...
	public static List getHardware_2010IncomingLinks(View view) {
		...
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_Dependencies_4026(modelElement, crossReferences));
		return result;
	}
	...
	public static List getConstraint_2011IncomingLinks(View view) {
		...
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_Constraints_4025(modelElement, crossReferences));
		return result;
	}
	...
	public static List getUserInterface_2012IncomingLinks(View view) {
		...
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_RequiredInterfaces_4023(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Feature_ProvidedInterfaces_4024(modelElement, crossReferences));
		return result;
	}
	...
	public static List getProcess_2014IncomingLinks(View view) {
		...
		result.addAll(getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(modelElement,
			crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_NumericalMethod_RealizingRequirement_4016(modelElement,
			crossReferences));
		result
			.addAll(getIncomingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Requirement_4036(modelElement, crossReferences));
		return result;
	}
	...
	public static List getPerformance_2015IncomingLinks(View view) {
		...
		result.addAll(getIncomingFeatureModelFacetLinks_NumericalMethod_RealizingRequirement_4016(modelElement,
			crossReferences));
		result
			.addAll(getIncomingFeatureModelFacetLinks_NumericalMethod_Performance_4017(modelElement, crossReferences));
		result
			.addAll(getIncomingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Requirement_4036(modelElement, crossReferences));
		return result;
	...
	public static List getDataFlow_2016IncomingLinks(View view) {
		...
		result
			.addAll(getIncomingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Requirement_4036(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Process_DataFlow_4040(modelElement, crossReferences));
		return result;
	}
	...
	public static List getDataDefinition_2017IncomingLinks(View view) {
		...
		result
			.addAll(getIncomingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(modelElement, crossReferences));
		result.addAll(getIncomingTypeModelFacetLinks_Requirement_4036(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Requirement_DefiningData_4038(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_MathematicalModel_4004(MathematicalModel container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getRefinements().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof MathematicalModel) {
				continue;
			}
			MathematicalModel link = (MathematicalModel) linkObject;
			if (MathematicalModel2EditPart.VISUAL_ID != ScrmVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			...
			result.add(new ScrmLinkDescriptor(src, dst, link, ScrmElementTypes.MathematicalModel_4004,
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_MathematicalModel_4010(MathematicalModel container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getSubMathematicalModels().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof MathematicalModel) {
				continue;
			}
			MathematicalModel link = (MathematicalModel) linkObject;
			if (MathematicalModel3EditPart.VISUAL_ID != ScrmVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			...
			result.add(new ScrmLinkDescriptor(src, dst, link, ScrmElementTypes.MathematicalModel_4010,
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_Feature_4029(Feature container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getSubFeatures().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			if (false == linkObject instanceof Feature) {
				continue;
			}
			Feature link = (Feature) linkObject;
			if (Feature2EditPart.VISUAL_ID != ScrmVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			...
			result
				.add(new ScrmLinkDescriptor(src, dst, link, ScrmElementTypes.Feature_4029, Feature2EditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getContainedTypeModelFacetLinks_Requirement_4036(Requirement container) {
		Collection result = new LinkedList();
		for (Iterator links = container.getRefinements().iterator(); links.hasNext();) {
			EObject linkObject = (EObject) links.next();
			...
			if (RequirementEditPart.VISUAL_ID != ScrmVisualIDRegistry.getLinkWithClassVisualID(link)) {
				continue;
			}
			List targets = link.getRefinements();
			Object theTarget = targets.size() == 1 ? targets.get(0) : null;
			...
			result.add(new ScrmLinkDescriptor(src, dst, link, ScrmElementTypes.Requirement_4036,
	...
	private static Collection getIncomingFeatureModelFacetLinks_ScientificKnowledge_Requirements_4005(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getScientificKnowledge_Requirements()) {
	...
	private static Collection getIncomingFeatureModelFacetLinks_ScientificProblem_RepresentingModel_4006(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getScientificProblem_RepresentingModel()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	...
	private static Collection getIncomingFeatureModelFacetLinks_ScientificProblem_SolvingMethod_4007(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getScientificProblem_SolvingMethod()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	...
	private static Collection getIncomingFeatureModelFacetLinks_ScientificProblem_InfluencedFeature_4008(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getScientificProblem_InfluencedFeature()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_MathematicalModel_4004(MathematicalModel target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() != KnowledgePackage.eINSTANCE.getMathematicalModel_Refinements()
			...
			MathematicalModel src = link.getRefinedModel();
			result.add(new ScrmLinkDescriptor(src, target, link, ScrmElementTypes.MathematicalModel_4004,
				MathematicalModel2EditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_MathematicalModel_4010(MathematicalModel target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			MathematicalModel src = link.getSuperMathematicalModel();
			result.add(new ScrmLinkDescriptor(src, target, link, ScrmElementTypes.MathematicalModel_4010,
				MathematicalModel3EditPart.VISUAL_ID));
		}
		return result;
	}
	...
	private static Collection getIncomingFeatureModelFacetLinks_MathematicalModel_NumericalMethods_4011(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getMathematicalModel_NumericalMethods()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_MathematicalModel_Dependencies_4012(Assumption target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getMathematicalModel_Dependencies()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_NumericalMethod_Dependencies_4015(Assumption target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getNumericalMethod_Dependencies()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.NumericalMethodDependencies_4015, NumericalMethodDependenciesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	...
	private static Collection getIncomingFeatureModelFacetLinks_NumericalMethod_RealizingRequirement_4016(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getNumericalMethod_RealizingRequirement()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_NumericalMethod_Performance_4017(Performance target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == KnowledgePackage.eINSTANCE.getNumericalMethod_Performance()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.NumericalMethodPerformance_4017, NumericalMethodPerformanceEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_RequiredInterfaces_4023(Interface target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_RequiredInterfaces()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureRequiredInterfaces_4023, FeatureRequiredInterfacesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_ProvidedInterfaces_4024(Interface target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_ProvidedInterfaces()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureProvidedInterfaces_4024, FeatureProvidedInterfacesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_Constraints_4025(Constraint target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_Constraints()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureConstraints_4025, FeatureConstraintsEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_Dependencies_4026(Hardware target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_Dependencies()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureDependencies_4026, FeatureDependenciesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(Requirement target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_DetailedRequirements()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureDetailedRequirements_4027, FeatureDetailedRequirementsEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_Feature_4029(Feature target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() != RequirementsPackage.eINSTANCE.getFeature_SubFeatures()
			...
			Feature src = link.getSupeFeature();
			result.add(new ScrmLinkDescriptor(src, target, link, ScrmElementTypes.Feature_4029,
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_RequiredFeatures_4030(Feature target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_RequiredFeatures()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureRequiredFeatures_4030, FeatureRequiredFeaturesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Feature_ExcludedFeatures_4032(Feature target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getFeature_ExcludedFeatures()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.FeatureExcludedFeatures_4032, FeatureExcludedFeaturesEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_Requirement_4036(Requirement target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() != RequirementsPackage.eINSTANCE.getRequirement_Refinements()
			...
			Requirement src = link.getRefinedRequirement();
			result.add(new ScrmLinkDescriptor(src, target, link, ScrmElementTypes.Requirement_4036,
				RequirementEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Requirement_DefiningData_4038(DataDefinition target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getRequirement_DefiningData()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target,
					ScrmElementTypes.RequirementDefiningData_4038, RequirementDefiningDataEditPart.VISUAL_ID));
			}
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Process_DataFlow_4040(DataFlow target,
		Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() == RequirementsPackage.eINSTANCE.getProcess_DataFlow()) {
				result.add(new ScrmLinkDescriptor(setting.getEObject(), target, ScrmElementTypes.ProcessDataFlow_4040,
	...
	private static Collection getOutgoingFeatureModelFacetLinks_ScientificProblem_SolvingMethod_4007(
		...
		result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.ScientificProblemSolvingMethod_4007,
			ScientificProblemSolvingMethodEditPart.VISUAL_ID));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_MathematicalModel_4004(MathematicalModel source) {
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_MathematicalModel_4010(MathematicalModel source) {
		MathematicalModel container = null;
		// Find container element for the link.
		// Climb up by containment hierarchy starting from the source
		// and return the first element that is instance of the container class.
	...
	private static Collection getOutgoingFeatureModelFacetLinks_MathematicalModel_NumericalMethods_4011(
		...
		Collection result = new LinkedList();
		for (Iterator destinations = source.getNumericalMethods().iterator(); destinations.hasNext();) {
	...
	private static Collection getOutgoingFeatureModelFacetLinks_MathematicalModel_Dependencies_4012(
		MathematicalModel source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getDependencies().iterator(); destinations.hasNext();) {
			Assumption destination = (Assumption) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.MathematicalModelDependencies_4012,
				MathematicalModelDependenciesEditPart.VISUAL_ID));
		}
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_NumericalMethod_Dependencies_4015(NumericalMethod source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getDependencies().iterator(); destinations.hasNext();) {
			Assumption destination = (Assumption) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.NumericalMethodDependencies_4015,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_NumericalMethod_Performance_4017(NumericalMethod source) {
		Collection result = new LinkedList();
		Performance destination = source.getPerformance();
		if (destination == null) {
			return result;
		}
		result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.NumericalMethodPerformance_4017,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_RequiredInterfaces_4023(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getRequiredInterfaces().iterator(); destinations.hasNext();) {
			Interface destination = (Interface) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureRequiredInterfaces_4023,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_ProvidedInterfaces_4024(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getProvidedInterfaces().iterator(); destinations.hasNext();) {
			Interface destination = (Interface) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureProvidedInterfaces_4024,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_Constraints_4025(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getConstraints().iterator(); destinations.hasNext();) {
			Constraint destination = (Constraint) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureConstraints_4025,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_Dependencies_4026(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getDependencies().iterator(); destinations.hasNext();) {
			Hardware destination = (Hardware) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureDependencies_4026,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_DetailedRequirements_4027(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getDetailedRequirements().iterator(); destinations.hasNext();) {
			Requirement destination = (Requirement) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureDetailedRequirements_4027,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_Feature_4029(Feature source) {
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_RequiredFeatures_4030(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getRequiredFeatures().iterator(); destinations.hasNext();) {
			...
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureRequiredFeatures_4030,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Feature_ExcludedFeatures_4032(Feature source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getExcludedFeatures().iterator(); destinations.hasNext();) {
			Feature destination = (Feature) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.FeatureExcludedFeatures_4032,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_Requirement_4036(Requirement source) {
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Requirement_DefiningData_4038(Requirement source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getDefiningData().iterator(); destinations.hasNext();) {
			DataDefinition destination = (DataDefinition) destinations.next();
			result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.RequirementDefiningData_4038,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Process_DataFlow_4040(Process source) {
		Collection result = new LinkedList();
		DataFlow destination = source.getDataFlow();
		if (destination == null) {
			return result;
		}
		result.add(new ScrmLinkDescriptor(source, destination, ScrmElementTypes.ProcessDataFlow_4040,
			ProcessDataFlowEditPart.VISUAL_ID));
		return result;
	}
