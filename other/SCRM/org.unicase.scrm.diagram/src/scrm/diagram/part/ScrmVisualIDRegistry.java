...
public class ScrmVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return scrm.diagram.part.ScrmVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (ScrmPackage.eINSTANCE.getSCRMDiagram().isSuperTypeOf(domainElement.eClass())
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = scrm.diagram.part.ScrmVisualIDRegistry.getModelID(containerView);
		if (!SCRMDiagramEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (SCRMDiagramEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = scrm.diagram.part.ScrmVisualIDRegistry.getVisualID(containerView);
		} else {
		...
		case SCRMDiagramEditPart.VISUAL_ID:
			if (KnowledgePackage.eINSTANCE.getScientificProblem().isSuperTypeOf(domainElement.eClass())) {
				return ScientificProblemEditPart.VISUAL_ID;
			}
			if (KnowledgePackage.eINSTANCE.getMathematicalModel().isSuperTypeOf(domainElement.eClass())) {
				return MathematicalModelEditPart.VISUAL_ID;
			}
			if (KnowledgePackage.eINSTANCE.getNumericalMethod().isSuperTypeOf(domainElement.eClass())) {
				return NumericalMethodEditPart.VISUAL_ID;
			}
			if (KnowledgePackage.eINSTANCE.getAssumption().isSuperTypeOf(domainElement.eClass())) {
				return AssumptionEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getFeature().isSuperTypeOf(domainElement.eClass())) {
				return FeatureEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getHardware().isSuperTypeOf(domainElement.eClass())) {
				return HardwareEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getConstraint().isSuperTypeOf(domainElement.eClass())) {
				return ConstraintEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getUserInterface().isSuperTypeOf(domainElement.eClass())) {
				return UserInterfaceEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getSoftwareInterface().isSuperTypeOf(domainElement.eClass())) {
				return SoftwareInterfaceEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getProcess().isSuperTypeOf(domainElement.eClass())) {
				return ProcessEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getPerformance().isSuperTypeOf(domainElement.eClass())) {
				return PerformanceEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getDataFlow().isSuperTypeOf(domainElement.eClass())) {
				return DataFlowEditPart.VISUAL_ID;
			}
			if (RequirementsPackage.eINSTANCE.getDataDefinition().isSuperTypeOf(domainElement.eClass())) {
				return DataDefinitionEditPart.VISUAL_ID;
			}
			if (scrm.requirements.dataProcessing.DataProcessingPackage.eINSTANCE.getInputDataReading().isSuperTypeOf(
				domainElement.eClass())) {
				return InputDataReadingEditPart.VISUAL_ID;
			}
			if (scrm.requirements.dataProcessing.DataProcessingPackage.eINSTANCE.getDataHandling().isSuperTypeOf(
				domainElement.eClass())) {
				return DataHandlingEditPart.VISUAL_ID;
			}
			if (scrm.requirements.dataProcessing.DataProcessingPackage.eINSTANCE.getResultsOutput().isSuperTypeOf(
				domainElement.eClass())) {
				return ResultsOutputEditPart.VISUAL_ID;
			}
			if (scrm.requirements.dataProcessing.DataProcessingPackage.eINSTANCE.getErrorHandling().isSuperTypeOf(
				domainElement.eClass())) {
				return ErrorHandlingEditPart.VISUAL_ID;
			}
			if (scrm.requirements.dataProcessing.DataProcessingPackage.eINSTANCE.getStatusMonitoring().isSuperTypeOf(
				domainElement.eClass())) {
	...
	public static boolean canCreateNode(View containerView, int nodeVisualID) {
		...
		case MathematicalModelEditPart.VISUAL_ID:
			if (MathematicalModelDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case NumericalMethodEditPart.VISUAL_ID:
			if (NumericalMethodDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case AssumptionEditPart.VISUAL_ID:
			if (AssumptionDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case FeatureEditPart.VISUAL_ID:
			if (FeatureDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case HardwareEditPart.VISUAL_ID:
			if (HardwareDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ConstraintEditPart.VISUAL_ID:
			if (ConstraintDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case UserInterfaceEditPart.VISUAL_ID:
			if (UserInterfaceDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case SoftwareInterfaceEditPart.VISUAL_ID:
			if (SoftwareInterfaceDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ProcessEditPart.VISUAL_ID:
			if (ProcessDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case PerformanceEditPart.VISUAL_ID:
			if (PerformanceDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case DataFlowEditPart.VISUAL_ID:
			if (DataFlowDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case DataDefinitionEditPart.VISUAL_ID:
			if (DataDefinitionDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case InputDataReadingEditPart.VISUAL_ID:
			if (InputDataReadingDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case DataHandlingEditPart.VISUAL_ID:
			if (DataHandlingDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ResultsOutputEditPart.VISUAL_ID:
			if (ResultsOutputDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case ErrorHandlingEditPart.VISUAL_ID:
			if (ErrorHandlingDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case StatusMonitoringEditPart.VISUAL_ID:
			if (StatusMonitoringDescriptionNameEditPart.VISUAL_ID == nodeVisualID) {
				return true;
			}
			break;
		case SCRMDiagramEditPart.VISUAL_ID:
	...
	public static int getLinkWithClassVisualID(EObject domainElement) {
		...
		if (RequirementsPackage.eINSTANCE.getRequirement().isSuperTypeOf(domainElement.eClass())) {
