 ...
 * @generated
 */
public class ScrmNewDiagramFileWizard extends Wizard {
	...
	private static class DiagramRootElementSelectionPage extends
		...
		protected String getSelectionTitle() {
			return Messages.ScrmNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
		...
		protected boolean validatePage() {
			if (selectedModelElement == null) {
				setErrorMessage(Messages.ScrmNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
