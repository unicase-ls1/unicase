 ...
 * <ul>
 *   <li>{@link scrm.requirements.impl.InterfaceImpl#getUsedKnowledge <em>Used Knowledge</em>}</li>
 *   <li>{@link scrm.requirements.impl.InterfaceImpl#getProvidingFeature <em>Providing Feature</em>}</li>
 *   <li>{@link scrm.requirements.impl.InterfaceImpl#getRequiringFeatures <em>Requiring Features</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class InterfaceImpl extends SCRMModelElementImpl implements Interface {
	/**
	...
	protected EClass eStaticClass() {
		return RequirementsPackage.Literals.INTERFACE;
	}
	...
	public ScientificKnowledge getUsedKnowledge() {
		if (eContainerFeatureID() != RequirementsPackage.INTERFACE__USED_KNOWLEDGE) return null;
	...
	public NotificationChain basicSetUsedKnowledge(ScientificKnowledge newUsedKnowledge, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newUsedKnowledge, RequirementsPackage.INTERFACE__USED_KNOWLEDGE, msgs);
		return msgs;
	}
	...
	public void setUsedKnowledge(ScientificKnowledge newUsedKnowledge) {
		if (newUsedKnowledge != eInternalContainer() || (eContainerFeatureID() != RequirementsPackage.INTERFACE__USED_KNOWLEDGE && newUsedKnowledge != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.INTERFACE__USED_KNOWLEDGE, newUsedKnowledge, newUsedKnowledge));
	}
	...
	public Feature getProvidingFeature() {
		if (eContainerFeatureID() != RequirementsPackage.INTERFACE__PROVIDING_FEATURE) return null;
	...
	public NotificationChain basicSetProvidingFeature(Feature newProvidingFeature, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newProvidingFeature, RequirementsPackage.INTERFACE__PROVIDING_FEATURE, msgs);
		return msgs;
	}
	...
	public void setProvidingFeature(Feature newProvidingFeature) {
		if (newProvidingFeature != eInternalContainer() || (eContainerFeatureID() != RequirementsPackage.INTERFACE__PROVIDING_FEATURE && newProvidingFeature != null)) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, RequirementsPackage.INTERFACE__PROVIDING_FEATURE, newProvidingFeature, newProvidingFeature));
	}
	...
	public EList<Feature> getRequiringFeatures() {
		if (requiringFeatures == null) {
			requiringFeatures = new EObjectWithInverseResolvingEList.ManyInverse<Feature>(Feature.class, this, RequirementsPackage.INTERFACE__REQUIRING_FEATURES, RequirementsPackage.FEATURE__REQUIRED_INTERFACES);
		}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RequirementsPackage.INTERFACE__USED_KNOWLEDGE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetUsedKnowledge((ScientificKnowledge)otherEnd, msgs);
			case RequirementsPackage.INTERFACE__PROVIDING_FEATURE:
				if (eInternalContainer() != null)
					msgs = eBasicRemoveFromContainer(msgs);
				return basicSetProvidingFeature((Feature)otherEnd, msgs);
			case RequirementsPackage.INTERFACE__REQUIRING_FEATURES:
