...
public class ConstraintImpl extends SCRMModelElementImpl implements Constraint {
	...
	public RequirementSpace getContainingRequirementSpace() {
		if (eContainerFeatureID() != RequirementsPackage.CONSTRAINT__CONTAINING_REQUIREMENT_SPACE)
			return null;
	...
	public NotificationChain basicSetContainingRequirementSpace(
		...
		msgs = eBasicSetContainer(
				...
				RequirementsPackage.CONSTRAINT__CONTAINING_REQUIREMENT_SPACE,
				msgs);
		return msgs;
	}
	...
	public void setContainingRequirementSpace(
		...
		if (newContainingRequirementSpace != eInternalContainer()
				|| (eContainerFeatureID() != RequirementsPackage.CONSTRAINT__CONTAINING_REQUIREMENT_SPACE && newContainingRequirementSpace != null)) {
