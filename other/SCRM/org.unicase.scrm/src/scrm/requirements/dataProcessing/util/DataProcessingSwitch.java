	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DataProcessingPackage.INPUT_DATA_READING: {
				...
				if (result == null) result = caseDataProcessing(inputDataReading);
			...
			case DataProcessingPackage.DATA_HANDLING: {
				...
				if (result == null) result = caseDataProcessing(dataHandling);
			...
			case DataProcessingPackage.RESULTS_OUTPUT: {
				...
				if (result == null) result = caseDataProcessing(resultsOutput);
			...
			case DataProcessingPackage.ERROR_HANDLING: {
				...
				if (result == null) result = caseDataProcessing(errorHandling);
			...
			case DataProcessingPackage.STATUS_MONITORING: {
				...
				if (result == null) result = caseDataProcessing(statusMonitoring);
