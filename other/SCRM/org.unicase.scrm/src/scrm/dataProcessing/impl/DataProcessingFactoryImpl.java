 ...
 * @generated
 */
public class DataProcessingFactoryImpl extends EFactoryImpl implements
	...
	public static DataProcessingFactory init() {
		try {
			DataProcessingFactory theDataProcessingFactory = (DataProcessingFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://unicase.org/model/scrm/dataProcessing");
