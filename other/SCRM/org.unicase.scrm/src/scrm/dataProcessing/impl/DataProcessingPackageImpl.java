 ...
 * $Id$
 */
package scrm.dataProcessing.impl;
...
import scrm.dataProcessing.DataHandling;
import scrm.dataProcessing.DataProcessing;
...
import scrm.dataProcessing.InputDataReading;
 ...
 * @generated
 */
public class DataProcessingPackageImpl extends EPackageImpl implements
	 ...
	 * @see scrm.dataProcessing.DataProcessingPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static DataProcessingPackage init() {
		if (isInited)
			return (DataProcessingPackage) EPackage.Registry.INSTANCE
		...
		DataProcessingPackageImpl theDataProcessingPackage = (DataProcessingPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof DataProcessingPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new DataProcessingPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(DataProcessingPackage.eNS_URI,
				theDataProcessingPackage);
	...
	public void initializePackageContents() {
		...
		dataProcessingEClass.getESuperTypes().add(
		...
		initEClass(dataProcessingEClass, DataProcessing.class,
				"DataProcessing", IS_ABSTRACT, IS_INTERFACE,
		...
		initEClass(dataHandlingEClass, DataHandling.class, "DataHandling",
