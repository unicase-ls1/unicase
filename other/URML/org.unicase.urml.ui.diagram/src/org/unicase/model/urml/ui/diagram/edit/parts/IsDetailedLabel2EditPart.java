...
public class IsDetailedLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsDetailedLabel2EditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public IsDetailedLabel2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4016, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsDetailedLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
