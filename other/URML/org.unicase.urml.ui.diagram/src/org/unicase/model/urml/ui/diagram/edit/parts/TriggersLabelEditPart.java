...
public class TriggersLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.TriggersLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public TriggersLabelEditPart(View view) {
		super(view);
	}
	...
	protected IFigure createFigurePrim() {
		return new TriggersLabelFigure();
	}

	/**
	 * @generated
	 */
	public class TriggersLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public TriggersLabelFigure() {
			this.setText("triggers");
		}
