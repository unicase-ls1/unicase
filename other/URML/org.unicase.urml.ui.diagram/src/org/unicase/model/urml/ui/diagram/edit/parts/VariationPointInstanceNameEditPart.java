...
public class VariationPointInstanceNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VariationPointInstanceNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider
				.getParser(UrmlElementTypes.VariationPointInstance_2014, getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.VariationPointInstanceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
