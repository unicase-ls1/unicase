 ...
 * @generated
 */
public class GoalRealizedFeaturesReorientCommand extends EditElementCommand {
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getRealizedFeatures().remove(getOldTarget());
		getNewSource().getRealizedFeatures().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getRealizedFeatures().remove(getOldTarget());
		getOldSource().getRealizedFeatures().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
