...
public class IsRefinedLabel4EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsRefinedLabel4EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public IsRefinedLabel4EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.FunctionalRequirementSubFunctionalRequirements_4044,
				getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsRefinedLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
