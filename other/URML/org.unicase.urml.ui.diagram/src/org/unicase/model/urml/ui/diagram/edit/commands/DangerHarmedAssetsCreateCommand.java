 ...
 * @generated
 */
public class DangerHarmedAssetsCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		if (source != null && false == source instanceof Danger) {
			return false;
		}
		if (target != null && false == target instanceof Asset) {
			return false;
		}
		if (getSource() == null) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getHarmedAssets().add(getTarget());
		}
