...
public class HarmsLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.HarmsLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public HarmsLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider
				.getParser(UrmlElementTypes.DangerHarmedAssets_4013, getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.HarmsLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new HarmsLabelFigure();
	}

	/**
	 * @generated
	 */
	public class HarmsLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public HarmsLabelFigure() {
			this.setText("harms");
		}
