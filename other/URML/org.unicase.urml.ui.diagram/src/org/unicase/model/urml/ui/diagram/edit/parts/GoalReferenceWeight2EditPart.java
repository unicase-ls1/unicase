...
public class GoalReferenceWeight2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeight2EditPart.VISUAL_ID), new Point(0,
			0));
	}
	 ...
	 * @generated
	 */
	public GoalReferenceWeight2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4024, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeight2EditPart.VISUAL_ID));
		}
		return parser;
	}
