...
public class SelectLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.SelectLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public SelectLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.VariationPointInstanceSelectedFeatures_4040,
				getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.SelectLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new SelectLabelFigure();
	}

	/**
	 * @generated
	 */
	public class SelectLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SelectLabelFigure() {
			this.setText("selects");
		}
