 ...
 * @generated
 */
public class FeatureDetailingFunctionalRequirementsCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public FeatureDetailingFunctionalRequirementsCreateCommand(CreateRelationshipRequest request, EObject source,
		EObject target) {
	...
	public boolean canExecute() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canCreateFeatureDetailingFunctionalRequirements_4006(
			getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getDetailingFunctionalRequirements().add(getTarget());
		}
