 ...
 * @generated
 */
public class VariationPointVarietyCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public VariationPointVarietyCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canCreateVariationPointVariety_4042(getSource(),
			getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getVariety().add(getTarget());
		}
