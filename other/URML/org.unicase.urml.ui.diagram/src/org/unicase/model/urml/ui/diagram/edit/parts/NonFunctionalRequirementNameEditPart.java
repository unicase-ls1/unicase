...
public class NonFunctionalRequirementNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public NonFunctionalRequirementNameEditPart(View view) {
		super(view);
	}
			...
			parser = UrmlParserProvider
				.getParser(
					...
					UrmlVisualIDRegistry
						.getType(org.unicase.model.urml.ui.diagram.edit.parts.NonFunctionalRequirementNameEditPart.VISUAL_ID));
		}
		return parser;
	}
