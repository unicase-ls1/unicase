...
public class UrmlNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	public Image getImage(View view) {
		...
		case URMLDiagramEditPart.VISUAL_ID:
			return getImage(
				"Navigator?Diagram?http://unicase.org/model/urml?URMLDiagram", UrmlElementTypes.URMLDiagram_69); //$NON-NLS-1$
	...
	public String getText(View view) {
		...
		switch (UrmlVisualIDRegistry.getVisualID(view)) {
		case URMLDiagramEditPart.VISUAL_ID:
			return getURMLDiagram_69Text(view);
		case GoalEditPart.VISUAL_ID:
	 ...
	 * @generated
	 */
	private String getURMLDiagram_69Text(View view) {
		URMLDiagram domainModelElement = (URMLDiagram) view.getElement();
		if (domainModelElement != null) {
			return domainModelElement.getName();
		} else {
			UrmlDiagramEditorPlugin.getInstance().logError("No domain element for view with visualID = " + 69); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
