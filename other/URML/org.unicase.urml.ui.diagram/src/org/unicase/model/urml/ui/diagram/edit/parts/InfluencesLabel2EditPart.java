...
public class InfluencesLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabel2EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public InfluencesLabel2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4023, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new InfluencesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InfluencesLabelFigure extends WrappingLabel {
