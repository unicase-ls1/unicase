...
public class MotivatesLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.MotivatesLabel2EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public MotivatesLabel2EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.ServiceSubServices_4022, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.MotivatesLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
