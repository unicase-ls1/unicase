...
public class InstantiateLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.InstantiateLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public InstantiateLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.VariationPointInstanceVariationPoint_4033,
				getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.InstantiateLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new InstantiateLabelFigure();
	}

	/**
	 * @generated
	 */
	public class InstantiateLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public InstantiateLabelFigure() {
			this.setText("instantiate");
		}
