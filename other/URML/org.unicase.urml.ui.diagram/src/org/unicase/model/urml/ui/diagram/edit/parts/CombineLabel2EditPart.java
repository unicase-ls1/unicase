 ...
 * @generated
 */
public class CombineLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.CombineLabel2EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public CombineLabel2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.VariationPointFeatures_4039, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.CombineLabel2EditPart.VISUAL_ID));
		}
		return parser;
	}
