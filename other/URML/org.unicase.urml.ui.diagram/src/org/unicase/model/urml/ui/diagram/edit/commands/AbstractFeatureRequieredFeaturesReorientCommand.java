 ...
 * @generated
 */
public class AbstractFeatureRequieredFeaturesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AbstractFeatureRequieredFeaturesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canExistAbstractFeatureRequieredFeatures_4037(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().getRequieredFeatures().remove(getOldTarget());
		getNewSource().getRequieredFeatures().add(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().getRequieredFeatures().remove(getOldTarget());
		getOldSource().getRequieredFeatures().add(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
