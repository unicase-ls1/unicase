 ...
 * @generated
 */
public class RequieresLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.RequieresLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public RequieresLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.AbstractFeatureRequieredFeatures_4037,
				getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.RequieresLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
