...
public class InfluencesLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public InfluencesLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4016, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
