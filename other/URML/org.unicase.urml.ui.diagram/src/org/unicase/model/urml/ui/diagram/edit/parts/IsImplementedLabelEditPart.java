...
public class IsImplementedLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsImplementedLabelEditPart.VISUAL_ID), new Point(0,
			20));
	}
	 ...
	 * @generated
	 */
	public IsImplementedLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.RequirementImplementingServices_4005,
				getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.IsImplementedLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new IsImplementedLabelFigure();
	}

	/**
	 * @generated
	 */
	public class IsImplementedLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public IsImplementedLabelFigure() {
			this.setText("is implemented by");
		}
