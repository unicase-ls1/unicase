 ...
 * @generated
 */
public class VariationPointFeaturesReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public VariationPointFeaturesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	protected boolean canReorientSource() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canExistVariationPointFeatures_4039(getNewSource(),
			getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canExistVariationPointFeatures_4039(getOldSource(),
			getNewTarget());
	}
