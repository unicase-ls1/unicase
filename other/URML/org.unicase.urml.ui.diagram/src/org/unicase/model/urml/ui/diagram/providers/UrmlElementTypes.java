...
public class UrmlElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType URMLDiagram_69 = getElementType("org.unicase.urml.ui.diagram.URMLDiagram_69"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(URMLDiagram_69, UrmlPackage.eINSTANCE.getURMLDiagram());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(URMLDiagram_69);
