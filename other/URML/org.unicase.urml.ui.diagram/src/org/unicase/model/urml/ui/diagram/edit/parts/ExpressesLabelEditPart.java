...
public class ExpressesLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.ExpressesLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public ExpressesLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.StakeholderGoals_4008, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.ExpressesLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new ExpressesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class ExpressesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public ExpressesLabelFigure() {
			this.setText("expresses");
		}
