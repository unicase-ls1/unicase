...
public class GoalReferenceWeight3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeight3EditPart.VISUAL_ID), new Point(0,
			0));
	}
	 ...
	 * @generated
	 */
	public GoalReferenceWeight3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4025, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeight3EditPart.VISUAL_ID));
		}
		return parser;
	}
