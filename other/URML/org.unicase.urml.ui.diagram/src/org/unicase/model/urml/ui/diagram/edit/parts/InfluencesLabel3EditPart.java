...
public class InfluencesLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabel3EditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public InfluencesLabel3EditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4024, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.InfluencesLabel3EditPart.VISUAL_ID));
		}
		return parser;
	}
