...
public class MotivatesLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.MotivatesLabelEditPart.VISUAL_ID), new Point(0, 20));
	}

	/**
	 * @generated
	 */
	public MotivatesLabelEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalRealizedFeatures_4004, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.MotivatesLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected IFigure createFigurePrim() {
		return new MotivatesLabelFigure();
	}

	/**
	 * @generated
	 */
	public class MotivatesLabelFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public MotivatesLabelFigure() {
			this.setText("motivates");
		}
