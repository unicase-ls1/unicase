 ...
 * @generated
 */
public class AbstractFeatureRequieredFeaturesCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public AbstractFeatureRequieredFeaturesCreateCommand(CreateRelationshipRequest request, EObject source,
		EObject target) {
	...
	public boolean canExecute() {
		...
		return UrmlBaseItemSemanticEditPolicy.LinkConstraints.canCreateAbstractFeatureRequieredFeatures_4037(
			getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		if (getSource() != null && getTarget() != null) {
			getSource().getRequieredFeatures().add(getTarget());
		}
