...
public class DangerNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DangerNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = UrmlParserProvider
				.getParser(UrmlElementTypes.Danger_2009, getParserElement(), UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.DangerNameEditPart.VISUAL_ID));
		}
		return parser;
	}
