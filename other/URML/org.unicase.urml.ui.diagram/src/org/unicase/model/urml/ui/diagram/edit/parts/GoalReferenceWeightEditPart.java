...
public class GoalReferenceWeightEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(UrmlVisualIDRegistry
			.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeightEditPart.VISUAL_ID), new Point(0,
			0));
	}
	 ...
	 * @generated
	 */
	public GoalReferenceWeightEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = UrmlParserProvider.getParser(UrmlElementTypes.GoalReference_4023, getParserElement(),
				UrmlVisualIDRegistry
					.getType(org.unicase.model.urml.ui.diagram.edit.parts.GoalReferenceWeightEditPart.VISUAL_ID));
		}
		return parser;
	}
