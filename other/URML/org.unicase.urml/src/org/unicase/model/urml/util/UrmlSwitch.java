...
public class UrmlSwitch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Stakeholder</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>URML Diagram</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
