...
public class RequirementSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case RequirementPackage.REQUIREMENT: {
			...
			if (result == null)
				result = caseMitigation(requirement);
			if (result == null)
				result = caseUrmlModelElement(requirement);
			if (result == null)
		...
		case RequirementPackage.FUNCTIONAL_REQUIREMENT: {
			...
			if (result == null)
				result = caseMitigation(functionalRequirement);
			if (result == null)
				result = caseUrmlModelElement(functionalRequirement);
			if (result == null)
		...
		case RequirementPackage.NON_FUNCTIONAL_REQUIREMENT: {
			...
			if (result == null)
				result = caseMitigation(nonFunctionalRequirement);
			if (result == null)
				result = caseUrmlModelElement(nonFunctionalRequirement);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mitigation</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
