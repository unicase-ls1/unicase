...
public class DangerSwitch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Asset</em>'. <!-- begin-user-doc --> This
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Danger</em>'. <!-- begin-user-doc --> This
	 * implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
