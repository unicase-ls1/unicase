...
public interface VariationPointRule extends UrmlModelElement {
	/**
	 * Returns the value of the '<em><b>Variation Point</b></em>' container reference. It is bidirectional and its
	 * opposite is '{@link urml.feature.VariationPoint#getRules <em>Rules</em>}'. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link urml.feature.VariationPointRule#getVariationPoint <em>Variation Point</em>}'
