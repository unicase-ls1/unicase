...
public interface VariationPoint extends AbstractFeature {
	/**
	 * Returns the value of the '<em><b>Variety</b></em>' reference list. The list contents are of type
	 * {@link urml.feature.AbstractFeature}. It is bidirectional and its opposite is '
	 * {@link urml.feature.AbstractFeature#getVariationPoint <em>Variation Point</em>}'. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Variety</em>' reference list isn't clear, there really should be more of a description
	 * here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the value of the '<em><b>Variety Multiplicity</b></em>' attribute. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Variety Multiplicity</em>' attribute isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Sets the value of the '{@link urml.feature.VariationPoint#getVarietyMultiplicity <em>Variety Multiplicity</em>}'
