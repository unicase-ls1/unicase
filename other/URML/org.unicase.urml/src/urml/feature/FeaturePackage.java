...
public interface FeaturePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ABSTRACT_FEATURE__VARIATION_POINT = UrmlPackage.URML_MODEL_ELEMENT_FEATURE_COUNT + 10;
	 ...
	 * @ordered
	 */
	int FEATURE__VARIATION_POINT = ABSTRACT_FEATURE__VARIATION_POINT;
	 ...
	 * @ordered
	 */
	int VARIATION_POINT__VARIATION_POINT = ABSTRACT_FEATURE__VARIATION_POINT;
	...
	/**
	 * The feature id for the '<em><b>Variety</b></em>' reference list. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int VARIATION_POINT__VARIETY = ABSTRACT_FEATURE_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Variety Multiplicity</b></em>' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int VARIATION_POINT__VARIETY_MULTIPLICITY = ABSTRACT_FEATURE_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for the reference '{@link urml.feature.AbstractFeature#getVariationPoint
	 ...
	 * @generated
	 */
	EReference getAbstractFeature_VariationPoint();
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.feature.VariationPoint#getVariety <em>Variety</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the reference list '<em>Variety</em>'.
	 * @see urml.feature.VariationPoint#getVariety()
	 * @see #getVariationPoint()
	 * @generated
	 */
	EReference getVariationPoint_Variety();

	/**
	 * Returns the meta object for the attribute '{@link urml.feature.VariationPoint#getVarietyMultiplicity
	 * <em>Variety Multiplicity</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Variety Multiplicity</em>'.
	 * @see urml.feature.VariationPoint#getVarietyMultiplicity()
	 * @see #getVariationPoint()
	 * @generated
	 */
	EAttribute getVariationPoint_VarietyMultiplicity();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EReference ABSTRACT_FEATURE__VARIATION_POINT = eINSTANCE.getAbstractFeature_VariationPoint();
		...
		/**
		 * The meta object literal for the '<em><b>Variety</b></em>' reference list feature. <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EReference VARIATION_POINT__VARIETY = eINSTANCE.getVariationPoint_Variety();

		/**
		 * The meta object literal for the '<em><b>Variety Multiplicity</b></em>' attribute feature. <!-- begin-user-doc
		 * --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		EAttribute VARIATION_POINT__VARIETY_MULTIPLICITY = eINSTANCE.getVariationPoint_VarietyMultiplicity();
