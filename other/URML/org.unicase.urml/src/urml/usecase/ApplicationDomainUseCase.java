...
public interface ApplicationDomainUseCase extends UseCase {
	/**
	 * Returns the value of the '<em><b>Detailed Goal</b></em>' reference list. The list contents are of type
	 * {@link urml.goal.Goal}. It is bidirectional and its opposite is '{@link urml.goal.Goal#getDetailingUseCases
	 * <em>Detailing Use Cases</em>}'. <!-- begin-user-doc -->
	 * <p>
