...
public class ServiceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ServicePackage.SERVICE: {
			...
			if (result == null)
				result = caseMitigation(service);
			if (result == null)
				result = caseUrmlModelElement(service);
			if (result == null)
				result = caseUnicaseModelElement(service);
			if (result == null)
				result = caseModelElement(service);
			if (result == null)
				result = caseIdentifiableElement(service);
			if (result == null)
		...
		case ServicePackage.SERVICE_PROVIDER: {
			...
			if (result == null)
				result = caseAsset(serviceProvider);
			if (result == null)
				result = caseUrmlModelElement(serviceProvider);
			if (result == null)
				result = caseUnicaseModelElement(serviceProvider);
			if (result == null)
				result = caseModelElement(serviceProvider);
			if (result == null)
				result = caseIdentifiableElement(serviceProvider);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
