...
public class ServiceImpl extends AssetImpl implements Service {
	 ...
	 * @ordered
	 */
	protected EList<org.unicase.model.classes.Class> usedClasses;
	...
	public EList<org.unicase.model.classes.Class> getUsedClasses() {
		if (usedClasses == null) {
			usedClasses = new EObjectResolvingEList<org.unicase.model.classes.Class>(
				org.unicase.model.classes.Class.class, this, ServicePackage.SERVICE__USED_CLASSES);
		}
		return usedClasses;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case ServicePackage.SERVICE__USED_CLASSES:
			return getUsedClasses();
		case ServicePackage.SERVICE__PARENT_SERVICE:
			if (resolve)
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ServicePackage.SERVICE__SATISFIED_REQUIREMENTS:
			...
			return;
		case ServicePackage.SERVICE__USED_CLASSES:
			getUsedClasses().clear();
			getUsedClasses().addAll((Collection<? extends org.unicase.model.classes.Class>) newValue);
			return;
		case ServicePackage.SERVICE__PARENT_SERVICE:
	...
	public boolean eIsSet(int featureID) {
		...
		case ServicePackage.SERVICE__USED_CLASSES:
			return usedClasses != null && !usedClasses.isEmpty();
		case ServicePackage.SERVICE__PARENT_SERVICE:
