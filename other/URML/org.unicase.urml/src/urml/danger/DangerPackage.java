...
public interface DangerPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link urml.danger.impl.AssetImpl <em>Asset</em>}' class. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the '{@link urml.danger.impl.DangerImpl <em>Danger</em>}' class. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The meta object id for the '{@link urml.danger.impl.ProceduralMitigationImpl <em>Procedural Mitigation</em>}'
	...
	/**
	 * Returns the meta object for class '{@link urml.danger.Asset <em>Asset</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Asset#getTriggeredDangers
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Asset#getHarmingDangers
	...
	/**
	 * Returns the meta object for class '{@link urml.danger.Danger <em>Danger</em>}'. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Danger#getTriggeringAssets
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Danger#getHarmedClasses
	 * <em>Harmed Classes</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link urml.danger.Mitigation <em>Mitigation</em>}'. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Mitigation#getMitigatedDangers
	 * <em>Mitigated Dangers</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for the attribute '{@link urml.danger.ProceduralMitigation#getMitigationProcedure
	 * <em>Mitigation Procedure</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Harmed Classes</b></em>' reference list feature. <!-- begin-user-doc
		 * --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '{@link urml.danger.impl.ProceduralMitigationImpl
