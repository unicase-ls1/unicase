...
public interface DangerPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ASSET__ENDANGERED_BY = UrmlPackage.URML_MODEL_ELEMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int ASSET_FEATURE_COUNT = UrmlPackage.URML_MODEL_ELEMENT_FEATURE_COUNT + 1;
	...
	/**
	 * The feature id for the '<em><b>Triggering Actors</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int DANGER__TRIGGERING_ACTORS = UrmlPackage.URML_MODEL_ELEMENT_FEATURE_COUNT + 0;

	/**
	 * The feature id for the '<em><b>Harmed Assets</b></em>' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 ...
	 * @ordered
	 */
	int DANGER_FEATURE_COUNT = UrmlPackage.URML_MODEL_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Asset#getEndangeredBy <em>Endangered By</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Endangered By</em>'.
	 * @see urml.danger.Asset#getEndangeredBy()
	 * @see #getAsset()
	 * @generated
	 */
	EReference getAsset_EndangeredBy();
	...
	/**
	 * Returns the meta object for the reference list '{@link urml.danger.Danger#getTriggeringActors <em>Triggering Actors</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference list '<em>Triggering Actors</em>'.
	 * @see urml.danger.Danger#getTriggeringActors()
	 * @see #getDanger()
	 * @generated
	 */
	EReference getDanger_TriggeringActors();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Endangered By</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference ASSET__ENDANGERED_BY = eINSTANCE.getAsset_EndangeredBy();
		...
		/**
		 * The meta object literal for the '<em><b>Triggering Actors</b></em>' reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
