...
public interface Mitigation extends UrmlModelElement {
	/**
	 * Returns the value of the '<em><b>Mitigated Dangers</b></em>' reference list. The list contents are of type
	 * {@link urml.danger.Danger}. It is bidirectional and its opposite is '{@link urml.danger.Danger#getMitigations
	 * <em>Mitigations</em>}'. <!-- begin-user-doc -->
	 * <p>
