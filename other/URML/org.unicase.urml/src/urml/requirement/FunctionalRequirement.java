 ...
 *   <li>{@link urml.requirement.FunctionalRequirement#getParentFunctionalRequirement <em>Parent Functional Requirement</em>}</li>
 * </ul>
 * </p>
 *
...
public interface FunctionalRequirement extends Requirement {
	 ...
	 * It is bidirectional and its opposite is '{@link urml.requirement.FunctionalRequirement#getParentFunctionalRequirement <em>Parent Functional Requirement</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Sub Functional Requirements</em>' containment reference list isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link urml.requirement.FunctionalRequirement#getSubFunctionalRequirements <em>Sub Functional Requirements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Parent Functional Requirement</em>' container reference isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	...
	/**
	 * Sets the value of the '{@link urml.requirement.FunctionalRequirement#getParentFunctionalRequirement <em>Parent Functional Requirement</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
