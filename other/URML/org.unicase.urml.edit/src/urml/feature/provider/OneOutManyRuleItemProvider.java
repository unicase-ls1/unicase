...
public class OneOutManyRuleItemProvider extends VariationPointRuleItemProvider implements IEditingDomainItemProvider,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OneOutManyRule"));
	}
	...
	public String getText(Object object) {
		String label = ((OneOutManyRule) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_OneOutManyRule_type")
			: getString("_UI_OneOutManyRule_type") + " " + label;
	}
