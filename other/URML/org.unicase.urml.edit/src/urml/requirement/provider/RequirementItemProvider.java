...
import urml.danger.provider.MitigationItemProvider;
import urml.requirement.Requirement;
import urml.requirement.RequirementFactory;
import urml.requirement.RequirementPackage;

/**
 * This is the item provider adapter for a {@link urml.requirement.Requirement} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class RequirementItemProvider extends MitigationItemProvider implements IEditingDomainItemProvider,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(RequirementPackage.Literals.REQUIREMENT__SUB_REQUIREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(RequirementPackage.Literals.REQUIREMENT__SUB_REQUIREMENTS,
