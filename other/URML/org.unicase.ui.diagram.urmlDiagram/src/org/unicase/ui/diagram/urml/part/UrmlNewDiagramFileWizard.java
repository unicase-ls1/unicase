 ...
 * @generated
 */
public class UrmlNewDiagramFileWizard extends Wizard {
	...
	private static class DiagramRootElementSelectionPage extends ModelElementSelectionPage {
		...
		protected String getSelectionTitle() {
			return Messages.UrmlNewDiagramFileWizard_RootSelectionPageSelectionTitle;
		}
		...
		protected boolean validatePage() {
			if (selectedModelElement == null) {
				setErrorMessage(Messages.UrmlNewDiagramFileWizard_RootSelectionPageNoSelectionMessage);
				return false;
			}
