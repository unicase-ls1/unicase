...
public final class StakeholderUtil {
	...
	public static ProjectSpace getActiveProjectSpace() {
		return WorkspaceManager.getInstance().getCurrentWorkspace().getProjectSpaces().get(0);
	}
	...
	public static void resolveAll(final Project project){
		new UnicaseCommand() {
			...
			protected void doRun() {
				...
				EList<StakeholderRole> roles = project.getAllModelElementsbyClass(UrmlPackage.eINSTANCE.getStakeholderRole(),
