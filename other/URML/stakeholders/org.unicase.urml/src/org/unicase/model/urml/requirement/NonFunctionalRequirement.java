 ...
 * <ul>
 *   <li>{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getConstrainedFeatures <em>Constrained Features</em>}</li>
 *   <li>{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getSubNonFunctionalRequirements <em>Sub Non Functional Requirements</em>}</li>
 *   <li>{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getParentNonFunctionalRequirement <em>Parent Non Functional Requirement</em>}</li>
 * </ul>
 * </p>
 *
...
public interface NonFunctionalRequirement extends Requirement {
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.urml.feature.AbstractFeature#getConstrainingNonFunctionalRequirements <em>Constraining Non Functional Requirements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getParentNonFunctionalRequirement <em>Parent Non Functional Requirement</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getSubNonFunctionalRequirements <em>Sub Non Functional Requirements</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link org.unicase.model.urml.requirement.NonFunctionalRequirement#getParentNonFunctionalRequirement <em>Parent Non Functional Requirement</em>}' container reference.
