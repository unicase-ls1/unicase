...
public class ServicePackageImpl extends EPackageImpl implements ServicePackage {
	...
	public static ServicePackage init() {
		...
		ServicePackageImpl theServicePackage = (ServicePackageImpl) (EPackage.Registry.INSTANCE
				...
				.get(eNS_URI) : new ServicePackageImpl());
	...
	public void initializePackageContents() {
		...
		initEReference(getService_SatisfiedRequirements(),
				theRequirementPackage.getRequirement(),
				theRequirementPackage.getRequirement_ImplementingServices(),
				"satisfiedRequirements", null, 0, -1, Service.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE,
				IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getService_ParentService(), this.getService(),
				this.getService_SubServices(), "parentService", null, 0, 1,
				Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getService_SubServices(), this.getService(),
				this.getService_ParentService(), "subServices", null, 0, -1,
				Service.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
	}
