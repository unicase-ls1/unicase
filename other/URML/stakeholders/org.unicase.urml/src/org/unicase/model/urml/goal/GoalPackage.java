...
public interface GoalPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int GOAL__ASSOCIATIONS = UrmlPackage.URML_MODEL_ELEMENT__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int GOAL__REVIEWED = UrmlPackage.URML_MODEL_ELEMENT__REVIEWED;
	 ...
	 * @ordered
	 */
	int GOAL_REFERENCE__ASSOCIATIONS = UrmlPackage.URML_MODEL_ELEMENT__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int GOAL_REFERENCE__REVIEWED = UrmlPackage.URML_MODEL_ELEMENT__REVIEWED;
