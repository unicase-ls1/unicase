...
public interface RequirementPackage extends EPackage {
	 ...
	 * @ordered
	 */
	int REQUIREMENT__ASSOCIATIONS = DangerPackage.MITIGATION__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int REQUIREMENT__REVIEWED = DangerPackage.MITIGATION__REVIEWED;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_REQUIREMENT__ASSOCIATIONS = REQUIREMENT__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int FUNCTIONAL_REQUIREMENT__REVIEWED = REQUIREMENT__REVIEWED;
	 ...
	 * @ordered
	 */
	int NON_FUNCTIONAL_REQUIREMENT__ASSOCIATIONS = REQUIREMENT__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int NON_FUNCTIONAL_REQUIREMENT__REVIEWED = REQUIREMENT__REVIEWED;
