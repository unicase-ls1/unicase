...
public interface UsecasePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int USE_CASE__ASSOCIATIONS = UrmlPackage.URML_MODEL_ELEMENT__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int USE_CASE__REVIEWED = UrmlPackage.URML_MODEL_ELEMENT__REVIEWED;
	 ...
	 * @ordered
	 */
	int APPLICATION_DOMAIN_USE_CASE__ASSOCIATIONS = USE_CASE__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int APPLICATION_DOMAIN_USE_CASE__REVIEWED = USE_CASE__REVIEWED;
	 ...
	 * @ordered
	 */
	int SOLUTION_DOMAIN_USE_CASE__ASSOCIATIONS = USE_CASE__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int SOLUTION_DOMAIN_USE_CASE__REVIEWED = USE_CASE__REVIEWED;
	 ...
	 * @ordered
	 */
	int ACTOR__ASSOCIATIONS = DangerPackage.ASSET__ASSOCIATIONS;
	 ...
	 * @ordered
	 */
	int ACTOR__REVIEWED = DangerPackage.ASSET__REVIEWED;
