...
import org.unicase.uiModeling.diagram.edit.parts.PanelEditPart;
import org.unicase.uiModeling.diagram.part.Messages;
import org.unicase.uiModeling.diagram.part.UiModelingDiagramEditor;
import org.unicase.uiModeling.diagram.part.UiModelingDiagramEditorPlugin;
import org.unicase.uiModeling.diagram.part.UiModelingDiagramEditorUtil;
...
public class OpenDiagramEditPolicy extends OpenEditPolicy {
	...
	private static class OpenDiagramCommand extends AbstractTransactionalCommand {
		...
		// FIXME canExecute if !(readOnly && getDiagramToOpen == null), i.e. open works on ro diagrams only when there's
		// associated diagram already
						...
						try {
							for (Iterator it = diagramFacet.eResource().getResourceSet().getResources().iterator(); it
								...
								if (nextResource.isLoaded() && !getEditingDomain().isReadOnly(nextResource)) {
									nextResource.save(UiModelingDiagramEditorUtil.getSaveOptions());
								}
							}
		...
		protected PreferencesHint getPreferencesHint() {
			...
			return UiModelingDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT;
		}
		...
		protected String getEditorID() {
			return UiModelingDiagramEditor.ID;
		}
	}
