 ...
 * @generated
 */
public class UiModelingBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected UiModelingBaseItemSemanticEditPolicy(IElementType elementType) {
		...
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(
					org.unicase.uiModeling.diagram.part.UiModelingVisualIDRegistry.getVisualID((View) view));
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = org.unicase.uiModeling.diagram.providers.UiModelingElementTypes
