...
public class TextEditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof TextTextEditPart) {
			((TextTextEditPart) childEditPart).setLabel(getPrimaryShape().getText_text());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WireframeVisualIDRegistry.getType(TextTextEditPart.VISUAL_ID));
	}
