...
import org.unicase.wireframe.diagram.edit.policies.Label2ItemSemanticEditPolicy;
...
public class Label2EditPart extends ShapeNodeEditPart {
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof LabelText2EditPart) {
			((LabelText2EditPart) childEditPart).setLabel(getPrimaryShape().getLabel_text());
			return true;
		}
		return false;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(WireframeVisualIDRegistry.getType(LabelText2EditPart.VISUAL_ID));
	}
