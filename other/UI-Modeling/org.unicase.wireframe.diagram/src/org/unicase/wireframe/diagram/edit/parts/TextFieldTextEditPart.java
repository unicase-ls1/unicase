 ...
 * @generated
 */
public class TextFieldTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TextFieldTextEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider.getParser(WireframeElementTypes.TextField_2005, getParserElement(),
				WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.TextFieldTextEditPart.VISUAL_ID));
		}
		return parser;
	}
