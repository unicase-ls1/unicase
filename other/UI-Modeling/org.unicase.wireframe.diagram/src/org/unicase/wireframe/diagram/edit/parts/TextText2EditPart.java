 ...
 * @generated
 */
public class TextText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TextText2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = WireframeParserProvider
				.getParser(WireframeElementTypes.Text_3004, getParserElement(), WireframeVisualIDRegistry
					.getType(org.unicase.wireframe.diagram.edit.parts.TextText2EditPart.VISUAL_ID));
		}
		return parser;
	}
