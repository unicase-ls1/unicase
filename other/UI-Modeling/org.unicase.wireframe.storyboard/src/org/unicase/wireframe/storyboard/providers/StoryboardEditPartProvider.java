...
import org.unicase.wireframe.storyboard.edit.parts.StoryboardEditPartFactory;
import org.unicase.wireframe.storyboard.part.StoryboardVisualIDRegistry;

/**
 * @generated
 */
public class StoryboardEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public StoryboardEditPartProvider() {
		setFactory(new StoryboardEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!StoryboardEditPart.MODEL_ID.equals(StoryboardVisualIDRegistry.getModelID(view))) {
				return false;
			}
