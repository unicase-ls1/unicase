...
import org.eclipse.emf.emfstore.common.model.provider.ModelItemProviderAdapterFactory;
 ...
 * @generated
 */
public class StoryboardDiagramEditorPlugin extends AbstractUIPlugin {

	/**
	 * @generated
	 */
	public static final String ID = "org.unicase.uiModeling.storyboard"; //$NON-NLS-1$
	 ...
	 * @generated
	 */
	private static StoryboardDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private org.unicase.uiModeling.storyboard.part.StoryboardDocumentProvider documentProvider;

	/**
	 * @generated
	 */
	private org.unicase.uiModeling.storyboard.providers.ElementInitializers initializers;

	/**
	 * @generated
	 */
	public StoryboardDiagramEditorPlugin() {
	}
	 ...
	 * @generated
	 */
	public static StoryboardDiagramEditorPlugin getInstance() {
		return instance;
	}
	...
	protected void fillItemProviderFactories(List<AdapterFactory> factories) {
		factories.add(new org.unicase.uiModeling.provider.UiModelingItemProviderAdapterFactory());
		factories.add(new ModelItemProviderAdapterFactory());
		factories.add(new DiagramItemProviderAdapterFactory());
		factories.add(new EcoreItemProviderAdapterFactory());
		factories.add(new org.unicase.model.provider.ModelItemProviderAdapterFactory());
		...
		factories.add(new org.eclipse.emf.emfstore.server.model.provider.ModelItemProviderAdapterFactory());
	 ...
	 * @generated
	 */
	public org.unicase.uiModeling.storyboard.part.StoryboardDocumentProvider getDocumentProvider() {
		if (documentProvider == null) {
			documentProvider = new org.unicase.uiModeling.storyboard.part.StoryboardDocumentProvider();
		}
	 ...
	 * @generated
	 */
	public org.unicase.uiModeling.storyboard.providers.ElementInitializers getElementInitializers() {
		return initializers;
	}
	 ...
	 * @generated
	 */
	public void setElementInitializers(org.unicase.uiModeling.storyboard.providers.ElementInitializers i) {
		this.initializers = i;
	}
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, StoryboardDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, StoryboardDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
