...
public interface Window extends Widget {
	 ...
	 * {@link org.unicase.uiModeling.Widget}. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Widgets</em>' containment reference isn't clear, there really should be more of a
	 * description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
