...
public class CheckboxImpl extends UnicaseModelElementImpl implements Checkbox {
	...
	public CheckboxGroup getGroup() {
		if (eContainerFeatureID() != UiModelingPackage.CHECKBOX__GROUP)
			return null;
	...
	public void setGroup(CheckboxGroup newGroup) {
		if (newGroup != eInternalContainer()
			|| (eContainerFeatureID() != UiModelingPackage.CHECKBOX__GROUP && newGroup != null)) {
			...
			if (newGroup != null)
				msgs = ((InternalEObject) newGroup).eInverseAdd(this, UiModelingPackage.CHECKBOX_GROUP__BOXES,
					CheckboxGroup.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case UiModelingPackage.CHECKBOX__GROUP:
			return eInternalContainer().eInverseRemove(this, UiModelingPackage.CHECKBOX_GROUP__BOXES,
				CheckboxGroup.class, msgs);
		}
