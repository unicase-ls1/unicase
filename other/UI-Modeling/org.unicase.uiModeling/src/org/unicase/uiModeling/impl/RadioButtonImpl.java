...
public class RadioButtonImpl extends UnicaseModelElementImpl implements RadioButton {
	...
	public RadioGroup getGroup() {
		if (eContainerFeatureID() != UiModelingPackage.RADIO_BUTTON__GROUP) return null;
	...
	public void setGroup(RadioGroup newGroup) {
		if (newGroup != eInternalContainer() || (eContainerFeatureID() != UiModelingPackage.RADIO_BUTTON__GROUP && newGroup != null)) {
			...
			if (newGroup != null)
				msgs = ((InternalEObject)newGroup).eInverseAdd(this, UiModelingPackage.RADIO_GROUP__BUTTONS, RadioGroup.class, msgs);
			msgs = basicSetGroup(newGroup, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UiModelingPackage.RADIO_BUTTON__GROUP, newGroup, newGroup));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case UiModelingPackage.RADIO_BUTTON__GROUP:
				return eInternalContainer().eInverseRemove(this, UiModelingPackage.RADIO_GROUP__BUTTONS, RadioGroup.class, msgs);
		}
