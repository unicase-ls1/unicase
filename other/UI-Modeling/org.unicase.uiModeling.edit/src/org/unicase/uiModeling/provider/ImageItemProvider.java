...
/**
 * This is the item provider adapter for a {@link org.unicase.uiModeling.Image} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class ImageItemProvider extends WidgetItemProvider implements IEditingDomainItemProvider,
	...
	protected void addImageURLPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
			...
			UiModelingPackage.Literals.IMAGE__IMAGE_URL, true, false, false,
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Image_type") : getString("_UI_Image_type") + " "
			+ label;
	}
