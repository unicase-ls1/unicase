...
public class DropdownItemItemProvider extends UnicaseModelElementItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DropdownItem_text_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DropdownItem_text_feature", "_UI_DropdownItem_type"),
				 UiModelingPackage.Literals.DROPDOWN_ITEM__TEXT,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/DropdownItem"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(DropdownItem.class)) {
