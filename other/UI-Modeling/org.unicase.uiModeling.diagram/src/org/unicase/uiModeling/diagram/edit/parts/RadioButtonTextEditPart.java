...
public class RadioButtonTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	/**
	 * @generated NOT: get the image for the parser element instead of its class
	 */
	protected Image getLabelIcon() {
		...
		return org.unicase.uiModeling.diagram.providers.UiModelingElementTypes.getImage(parserElement);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = org.unicase.uiModeling.diagram.providers.UiModelingParserProvider.getParser(
				org.unicase.uiModeling.diagram.providers.UiModelingElementTypes.RadioButton_3006, getParserElement(),
