...
public class Text2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.uiModeling.diagram.edit.policies.Text2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.unicase.uiModeling.diagram.edit.parts.TextText2EditPart) {
			((org.unicase.uiModeling.diagram.edit.parts.TextText2EditPart) childEditPart).setLabel(getPrimaryShape()
				.getText_text());
			return true;
		}
		return false;
	...
	public class TextDescriptor extends RectangleFigure {
		...
		public TextDescriptor() {
			...
			Dimension size = UiModelingDiagramUtil.getSize(Text2EditPart.this);
		...
		private void createContents() {
			...
			new UiModelingAdapter(Text2EditPart.this).adapt();
			// end of custom code
