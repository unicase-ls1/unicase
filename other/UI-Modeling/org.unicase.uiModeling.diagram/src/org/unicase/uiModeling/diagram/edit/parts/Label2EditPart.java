...
public class Label2EditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.uiModeling.diagram.edit.policies.Label2ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.unicase.uiModeling.diagram.edit.parts.LabelText2EditPart) {
			((org.unicase.uiModeling.diagram.edit.parts.LabelText2EditPart) childEditPart).setLabel(getPrimaryShape()
				.getLabel_text());
			return true;
		}
		return false;
	...
	public class LabelDescriptor extends RectangleFigure {
		...
		public LabelDescriptor() {
			...
			Dimension size = UiModelingDiagramUtil.getSize(Label2EditPart.this);
		...
		/**
		 * @generated NOT: added custom code to capture size changes
		 */
		private void createContents() {
			...
			new UiModelingAdapter(Label2EditPart.this).adapt();
			// end of custom code
