 ...
 * @generated
 */
public class DropdownListEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public DropdownListEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.uiModeling.diagram.edit.policies.DropdownListItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.unicase.uiModeling.diagram.edit.parts.WrappingLabelEditPart) {
			((org.unicase.uiModeling.diagram.edit.parts.WrappingLabelEditPart) childEditPart)
				.setLabel(getPrimaryShape().getDropdownList_text());
			return true;
		}
		if (childEditPart instanceof org.unicase.uiModeling.diagram.edit.parts.DropdownListDropdownItemsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDropdownList_items();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way
			pane.add(((org.unicase.uiModeling.diagram.edit.parts.DropdownListDropdownItemsCompartmentEditPart) childEditPart)
				.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof org.unicase.uiModeling.diagram.edit.parts.DropdownListDropdownItemsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getDropdownList_items();
			pane.remove(((org.unicase.uiModeling.diagram.edit.parts.DropdownListDropdownItemsCompartmentEditPart) childEditPart)
				.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof org.unicase.uiModeling.diagram.edit.parts.DropdownListDropdownItemsCompartmentEditPart) {
	...
	public class DropdownListDescriptor extends RectangleFigure {
		...
		private void createContents() {
			...
			EObject element = EditPartUtility.getElement(DropdownListEditPart.this);
