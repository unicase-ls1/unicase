...
public class ApplyPatchAttachmentOperation extends Thread {
	 ...
	 */
	public ApplyPatchAttachmentOperation(IWorkbenchPart part, IStorage patch, IResource target, CompareConfiguration configuration) {
	 ...
	 */
	public ApplyPatchAttachmentOperation(IWorkbenchPart targetPart, IResource resource) {
	...
	public void openWizard() {
		...
		if (saveAllEditors) {
			...
			canceled = dialog.open() == Window.CANCEL;
