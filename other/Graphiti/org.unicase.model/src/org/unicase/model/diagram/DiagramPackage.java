...
public interface DiagramPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link org.unicase.model.diagram.impl.GDiagramImpl <em>GDiagram</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.unicase.model.diagram.impl.GDiagramImpl
	 * @see org.unicase.model.diagram.impl.DiagramPackageImpl#getGDiagram()
	 * @generated
	 */
	int GDIAGRAM = 7;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__NAME = ModelPackage.ATTACHMENT__NAME;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__DESCRIPTION = ModelPackage.ATTACHMENT__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__ANNOTATIONS = ModelPackage.ATTACHMENT__ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__ATTACHMENTS = ModelPackage.ATTACHMENT__ATTACHMENTS;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__INCOMING_DOCUMENT_REFERENCES = ModelPackage.ATTACHMENT__INCOMING_DOCUMENT_REFERENCES;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__LEAF_SECTION = ModelPackage.ATTACHMENT__LEAF_SECTION;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__STATE = ModelPackage.ATTACHMENT__STATE;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__APPLIED_STEREOTYPE_INSTANCES = ModelPackage.ATTACHMENT__APPLIED_STEREOTYPE_INSTANCES;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__COMMENTS = ModelPackage.ATTACHMENT__COMMENTS;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__CREATION_DATE = ModelPackage.ATTACHMENT__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__CREATOR = ModelPackage.ATTACHMENT__CREATOR;
	 ...
	 * @ordered
	 */
	int GDIAGRAM__REFERRING_MODEL_ELEMENTS = ModelPackage.ATTACHMENT__REFERRING_MODEL_ELEMENTS;

	/**
	 * The feature id for the '<em><b>Graphiti Diagram</b></em>' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GDIAGRAM__GRAPHITI_DIAGRAM = ModelPackage.ATTACHMENT_FEATURE_COUNT + 0;

	/**
	 * The number of structural features of the '<em>GDiagram</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int GDIAGRAM_FEATURE_COUNT = ModelPackage.ATTACHMENT_FEATURE_COUNT + 1;

	/**
	 * The meta object id for the '{@link org.unicase.model.diagram.impl.OrgChartDiagramImpl <em>Org Chart Diagram</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.unicase.model.diagram.impl.OrgChartDiagramImpl
	 * @see org.unicase.model.diagram.impl.DiagramPackageImpl#getOrgChartDiagram()
	 * @generated
	 */
	int ORG_CHART_DIAGRAM = 8;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__NAME = GDIAGRAM__NAME;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__DESCRIPTION = GDIAGRAM__DESCRIPTION;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__ANNOTATIONS = GDIAGRAM__ANNOTATIONS;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__ATTACHMENTS = GDIAGRAM__ATTACHMENTS;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__INCOMING_DOCUMENT_REFERENCES = GDIAGRAM__INCOMING_DOCUMENT_REFERENCES;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__LEAF_SECTION = GDIAGRAM__LEAF_SECTION;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__STATE = GDIAGRAM__STATE;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__APPLIED_STEREOTYPE_INSTANCES = GDIAGRAM__APPLIED_STEREOTYPE_INSTANCES;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__COMMENTS = GDIAGRAM__COMMENTS;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__CREATION_DATE = GDIAGRAM__CREATION_DATE;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__CREATOR = GDIAGRAM__CREATOR;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__REFERRING_MODEL_ELEMENTS = GDIAGRAM__REFERRING_MODEL_ELEMENTS;
	 ...
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM__GRAPHITI_DIAGRAM = GDIAGRAM__GRAPHITI_DIAGRAM;

	/**
	 * The number of structural features of the '<em>Org Chart Diagram</em>' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int ORG_CHART_DIAGRAM_FEATURE_COUNT = GDIAGRAM_FEATURE_COUNT + 0;
	...
	/**
	 * Returns the meta object for class '{@link org.unicase.model.diagram.GDiagram <em>GDiagram</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>GDiagram</em>'.
	 * @see org.unicase.model.diagram.GDiagram
	 * @generated
	 */
	EClass getGDiagram();

	/**
	 * Returns the meta object for the containment reference '{@link org.unicase.model.diagram.GDiagram#getGraphitiDiagram <em>Graphiti Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference '<em>Graphiti Diagram</em>'.
	 * @see org.unicase.model.diagram.GDiagram#getGraphitiDiagram()
	 * @see #getGDiagram()
	 * @generated
	 */
	EReference getGDiagram_GraphitiDiagram();

	/**
	 * Returns the meta object for class '{@link org.unicase.model.diagram.OrgChartDiagram <em>Org Chart Diagram</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Org Chart Diagram</em>'.
	 * @see org.unicase.model.diagram.OrgChartDiagram
	 * @generated
	 */
	EClass getOrgChartDiagram();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '{@link org.unicase.model.diagram.impl.GDiagramImpl <em>GDiagram</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.unicase.model.diagram.impl.GDiagramImpl
		 * @see org.unicase.model.diagram.impl.DiagramPackageImpl#getGDiagram()
		 * @generated
		 */
		EClass GDIAGRAM = eINSTANCE.getGDiagram();

		/**
		 * The meta object literal for the '<em><b>Graphiti Diagram</b></em>' containment reference feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference GDIAGRAM__GRAPHITI_DIAGRAM = eINSTANCE.getGDiagram_GraphitiDiagram();

		/**
		 * The meta object literal for the '{@link org.unicase.model.diagram.impl.OrgChartDiagramImpl <em>Org Chart Diagram</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see org.unicase.model.diagram.impl.OrgChartDiagramImpl
		 * @see org.unicase.model.diagram.impl.DiagramPackageImpl#getOrgChartDiagram()
		 * @generated
		 */
		EClass ORG_CHART_DIAGRAM = eINSTANCE.getOrgChartDiagram();
