...
import org.unicase.model.diagram.OrgChartDiagram;
...
public class DiagramPackageImpl extends EPackageImpl implements DiagramPackage {
	 ...
	 * @generated
	 */
	private EClass gDiagramEClass = null;
	 ...
	 * @generated
	 */
	private EClass orgChartDiagramEClass = null;
	 ...
	 * @generated
	 */
	public EClass getGDiagram() {
		return gDiagramEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getGDiagram_GraphitiDiagram() {
		return (EReference) gDiagramEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EClass getOrgChartDiagram() {
		return orgChartDiagramEClass;
	}
	...
	public void createPackageContents() {
		...
		gDiagramEClass = createEClass(GDIAGRAM);
		createEReference(gDiagramEClass, GDIAGRAM__GRAPHITI_DIAGRAM);

		orgChartDiagramEClass = createEClass(ORG_CHART_DIAGRAM);
	}
	...
	public void initializePackageContents() {
		...
		PictogramsPackage thePictogramsPackage = (PictogramsPackage) EPackage.Registry.INSTANCE
			.getEPackage(PictogramsPackage.eNS_URI);
		...
		gDiagramEClass.getESuperTypes().add(theModelPackage.getAttachment());
		orgChartDiagramEClass.getESuperTypes().add(this.getGDiagram());
		...
		initEClass(gDiagramEClass, GDiagram.class, "GDiagram", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getGDiagram_GraphitiDiagram(), thePictogramsPackage.getDiagram(), null, "graphitiDiagram", null,
			0, 1, GDiagram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(orgChartDiagramEClass, OrgChartDiagram.class, "OrgChartDiagram", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
	}
