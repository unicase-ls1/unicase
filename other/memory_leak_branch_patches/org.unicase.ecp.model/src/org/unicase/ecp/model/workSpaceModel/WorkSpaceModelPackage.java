 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see org.unicase.ecp.model.workSpaceModel.WorkSpaceModelFactory
 * @model kind="package"
 * @generated
 */
public interface WorkSpaceModelPackage extends EPackage {
	 ...
	 * @generated
	 */
	WorkSpaceModelPackage eINSTANCE = org.unicase.ecp.model.workSpaceModel.impl.WorkSpaceModelPackageImpl.init();

	/**
	 * The meta object id for the '{@link org.unicase.ecp.model.workSpaceModel.impl.ECPWorkspaceImpl <em>ECP Workspace</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see org.unicase.ecp.model.workSpaceModel.impl.ECPWorkspaceImpl
	 * @see org.unicase.ecp.model.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPWorkspace()
	 * @generated
	 */
	int ECP_WORKSPACE = 0;
	...
	/**
	 * The meta object id for the '{@link org.unicase.ecp.model.workSpaceModel.impl.ECPProjectImpl <em>ECP Project</em>}' class.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @see org.unicase.ecp.model.workSpaceModel.impl.ECPProjectImpl
	 * @see org.unicase.ecp.model.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPProject()
	 * @generated
	 */
	int ECP_PROJECT = 1;
	...
	/**
	 * Returns the meta object for class '{@link org.unicase.ecp.model.workSpaceModel.ECPWorkspace <em>ECP Workspace</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @return the meta object for class '<em>ECP Workspace</em>'.
	 * @see org.unicase.ecp.model.workSpaceModel.ECPWorkspace
	 * @generated
	 */
	EClass getECPWorkspace();

	/**
	 * Returns the meta object for the containment reference list '{@link org.unicase.ecp.model.workSpaceModel.ECPWorkspace#getProjects <em>Projects</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the reference '{@link org.unicase.ecp.model.workSpaceModel.ECPWorkspace#getActiveProject <em>Active Project</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link org.unicase.ecp.model.workSpaceModel.ECPProject <em>ECP Project</em>}'.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the container reference '{@link org.unicase.ecp.model.workSpaceModel.ECPProject#getWorkspace <em>Workspace</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the container reference '<em>Workspace</em>'.
	 * @see org.unicase.ecp.model.workSpaceModel.ECPProject#getWorkspace()
	 * @see #getECPProject()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the reference '{@link org.unicase.ecp.model.workSpaceModel.ECPProject#getRootObject <em>Root Object</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Root Object</em>'.
	 * @see org.unicase.ecp.model.workSpaceModel.ECPProject#getRootObject()
	 * @see #getECPProject()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.unicase.ecp.model.workSpaceModel.impl.ECPWorkspaceImpl <em>ECP Workspace</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @see org.unicase.ecp.model.workSpaceModel.impl.ECPWorkspaceImpl
		 * @see org.unicase.ecp.model.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPWorkspace()
		 * @generated
		...
		/**
		 * The meta object literal for the '{@link org.unicase.ecp.model.workSpaceModel.impl.ECPProjectImpl <em>ECP Project</em>}' class.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * @see org.unicase.ecp.model.workSpaceModel.impl.ECPProjectImpl
		 * @see org.unicase.ecp.model.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPProject()
		 * @generated
