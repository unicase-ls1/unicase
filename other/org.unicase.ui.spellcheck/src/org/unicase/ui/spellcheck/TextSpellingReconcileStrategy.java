 ...
 * @since 3.3
 */
public class TextSpellingReconcileStrategy implements IReconcilingStrategy, IReconcilingStrategyExtension {
	...
	private class SpellingProblemCollector implements ISpellingProblemCollector {
		...
		/*
		 * @seeorg.eclipse.ui.texteditor.spelling.ISpellingProblemCollector#accept(org.eclipse.ui.texteditor.spelling.
		 * SpellingProblem)
		 */
	...
	/**
	 * Region array, used to prevent us from creati ng a new array on each reconcile pass.
	 * 
	 * @since 3.4
	 */
	 ...
	 */
	public TextSpellingReconcileStrategy(ISourceViewer viewer, SpellingService spellingService) {
...
/*
	public static IReconciler getReconciler(ISourceViewer sourceViewer) {
		...
		IReconcilingStrategy strategy = new TextSpellingReconcileStrategy(sourceViewer, spellingService);
	 ...
	 * 
	 * @return the content type of the underlying editor input or <code>null</code> if none could be determined
	 */
	...
	/*
	 * @seeorg.eclipse.jface.text.reconciler.IReconcilingStrategyExtension#setProgressMonitor(org.eclipse.core.runtime.
	 * IProgressMonitor)
	 */
	 ...
	 * 
	 * @return the annotation model of the underlying editor input or <code>null</code> if none could be determined
	 */
