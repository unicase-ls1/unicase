...
public class MESpellcheckRichTextControl extends MERichTextControl {
	...
	private static SpellingService spellService;
	...
	public Control createControl(Composite parent, int style) {
		...
		spellService = EditorsPlugin.getDefault().getSpellingService();
		createToolBar();
		createStyledText();
		eAdapter = new AdapterImpl() {
			@Override
			public void notifyChanged(Notification msg) {
				if (msg.getFeature() != null && msg.getFeature().equals(MESpellcheckRichTextControl.this.attribute)) {
					load();
				}
