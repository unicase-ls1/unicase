 ...
 * @model annotation=
 *        "http://unicase.org/operations description='An association to an abstract class is partitioned into seperate associations for every subclass.' label='Partition Association'"
 * @generated
 */
