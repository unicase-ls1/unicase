...
public interface OperationsFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Extract Class Operation</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Push Down Operation</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Pull Up Operation</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
