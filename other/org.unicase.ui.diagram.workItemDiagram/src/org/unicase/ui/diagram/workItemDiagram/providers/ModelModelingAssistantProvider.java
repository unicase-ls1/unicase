...
public class ModelModelingAssistantProvider extends ModelingAssistantProvider {
	...
	public List getTypesForPopupBar(IAdaptable host) {
		...
		if (editPart instanceof org.unicase.ui.diagram.workItemDiagram.edit.parts.MEDiagramEditPart) {
	...
	protected EObject selectElement(EObject[] elements) {
		...
		ElementListSelectionDialog dialog = new ElementListSelectionDialog(
				shell, labelProvider);
		dialog
				.setMessage(org.unicase.ui.diagram.workItemDiagram.part.Messages.ModelModelingAssistantProviderMessage);
		dialog
				.setTitle(org.unicase.ui.diagram.workItemDiagram.part.Messages.ModelModelingAssistantProviderTitle);
