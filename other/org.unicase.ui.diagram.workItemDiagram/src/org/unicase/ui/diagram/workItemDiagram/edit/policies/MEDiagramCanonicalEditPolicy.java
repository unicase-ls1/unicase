...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.ui.diagram.workItemDiagram.part.ModelDiagramUpdater
				.getMEDiagram_33SemanticChildren(viewObject).iterator(); it
				.hasNext();) {
			result
					.add(((org.unicase.ui.diagram.workItemDiagram.part.ModelNodeDescriptor) it
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator
			...
			int diagramLinkVisualID = org.unicase.ui.diagram.workItemDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator
					.hasNext();) {
				org.unicase.ui.diagram.workItemDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.workItemDiagram.part.ModelLinkDescriptor) LinkDescriptorsIterator
						.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.diagram.workItemDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
						.addAll(org.unicase.ui.diagram.workItemDiagram.part.ModelDiagramUpdater
	...
	private Collection createConnections(Collection linkDescriptors,
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator
				.hasNext();) {
			final org.unicase.ui.diagram.workItemDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.workItemDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
					.next();
