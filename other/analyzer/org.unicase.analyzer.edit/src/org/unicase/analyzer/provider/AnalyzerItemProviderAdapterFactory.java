...
public class AnalyzerItemProviderAdapterFactory extends AnalyzerAdapterFactory
	 ...
	 * {@link org.unicase.analyzer.ProjectAnalysisData} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	 ...
	 * {@link org.unicase.analyzer.ProjectAnalysisData}. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createProjectAnalysisDataAdapter() {
		if (projectAnalysisDataItemProvider == null) {
			projectAnalysisDataItemProvider = new ProjectAnalysisDataItemProvider(
					this);
		}
	...
	/**
	 * This keeps track of the one adapter used for all
	 * {@link org.unicase.analyzer.AnalyzerConfiguration} instances. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a
	 * {@link org.unicase.analyzer.AnalyzerConfiguration}. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	...
	public Adapter createAnalyzerConfigurationAdapter() {
		if (analyzerConfigurationItemProvider == null) {
			analyzerConfigurationItemProvider = new AnalyzerConfigurationItemProvider(
					this);
		}
	...
	public void dispose() {
		if (projectAnalysisDataItemProvider != null)
			projectAnalysisDataItemProvider.dispose();
		if (analyzerConfigurationItemProvider != null)
			analyzerConfigurationItemProvider.dispose();
	}
