...
public class VersionSpecQueryItemProvider extends ItemProviderAdapter implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(
		...
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(IteratorPackage.Literals.VERSION_SPEC_QUERY__END_VERSION);
			childrenFeatures
					.add(IteratorPackage.Literals.VERSION_SPEC_QUERY__START_VERSION);
		}
	...
	/**
	 * This returns VersionSpecQuery.gif. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
