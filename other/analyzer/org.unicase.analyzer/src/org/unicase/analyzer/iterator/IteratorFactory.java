...
public interface IteratorFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Version Iterator</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Time Iterator</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>Version Spec Query</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
