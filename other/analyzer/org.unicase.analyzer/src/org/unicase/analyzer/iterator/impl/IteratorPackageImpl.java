...
public class IteratorPackageImpl extends EPackageImpl implements IteratorPackage {
	...
	public static IteratorPackage init() {
		...
		IteratorPackageImpl theIteratorPackage = (IteratorPackageImpl) (EPackage.Registry.INSTANCE.getEPackage(eNS_URI) instanceof IteratorPackageImpl ? EPackage.Registry.INSTANCE
			.getEPackage(eNS_URI)
			: new IteratorPackageImpl());
		...
		AnalyzerPackageImpl theAnalyzerPackage = (AnalyzerPackageImpl) (EPackage.Registry.INSTANCE
			.getEPackage(AnalyzerPackage.eNS_URI) instanceof AnalyzerPackageImpl ? EPackage.Registry.INSTANCE
			.getEPackage(AnalyzerPackage.eNS_URI) : AnalyzerPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEClass(versionIteratorEClass, VersionIterator.class, "VersionIterator", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getVersionIterator_StepLength(), ecorePackage.getEInt(), "stepLength", null, 0, 1,
			VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEReference(getVersionIterator_ProjectId(), theEsmodelPackage.getProjectId(), null, "projectId", null, 0, 1,
			VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
			!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersionIterator_Forward(), ecorePackage.getEBoolean(), "forward", null, 0, 1,
			VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersionIterator_ReturnProjectDataCopy(), theEcorePackage.getEBoolean(),
			"returnProjectDataCopy", null, 0, 1, VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
			!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVersionIterator_VersionSpecQuery(), this.getVersionSpecQuery(), null, "versionSpecQuery",
			null, 0, 1, VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
			!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getVersionIterator_Default(), theEcorePackage.getEBoolean(), "default", null, 0, 1,
			VersionIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);

		initEClass(timeIteratorEClass, TimeIterator.class, "TimeIterator", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getTimeIterator_StartDate(), ecorePackage.getEDate(), "startDate", null, 0, 1,
			TimeIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeIterator_EndDate(), ecorePackage.getEDate(), "endDate", null, 0, 1, TimeIterator.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTimeIterator_StepLengthUnit(), theEcorePackage.getEInt(), "stepLengthUnit", null, 0, 1,
			TimeIterator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
			!IS_DERIVED, IS_ORDERED);

		initEClass(versionSpecQueryEClass, VersionSpecQuery.class, "VersionSpecQuery", !IS_ABSTRACT, !IS_INTERFACE,
			IS_GENERATED_INSTANCE_CLASS);
		initEReference(getVersionSpecQuery_EndVersion(), theVersioningPackage.getVersionSpec(), null, "endVersion",
			null, 0, 1, VersionSpecQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
			!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getVersionSpecQuery_StartVersion(), theVersioningPackage.getVersionSpec(), null, "startVersion",
			null, 0, 1, VersionSpecQuery.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
			!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
