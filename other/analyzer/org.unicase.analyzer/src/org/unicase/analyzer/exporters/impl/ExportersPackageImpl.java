...
public class ExportersPackageImpl extends EPackageImpl implements ExportersPackage {
	...
	public static ExportersPackage init() {
		if (isInited)
			return (ExportersPackage) EPackage.Registry.INSTANCE.getEPackage(ExportersPackage.eNS_URI);

		// Obtain or create and register package
		ExportersPackageImpl theExportersPackage = (ExportersPackageImpl) (EPackage.Registry.INSTANCE
			.getEPackage(eNS_URI) instanceof ExportersPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(eNS_URI)
			: new ExportersPackageImpl());
	...
	public void initializePackageContents() {
		...
		initEAttribute(getExporter_FileName(), theEcorePackage.getEString(), "fileName", null, 0, 1, Exporter.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getExporter_Overwrite(), theEcorePackage.getEBoolean(), "overwrite", null, 0, 1, Exporter.class,
			!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	}
