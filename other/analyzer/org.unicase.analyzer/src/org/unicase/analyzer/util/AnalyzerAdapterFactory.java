...
public class AnalyzerAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected AnalyzerSwitch<Adapter> modelSwitch = new AnalyzerSwitch<Adapter>() {
		@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.analyzer.ProjectAnalysisData
	 * <em>Project Analysis Data</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.analyzer.AnalyzerConfiguration
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.analyzer.TwoDDataAnalyzer
	 * <em>Two DData Analyzer</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 * @return the new adapter.
