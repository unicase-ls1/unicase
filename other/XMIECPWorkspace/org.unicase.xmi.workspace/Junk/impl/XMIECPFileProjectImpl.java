...
public class XMIECPFileProjectImpl extends ECPProjectImpl implements XMIECPFileProject {
	 ...
	 * @ordered
	 */
	protected static final String XMI_FILE_PATH_EDEFAULT = new DefaultWorkspaceLocationProvider().getWorkspaceDirectory() + "xmiworkspace.ucw";
	 ...
	 */
	private void init() {
		// set root object with the project itself
		setRootObject(this);
		...
		if(!this.resource.getContents().isEmpty()) {
			...
			//TODO set Name
			XMIECPFileProjectImpl thisProject = (XMIECPFileProjectImpl) rootObject;
			baseElements.addAll(thisProject.getRootLevel());
		}
	...
	public void setXmiFilePath(String newXmiFilePath) {
		...
		//if(!oldXmiFilePath.equals(xmiFilePath))	init();
		init();
	}
	...
	public boolean contains(EObject eObject) {
		if(eObject.equals(this)) return true;
