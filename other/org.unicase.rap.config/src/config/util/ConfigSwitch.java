...
public class ConfigSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ConfigPackage.CONFIG_ENTITY: {
				ConfigEntity configEntity = (ConfigEntity)theEObject;
				T result = caseConfigEntity(configEntity);
				if (result == null) result = caseModelElement(configEntity);
				if (result == null) result = caseIdentifiableElement(configEntity);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ConfigPackage.STRING_TO_OBJECT: {
	 ...
	 * @generated
	 */
	public T caseConfigEntity(ConfigEntity object) {
		return null;
	}
