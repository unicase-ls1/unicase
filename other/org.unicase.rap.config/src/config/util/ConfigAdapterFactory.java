...
public class ConfigAdapterFactory extends AdapterFactoryImpl {
	...
	protected ConfigSwitch<Adapter> modelSwitch =
		new ConfigSwitch<Adapter>() {
			@Override
			public Adapter caseConfigEntity(ConfigEntity object) {
				return createConfigEntityAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link config.ConfigEntity <em>Entity</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createConfigEntityAdapter() {
		return null;
	}
