...
/**
 * This class test all the functionality concerning delete adapter in MEEDitor.
 * 
 * @author Nitesh
 */
public class MEHyperlinkDeleteAdapterTest extends MEEditorTest {
	...
	/**
	 * Test the functionality of delete adapter by simulating mouse click and removing a reviewer for an action item and
	 * checking if this event gets updated for that ME.
	 */
	...
	/**
	 * Test deleting removing of a reference using delete adapter from within Multilink widget. Finally verifies if the
	 * change is persistent for the ME.
	 */
	@SuppressWarnings("unchecked")
	@Test
