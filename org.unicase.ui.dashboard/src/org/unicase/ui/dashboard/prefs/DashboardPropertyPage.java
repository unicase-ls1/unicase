...
public class DashboardPropertyPage extends PropertyPage {
	...
	private final class SavePropertiesCommand extends
		...
		protected Object doRun() {
			...
			for (EObject me : subscriptions) {
				subscriptionsIds.add(ModelUtil.getProject(me).getModelElementId(me));
			}
	...
	private void loadProperties() {
		...
		OrgUnitProperty dashboardSize = PreferenceManager.INSTANCE.getProperty(
				projectSpace, DashboardKey.DASHBOARD_SIZE);
	...
	private void loadProviderProperties() {
		OrgUnitProperty taskProvider = PreferenceManager.INSTANCE.getProperty(
				projectSpace, DashboardKey.TASK_PROVIDER);
		...
		OrgUnitProperty taskChangeProvider = PreferenceManager.INSTANCE
				.getProperty(projectSpace, DashboardKey.TASK_CHANGE_PROVIDER);
		...
		OrgUnitProperty taskReviewProvider = PreferenceManager.INSTANCE
				.getProperty(projectSpace, DashboardKey.TASK_REVIEW_PROVIDER);
		...
		OrgUnitProperty subscriptionProvider = PreferenceManager.INSTANCE
				.getProperty(projectSpace, DashboardKey.SUBSCRIPTION_PROVIDER);
