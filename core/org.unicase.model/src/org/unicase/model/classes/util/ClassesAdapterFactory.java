...
public class ClassesAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.unicase.model.classes.Class <em>Class</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.classes.PackageElement
	 * <em>Package Element</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.classes.MethodArgument
	 * <em>Method Argument</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.classes.Dependency <em>Dependency</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful
	 * to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
