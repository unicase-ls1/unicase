...
/**
 * <!-- begin-user-doc --> A representation of the literals of the enumeration '<em><b>IPrimitive Type</b></em>', and
 * utility methods for working with them. <!-- end-user-doc -->
 * 
 * @see org.unicase.model.implementation.ImplementationPackage#getIPrimitiveType()
 * @model
 * @generated
 */
public enum IPrimitiveType implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>IPrimitive Type</b></em>' enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	private static final IPrimitiveType[] VALUES_ARRAY = new IPrimitiveType[] { STRING, BOOLEAN, INTEGER, DATE, DOUBLE,
		ENUMERATION, };

	/**
	 * A public read-only list of all the '<em><b>IPrimitive Type</b></em>' enumerators. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<IPrimitiveType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>IPrimitive Type</b></em>' literal with the specified literal value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static IPrimitiveType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IPrimitiveType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>IPrimitive Type</b></em>' literal with the specified name. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 */
	public static IPrimitiveType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			IPrimitiveType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>IPrimitive Type</b></em>' literal with the specified integer value. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static IPrimitiveType get(int value) {
		switch (value) {
		case STRING_VALUE:
			return STRING;
		case BOOLEAN_VALUE:
	 ...
	 * @generated
	 */
	private IPrimitiveType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
