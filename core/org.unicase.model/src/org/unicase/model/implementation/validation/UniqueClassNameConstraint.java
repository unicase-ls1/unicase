 ...
 * @author herrmama
 */
public class UniqueClassNameConstraint extends UniqueNameConstraintBase<IPackage> {

	/**
	 * Constructor.
	 */
	public UniqueClassNameConstraint() {
		super(ImplementationPackage.Literals.ICLASS__PARENT_PACKAGE, Arrays.asList(
