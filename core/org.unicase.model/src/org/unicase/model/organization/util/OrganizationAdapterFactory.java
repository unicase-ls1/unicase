...
public class OrganizationAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.unicase.model.organization.User <em>User</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.model.organization.OrgUnit <em>Org Unit</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.unicase.model.organization.Group <em>Group</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
