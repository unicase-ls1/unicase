 ...
 * @model annotation=
 *        "http://unicase.org/operations description='A set of attributes and associations are extracted to a new class which is reachable trough a composition.' label='Extract Class'"
 * @generated
 */
public interface ExtractClassOperation extends SemanticCompositeOperation {
	...
	/**
	 * <!-- begin-user-doc --> Get all possible outgoing associations suitable for extraction.
	 * 
	 * @param project the project to apply the operation on
	 * @return the list of associations <!-- end-user-doc -->
	 * @model
	 * @generated
	 */
	...
	/**
	 * <!-- begin-user-doc --> Get all incoming associations that are to be extracted. <!-- end-user-doc -->
	 * 
	 * @model annotation=
	...
	/**
	 * <!-- begin-user-doc --> Get all possible incoming associations for extraction. <!-- end-user-doc -->
	 * 
	 * @model
	 * @generated
	 */
	...
	/**
	 * <!-- begin-user-doc --> Validate the new class name to avoid name collisions. <!-- end-user-doc -->
	 * 
	 * @model required="true"
	...
	/**
	 * <!-- begin-user-doc --> Validate name of the composition to check for name collisions. <!-- end-user-doc -->
	 * 
	 * @model required="true" annotation=
