...
/**
 * MetaModelContext used by the editor to determine which model elements belong
 * to the model.
 * 
 * @author helming
 */
public abstract class MetaModelElementContext {
	...
	/**
	 * Retrieve all EClasses from the ECore package registry that are subclasses
	 * of the given EClass. Does not include abstract classes or interfaces.
	 * 
	 * @param eClass
	...
	/**
	 * Returns all types of model elements in this context. Could exclude
	...
	protected Set<EClass> getAllModelElementEClassesImpl() {
		...
		for (Entry<String, Object> entry : new HashSet<Entry<String, Object>>(
			...
			// BEGIN SUPRESS CATCH EXCEPTION
				...
				String message = "Failed to load model package "
						+ entry.getKey();
				Activator.getDefault().logException(message,
	...
	private boolean isKnownPackage(String key) {
		...
		String elements[] = { "http://www.eclipse.org/gmf/2008/mappings",
				...
				"http://unicase.org/emfstore/esmodel",
				"http://www.cs.tum.edu/cope/migration",
				"http://unicase.org/esmodel/accesscontrol/roles",
				"http:///com/ibm/etools/dtd.ecore",
				"http:///www.eclipse.org/m2m/qvt/operational/trace.ecore",
				"http://www.eclipse.org/qvt/1.0.0/Operational/Expressions",
				"http://www.eclipse.org/gmf/2006/GenModel",
				"http://www.eclipse.org/uml2/3.0.0/UML",
				"http://www.eclipse.org/uml2/2.0.0/UML",
				"http://www.eclipse.org/gmf/runtime/1.0.0/notation",
				"http://www.eclipse.org/emf/2002/Tree",
				"http://www.eclipse.org/OCL2/1.0.0/ocl/uml",
				"http://www.eclipse.org/OCL2/1.0.0/ocl/types",
				"http://unicase.org/esmodel/versioning/events",
				"http://www.eclipse.org/emf/2003/Change",
				"http://www.eclipse.org/OCL2/1.0.0/ocl/query",
				"http://www.eclipse.org/gmf/2006/Trace",
				"http://www.eclipse.org/QVT2/1.0.0/Operational/cst",
				"http://unicase.org/esmodel/accesscontrol",
				"http://www.eclipse.org/emf/2005/Ecore2XML",
				"http://unicase.org/esmodel/versioning/operations",
				"http://www.eclipse.org/emf/2002/Ecore",
				"http://www.eclipse.org/QVT2/1.0.0/Operational/cst/temp",
				"http://www.eclipse.org/gmf/2005/GenModel/2.0",
				"http://www.eclipse.org/gmf/2005/ToolDefinition",
				"http://unicase.org/esmodel/versioning",
				"http://www.cs.tum.edu/cope/declaration",
				"http://www.eclipse.org/gmf/2005/GenModel",
				"http://www.eclipse.org/gmf/2005/mappings",
				"http://unicase.org/workspace",
				...
				"http://www.eclipse.org/gmf/2005/mappings/2.0",
				...
				"moduleCore.xmi", "http://www.eclipse.org/emf/2002/XSD2Ecore",
				"http://unicase.org/workspaceModel",
				...
				"http://unicase.org/metamodel",
				"http://www.eclipse.org/gmf/2008/GenModel", "DTD.xmi",
				"http://www.eclipse.org/ocl/1.1.0/OCL/CST",
				"http://www.eclipse.org/OCL2/1.0.0/ocl/expressions",
				"componentcore.xmi", "http://www.eclipse.org/ocl/1.1.0/Ecore",
				"http://unicase.org/esmodel/notification",
				"http://www.eclipse.org/OCL2/1.0.0/oclstdlib",
				"http://unicase.org/esmodel/versioning/events/server/",
				"http://unicase.org/emfstore/esmodel/url",
	...
	/**
	 * @param newMEInstance
	 *            {@link EObject} the new modelElement instance.
	 * @return EReference the Container
	 * @param parent
	 *            The EObject to get containment references from
	 */
	public EReference getPossibleContainingReference(
			final EObject newMEInstance, EObject parent) {
	...
	/**
	 * Retrieve all EClasses from the Ecore package that are model element
	 * subclasses.
	 * 
	 * @param ePackage
	...
	/**
	 * If the meta model context is guessing the packages. Happens if no model
	 * package is registered for EMF Client Platform.
	 * 
