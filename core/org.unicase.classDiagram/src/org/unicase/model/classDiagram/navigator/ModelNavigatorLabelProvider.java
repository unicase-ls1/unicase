...
public class ModelNavigatorLabelProvider extends LabelProvider implements
	...
	public Image getImage(View view) {
		...
		case org.unicase.model.classDiagram.edit.parts.ClassSuperClassesEditPart.VISUAL_ID:
			return getImage(
					"Navigator?Link?http://unicase.org/model/classes?Class?superClasses", org.unicase.model.classDiagram.providers.ModelElementTypes.ClassSuperClasses_4007); //$NON-NLS-1$
