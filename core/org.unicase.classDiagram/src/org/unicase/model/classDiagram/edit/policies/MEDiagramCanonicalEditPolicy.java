...
import org.unicase.model.classDiagram.part.ShowRelatedElementsController;
...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.model.classDiagram.part.ModelDiagramUpdater.getMEDiagram_88SemanticChildren(
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			int diagramLinkVisualID = org.unicase.model.classDiagram.part.ModelVisualIDRegistry
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.model.classDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(org.unicase.model.classDiagram.part.ModelDiagramUpdater
		...
		case org.unicase.model.classDiagram.edit.parts.ClassEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result
					.addAll(org.unicase.model.classDiagram.part.ModelDiagramUpdater.getClass_2001ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement()) || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
			}
	...
	private Collection createConnections(Collection linkDescriptors, Map domain2NotationMap) {
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator.hasNext();) {
			final org.unicase.model.classDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.model.classDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
				.next();
