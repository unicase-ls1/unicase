...
public class ModelViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return org.unicase.ui.diagram.componentDiagram.edit.parts.MEDiagramEditPart.MODEL_ID.equals(op
			.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry.getVisualID(op
				.getSemanticHint());
			if (elementType != null) {
				...
				if (!org.unicase.ui.diagram.componentDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
					.equals(org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry.getModelID(op
						.getContainerView()))) {
		...
		return org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentServiceEditPart.VISUAL_ID == visualID
			|| org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(org.unicase.ui.diagram.componentDiagram.edit.parts.MEDiagramEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		switch (visualID) {
		case org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentServiceEditPart.VISUAL_ID:
			return createComponentService_2001(domainElement, containerView, index, persisted, preferencesHint);
		case org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentEditPart.VISUAL_ID:
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView, String semanticHint, int index,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry.getVisualID(elementTypeHint)) {
		case org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentOfferedServicesEditPart.VISUAL_ID:
			return createComponentOfferedServices_4001(containerView, index, persisted, preferencesHint);
		case org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentConsumedServicesEditPart.VISUAL_ID:
			return createComponentConsumedServices_4002(containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createComponentService_2001(EObject domainElement, View containerView, int index, boolean persisted,
		...
		node.setType(org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createComponentOfferedServices_4001(View containerView, int index, boolean persisted,
		PreferencesHint preferencesHint) {
		...
		edge.setType(org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createComponentConsumedServices_4002(View containerView, int index, boolean persisted,
		PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		MERelativeBendpoints bendpoints = DiagramFactory.eINSTANCE.createMERelativeBendpoints();
	...
	private void stampShortcut(View containerView, Node target) {
		if (!org.unicase.ui.diagram.componentDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
			.equals(org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry.getModelID(containerView))) {
			EAnnotation shortcutAnnotation = EcoreFactory.eINSTANCE.createEAnnotation();
			shortcutAnnotation.setSource("Shortcut"); //$NON-NLS-1$
			shortcutAnnotation.getDetails().put(
				"modelID", org.unicase.ui.diagram.componentDiagram.edit.parts.MEDiagramEditPart.MODEL_ID); //$NON-NLS-1$
