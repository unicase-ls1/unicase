...
public class ModelDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof org.unicase.ui.diagram.componentDiagram.navigator.ModelDomainNavigatorItem) {
			return wrapEObjects(
				myAdapterFctoryContentProvier
					.getChildren(((org.unicase.ui.diagram.componentDiagram.navigator.ModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new org.unicase.ui.diagram.componentDiagram.navigator.ModelDomainNavigatorItem(
