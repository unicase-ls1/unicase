...
public class ModelElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ModelElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(
			org.unicase.ui.diagram.componentDiagram.part.Messages.ModelElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "model_diagram".equals(fileExtension); //$NON-NLS-1$
	}
