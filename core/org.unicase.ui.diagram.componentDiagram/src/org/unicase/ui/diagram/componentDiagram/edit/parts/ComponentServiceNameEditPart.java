...
public class ComponentServiceNameEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
				org.unicase.ui.diagram.componentDiagram.edit.parts.ModelEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
