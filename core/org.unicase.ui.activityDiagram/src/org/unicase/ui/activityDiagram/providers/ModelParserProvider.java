...
public class ModelParserProvider extends AbstractProvider implements
	...
	protected IParser createActivityName_5001Parser() {
		...
		org.unicase.ui.activityDiagram.parsers.MessageFormatParser parser = new org.unicase.ui.activityDiagram.parsers.MessageFormatParser(
				features);
		return parser;
	}
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(org.unicase.ui.activityDiagram.part.ModelVisualIDRegistry
					.getVisualID(vid));
		}
