...
public class ModelDiagramUpdater {
	...
	public static List getMEDiagram_55SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			int visualID = org.unicase.ui.diagram.stateDiagram.part.ModelVisualIDRegistry.getNodeVisualID(view,
				childElement);
			if (visualID == org.unicase.ui.diagram.stateDiagram.edit.parts.StateEditPart.VISUAL_ID) {
				result.add(new org.unicase.ui.diagram.stateDiagram.part.ModelNodeDescriptor(childElement, visualID));
				continue;
			}
	...
	private static Collection getContainedTypeModelFacetLinks_Transition_4001(MEDiagram container) {
		...
		for (Iterator links = container.getNewElements().iterator(); links.hasNext();) {
			...
			result.add(new org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor(src, dst, link,
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_Transition_4001(StateNode target, Map crossReferences) {
		Collection result = new LinkedList();
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			StateNode src = link.getSource();
			result.add(new org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor(src, target, link,
				org.unicase.ui.diagram.stateDiagram.providers.ModelElementTypes.Transition_4001,
				org.unicase.ui.diagram.stateDiagram.edit.parts.TransitionEditPart.VISUAL_ID));
		}
		return result;
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_Transition_4001(StateNode source) {
