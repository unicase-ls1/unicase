...
public class ModelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		if (editPolicyCommand != null) {
			...
			request
					.setParameter(
							org.unicase.ui.diagram.stateDiagram.edit.helpers.ModelBaseEditHelper.EDIT_POLICY_COMMAND,
							command);
		}
		IElementType requestContextElementType = getContextElementType(request);
		request
				.setParameter(
						org.unicase.ui.diagram.stateDiagram.edit.helpers.ModelBaseEditHelper.CONTEXT_ELEMENT_TYPE,
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = org.unicase.ui.diagram.stateDiagram.providers.ModelElementTypes
	...
	public static class LinkConstraints {
		...
		public static boolean canExistTransition_4001(MEDiagram container,
				StateNode source, StateNode target) {
			return true;
		}
	}
