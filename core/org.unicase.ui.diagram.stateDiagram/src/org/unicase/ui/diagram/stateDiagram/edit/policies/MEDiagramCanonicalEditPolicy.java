...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.ui.diagram.stateDiagram.part.ModelDiagramUpdater
			.getMEDiagram_55SemanticChildren(viewObject).iterator(); it.hasNext();) {
			result.add(((org.unicase.ui.diagram.stateDiagram.part.ModelNodeDescriptor) it.next()).getModelElement());
		}
		return result;
	}
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		int visualID = org.unicase.ui.diagram.stateDiagram.part.ModelVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			int diagramLinkVisualID = org.unicase.ui.diagram.stateDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator.hasNext();) {
				org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor) LinkDescriptorsIterator
					.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.diagram.stateDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(org.unicase.ui.diagram.stateDiagram.part.ModelDiagramUpdater
		...
		case org.unicase.ui.diagram.stateDiagram.edit.parts.StateInitialEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(org.unicase.ui.diagram.stateDiagram.part.ModelDiagramUpdater
					.getStateInitial_2002ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement()) || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
			}
		...
		case org.unicase.ui.diagram.stateDiagram.edit.parts.StateEndEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(org.unicase.ui.diagram.stateDiagram.part.ModelDiagramUpdater
					.getStateEnd_2003ContainedLinks(view));
			}
			if (!domain2NotationMap.containsKey(view.getElement()) || view.getEAnnotation("Shortcut") == null) { //$NON-NLS-1$
				domain2NotationMap.put(view.getElement(), view);
			}
	...
	private Collection createConnections(Collection linkDescriptors, Map domain2NotationMap) {
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator.hasNext();) {
			final org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.stateDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
				.next();
