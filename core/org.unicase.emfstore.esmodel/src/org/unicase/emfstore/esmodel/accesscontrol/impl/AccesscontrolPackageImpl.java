...
public class AccesscontrolPackageImpl extends EPackageImpl implements AccesscontrolPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getOrgUnitProperty_Project(), theEsmodelPackage.getProjectId(), null, "project", null, 0, 1, OrgUnitProperty.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
