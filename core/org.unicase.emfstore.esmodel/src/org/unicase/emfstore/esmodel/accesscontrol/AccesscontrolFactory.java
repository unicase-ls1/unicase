...
public interface AccesscontrolFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>AC User</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>AC Org Unit</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>AC Group</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns a new object of class '<em>AC Org Unit Id</em>'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
