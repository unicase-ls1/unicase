...
import org.unicase.emfstore.esmodel.url.*;
...
public class UrlAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.emfstore.esmodel.url.ProjectUrlFragment <em>Project Url Fragment</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.emfstore.esmodel.url.ModelElementUrlFragment <em>Model Element Url Fragment</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.emfstore.esmodel.url.ModelElementUrl <em>Model Element Url</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * @return the new adapter.
