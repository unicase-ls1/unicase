...
public class ServerPackageImpl extends EPackageImpl implements ServerPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getServerProjectEvent_ProjectId(), theEsmodelPackage.getProjectId(), null, "projectId", null, 0, 1, ServerProjectEvent.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
