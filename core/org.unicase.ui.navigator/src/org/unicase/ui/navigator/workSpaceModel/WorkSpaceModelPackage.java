...
public interface WorkSpaceModelPackage extends EPackage {
	 ...
	 * @generated
	 */
	String eNS_PREFIX = "org.unicase.ui.navigator.workspaceModel";
	...
	/**
	 * The meta object id for the '{@link org.unicase.ui.navigator.workSpaceModel.impl.ECPWorkspaceImpl
	 * <em>ECP Workspace</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The number of structural features of the '<em>ECP Workspace</em>' class. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int ECP_WORKSPACE_FEATURE_COUNT = 0;

	/**
	 * The meta object id for the '{@link org.unicase.ui.navigator.workSpaceModel.impl.ECPProjectImpl
	 * <em>ECP Project</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 ...
	 * @ordered
	 */
	int ECP_PROJECT_FEATURE_COUNT = 0;

	/**
	 * Returns the meta object for class '{@link org.unicase.ui.navigator.workSpaceModel.ECPWorkspace
	 * <em>ECP Workspace</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * Returns the meta object for class '{@link org.unicase.ui.navigator.workSpaceModel.ECPProject
	 * <em>ECP Project</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link org.unicase.ui.navigator.workSpaceModel.impl.ECPWorkspaceImpl
		 * <em>ECP Workspace</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.unicase.ui.navigator.workSpaceModel.impl.ECPWorkspaceImpl
		 * @see org.unicase.ui.navigator.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPWorkspace()
		...
		/**
		 * The meta object literal for the '{@link org.unicase.ui.navigator.workSpaceModel.impl.ECPProjectImpl
		 * <em>ECP Project</em>}' class. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @see org.unicase.ui.navigator.workSpaceModel.impl.ECPProjectImpl
		 * @see org.unicase.ui.navigator.workSpaceModel.impl.WorkSpaceModelPackageImpl#getECPProject()
