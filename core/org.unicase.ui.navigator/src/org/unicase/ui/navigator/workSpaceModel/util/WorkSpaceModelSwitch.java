...
public class WorkSpaceModelSwitch<T> {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ECP Workspace</em>'. <!-- begin-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>ECP Project</em>'. <!-- begin-user-doc -->
	 * This implementation returns null; returning a non-null result will terminate the switch. <!-- end-user-doc -->
	 * 
	 * @param object the target of the switch.
