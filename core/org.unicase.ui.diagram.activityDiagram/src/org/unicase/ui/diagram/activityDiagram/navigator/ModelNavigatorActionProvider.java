...
public class ModelNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(org.unicase.ui.diagram.activityDiagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorItem) {
					selectedElement = ((org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorItem) selectedElement)
						.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (org.unicase.ui.diagram.activityDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
						.equals(org.unicase.ui.diagram.activityDiagram.part.ModelVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, org.unicase.ui.diagram.activityDiagram.part.ModelDiagramEditor.ID);
