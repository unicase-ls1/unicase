...
public class ModelSheetLabelProvider extends DecoratingLabelProvider {
	...
	public ModelSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(org.unicase.ui.diagram.activityDiagram.part.ModelDiagramEditorPlugin
	...
	public String getText(Object element) {
		...
		if (selected instanceof org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorGroup) {
			return ((org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorGroup) selected).getGroupName();
		}
