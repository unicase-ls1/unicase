...
public class ModelSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorGroup) {
			return ((org.unicase.ui.diagram.activityDiagram.navigator.ModelNavigatorGroup) element)
					.getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = org.unicase.ui.diagram.activityDiagram.part.ModelVisualIDRegistry
					.getVisualID(view);
			IElementType etype = org.unicase.ui.diagram.activityDiagram.providers.ModelElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
