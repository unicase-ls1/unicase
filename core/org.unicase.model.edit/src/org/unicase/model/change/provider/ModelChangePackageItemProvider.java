 ...
 * @generated
 */
public class ModelChangePackageItemProvider extends UnicaseModelElementItemProvider implements
	 ...
	 * @generated
	 */
	public ModelChangePackageItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This adds a property descriptor for the Source Version feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSourceVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			...
			getString("_UI_PropertyDescriptor_description", "_UI_ModelChangePackage_sourceVersion_feature",
				"_UI_ModelChangePackage_type"), ChangePackage.Literals.MODEL_CHANGE_PACKAGE__SOURCE_VERSION, true,
			false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Target Version feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addTargetVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory)
			...
			getString("_UI_PropertyDescriptor_description", "_UI_ModelChangePackage_targetVersion_feature",
				"_UI_ModelChangePackage_type"), ChangePackage.Literals.MODEL_CHANGE_PACKAGE__TARGET_VERSION, true,
			false, false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns ModelChangePackage.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
