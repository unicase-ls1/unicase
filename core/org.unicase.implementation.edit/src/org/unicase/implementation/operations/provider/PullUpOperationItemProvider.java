 ...
 * @generated
 */
public class PullUpOperationItemProvider extends SemanticCompositeOperationItemProvider implements
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OperationsPackage.Literals.PULL_UP_OPERATION__SUPER_CLASS);
			childrenFeatures.add(OperationsPackage.Literals.PULL_UP_OPERATION__ATTRIBUTES);
			childrenFeatures.add(OperationsPackage.Literals.PULL_UP_OPERATION__OUTGOING_ASSOCIATIONS);
			childrenFeatures.add(OperationsPackage.Literals.PULL_UP_OPERATION__INCOMING_ASSOCIATIONS);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PullUpOperation"));
	}
