...
public class ExtractSuperClassOperationItemProvider extends SemanticCompositeOperationItemProvider implements
	...
	public Collection<?> getChildren(Object object) {
		if (object instanceof ExtractSuperClassOperation) {
			...
			org.unicase.emfstore.esmodel.versioning.operations.OperationsFactory factory = 
			...
			extractsGroup.getModelElements().addAll(operation.getAssociations());
	...
	/**
	 * This adds a property descriptor for the Super Super Classes feature. <!-- begin-user-doc --> <!-- end-user-doc
	 * -->
	 * 
	 * @generated
	 */
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__SUB_CLASSES);
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__ATTRIBUTES);
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__ASSOCIATIONS);
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__TARGET_PACKAGE);
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__SUPER_SUPER_CLASSES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__ASSOCIATIONS, MetamodelFactory.eINSTANCE
				.createModelElementId()));
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify = childFeature == OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__SUB_CLASSES
			...
			|| childFeature == OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__ASSOCIATIONS
