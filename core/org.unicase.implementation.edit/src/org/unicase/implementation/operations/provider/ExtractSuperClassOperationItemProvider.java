...
public class ExtractSuperClassOperationItemProvider extends SemanticCompositeOperationItemProvider implements
	...
	public Collection<?> getChildren(Object object) {
		if (object instanceof ExtractSuperClassOperation) {
			...
			extractsGroup.getModelElements().addAll(
					operation.getOutgoingAssociations());
			extractsGroup.getModelElements().addAll(
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__OUTGOING_ASSOCIATIONS);
			childrenFeatures.add(OperationsPackage.Literals.EXTRACT_SUPER_CLASS_OPERATION__INCOMING_ASSOCIATIONS);
	...
	/**
	 * This returns ExtractSuperClassOperation.gif.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 * @generated
	 */
	@Override
