...
public class ModelNavigatorContentProvider implements ICommonContentProvider {
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource.getContents(),
				org.unicase.ui.diagram.classDiagram.edit.parts.MEDiagramEditPart.MODEL_ID), file, false));
	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case org.unicase.ui.diagram.classDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			...
			org.unicase.ui.diagram.classDiagram.navigator.ModelNavigatorGroup links = new org.unicase.ui.diagram.classDiagram.navigator.ModelNavigatorGroup(
				org.unicase.ui.diagram.classDiagram.part.Messages.NavigatorGroupName_MEDiagram_88_links,
				"icons/linksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections.singleton(view),
				org.unicase.ui.diagram.classDiagram.edit.parts.ClassEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(view),
				org.unicase.ui.diagram.classDiagram.edit.parts.PackageEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
		...
		case org.unicase.ui.diagram.classDiagram.edit.parts.ClassEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections.singleton(view),
				org.unicase.ui.diagram.classDiagram.edit.parts.ClassClassNode_attributesEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
				org.unicase.ui.diagram.classDiagram.edit.parts.AttributeEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
			connectedViews = getChildrenByType(Collections.singleton(view),
				org.unicase.ui.diagram.classDiagram.edit.parts.ClassClassNode_methodsEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
				org.unicase.ui.diagram.classDiagram.edit.parts.MethodEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement, false));
	...
	private Collection getLinksSourceByType(Collection edges, int visualID) {
		Collection result = new ArrayList();
		String type = org.unicase.ui.diagram.classDiagram.part.ModelVisualIDRegistry.getType(visualID);
	...
	private Collection createNavigatorItems(Collection views, Object parent, boolean isLeafs) {
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new org.unicase.ui.diagram.classDiagram.navigator.ModelNavigatorItem((View) it.next(), parent,
				isLeafs));
		}
		return result;
	}
