 ...
 * @generated
 */
public class Association4EditPart extends ConnectionNodeEditPart implements ITreeBranchEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
			new org.unicase.ui.diagram.classDiagram.edit.policies.Association4ItemSemanticEditPolicy());
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof org.unicase.ui.diagram.classDiagram.edit.parts.AssociationName4EditPart) {
			((org.unicase.ui.diagram.classDiagram.edit.parts.AssociationName4EditPart) childEditPart)
				.setLabel(getPrimaryShape().getFigureAssociationFigure_name());
			return true;
		}
		if (childEditPart instanceof org.unicase.ui.diagram.classDiagram.edit.parts.AssociationSourceMultiplicity4EditPart) {
			((org.unicase.ui.diagram.classDiagram.edit.parts.AssociationSourceMultiplicity4EditPart) childEditPart)
				.setLabel(getPrimaryShape().getFigureAssociationFigure_sourceMultiplicity());
			return true;
		}
		if (childEditPart instanceof org.unicase.ui.diagram.classDiagram.edit.parts.AssociationTargetMultiplicity4EditPart) {
			((org.unicase.ui.diagram.classDiagram.edit.parts.AssociationTargetMultiplicity4EditPart) childEditPart)
