...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	 ...
	 * @return Returns the semantic childran of this EditPolicy, including the temporary children of the
	 *         {@link MEDiagramShowElementsEditPolicy}, if such exists.
	 */
	@Override
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		int visualID = org.unicase.ui.diagram.classDiagram.part.ModelVisualIDRegistry.getVisualID(view);
		switch (visualID) {
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			int diagramLinkVisualID = org.unicase.ui.diagram.classDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator.hasNext();) {
				org.unicase.ui.diagram.classDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.classDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
					.next();
		...
		if (editPolicy instanceof MEDiagramShowElementsEditPolicy) {
			...
			Collection<? extends Edge> relatedConnectionElements = instance.getRelatedEdges();
	...
	private Collection createConnections(Collection linkDescriptors, Map domain2NotationMap) {
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator.hasNext();) {
			final org.unicase.ui.diagram.classDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.classDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
				.next();
