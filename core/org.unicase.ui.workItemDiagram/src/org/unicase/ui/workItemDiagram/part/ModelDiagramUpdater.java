...
public class ModelDiagramUpdater {
	...
	public static List getMEDiagram_33SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			if (visualID == org.unicase.ui.workItemDiagram.edit.parts.ActionItemEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.workItemDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.workItemDiagram.edit.parts.IssueEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.workItemDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.workItemDiagram.edit.parts.BugReportEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.workItemDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
	...
	private static Collection getIncomingFeatureModelFacetLinks_WorkItem_Successors_4003(
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			if (setting.getEStructuralFeature() == TaskPackage.eINSTANCE
				...
				result
						.add(new org.unicase.ui.workItemDiagram.part.ModelLinkDescriptor(
								setting.getEObject(),
								target,
