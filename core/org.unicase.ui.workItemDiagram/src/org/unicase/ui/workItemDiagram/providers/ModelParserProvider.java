...
public class ModelParserProvider extends AbstractProvider implements
	...
	protected IParser createActionItemName_5001Parser() {
		...
		org.unicase.ui.workItemDiagram.parsers.MessageFormatParser parser = new org.unicase.ui.workItemDiagram.parsers.MessageFormatParser(
				features);
		return parser;
	}
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(org.unicase.ui.workItemDiagram.part.ModelVisualIDRegistry
					.getVisualID(vid));
		}
