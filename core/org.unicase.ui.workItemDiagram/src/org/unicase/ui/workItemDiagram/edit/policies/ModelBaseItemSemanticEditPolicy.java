...
public class ModelBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (semanticCommand != null) {
			...
			completedRequest
					.setParameter(
							org.unicase.ui.workItemDiagram.edit.helpers.ModelBaseEditHelper.EDIT_POLICY_COMMAND,
							command);
		}
		if (elementType != null) {
	...
	public static class LinkConstraints {
		 ...
		 * @generated
		 */
		public static boolean canCreateWorkItemSuccessors_4003(WorkItem source,
				WorkItem target) {
			if (source != null) {
			...
			return canExistWorkItemSuccessors_4003(source, target);
		}

		/**
		 * @generated
		 */
		public static boolean canExistWorkItemSuccessors_4003(WorkItem source,
				WorkItem target) {
