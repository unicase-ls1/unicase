...
public class ProjectSpaceItemProvider extends ItemProviderAdapter implements
	...
	protected void addBaseVersionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ProjectSpace_baseVersion_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ProjectSpace_baseVersion_feature",
						"_UI_ProjectSpace_type"),
				WorkspacePackage.Literals.PROJECT_SPACE__BASE_VERSION, true,
