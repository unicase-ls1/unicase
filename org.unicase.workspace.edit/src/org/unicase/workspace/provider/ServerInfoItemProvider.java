...
public class ServerInfoItemProvider extends ItemProviderAdapter implements
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_ServerInfo_name_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ServerInfo_name_feature", "_UI_ServerInfo_type"),
				WorkspacePackage.Literals.SERVER_INFO__NAME, true, false,
	...
	protected void addUrlPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ServerInfo_url_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ServerInfo_url_feature", "_UI_ServerInfo_type"),
				WorkspacePackage.Literals.SERVER_INFO__URL, true, false, false,
	...
	protected void addPortPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(), getResourceLocator(),
						getString("_UI_ServerInfo_port_feature"), getString(
								"_UI_PropertyDescriptor_description",
								"_UI_ServerInfo_port_feature",
								"_UI_ServerInfo_type"),
						WorkspacePackage.Literals.SERVER_INFO__PORT, true,
						false, false,
	...
	protected void addDisplayNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ServerInfo_displayName_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ServerInfo_displayName_feature",
						"_UI_ServerInfo_type"),
				WorkspacePackage.Literals.SERVER_INFO__DISPLAY_NAME, true,
	...
	protected void addProjectInfosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ServerInfo_projectInfos_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ServerInfo_projectInfos_feature",
						"_UI_ServerInfo_type"),
				WorkspacePackage.Literals.SERVER_INFO__PROJECT_INFOS, true,
	...
	protected void addLastUsersessionPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_ServerInfo_lastUsersession_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_ServerInfo_lastUsersession_feature",
						"_UI_ServerInfo_type"),
				WorkspacePackage.Literals.SERVER_INFO__LAST_USERSESSION, true,
				false, true, null, null, null));
	}
