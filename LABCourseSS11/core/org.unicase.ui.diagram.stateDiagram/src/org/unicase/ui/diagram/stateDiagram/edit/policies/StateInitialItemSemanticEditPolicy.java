 ...
 * @generated
 */
public class StateInitialItemSemanticEditPolicy
		extends
	 ...
	 * @generated
	 */
	public StateInitialItemSemanticEditPolicy() {
		super(
				org.unicase.ui.diagram.stateDiagram.providers.ModelElementTypes.StateInitial_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (org.unicase.ui.diagram.stateDiagram.part.ModelVisualIDRegistry
					.getVisualID(incomingLink) == org.unicase.ui.diagram.stateDiagram.edit.parts.TransitionEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (org.unicase.ui.diagram.stateDiagram.part.ModelVisualIDRegistry
					.getVisualID(outgoingLink) == org.unicase.ui.diagram.stateDiagram.edit.parts.TransitionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
