...
public class ModelDiagramUpdater {
	...
	public static List getMEDiagram_99SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			int visualID = org.unicase.ui.diagram.componentDiagram.part.ModelVisualIDRegistry.getNodeVisualID(view,
				childElement);
			if (visualID == org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentServiceEditPart.VISUAL_ID) {
				result
					.add(new org.unicase.ui.diagram.componentDiagram.part.ModelNodeDescriptor(childElement, visualID));
				continue;
			}
	...
	public static List getComponent_2002ContainedLinks(View view) {
		...
		List result = new LinkedList();
		result.addAll(getOutgoingFeatureModelFacetLinks_Component_OfferedServices_4001(modelElement));
		result.addAll(getOutgoingFeatureModelFacetLinks_Component_ConsumedServices_4002(modelElement));
		return result;
	}
	...
	public static List getComponentService_2001IncomingLinks(View view) {
		...
		List result = new LinkedList();
		result.addAll(getIncomingFeatureModelFacetLinks_Component_OfferedServices_4001(modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Component_ConsumedServices_4002(modelElement, crossReferences));
		return result;
	}
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Component_OfferedServices_4001(ComponentService target,
		Map crossReferences) {
		...
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			if (setting.getEStructuralFeature() == ComponentPackage.eINSTANCE.getComponent_OfferedServices()) {
				result.add(new org.unicase.ui.diagram.componentDiagram.part.ModelLinkDescriptor(setting.getEObject(),
					target,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Component_OfferedServices_4001(Component source) {
		Collection result = new LinkedList();
		for (Iterator destinations = source.getOfferedServices().iterator(); destinations.hasNext();) {
			...
			result.add(new org.unicase.ui.diagram.componentDiagram.part.ModelLinkDescriptor(source, destination,
				org.unicase.ui.diagram.componentDiagram.providers.ModelElementTypes.ComponentOfferedServices_4001,
				org.unicase.ui.diagram.componentDiagram.edit.parts.ComponentOfferedServicesEditPart.VISUAL_ID));
		}
		return result;
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Component_ConsumedServices_4002(Component source) {
		Collection result = new LinkedList();
