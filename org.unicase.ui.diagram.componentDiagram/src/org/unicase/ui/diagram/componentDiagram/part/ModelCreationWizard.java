...
public class ModelCreationWizard extends Wizard implements INewWizard {
	 ...
	 * @generated
	 */
	protected org.unicase.ui.diagram.componentDiagram.part.ModelCreationWizardPage domainModelFilePage;
	...
	public void addPages() {
		...
		domainModelFilePage = new org.unicase.ui.diagram.componentDiagram.part.ModelCreationWizardPage(
		...
		domainModelFilePage
				.setTitle(org.unicase.ui.diagram.componentDiagram.part.Messages.ModelCreationWizard_DomainModelFilePageTitle);
		domainModelFilePage
				.setDescription(org.unicase.ui.diagram.componentDiagram.part.Messages.ModelCreationWizard_DomainModelFilePageDescription);
	...
	public boolean performFinish() {
		IRunnableWithProgress op = new WorkspaceModifyOperation(null) {
			...
			protected void execute(IProgressMonitor monitor)
				...
				diagram = org.unicase.ui.diagram.componentDiagram.part.ModelDiagramEditorUtil
		...
		try {
			...
			if (e.getTargetException() instanceof CoreException) {
				ErrorDialog
						.openError(
								getContainer().getShell(),
								org.unicase.ui.diagram.componentDiagram.part.Messages.ModelCreationWizardCreationError,
