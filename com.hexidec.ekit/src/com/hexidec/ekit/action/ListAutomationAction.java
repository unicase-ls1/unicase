		...
		try
		{
			...
			else
			{
				...
				else
				{
					...
					// tokenize on known linebreaks if present, otherwise manually parse on non-positive characters
					...
					else
					{
						...
						{
							if(Character.getNumericValue(selText.charAt(ch)) < 0 && sbItem.length() > 0)
							{
								sbNew.append("<li>");
