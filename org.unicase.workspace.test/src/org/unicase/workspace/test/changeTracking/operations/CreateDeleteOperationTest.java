...
public class CreateDeleteOperationTest extends OperationTest {
	...
	public void createInNonProjectContainmentTest() {
		...
		assertEquals(ModelUtil.getProject(useCase).getModelElementId(useCase), createOperation.getModelElementId());
		assertEquals(ModelUtil.getProject(section).getModelElementId(section), multiReferenceOperation
			.getModelElementId());
	}
