...
public class ConflictDetectionAttributeTest extends ConflictDetectionTest {
	...
	public void conflictAttribute() {
		...
		Actor actor1 = (Actor) getProject().getModelElementId(ModelUtil.getProject(actor).getModelElementId(actor));
		Actor actor2 = (Actor) project2.getModelElementId(ModelUtil.getProject(actor).getModelElementId(actor));
