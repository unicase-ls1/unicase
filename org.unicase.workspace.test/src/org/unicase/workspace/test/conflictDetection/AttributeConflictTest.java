...
public class AttributeConflictTest {
	...
	public void testAttributeWithAttributeConflict() {
		...
		attributeOperation1.setModelElementId(ModelUtil.getProject(modelElement).getModelElementId(modelElement));
		...
		attributeOperation2.setModelElementId(ModelUtil.getProject(modelElement).getModelElementId(modelElement));
