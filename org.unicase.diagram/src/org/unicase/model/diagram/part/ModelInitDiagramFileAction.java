	...
	public void run(IAction action) {
		...
		if (diagramRoot == null) {
			MessageDialog
					.openError(
							getShell(),
							Messages.ModelInitDiagramFileAction_InitDiagramFileResourceErrorDialogTitle,
							Messages.ModelInitDiagramFileAction_InitDiagramFileResourceErrorDialogMessage);
			return;
		}
		Wizard wizard = new ModelNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(
				Messages.ModelInitDiagramFileAction_InitDiagramFileWizardTitle,
				MEDiagramEditPart.MODEL_ID));
