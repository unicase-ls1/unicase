...
public class TestTestStepParameterTableLabelProvider {

    private TestStepInput testStepInput;
    private TestStepOutput testStepOutput;
    private TestStepParameterTableLabelProvider provider;
    ...
    public void setUp() throws Exception {
        ...
        this.provider = new TestStepParameterTableLabelProvider();
    ...
    public void testGetColumnImageInvalidElement() {
        ...
        this.image = this.provider.getColumnImage("Test", COLUMN_NAME);
        assertNull(this.image);
        this.image = this.provider.getColumnImage("Test", COLUMN_TYPE);
        assertNull(this.image);
        this.image = this.provider.getColumnImage("Test", COLUMN_RANGE);
        assertNull(this.image);
        this.image = this.provider.getColumnImage("Test", COLUMN_ID);
        assertNull(this.image);
        System.out.println("PASSED");
    }
    ...
    public void testGetColumnTextValidElement() {
        ...
        String text = this.provider.getColumnText(this.testStepInput,
                COLUMN_NAME);
