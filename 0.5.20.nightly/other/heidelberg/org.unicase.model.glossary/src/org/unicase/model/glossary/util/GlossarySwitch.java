 ...
 * $Id$
 */
package org.unicase.model.glossary.util;
...
public class GlossarySwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case GlossaryPackage.GLOSSARY_ENTRY: {
				GlossaryEntry glossaryEntry = (GlossaryEntry)theEObject;
				T result = caseGlossaryEntry(glossaryEntry);
				if (result == null) result = caseUnicaseModelElement(glossaryEntry);
				if (result == null) result = caseModelElement(glossaryEntry);
				if (result == null) result = caseIdentifiableElement(glossaryEntry);
