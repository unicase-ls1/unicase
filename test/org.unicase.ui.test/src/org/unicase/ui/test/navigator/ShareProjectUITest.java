	...
	public void updateProjectUpdate() {
		...
		new UnicaseCommand() {
			...
			protected void doRun() {
				...
				// Usersession usersession = getProjectSpace().getUsersession();
				// if (usersession == null) {
				// usersession = WorkspaceFactory.eINSTANCE.createUsersession();
				...
				// SetupHelper.getServerInfo(), usersession.getSessionId());
				...
				//
				// try {
				// ACOrgUnitId orgUnitId = SetupHelper.createUserOnServer(usersession.getSessionId(), "foo");
				// SetupHelper.setUsersRole(usersession.getSessionId(), orgUnitId, RolesPackage.eINSTANCE
				// .getServerAdmin(), projectSpace.getProjectId());
				...
				// }
				// usersession.setServerInfo(SetupHelper.getServerInfo());
				// usersession.setUsername("foo");
				// usersession.setPassword("foo");
				//
				// if (!usersession.isLoggedIn()) {
				// try {
				// usersession.logIn();
