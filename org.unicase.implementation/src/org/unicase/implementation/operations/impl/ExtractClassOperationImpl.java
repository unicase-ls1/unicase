 ...
 * <em><b>Extract Class Operation</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getContextClass
 * <em>Context Class</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getAttributes
 * <em>Attributes</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getOutgoingAssociations
 * <em>Outgoing Associations</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getIncomingAssociations
 * <em>Incoming Associations</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getCompositionName
 * <em>Composition Name</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getClassName
 * <em>Class Name</em>}</li>
 * <li>
 * {@link org.unicase.implementation.operations.impl.ExtractClassOperationImpl#getTargetPackage
 ...
 * @generated
 */
public class ExtractClassOperationImpl
		extends
		org.eclipse.emf.emfstore.internal.server.model.versioning.operations.semantic.impl.SemanticCompositeOperationImpl
		implements ExtractClassOperation {
	/**
	 * The cached value of the '{@link #getContextClass()
	 * <em>Context Class</em>}' containment reference. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getContextClass()
	 * @generated
	 * @ordered
	 */
	protected org.eclipse.emf.emfstore.internal.common.model.ModelElementId contextClass;
	...
	/**
	 * The default value of the '{@link #getCompositionName()
	 * <em>Composition Name</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getCompositionName()
	 * <em>Composition Name</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getCompositionName()
	 ...
	 * @generated
	 */
	public org.eclipse.emf.emfstore.internal.common.model.ModelElementId getContextClass() {
		return contextClass;
	}
	 ...
	 * @generated
	 */
	public NotificationChain basicSetContextClass(
			org.eclipse.emf.emfstore.internal.common.model.ModelElementId newContextClass,
			NotificationChain msgs) {
		org.eclipse.emf.emfstore.internal.common.model.ModelElementId oldContextClass = contextClass;
		contextClass = newContextClass;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					OperationsPackage.EXTRACT_CLASS_OPERATION__CONTEXT_CLASS,
					oldContextClass, newContextClass);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setContextClass(
		...
		if (newContextClass != contextClass) {
			...
			if (contextClass != null)
				msgs = ((InternalEObject) contextClass)
						.eInverseRemove(
								this,
			...
			if (newContextClass != null)
				msgs = ((InternalEObject) newContextClass)
						.eInverseAdd(
								this,
								EOPPOSITE_FEATURE_BASE
										- OperationsPackage.EXTRACT_CLASS_OPERATION__CONTEXT_CLASS,
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					OperationsPackage.EXTRACT_CLASS_OPERATION__CONTEXT_CLASS,
					newContextClass, newContextClass));
	}
	...
	public EList<org.eclipse.emf.emfstore.internal.common.model.ModelElementId> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<org.eclipse.emf.emfstore.internal.common.model.ModelElementId>(
					...
					this, OperationsPackage.EXTRACT_CLASS_OPERATION__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public void setCompositionName(String newCompositionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(
					this,
					Notification.SET,
					OperationsPackage.EXTRACT_CLASS_OPERATION__COMPOSITION_NAME,
					oldCompositionName, compositionName));
	}
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					OperationsPackage.EXTRACT_CLASS_OPERATION__CLASS_NAME,
	...
	public NotificationChain basicSetTargetPackage(
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET,
					OperationsPackage.EXTRACT_CLASS_OPERATION__TARGET_PACKAGE,
	 ...
	 * @generated
	 */
	public org.unicase.model.classes.Class getContextClass(
	 ...
	 * 
	 * @param project
	 *            the project the operation is about to be invoked on
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
		case OperationsPackage.EXTRACT_CLASS_OPERATION__CONTEXT_CLASS:
			setContextClass((org.eclipse.emf.emfstore.internal.common.model.ModelElementId) newValue);
			return;
		case OperationsPackage.EXTRACT_CLASS_OPERATION__ATTRIBUTES:
			getAttributes().clear();
			getAttributes()
	...
	public void eUnset(int featureID) {
		switch (featureID) {
		case OperationsPackage.EXTRACT_CLASS_OPERATION__CONTEXT_CLASS:
			setContextClass((org.eclipse.emf.emfstore.internal.common.model.ModelElementId) null);
			return;
		case OperationsPackage.EXTRACT_CLASS_OPERATION__ATTRIBUTES:
			getAttributes().clear();
			return;
	...
	public boolean eIsSet(int featureID) {
		...
		case OperationsPackage.EXTRACT_CLASS_OPERATION__COMPOSITION_NAME:
			return COMPOSITION_NAME_EDEFAULT == null ? compositionName != null
					: !COMPOSITION_NAME_EDEFAULT.equals(compositionName);
		case OperationsPackage.EXTRACT_CLASS_OPERATION__CLASS_NAME:
	...
	public void semanticApply(Project project) {
		...
		composition.setSourceRole(OperationHelper.firstLower(contextClass
				.getName()));
