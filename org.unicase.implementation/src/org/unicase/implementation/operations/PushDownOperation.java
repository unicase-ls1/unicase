 ...
 * @model annotation=
 *        "http://unicase.org/operations description='Attributes and associations are pushed down to sub classes.' label='Push Down Attributes and Associations'"
 * @generated
 */
public interface PushDownOperation extends SemanticCompositeOperation {
	...
	/**
	 * Sets the value of the '{@link org.unicase.implementation.operations.PushDownOperation#getSuperClass
	 ...
	 * 
	 * @model required="true" annotation=
	 *        "http://unicase.org/operations description='At least one attribute or association must be pushed down.'"
	 * @generated
	 */
