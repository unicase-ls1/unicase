...
public class OperationsAdapterFactory extends AdapterFactoryImpl {
	...
	protected OperationsSwitch<Adapter> modelSwitch = new OperationsSwitch<Adapter>() {
			...
			@Override
			public Adapter caseIdentifiableElement(org.eclipse.emf.emfstore.internal.common.model.IdentifiableElement object) {
				return createIdentifiableElementAdapter();
			}
			@Override
			public Adapter caseAbstractOperation(org.eclipse.emf.emfstore.internal.server.model.versioning.operations.AbstractOperation object) {
				return createAbstractOperationAdapter();
			}
			@Override
			public Adapter caseCompositeOperation(org.eclipse.emf.emfstore.internal.server.model.versioning.operations.CompositeOperation object) {
				return createCompositeOperationAdapter();
			}
			@Override
			public Adapter caseSemanticCompositeOperation(org.eclipse.emf.emfstore.internal.server.model.versioning.operations.semantic.SemanticCompositeOperation object) {
