...
public class ModelDiagramUpdater {
	...
	public static List getMEDiagram_22SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			int visualID = org.unicase.ui.diagram.activityDiagram.part.ModelVisualIDRegistry.getNodeVisualID(view,
				childElement);
			if (visualID == org.unicase.ui.diagram.activityDiagram.edit.parts.ActivityEditPart.VISUAL_ID) {
				result.add(new org.unicase.ui.diagram.activityDiagram.part.ModelNodeDescriptor(childElement, visualID));
				continue;
			}
	...
	private static Collection getContainedTypeModelFacetLinks_Transition_4001(MEDiagram container) {
		...
		for (Iterator links = container.getNewElements().iterator(); links.hasNext();) {
			...
			result.add(new org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor(src, dst, link,
	 ...
	 * @generated
	 */
	private static Collection getIncomingTypeModelFacetLinks_Transition_4001(ActivityObject target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			EStructuralFeature.Setting setting = (EStructuralFeature.Setting) it.next();
			if (setting.getEStructuralFeature() != ActivityPackage.eINSTANCE.getTransition_Target()
			...
			ActivityObject src = link.getSource();
			result.add(new org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor(src, target, link,
				org.unicase.ui.diagram.activityDiagram.providers.ModelElementTypes.Transition_4001,
				org.unicase.ui.diagram.activityDiagram.edit.parts.TransitionEditPart.VISUAL_ID));
		}
		return result;
	 ...
	 * @generated
	 */
	private static Collection getOutgoingTypeModelFacetLinks_Transition_4001(ActivityObject source) {
