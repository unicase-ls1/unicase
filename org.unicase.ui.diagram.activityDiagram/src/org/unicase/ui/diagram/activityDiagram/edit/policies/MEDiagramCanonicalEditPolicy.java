...
public class MEDiagramCanonicalEditPolicy extends CanonicalConnectionEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		for (Iterator it = org.unicase.ui.diagram.activityDiagram.part.ModelDiagramUpdater
			.getMEDiagram_22SemanticChildren(viewObject).iterator(); it.hasNext();) {
			result.add(((org.unicase.ui.diagram.activityDiagram.part.ModelNodeDescriptor) it.next()).getModelElement());
		}
		return result;
	}
	...
	private Collection refreshConnections() {
		...
		for (Iterator linksIterator = existingLinks.iterator(); linksIterator.hasNext();) {
			...
			int diagramLinkVisualID = org.unicase.ui.diagram.activityDiagram.part.ModelVisualIDRegistry
			...
			for (Iterator LinkDescriptorsIterator = linkDescriptors.iterator(); LinkDescriptorsIterator.hasNext();) {
				org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor) LinkDescriptorsIterator
					.next();
	...
	private Collection collectAllLinks(View view, Map domain2NotationMap) {
		...
		case org.unicase.ui.diagram.activityDiagram.edit.parts.MEDiagramEditPart.VISUAL_ID: {
			if (!domain2NotationMap.containsKey(view.getElement())) {
				result.addAll(org.unicase.ui.diagram.activityDiagram.part.ModelDiagramUpdater
	...
	private Collection createConnections(Collection linkDescriptors, Map domain2NotationMap) {
		...
		for (Iterator linkDescriptorsIterator = linkDescriptors.iterator(); linkDescriptorsIterator.hasNext();) {
			final org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor nextLinkDescriptor = (org.unicase.ui.diagram.activityDiagram.part.ModelLinkDescriptor) linkDescriptorsIterator
				.next();
