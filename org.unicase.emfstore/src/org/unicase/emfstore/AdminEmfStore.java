...
/**
 * AdminEmfStore offers an interface for administrating the users and their
 * rights.
 * 
 * @author Hodaie
 * @author Wesendonk
...
public interface AdminEmfStore {
	 ...
	 *            the session id for authentication
	 * @param user
	 *            the user's orgUnitId
	 * @param group
	 *            the group's orgUnitId
	 * @throws EmfStoreException
	 *             if any error in the EmfStore occurs
	 */
	 ...
	 *             if any error in the EmfStore occurs
	 */
	void changeOrgUnit(SessionId sessionId, ACOrgUnitId orgUnitId, String name,
	 ...
	 *             if any error in the EmfStore occurs
	 */
	void addParticipant(SessionId sessionId, ProjectId projectId,
	 ...
	 *             if any error in the EmfStore occurs
	 */
	void removeParticipant(SessionId sessionId, ProjectId projectId,
			ACOrgUnitId participant) throws EmfStoreException;
	 ...
	 *            the orgUnit
	 * @param role
	 *            new role for orgUnit
	 * @throws EmfStoreException
	 *             if any error in the EmfStore occurs.
	 */
	void changeRole(SessionId sessionId, ProjectId projectId,
