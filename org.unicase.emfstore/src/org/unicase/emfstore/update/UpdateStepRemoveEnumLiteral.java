...
public abstract class UpdateStepRemoveEnumLiteral extends UpdateStepTransformFeature {
	...
	/**
	 * @return The name of the literal that should be deleted
	 */
	 ...
	 * {@inheritDoc}
	 * 
	 * @see org.unicase.emfstore.update.UpdateStepTransformFeature#updateFeature(org.unicase.model.ModelElement,
	...
	public int updateFeature(ModelElement modelElement, EStructuralFeature feature) {
		...
		if (featureValue != null && featureValue instanceof Enumerator
