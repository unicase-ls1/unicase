 ...
 * It requires {@link EmfStore} and {@link AuthenticationControl} to delegate the messaeges.
 * 
 * @author Wesendonk
 * @author koegel
 */
public interface ConnectionHandler {
	 ...
	 */
	void init(EmfStore emfStore, AuthenticationControl accessControl) throws FatalEmfStoreException;
