...
public interface RMIEmfStoreFacade extends Remote {
	 ...
	 */
	List<String> getProjectList(String sessionId) throws RemoteException,
			EmfStoreException;
	 ...
	 *             if a problem in the element store occurs
	 */
	String getProject(String sessionId, String projectId, String versionSpec)
	 ...
	 *             if a problem in the element store occurs
	 */
	List<String> getChanges(String sessionId, String projectId, String source,
