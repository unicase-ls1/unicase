 ...
 * <p> The following features are supported: <ul> <li>{@link org.unicase.workspace.Usersession#getUsername
 * <em>Username</em>}</li> <li>{@link org.unicase.workspace.Usersession#getPassword <em>Password</em>}</li> <li>{@link
 * org.unicase.workspace.Usersession#getSessionId <em>Session Id</em>}</li> <li>{@link
 * org.unicase.workspace.Usersession#getPersistentPassword <em>Persistent Password</em>}</li> <li>{@link
 * org.unicase.workspace.Usersession#getServerInfo <em>Server Info</em>}</li> <li>{@link
 * org.unicase.workspace.Usersession#isSavePassword <em>Save Password</em>}</li> <li>{@link
 * org.unicase.workspace.Usersession#getACUser <em>AC User</em>}</li> </ul> </p>
