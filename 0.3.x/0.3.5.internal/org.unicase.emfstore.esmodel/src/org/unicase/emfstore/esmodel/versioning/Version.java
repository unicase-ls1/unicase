...
/*
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>Version</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link org.unicase.emfstore.esmodel.versioning.Version#getProjectState
 * <em>Project State</em>}</li> <li>{@link org.unicase.emfstore.esmodel.versioning.Version#getPrimarySpec <em>Primary
 * Spec</em>}</li> <li>{@link org.unicase.emfstore.esmodel.versioning.Version#getTagSpecs <em>Tag Specs</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.versioning.Version#getNextVersion <em>Next Version</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.Version#getPreviousVersion <em>Previous Version</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.Version#getChanges <em>Changes</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.Version#getLogMessage <em>Log Message</em>}</li> </ul> </p>
...
public interface Version extends EObject {
	 ...
	 * It is bidirectional and its opposite is '{@link org.unicase.emfstore.esmodel.versioning.Version#getPreviousVersion <em>Previous Version</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
