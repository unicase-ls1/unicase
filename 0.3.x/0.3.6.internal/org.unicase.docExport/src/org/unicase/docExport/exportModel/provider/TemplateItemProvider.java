		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ExportModelPackage.Literals.TEMPLATE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDefaultTemplatePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Template_defaultTemplate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Template_defaultTemplate_feature", "_UI_Template_type"),
				 ExportModelPackage.Literals.TEMPLATE__DEFAULT_TEMPLATE,
				 true,
				 false,
				 false,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ExportModelPackage.Literals.TEMPLATE__MODEL_ELEMENT_RENDERER_MAPPING,
				 RenderersFactory.eINSTANCE.createModelElementRendererMapping()));
