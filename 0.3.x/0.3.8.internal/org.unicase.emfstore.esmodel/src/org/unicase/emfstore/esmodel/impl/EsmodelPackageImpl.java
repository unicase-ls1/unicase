...
public class EsmodelPackageImpl extends EPackageImpl implements EsmodelPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getClientVersionInfo_Version(), theEcorePackage.getEString(), "version", null, 0, 1, ClientVersionInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getClientVersionInfo_Name(), theEcorePackage.getEString(), "name", null, 0, 1, ClientVersionInfo.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
