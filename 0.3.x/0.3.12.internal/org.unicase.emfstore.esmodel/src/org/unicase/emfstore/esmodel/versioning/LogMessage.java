 ...
 * org.unicase.emfstore.esmodel.versioning.LogMessage#getAuthor <em>Author</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.LogMessage#getMessage <em>Message</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.LogMessage#getDate <em>Date</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.LogMessage#getClientDate <em>Client Date</em>}</li> </ul> </p>
