...
public class ModelDiagramUpdater {
	...
	public static List getClassClassNode_attributes_7001SemanticChildren(
		...
		for (Iterator it = modelElement.getAttributes().iterator(); it
			...
			if (visualID == org.unicase.ui.tom.classDiagram.edit.parts.AttributeEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.tom.classDiagram.part.ModelNodeDescriptor(
	...
	public static List getClassClassNode_methods_7002SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getMethods().iterator(); it.hasNext();) {
			...
			int visualID = org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
					.getNodeVisualID(view, childElement);
			if (visualID == org.unicase.ui.tom.classDiagram.edit.parts.MethodEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.tom.classDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
	...
	public static List getMEDiagram_88SemanticChildren(View view) {
		...
		for (Iterator it = modelElement.getElements().iterator(); it.hasNext();) {
			...
			int visualID = org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
					.getNodeVisualID(view, childElement);
			if (visualID == org.unicase.ui.tom.classDiagram.edit.parts.ClassEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.tom.classDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
			}
			if (visualID == org.unicase.ui.tom.classDiagram.edit.parts.PackageEditPart.VISUAL_ID) {
				result
						.add(new org.unicase.ui.tom.classDiagram.part.ModelNodeDescriptor(
								childElement, visualID));
				continue;
	...
	public static List getClass_2001ContainedLinks(View view) {
		...
		List result = new LinkedList();
		result
				.addAll(getOutgoingFeatureModelFacetLinks_Class_SubClasses_4005(modelElement));
		return result;
	}
	...
	public static List getClass_2001IncomingLinks(View view) {
		...
		result.addAll(getIncomingTypeModelFacetLinks_Association_4004(
				modelElement, crossReferences));
		result.addAll(getIncomingFeatureModelFacetLinks_Class_SubClasses_4005(
				modelElement, crossReferences));
	...
	private static Collection getContainedTypeModelFacetLinks_Association_4001(
		...
		for (Iterator links = container.getNewElements().iterator(); links
			...
			result
					.add(new org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor(
							src,
							dst,
							link,
	...
	private static Collection getContainedTypeModelFacetLinks_Dependency_4006(
		...
		for (Iterator links = container.getNewElements().iterator(); links
			...
			if (org.unicase.ui.tom.classDiagram.edit.parts.DependencyEditPart.VISUAL_ID != org.unicase.ui.tom.classDiagram.part.ModelVisualIDRegistry
					.getLinkWithClassVisualID(link)) {
				continue;
			}
			...
			result
					.add(new org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor(
							...
							dst,
							link,
							org.unicase.ui.tom.classDiagram.providers.ModelElementTypes.Dependency_4006,
	 ...
	 * @generated
	 */
	private static Collection getIncomingFeatureModelFacetLinks_Class_SubClasses_4005(
			Class target, Map crossReferences) {
		Collection result = new LinkedList();
		Collection settings = (Collection) crossReferences.get(target);
		for (Iterator it = settings.iterator(); it.hasNext();) {
			...
			if (setting.getEStructuralFeature() == ClassesPackage.eINSTANCE
				...
				result
						.add(new org.unicase.ui.tom.classDiagram.part.ModelLinkDescriptor(
								setting.getEObject(),
								target,
								org.unicase.ui.tom.classDiagram.providers.ModelElementTypes.ClassSubClasses_4005,
	 ...
	 * @generated
	 */
	private static Collection getOutgoingFeatureModelFacetLinks_Class_SubClasses_4005(
			Class source) {
		Collection result = new LinkedList();
