...
/*
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Read Event</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.ReadEvent#getModelElement <em>Model Element</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.ReadEvent#getSourceView <em>Source View</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.ReadEvent#getReadView <em>Read View</em>}</li> </ul> </p>
...
public interface ReadEvent extends Event {
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.versioning.events.ReadEvent#getModelElement <em>Model Element</em>}' containment reference.
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.versioning.events.ReadEvent#getReadView <em>Read View</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
