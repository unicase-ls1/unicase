...
public class ModelNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public OpenDiagramAction(ICommonViewerWorkbenchSite viewerSite) {
			super(org.unicase.model.classDiagram.part.Messages.NavigatorActionProvider_OpenDiagramActionName);
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof org.unicase.model.classDiagram.navigator.ModelNavigatorItem) {
					selectedElement = ((org.unicase.model.classDiagram.navigator.ModelNavigatorItem) selectedElement)
						.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (org.unicase.model.classDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
						.equals(org.unicase.model.classDiagram.part.ModelVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, org.unicase.model.classDiagram.part.ModelDiagramEditor.ID);
