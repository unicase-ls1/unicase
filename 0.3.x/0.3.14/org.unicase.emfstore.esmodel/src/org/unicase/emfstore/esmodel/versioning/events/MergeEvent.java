...
/*
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Merge Event</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.MergeEvent#getNumberOfConflicts <em>Number Of Conflicts</em>}</li>
