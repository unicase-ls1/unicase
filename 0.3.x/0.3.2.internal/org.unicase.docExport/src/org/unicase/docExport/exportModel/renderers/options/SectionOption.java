...
/**
 * <!-- begin-user-doc -->
 * A representation of the model object '<em><b>Section Option</b></em>'.
 * <!-- end-user-doc -->
 *
 * <p>
...
public interface SectionOption extends RendererOption {
	/**
	 * Returns the value of the '<em><b>Section Numbering Style</b></em>' attribute.
	 * The literals are from the enumeration {@link org.unicase.docExport.exportModel.renderers.options.SectionNumberingStyle}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Section Numbering Style</em>' attribute isn't clear,
	 ...
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Leave Out Previous Section Numbering</em>' attribute isn't clear,
	 * there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
