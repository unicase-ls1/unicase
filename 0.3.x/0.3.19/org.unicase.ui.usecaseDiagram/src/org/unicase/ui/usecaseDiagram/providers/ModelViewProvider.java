...
public class ModelViewProvider extends AbstractViewProvider {
	...
	protected Class getDiagramViewClass(IAdaptable semanticAdapter, String diagramKind) {
		...
		if (org.unicase.ui.usecaseDiagram.edit.parts.MEDiagramEditPart.MODEL_ID.equals(diagramKind)
			&& org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getDiagramVisualID(semanticElement) != -1) {
			return org.unicase.ui.usecaseDiagram.view.factories.MEDiagramViewFactory.class;
		}
		return null;
	}
	...
	protected Class getNodeViewClass(IAdaptable semanticAdapter, View containerView, String semanticHint) {
		...
		if (semanticHint == null) {
			...
			visualID = org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getNodeVisualID(containerView,
				domainElement);
		} else {
			visualID = org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getVisualID(semanticHint);
			if (elementType != null) {
				// Semantic hint is specified together with element type.
				// Both parameters should describe exactly the same diagram element.
				// In addition we check that visualID returned by VisualIDRegistry.getNodeVisualID() for
				// domainElement (if specified) is the same as in element type.
				if (!org.unicase.ui.usecaseDiagram.providers.ModelElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
					&& visualID != org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getNodeVisualID(
				...
				if (!org.unicase.ui.usecaseDiagram.edit.parts.MEDiagramEditPart.MODEL_ID
					.equals(org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getModelID(containerView))) {
	...
	protected Class getNodeViewClass(View containerView, int visualID) {
		if (containerView == null
			|| !org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.canCreateNode(containerView, visualID)) {
			return null;
		}
		switch (visualID) {
		case org.unicase.ui.usecaseDiagram.edit.parts.ActorEditPart.VISUAL_ID:
	...
	protected Class getEdgeViewClass(IAdaptable semanticAdapter, View containerView, String semanticHint) {
		...
		int visualID = org.unicase.ui.usecaseDiagram.part.ModelVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(semanticAdapter);
		if (domainElement != null
