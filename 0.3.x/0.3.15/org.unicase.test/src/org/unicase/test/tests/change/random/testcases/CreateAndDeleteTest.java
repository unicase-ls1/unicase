...
public class CreateAndDeleteTest extends ChangePackageTest {
	...
	private void changeSimpleRef(ModelElement me) {
		...
		EReference ref = nonContainmentRefs.get(getRandom().nextInt(nonContainmentRefs.size() - 1));
		EClass refType = ref.getEReferenceType();
		List<ModelElement> refTypeMEs = getTestProject().getAllModelElementsbyClass(refType,
