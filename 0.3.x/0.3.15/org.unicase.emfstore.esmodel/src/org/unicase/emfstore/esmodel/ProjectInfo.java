 ...
 * <p> The following features are supported: <ul> <li>{@link org.unicase.emfstore.esmodel.ProjectInfo#getName
 * <em>Name</em>}</li> <li>{@link org.unicase.emfstore.esmodel.ProjectInfo#getDescription <em>Description</em>}</li>
 * <li>{@link org.unicase.emfstore.esmodel.ProjectInfo#getProjectId <em>Project Id</em>}</li> <li>{@link
 * org.unicase.emfstore.esmodel.ProjectInfo#getVersion <em>Version</em>}</li> </ul> </p>
