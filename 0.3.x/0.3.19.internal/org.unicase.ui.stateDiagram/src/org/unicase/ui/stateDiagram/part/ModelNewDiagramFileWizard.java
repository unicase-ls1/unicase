...
public class ModelNewDiagramFileWizard extends Wizard {
	...
	public ModelNewDiagramFileWizard(URI domainModelURI, EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		...
		myFileCreationPage.setFileName(org.unicase.ui.stateDiagram.part.ModelDiagramEditorUtil.getUniqueFileName(
	...
	public boolean performFinish() {
		...
		org.unicase.ui.stateDiagram.part.ModelDiagramEditorUtil.setCharset(diagramFile);
		affectedFiles.add(diagramFile);
		URI diagramModelURI = URI.createPlatformResourceURI(diagramFile.getFullPath().toString(), true);
		ResourceSet resourceSet = myEditingDomain.getResourceSet();
		final Resource diagramResource = resourceSet.createResource(diagramModelURI);
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(myEditingDomain,
			org.unicase.ui.stateDiagram.part.Messages.ModelNewDiagramFileWizard_InitDiagramCommand, affectedFiles) {
		...
		try {
			...
			org.unicase.ui.stateDiagram.part.ModelDiagramEditorUtil.openDiagram(diagramResource);
