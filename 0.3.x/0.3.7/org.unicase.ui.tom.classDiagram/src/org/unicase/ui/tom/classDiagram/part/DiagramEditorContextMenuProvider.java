...
public class DiagramEditorContextMenuProvider extends
	 ...
	 * @generated
	 */
	private org.unicase.ui.tom.classDiagram.part.DeleteElementAction deleteAction;
	...
	public DiagramEditorContextMenuProvider(IWorkbenchPart part,
		...
		super(part, viewer);
		this.part = part;
		deleteAction = new org.unicase.ui.tom.classDiagram.part.DeleteElementAction(
				part);
		deleteAction.init();
	}
