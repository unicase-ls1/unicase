...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Undo Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class UndoEventImpl extends EventImpl implements UndoEvent {
	...
	public AbstractOperation getOperation() {
		if (operation != null && operation.eIsProxy()) {
			...
			if (operation != oldOperation) {
				...
				NotificationChain msgs = oldOperation.eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE
								- EventsPackage.UNDO_EVENT__OPERATION, null,
						null);
				if (newOperation.eInternalContainer() == null) {
					msgs = newOperation.eInverseAdd(this,
							EOPPOSITE_FEATURE_BASE
									- EventsPackage.UNDO_EVENT__OPERATION,
							null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							EventsPackage.UNDO_EVENT__OPERATION, oldOperation,
							operation));
			}
		}
		return operation;
	 ...
	 * @generated
	 */
	public NotificationChain basicSetOperation(AbstractOperation newOperation,
			NotificationChain msgs) {
		AbstractOperation oldOperation = operation;
		operation = newOperation;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, EventsPackage.UNDO_EVENT__OPERATION,
	...
	public void setOperation(AbstractOperation newOperation) {
		if (newOperation != operation) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					EventsPackage.UNDO_EVENT__OPERATION, newOperation,
					newOperation));
	}
