...
/*
 * <!-- begin-user-doc --> A representation of the model object '<em><b>Undo Event</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link
 * org.unicase.emfstore.esmodel.versioning.events.UndoEvent#getOperation <em>Operation</em>}</li> </ul> </p>
...
public interface UndoEvent extends Event {
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.versioning.events.UndoEvent#getOperation <em>Operation</em>}' containment reference.
