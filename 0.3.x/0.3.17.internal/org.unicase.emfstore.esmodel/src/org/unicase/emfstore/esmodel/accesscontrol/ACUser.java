...
/*
 * <!-- begin-user-doc --> A representation of the model object ' <em><b>AC User</b></em>'. <!-- end-user-doc --> <p>
 * The following features are supported: <ul> <li>{@link org.unicase.emfstore.esmodel.accesscontrol.ACUser#getFirstName
 * <em>First Name</em>}</li> <li>{@link org.unicase.emfstore.esmodel.accesscontrol.ACUser#getLastName <em>Last
 * Name</em>}</li> </ul> </p>
...
public interface ACUser extends ACOrgUnit {
	...
	/**
	 * Sets the value of the '{@link org.unicase.emfstore.esmodel.accesscontrol.ACUser#getLastName <em>Last Name</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
