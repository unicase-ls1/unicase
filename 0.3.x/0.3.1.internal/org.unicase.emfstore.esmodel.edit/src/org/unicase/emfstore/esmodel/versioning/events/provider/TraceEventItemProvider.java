...
/**
 * This is the item provider adapter for a {@link org.unicase.emfstore.esmodel.versioning.events.TraceEvent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TraceEventItemProvider extends EventItemProvider implements
	...
	protected void addSourceElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_TraceEvent_sourceElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_TraceEvent_sourceElement_feature",
						"_UI_TraceEvent_type"),
				EventsPackage.Literals.TRACE_EVENT__SOURCE_ELEMENT, true,
	...
	protected void addTargetElementPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TraceEvent_targetElement_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_TraceEvent_targetElement_feature",
						"_UI_TraceEvent_type"),
				EventsPackage.Literals.TRACE_EVENT__TARGET_ELEMENT, true,
				false, true, null, null, null));
	}
	...
	protected void addFeatureNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory)
						.getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_TraceEvent_featureName_feature"), getString(
						"_UI_PropertyDescriptor_description",
						"_UI_TraceEvent_featureName_feature",
						"_UI_TraceEvent_type"),
				EventsPackage.Literals.TRACE_EVENT__FEATURE_NAME, true, false,
