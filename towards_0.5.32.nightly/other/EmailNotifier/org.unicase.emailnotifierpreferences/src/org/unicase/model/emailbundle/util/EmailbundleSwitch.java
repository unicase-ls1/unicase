 ...
 * @generated
 */
public class EmailbundleSwitch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EmailbundlePackage.BUNDLE: {
				Bundle bundle = (Bundle)theEObject;
				T result = caseBundle(bundle);
				if (result == null) result = caseUnicaseModelElement(bundle);
				if (result == null) result = caseModelElement(bundle);
				if (result == null) result = caseIdentifiableElement(bundle);
