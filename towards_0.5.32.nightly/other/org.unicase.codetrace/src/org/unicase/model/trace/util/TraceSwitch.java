 ...
 */
package org.unicase.model.trace.util;
...
public class TraceSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case TracePackage.CODE_LOCATION: {
			...
			if (result == null)
				result = caseAttachment(codeLocation);
			if (result == null)
				result = caseNonDomainElement(codeLocation);
			if (result == null)
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Line Hash</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Line Hash</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
