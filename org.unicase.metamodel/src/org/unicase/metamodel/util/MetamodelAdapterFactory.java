...
public class MetamodelAdapterFactory extends AdapterFactoryImpl {
	...
	protected MetamodelSwitch<Adapter> modelSwitch = new MetamodelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEObjectToModelElementIdContainmentMap(Map.Entry<EObject, ModelElementId> object) {
			return createEObjectToModelElementIdContainmentMapAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.unicase.metamodel.ModelElementId <em>Model Element Id</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can
	 * easily ignore cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!--
	 * end-user-doc -->
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link java.util.Map.Entry <em>EObject To Model Element Id Containment Map</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
