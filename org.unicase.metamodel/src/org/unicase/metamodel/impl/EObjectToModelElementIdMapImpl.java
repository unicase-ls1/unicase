 ...
 * <ul>
 *   <li>{@link org.unicase.metamodel.impl.EObjectToModelElementIdMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.unicase.metamodel.impl.EObjectToModelElementIdMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EObjectToModelElementIdMapImpl extends EObjectImpl implements BasicEMap.Entry<EObject, ModelElementId> {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.EOBJECT_TO_MODEL_ELEMENT_ID_MAP;
	}
			...
			if (key != oldKey) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__KEY, oldKey, key));
			}
		}
		return key;
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				...
				NotificationChain msgs = oldValue.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE, null, null);
				if (newValue.eInternalContainer() == null) {
					msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public NotificationChain basicSetTypedValue(ModelElementId newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypedValue(ModelElementId newValue) {
		if (newValue != value) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE, newValue, newValue));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__VALUE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_MAP__KEY:
			if (resolve)
				return getTypedKey();
