...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>EObject To Model Element Id Containment Map</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.unicase.metamodel.impl.EObjectToModelElementIdContainmentMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.unicase.metamodel.impl.EObjectToModelElementIdContainmentMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class EObjectToModelElementIdContainmentMapImpl extends EObjectImpl implements
	 ...
	 * @generated
	 */
	protected EObjectToModelElementIdContainmentMapImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP;
	}
		...
		if (key != null && key.eIsProxy()) {
			...
			if (key != oldKey) {
				...
				NotificationChain msgs = oldKey.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__KEY, null, null);
				if (newKey.eInternalContainer() == null) {
					msgs = newKey.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__KEY, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__KEY, oldKey, key));
			}
		}
		return key;
	}
	...
	public NotificationChain basicSetTypedKey(EObject newKey, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__KEY, oldKey, newKey);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setTypedKey(EObject newKey) {
		if (newKey != key) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__KEY, newKey, newKey));
	}
		...
		if (value != null && value.eIsProxy()) {
			...
			if (value != oldValue) {
				...
				NotificationChain msgs = oldValue.eInverseRemove(this, EOPPOSITE_FEATURE_BASE
					- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__VALUE, null, null);
				if (newValue.eInternalContainer() == null) {
					msgs = newValue.eInverseAdd(this, EOPPOSITE_FEATURE_BASE
						- MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__VALUE, null, msgs);
				}
				if (msgs != null)
					msgs.dispatch();
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__VALUE, oldValue, value));
			}
		}
		return value;
	}
	...
	public NotificationChain basicSetTypedValue(ModelElementId newValue, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__VALUE, oldValue, newValue);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setTypedValue(ModelElementId newValue) {
		if (newValue != value) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				MetamodelPackage.EOBJECT_TO_MODEL_ELEMENT_ID_CONTAINMENT_MAP__VALUE, newValue, newValue));
	}
...
} //EObjectToModelElementIdContainmentMapImpl
